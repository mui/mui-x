...
export default [
  ...
  { pathname: '/x/api/date-pickers/date-range-calendar', title: 'DateRangeCalendar', plan: 'pro' },
  { pathname: '/x/api/date-pickers/date-range-picker', title: 'DateRangePicker', plan: 'pro' },
  {
  ...
  { pathname: '/x/api/date-pickers/pickers-sections-list', title: 'PickersSectionsList' },
  ...
  { pathname: '/x/api/date-pickers/static-date-time-picker', title: 'StaticDateTimePicker' },
