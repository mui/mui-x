...
:::info
The technical support covers only MUI X components. If you need coverage of MUI Core components, you'll have to purchase the [priority support](/x/introduction/priority-support/).
:::
