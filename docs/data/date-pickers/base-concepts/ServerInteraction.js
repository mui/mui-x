...
DisplayEvents.propTypes = {
  onAcceptLogs: PropTypes.arrayOf(
    PropTypes.oneOfType([
  ...
  onChangeLogs: PropTypes.arrayOf(
    PropTypes.oneOfType([
      PropTypes.oneOf([null]),
      PropTypes.shape({
        /**
...
export default function ServerInteraction() {
  const [onChangeLogs, setOnChangeLogs] = React.useState([]);
  const [onAcceptLogs, setOnAcceptLogs] = React.useState([]);
