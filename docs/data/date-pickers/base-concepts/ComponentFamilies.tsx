...
export default function ComponentFamilies() {
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      ...
      >
        <DemoItem label="Date">
          <DateField defaultValue={dayjs('2022-04-21')} />
        </DemoItem>
        <DemoItem label="Time">
          <TimeField defaultValue={dayjs('2022-04-21T15:30')} />
        </DemoItem>
        <DemoItem label="Date Time">
          <DateTimeField defaultValue={dayjs('2022-04-21T15:30')} />
        </DemoItem>
        <DemoItem
        ...
        >
          <MultiInputDateTimeRangeField
            defaultValue={[dayjs('2022-04-21T15:30'), dayjs('2022-04-10T18:30')]}
          />
        </DemoItem>
      </DemoContainer>
