...
const shortcuts = [
  {
    ...
    getValue: (value, view, isValid, adapter) => {
      // (January 1)
      const today = adapter.date();
      return adapter.setDay(adapter.setMonth(today, 0), 1);
    },
  },
  {
  ...
  },
  {
    ...
    getValue: (value, view, isValid, adapter) => {
      // (July 4)
      const today = adapter.date();
      return adapter.setDay(adapter.setMonth(today, 6), 4);
    },
  },
  {
    label: 'Labor Day',
  ...
  },
  {
    ...
    getValue: (value, view, isValid, adapter) => {
      // (November 11)
      const today = adapter.date();
      return adapter.setDay(adapter.setMonth(today, 10), 11);
    },
  },
  {
  ...
  },
  {
    ...
    getValue: (value, view, isValid, adapter) => {
      // (December 1)
      const today = adapter.date();
      return adapter.setDay(adapter.setMonth(today, 11), 1);
    },
  },
  {
    label: 'Christmas Day',
    getValue: (value, view, isValid, adapter) => {
      // (December 25)
      const today = adapter.date();
      return adapter.setDay(adapter.setMonth(today, 11), 25);
    },
  },
];
