...
This is the advanced demo for teams that want to keep the headless behavior model while reshaping the markup to match a product-specific design system.
...
- Continue with [Customization](/x/react-chat/headless/customization/) for the cross-cutting reference page.
- Return to [Minimal headless shell](/x/react-chat/headless/examples/minimal-shell/) if the slot model feels abstract and you want to re-anchor on the default structure.
