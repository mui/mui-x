...
export function DemoSplitLayout({ sidebar, children }) {
  return (
...
export function DemoHeading({ title, description, actions }) {
  return (
    <div
      style={{
        display: 'flex',
...
export function DemoSectionLabel({ children }) {
...
export function DemoTextarea(props) {
  const { style, ...other } = props;

  return <textarea style={{ ...styles.textarea, ...style }} {...other} />;
}

export function DemoTag({ children }) {
...
export function DemoStats({ items }) {
  return (
...
export function DemoCodeBlock({ children }) {
