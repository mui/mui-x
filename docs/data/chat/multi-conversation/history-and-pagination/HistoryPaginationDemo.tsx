...
type ListMessages = NonNullable<ChatAdapter['listMessages']>;
...
const allMessages: ChatMessage[] = Array.from({ length: TOTAL }, (_, index) => {
...
const listMessages: ListMessages = async ({ cursor }) => {
...
const adapter: ChatAdapter = { ...createEchoAdapter(), listMessages };
