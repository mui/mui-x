...
// Demo data
// ---------------------------------------------------------------------------
function createAvatarDataUrl(label, bg, fg = '#ffffff') {
...
// Slot components
// ---------------------------------------------------------------------------
const IntercomMessageGroup = React.forwardRef(
  function IntercomMessageGroup(props, ref) {
...
const IntercomMessageRoot = React.forwardRef(
  function IntercomMessageRoot(props, ref) {
    const { children, ownerState, style, ...other } = props;
...
const IntercomBubble = React.forwardRef(function IntercomBubble(props, ref) {
  const { children, ownerState, style, ...other } = props;
  const isUser = ownerState?.role === 'user';
  return (
    <div
...
const IntercomMeta = React.forwardRef(function IntercomMeta(props, ref) {
...
const IntercomComposerRoot = React.forwardRef(
  function IntercomComposerRoot(props, ref) {
    const { children, ownerState, style, ...other } = props;
    return (
      <form
        ref={ref}
...
const IntercomTextArea = React.forwardRef(function IntercomTextArea(props, ref) {
  const { ownerState, style, ...other } = props;
  return (
    <textarea
      ref={ref}
...
const IntercomSendButton = React.forwardRef(function IntercomSendButton(props, ref) {
