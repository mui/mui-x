...
const initialMessages = [
  ...
  },
  {
    ...
    role: 'user',
    status: 'sent',
    parts: [{ type: 'text', text: 'I was charged twice this month.' }],
  },
  {
    id: 'onboarding-1',
  ...
  },
  {
    ...
    role: 'user',
    status: 'sent',
    parts: [{ type: 'text', text: 'Where do I add my team members?' }],
  },
];

export default function ControlledActiveConversation() {
  const [activeId, setActiveId] = React.useState(BILLING_ID);
