 ...
 */
export function buildStudioContext(view: ContextRef): Record<string, unknown> {
...
export const STUDIO_COPILOT_PLUGINS = [studioFormulaPlugin(), studioPdfReportPlugin()];
 ...
 * collide.
 */
export function createStudioCopilotAdapter({
  ctxRef,
  storageKey,
}: {
