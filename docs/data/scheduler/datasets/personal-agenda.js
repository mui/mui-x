...
export const initialEvents = [
  ...
  ...Array.from({ length: 52 }, (_1, i) =>
    Array.from({ length: 5 }, (_2, j) => ({
      ...
      end: START_OF_FIRST_WEEK.plus({ days: i * 7 + j }).set({
        hour: 9,
        minute: 30,
      }),
      title: 'Daily Standup',
  ...
  ...Array.from({ length: 52 / 2 }, (_1, i) => ({
    ...
    start: START_OF_FIRST_WEEK.plus({ weeks: 2 * i + 1 }).set({
      hour: 14,
      weekday: 3,
    }),
    end: START_OF_FIRST_WEEK.plus({ weeks: 2 * i + 1 }).set({
      hour: 15,
      weekday: 3,
    }),
  ...
  ...Array.from({ length: 52 / 3 }, (_1, i) => ({
    id: `1-on-1-john-${i + 1}`,
    start: START_OF_FIRST_WEEK.plus({ weeks: 3 * i + 1 }).set({
      hour: 10,
      weekday: 3,
    }),
    end: START_OF_FIRST_WEEK.plus({ weeks: 3 * i + 1 }).set({
      hour: 11,
      weekday: 3,
    }),
  ...
  ...Array.from({ length: 52 }, (_1, i) => [
    ...
    },
    {
      ...
      end: START_OF_FIRST_WEEK.plus({ weeks: i }).set({
        weekday: 3,
        hour: 7,
        minute: 45,
      }),
    ...
    },
    {
      ...
      start: START_OF_FIRST_WEEK.plus({ weeks: i }).set({
        weekday: 4,
        hour: 18,
        minute: 30,
      }),
