...
export const initialEvents: CalendarEvent[] = [
  ...
  },
  {
    ...
    title: 'Last Friday of Month -1FR',
    resource: 'monthly',
  ...
  },
  {
    ...
    title: '2nd and 4th Tuesday, 2TU and 4TU',
    resource: 'monthly',
  ...
  },
  {
    ...
    title: 'Monthly on 20th every two months',
    resource: 'monthly',
  ...
  },
  {
    ...
    title: 'Monthly on 31st (skip short months)',
    resource: 'monthly',
  ...
  },
  {
    ...
    title: 'Every 2 Months on 2nd Thu, 2TH',
    resource: 'monthly',
  ...
  // ALL-DAY AND SPANNING EVENTS
  {
    ...
    end: START.set({ month: 7, day: 6, hour: 9 }),
    title: 'First Saturday of the Month, 1SA',
    allDay: true,
    resource: 'allday',
  ...
  },
  {
    ...
    end: START.plus({ weeks: 1 }).set({ weekday: 1, hour: 0 }),
