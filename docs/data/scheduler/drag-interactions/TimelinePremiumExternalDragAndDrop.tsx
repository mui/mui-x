...
import classes from './TimelinePremiumExternalDragAndDrop.module.css';

const isValidDropTarget = buildIsValidDropTarget(['TimelinePremiumEvent']);
...
export default function TimelinePremiumExternalDragAndDrop() {
