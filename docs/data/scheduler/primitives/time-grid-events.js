...
export function groupEventsByDay(eventsToGroup) {
  const groupedEvents = {};
  ...
  return Object.values(groupedEvents).sort(
    (a, b) => a.date.toMillis() - b.date.toMillis(),
  );
}

export function groupEventsByResource(eventsToGroup) {
  const groupedEvents = {};
...
export function getEventsDateRange(eventsToGroup) {
  let start = null;
  let end = null;
