...
const settings = {
  height: 400,
  xAxis: [{ data: dates, valueFormatter: (value: number) => `${value}` }],
  yAxis: [
    {
      id: 'subscribers',
      label: 'Subscribers',
      valueFormatter: (value: number) => subscribersFormatter.format(value!),
    },
    {
      id: 'growth',
      position: 'right',
      label: 'Subscriber Growth',
      valueFormatter: (value: number) => subscriberGrowthFormatter.format(value!),
    },
  ],
  slotProps: {
    legend: {
