      ...
      <Stack spacing={2} sx={{ minWidth: 200 }}>
        ...
        <div>
          ...
          <Slider
            ...
            onChange={(event, value) => {
              setView((prev) => ({
                ...prev,
                translation: [value, prev.translation[1]],
              }));
            }}
          />
          <Slider
            ...
            onChange={(event, value) => {
              setView((prev) => ({
                ...prev,
                translation: [prev.translation[0], value],
              }));
            }}
          />
        </div>
        <div>
          ...
          <Slider
            ...
            onChange={(event, value) => {
              setView((prev) => ({ ...prev, zoomLevel: value }));
            }}
          />
        </div>
        <div>
