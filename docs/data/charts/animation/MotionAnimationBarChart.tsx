...
import { BarChart, type BarElementProps } from '@mui/x-charts/BarChart';
...
function AnimatedBar(props: BarElementProps) {
  const { x, y, height, width, color, dataIndex, ...other } = props;
