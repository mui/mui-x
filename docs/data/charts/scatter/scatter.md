...
Scatter charts provide an click handler called `onItemClick` with the following signature.
...
If `disableVoronoi=true` users need to click on the scatter element, and the mouse event will come from this element.
