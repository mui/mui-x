...
export const countryData = {
  ...
  EGY: { country: 'Egypt, Arab Rep.', continent: 'Africa' },
  ...
  HKG: { country: 'Hong Kong SAR, China', continent: 'Asia' },
  ...
  IRN: { country: 'Iran, Islamic Rep.', continent: 'Asia' },
  ...
  KGZ: { country: 'Kyrgyz Republic', continent: 'Asia' },
  LAO: { country: 'Lao PDR', continent: 'Asia' },
  ...
  FSM: { country: 'Micronesia, Fed. Sts.', continent: 'Oceania' },
  ...
  SVK: { country: 'Slovak Republic', continent: 'Europe' },
