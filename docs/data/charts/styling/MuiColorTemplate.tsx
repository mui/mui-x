...
const categorical = {
  ...
  signalDuo: signalDuoPalette,
  desertDune: desertDunePalette,
  tropicalPunch: tropicalPunchPalette,
  sageGarden: sageGardenPalette,
  neonCyber: neonCyberPalette,
  autumnSpice: autumnSpicePalette,
  sunsetCoral: sunsetCoralPalette,
  candyPop: candyPopPalette,
} as const;
const sequential = {
