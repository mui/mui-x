...
const symbols: Record<string, string> = {
  ...
  diamond: 'M0,-7.423L4.285,0L0,7.423L-4.285,0Z',
  star: 'M0,-7.528L1.69,-2.326L7.16,-2.326L2.735,0.889L4.425,6.09L0,2.875L-4.425,6.09L-2.735,0.889L-7.16,-2.326L-1.69,-2.326Z',
};

function CustomMark({ itemId, color, className }: ChartsLabelMarkProps) {
  const data = symbols[itemId?.toString() ?? 'cross'];
