...
Multi filters allow filtering rows by multiple columns with multiple criteria. To add more filters from the filter panel, use `Add Filter` button on the panel.
