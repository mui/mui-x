...
If the filter operator has a [custom `InputComponent`](/x/react-data-grid/filtering/#custom-input-component), the same component is being used for the header filter.
