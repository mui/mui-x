...
To export server-side data through the DataGrid, use [`updateRows()`](/x/react-data-grid/row-updates/#the-updaterows-method) to temporary set the data before calling one of export functions.
