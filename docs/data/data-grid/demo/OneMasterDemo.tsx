...
import { DataGridPremium, GridColDef, GridRenderCellParams, GridToolbarContainer, GridToolbarQuickFilter } from "@mui/x-data-grid-premium";
...
export const PlanTag = (props:{plan:string}) => {
  ...
  return <Chip avatar={avatar} sx={{background:chipPropperties.color}} label={plan} />
}
