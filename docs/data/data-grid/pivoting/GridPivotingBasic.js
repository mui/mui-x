...
function FieldsSelect({ options, label = '', values, onChange }) {
...
function SingleSelect({ label, value, onChange, options }) {
  const labelId = useId();
  const id = useId();
...
function ValuesEditor({ values, options, onChange }) {
...
function PivotModelEditor({ pivotModel, columns, onPivotModelChange }) {
