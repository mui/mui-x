...
Visit the [MUI Console](https://console.mui.com/lp/ai-datagrid) to grab a free API key or manage your plan.
:::
...
1. Get an API key from the [MUI Console](https://console.mui.com/lp/ai-datagrid)—a free tier is available, and you can manage your plan there as well.
