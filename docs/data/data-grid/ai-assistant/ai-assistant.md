...
Visit the [MUI Console](https://console.mui.com/lp/ai-datagrid?utm_source=docs&utm_medium=referral&utm_campaign=ai-datagrid&utm_content=info-callout) to grab a free API key or manage your plan.
:::
...
1. Get an API key from the [MUI Console](https://console.mui.com/lp/ai-datagrid?utm_source=docs&utm_medium=referral&utm_campaign=ai-datagrid&utm_content=setup-step)—a free tier is available, and you can manage your plan there as well.
