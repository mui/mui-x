...
- High performance 🚀
- [Filtering](/x/react-data-grid/filtering/overview/), [multi-filters](/x/react-data-grid/filtering/multi-filters/) <span class="plan-pro"></span>, and [header filters](/x/react-data-grid/filtering/header-filters/) <span class="plan-premium"></span>
