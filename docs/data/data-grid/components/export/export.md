...
You can set up a custom export button to download the full dataset—beyond the current page—while preserving the sorting, filtering, and grouping. It uses the built-in [exportDataAsExcel](/x/react-data-grid/export/#excel) API.
