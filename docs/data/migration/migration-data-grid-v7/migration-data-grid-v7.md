...
- The "Select all" checkbox would now be checked when all the selectable rows are selected, even when some rows are not selected because of the `isRowSelectable` prop.
