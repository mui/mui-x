...
import translation from 'docs/translations/api-docs/data-grid/grid-row-order-change-params/grid-row-order-change-params.json';
import jsonPageContent from './grid-row-order-change-params.json';
