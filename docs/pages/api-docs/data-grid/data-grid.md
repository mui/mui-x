...
| <span class="prop-name">onCellFocusOut</span> | <span class="prop-type">(params: GridCellParams, event?: MuiEvent<MouseEvent>, details?: any) => void</span> |   | Callback fired when a cell loses focus. |
