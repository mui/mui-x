...
| <span class="prop-name">onViewportRowsChange</span> | <span class="prop-type">(param: GridViewportRowsChangeParams) => void</span> |   | Callback fired when the virtual page changes. |
