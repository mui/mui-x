...
| <span class="prop-name">onPageChange</span> | <span class="prop-type">(page: number, event: MuiEvent<{}>) => void</span> |   | Callback fired when the current page has changed. |
| <span class="prop-name">onPageSizeChange</span> | <span class="prop-type">(pageSize: number, event: MuiEvent<{}>) => void</span> |   | Callback fired when the page size has changed. |
