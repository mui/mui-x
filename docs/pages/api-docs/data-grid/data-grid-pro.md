...
| <span class="prop-name">onCellEditCommit</span> | <span class="prop-type">(params: GridCellEditCommitParams, event: MouseEvent<React.SyntheticEvent>) => void</span> |   | Callback fired when the cell changes are committed. |
