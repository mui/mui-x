...
| <span class="prop-name optional">disable<sup><abbr title="optional">?</abbr></sup></span>       | <span class="prop-type">boolean</span>            | <span class="prop-default">false<br /></span>                  | If `true`, the Print export option will be removed from the GridToolbarExport menu.                                                        |
