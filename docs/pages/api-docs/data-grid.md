...
| Name | Type | Default | Description |
|:-----|:-----|:--------|:------------|
| <span class="prop-name">Checkbox</span> | <span class="prop-type">React.ElementType</span> | <span class="prop-type">GridCheckbox</span> | Checkbox component used in the grid for both header and cells.|
