...
| <span class="prop-name">AllFilteredOverlay</span> | <span class="prop-type">React.ElementType</span> | <span class="prop-type">AllFilteredOverlay</span> | All filtered overlay component rendered when the grid has no results after filtering.|
