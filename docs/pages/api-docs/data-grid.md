...
| <span class="prop-name">NoFilteredRowsOverlay </span> | <span class="prop-type">React.ElementType</span> | <span class="prop-type">NoFilteredRowsOverlay </span> | No filtered rows overlay component rendered when the grid has no results after filtering.|
