...
const allThreads: Record<string, ChatMessage[]> = {
  historical: [
    {
      id: 'h-u1',
...
const GptConversationItem = React.forwardRef(function GptConversationItem(
  ...
  const hasUnread = (conversation as { unreadCount?: number })?.unreadCount
    ? (conversation as { unreadCount: number }).unreadCount > 0
    : false;
  ...
  return (
    <React.Fragment>
      ...
      <ConversationMenu anchorEl={menuAnchor} onClose={() => setMenuAnchor(null)} />
    </React.Fragment>
  );
});

const GptConversationAvatar = React.forwardRef(function GptConversationAvatar(
...
const GptConversationTitle = React.forwardRef(function GptConversationTitle(
  props: React.HTMLAttributes<HTMLDivElement> & {
...
const GptConversationPreview = React.forwardRef(function GptConversationPreview(
  props: React.HTMLAttributes<HTMLDivElement> & {
    ownerState?: unknown;
    conversation?: unknown;
    selected?: boolean;
...
const GptConversationTimestamp = React.forwardRef(function GptConversationTimestamp(
  props: React.HTMLAttributes<HTMLDivElement> & {
    ownerState?: unknown;
    conversation?: unknown;
    selected?: boolean;
...
const GptAuthorName = React.forwardRef(function GptAuthorName(
  props: React.PropsWithChildren<React.HTMLAttributes<HTMLDivElement>> & {
...
const GptMessageRoot = React.forwardRef(function GptMessageRoot(
  props: React.PropsWithChildren<React.HTMLAttributes<HTMLDivElement>> & {
    ownerState?: { role?: string };
  },
  ref: React.Ref<HTMLDivElement>,
...
const GptAvatar = React.forwardRef(function GptAvatar(
  props: React.PropsWithChildren<React.HTMLAttributes<HTMLDivElement>> & {
    ownerState?: { role?: string };
  },
  ref: React.Ref<HTMLDivElement>,
...
const GptBubble = React.forwardRef(function GptBubble(
  props: React.PropsWithChildren<React.HTMLAttributes<HTMLDivElement>> & {
    ownerState?: { role?: string };
  },
  ref: React.Ref<HTMLDivElement>,
...
// Hide timestamps
const GptMeta = React.forwardRef(function GptMeta(
  props: React.HTMLAttributes<HTMLDivElement> & {
    ownerState?: {
      role?: string;
      message?: { createdAt?: string; status?: string };
    };
  },
  ref: React.Ref<HTMLDivElement>,
) {
...
const GptToolHeader = React.forwardRef(function GptToolHeader(
  props: React.HTMLAttributes<HTMLDivElement> & { ownerState?: ToolPartOwnerState },
  ref: React.Ref<HTMLDivElement>,
) {
  const { ownerState: _ownerState, style, ...other } = props;
...
const GptToolTitle = React.forwardRef(function GptToolTitle(
  props: React.HTMLAttributes<HTMLDivElement> & { ownerState?: ToolPartOwnerState },
  ref: React.Ref<HTMLDivElement>,
) {
  const { ownerState: _ownerState, children, style, ...other } = props;
...
const GptToolState = React.forwardRef(function GptToolState(
  props: React.HTMLAttributes<HTMLSpanElement> & { ownerState?: ToolPartOwnerState },
  ref: React.Ref<HTMLSpanElement>,
) {
  const { ownerState, style, ...other } = props;
...
const GptTextArea = React.forwardRef(function GptTextArea(
...
const GptSendButton = React.forwardRef(function GptSendButton(
