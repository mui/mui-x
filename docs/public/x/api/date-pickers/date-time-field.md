...
- [Date Time Field](/x/react-date-pickers/date-time-field/)
...
You can use `MuiDateTimeField` to change the default props of this component with the theme.
...
- [/packages/x-date-pickers/src/DateTimeField/DateTimeField.tsx](https://github.com/mui/material-ui/tree/HEAD/packages/x-date-pickers/src/DateTimeField/DateTimeField.tsx)