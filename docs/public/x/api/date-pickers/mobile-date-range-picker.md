...
- [/packages/x-date-pickers-pro/src/MobileDateRangePicker/MobileDateRangePicker.tsx](https://github.com/mui/material-ui/tree/HEAD/packages/x-date-pickers-pro/src/MobileDateRangePicker/MobileDateRangePicker.tsx)