    ...
    return {
      ...
      resolve: {
        ...
        alias: {
          ...
          '@mui/x-data-grid/internals': path.resolve(
            currentDirectory,
            '../packages/x-data-grid/src/internals',
          ),
          '@mui/x-data-grid-pro/internals': path.resolve(
            currentDirectory,
            '../packages/x-data-grid-pro/src/internals',
          ),
          '@mui/x-data-grid-premium/internals': path.resolve(
            currentDirectory,
            '../packages/x-data-grid-premium/src/internals',
          ),
