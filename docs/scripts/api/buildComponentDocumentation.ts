...
import createDescribeableProp, {DescribeablePropDescriptor} from "@material-ui/monorepo/docs/src/modules/utils/createDescribeableProp";
import generatePropDescription from "@material-ui/monorepo/docs/src/modules/utils/generatePropDescription";
import {parse as parseDoctrine} from "doctrine";
import generatePropTypeDescription, {getChained} from "@material-ui/monorepo/docs/src/modules/utils/generatePropTypeDescription";
...
export default async function buildComponentDocumentation (options: BuildComponentDocumentationOptions) {
    ...
    const apiDocsTranslationDirectory = path.resolve(workspaceRoot, 'docs', 'translations', 'api-docs', 'data-grid')
