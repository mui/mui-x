...
import {escapeCell, generateSignatureStr, generateTypeStr, linkify, writePrettifiedFile} from "./utils";
...
export default function buildInterfaceDocumentation (options: BuildInterfaceDocumentationOptions) {
    const { reflection, apisToGenerate, prettierConfigPath, workspaceRoot, outputDirectory } = options
