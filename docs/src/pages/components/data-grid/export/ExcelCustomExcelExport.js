...
function CustomToolbar({ excelOptions }) {
  return (
    <GridToolbarContainer>
...
CustomToolbar.propTypes = {
  excelOptions: PropTypes.any.isRequired,
};
...
export default function ExcelCustomExcelExport() {
  return (
    <div style={{ height: 300, width: '100%' }}>
      <DataGridPro
        ...
        componentsProps={{ toolbar: { excelOptions: { exceljsPreprocess } } }}
