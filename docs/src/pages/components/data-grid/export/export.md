...
To enable the export selector you need to compose a toolbar containing the `ExportSelector` component, and apply it using the `Toolbar` key in the grid `components` prop.
