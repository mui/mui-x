...
{{"demo": "pages/components/pickers/time-picker/BasicTimePicker.js"}}

## Static mode

It's possible to render any time picker inline. This will enable building custom popover/modal containers.

{{"demo": "pages/components/pickers/time-picker/StaticTimePickerDemo.js", "bg": true}}
...
{{"demo": "pages/components/pickers/time-picker/ResponsiveTimePickers.js"}}

## Form props

The time picker component can be disabled or read-only.

{{"demo": "pages/components/pickers/time-picker/FormPropsTimePickers.js"}}
...
{{"demo": "pages/components/pickers/time-picker/LocalizedTimePicker.js"}}

## Time validation

{{"demo": "pages/components/pickers/time-picker/TimeValidationTimePicker.js"}}

## Landscape

{{"demo": "pages/components/pickers/time-picker/StaticTimePickerLandscape.js", "bg": true}}
...
{{"demo": "pages/components/pickers/time-picker/SubComponentsTimePickers.js"}}

## Seconds

The seconds input can be used for selection of a precise time point.

{{"demo": "pages/components/pickers/time-picker/SecondsTimePicker.js"}}
