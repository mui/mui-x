...
{{"demo": "pages/components/pickers/date-picker/BasicDatePicker.js"}}
...
{{"demo": "pages/components/pickers/date-picker/StaticDatePickerDemo.js", "bg": true}}
...
{{"demo": "pages/components/pickers/date-picker/ResponsiveDatePickers.js"}}

## Propriedades de formulário

The date picker component can be disabled or read-only.

{{"demo": "pages/components/pickers/date-picker/FormPropsDatePickers.js"}}
...
{{"demo": "pages/components/pickers/date-picker/LocalizedDatePicker.js"}}
...
{{"demo": "pages/components/pickers/date-picker/JalaliDatePicker.js"}}
...
{{"demo": "pages/components/pickers/date-picker/ViewsDatePicker.js"}}
...
{{"demo": "pages/components/pickers/date-picker/StaticDatePickerLandscape.js", "bg": true}}
...
{{"demo": "pages/components/pickers/date-picker/SubComponentsPickers.js"}}
...
{{"demo": "pages/components/pickers/date-picker/CustomInput.js"}}
...
{{"demo": "pages/components/pickers/date-picker/CustomDay.js"}}
...
{{"demo": "pages/components/pickers/date-picker/ServerRequestDatePicker.js"}}

## Helper text

Você pode mostrar um texto de ajuda com o formato de data aceito.

{{"demo": "pages/components/pickers/date-picker/HelperText.js"}}
