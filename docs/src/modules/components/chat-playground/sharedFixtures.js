 ...
 */
export const directoryConversations = [
  {
    id: 'styling',
...
export const longThreadMessages = [
  {
    id: 'long-1',
  ...
  },
  {
    ...
    parts: [
      {
        type: 'text',
        text: '1) header spacing  2) bubble radius  3) timestamp position',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    parts: [
      {
        type: 'text',
        text: 'Sounds good. The default is `shape.borderRadius * 2`.',
      },
    ],
  },
];
...
export const groupThreadMessages = [
  {
    id: 'grp-1',
    conversationId: 'styling',
    role: 'assistant',
  ...
  },
  {
    ...
    parts: [
      {
        type: 'text',
        text: 'First — the avatar only renders for the first message in a group.',
      },
    ],
  },
  {
    ...
    status: 'read',
    parts: [
      { type: 'text', text: 'Second — bubbles tighten vertically when grouped.' },
    ],
  },
];
...
export const bubbleMessages = {
  ...
  user: {
    ...
    parts: [
      {
        type: 'text',
        text: 'And user bubbles use `palette.primary.main` for emphasis.',
      },
    ],
  },
};

export const bubbleConversation = {
  id: 'bubble',
