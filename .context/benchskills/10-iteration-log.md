...
**Conclusion**: the **verbose tool-naming scheme + multi-step combo silently dropped 10pp from the actual production number.** The "naming doesn't matter" finding from the 7-scheme experiment was true *aggregate*, but the rename DID cost us small percentages on every feature and those compound across 95 prompts × 6 arms.
