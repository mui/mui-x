...
This view exposes *which test cases* benefit from which tool naming. Cells with `0/N` show universal failures (e.g. SKILL.md authoring issue). Cells where one scheme wins by a clear margin reveal naming-sensitive prompts.
