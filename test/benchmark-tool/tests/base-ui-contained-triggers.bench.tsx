...
import './base-ui-styles/base-ui-theme.module.css';
import menuDemoStyles from './base-ui-styles/submenu.module.css';
import tooltipDemoStyles from './base-ui-styles/tooltip.module.css';
import popoverDemoStyles from './base-ui-styles/popover.module.css';
import dialogDemoStyles from './base-ui-styles/dialog.module.css';
import styles from './base-ui-styles/perf.module.css';
      ...
      <Menu.Portal>
        <Menu.Positioner sideOffset={8} className={menuDemoStyles.Positioner}>
          <Menu.Popup className={menuDemoStyles.Popup}>
            ...
            {menuItems.map((item) => (
              <Menu.Item key={item.index} className={menuDemoStyles.Item}>
...
benchmark('base-ui contained triggers', <PerfExperiment />);
