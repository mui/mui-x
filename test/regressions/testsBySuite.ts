...
const docsImports = import.meta.glob<React.ComponentType>(
  [
    ...
    '!docsx/data/scheduler/event-calendar/lazy-loading/BasicDataSource', // Has random behavior
    '!docsx/data/scheduler/event-calendar/lazy-loading/ErrorHandling', // Has random behavior
