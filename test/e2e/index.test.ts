    ...
    describe('<DatePicker />', () => {
      describe('<DesktopDatePicker />', () => {
        ...
        describe('Focus behavior', () => {
          it('should close the date picker and move focus to the text field when clicking it', async () => {
            await renderFixture('DatePicker/PickersFocusManagement');
          ...
          it('should close the time picker with digital clock and move focus to the text field when clicking it', async () => {
            await renderFixture('DatePicker/PickersFocusManagement');
          ...
          it('should close the time picker with multi section digital clock and move focus to the text field when clicking it', async () => {
            await renderFixture('DatePicker/PickersFocusManagement');

            await page.getByRole('button', { name: 'Choose time' }).nth(1).click();
          ...
          it('should handle date range picker ', async () => {
            ...
            // assert that opening range picker closes the date picker
            await page.getByRole('button', { name: 'Choose date' }).click();
            await page.getByRole('group', { name: 'Desktop Date Range Picker' }).click();

            // check that date picker has been closed
            await page.waitForSelector('[role="dialog"]', { state: 'detached' });

            const decoyInput = page.getByRole('textbox', { name: 'decoy' });
            await decoyInput.click();
            // check that date range picker has been closed
