...
exports.excludeRowSelection = exports.includeRowSelection = exports.getSelectInput = void 0;
exports.$ = $;
exports.$$ = $$;
exports.grid = grid;
...
var excludeRowSelection = function (ids) {
    return { type: 'exclude', ids: new Set(ids) };
};
exports.excludeRowSelection = excludeRowSelection;
