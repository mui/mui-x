...
name (`/mui-x-review`, `$mui-x-review`, "the MUI X review skill", or a CI
...
- **Repository/framework correctness lens.** Apply invariants of codebase
  under review, not just generic language bugs. For MUI X / React component
...
MUI X has stricter quality bar than most apps — small component-library
