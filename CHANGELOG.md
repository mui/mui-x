...
#### `@mui/x-data-grid-pro@8.17.1` [![pro](https://mui.com/r/x-pro-svg)](https://mui.com/r/x-pro-svg-link 'Pro plan')

Same changes as in `@mui/x-data-grid@8.17.1`.

#### `@mui/x-data-grid-premium@8.17.1` [![premium](https://mui.com/r/x-premium-svg)](https://mui.com/r/x-premium-svg-link 'Premium plan')

Same changes as in `@mui/x-data-grid-pro@8.17.1`, plus:
...
#### `@mui/x-date-pickers@8.17.1`

- [pickers] Keep invalid date state consistent (#20040) @michelengelen

#### `@mui/x-date-pickers-pro@8.17.1` [![pro](https://mui.com/r/x-pro-svg)](https://mui.com/r/x-pro-svg-link 'Pro plan')

Same changes as in `@mui/x-date-pickers@8.17.1`.
...
#### `@mui/x-charts-pro@8.17.1` [![pro](https://mui.com/r/x-pro-svg)](https://mui.com/r/x-pro-svg-link 'Pro plan')

Same changes as in `@mui/x-charts@8.17.1`, plus:

- [charts-pro] Allow specifying Content Security Policy nonce on export (#20053) @bernardobelchior

#### `@mui/x-charts-premium@8.17.1` [![premium](https://mui.com/r/x-premium-svg)](https://mui.com/r/x-premium-svg-link 'Premium plan')

Same changes as in `@mui/x-charts-pro@8.17.1`.

### Tree View

#### `@mui/x-tree-view@8.17.1`
...
#### `@mui/x-tree-view-pro@8.17.1` [![pro](https://mui.com/r/x-pro-svg)](https://mui.com/r/x-pro-svg-link 'Pro plan')

Same changes as in `@mui/x-tree-view@8.17.1`.

### Codemod

#### `@mui/x-codemod@8.17.1`
