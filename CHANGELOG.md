...
- [Access to the API Object in the community version](https://mui.com.com/x/react-data-grid/api-object/)
- [Improved column menu](https://mui.com.com/x/react-data-grid/column-menu/)
- [Cell selection range](https://mui.com.com/x/react-data-grid/cell-selection/) (Premium)

**Date and Time pickers**

- [Fields: the new default input for pickers](https://mui.com.com/x/react-date-pickers/fields/).
- [Improved layout customization](https://mui.com.com/x/react-date-pickers/custom-layout/)
- [Edit date ranges with drag and drop](https://mui.com.com/x/react-date-pickers/date-range-calendar/) (Pro)

You can check the migration guides for the [Data Grid](https://mui.com.com/x/migration/migration-data-grid-v5/) and [Date Pickers](https://mui.com.com/x/migration/migration-pickers-v5/) in the documentation.
...
- The new pickers have replaced the legacy one.
  ...
  If you were still using the legacy picker (`DatePicker`, `DesktopDatePicker`, ...), please take a look at our [migration guide](https://mui.com.com/x/migration/migration-pickers-v5/#picker-components) for detailed explanations on how to start using the new ones.
...
- 🚀 The `apiRef` prop is now available in the `@mui/x-data-grid` package:
  ...
  See [the documentation](https://mui.com.com/x/react-data-grid/api-object/) for more information.
...
- 🎁 The `DataGridPremium` now supports cell selection:
  ...
  See [the documentation](https://mui.com.com/x/react-data-grid/selection/#cell-selection) for more information
...
- 🎁 Introduce the v6 pickers, built on top of the field components [DatePicker](https://mui.com.com/x/react-date-pickers/date-picker/), [TimePicker](https://mui.com.com/x/react-date-pickers/time-picker/), [DateTimePicker](https://mui.com.com/x/react-date-pickers/date-time-picker/), [DateRangePicker](https://mui.com.com/x/react-date-pickers/date-range-picker/).
...
- ⌚️ New components to edit date and time with <kbd>keyboard</kbd>—without using any modal or dropdown UI.
  Please check out our [documentation](https://mui.com.com/x/react-date-pickers/fields/) to discover those new components.

  - [`DateField`](https://mui.com.com/x/react-date-pickers/date-field/) to edit date
  - [`TimeField`](https://mui.com.com/x/react-date-pickers/time-field/) to edit time
  - [`DateTimeField`](https://mui.com.com/x/react-date-pickers/date-time-field/) to edit date and time
  - [`MultiInputDateRangeField` / `SingleInputDateRangeField`](https://mui.com.com/x/react-date-pickers/date-range-field/) to edit date range
  - [`MultiInputTimeRangeField`](https://mui.com.com/x/react-date-pickers/time-range-field/) to edit time range with two inputs
  - [`MultiInputDateTimeRangeField`](https://mui.com.com/x/react-date-pickers/date-time-range-field/) to edit date and time range with two inputs
...
- 📚 New [page describing the validation props on each picker](https://mui.com.com/x/react-date-pickers/validation/) (#6064) @flaviendelangle
- 📚 Documentation improvements
- 🐞 Bugfixes
...
- [DataGrid] Remove legacy editing API
  ...
  - The `cellEditCommit` event was removed and the `processRowUpdate` prop can be used in place. More information, check the [docs](https://mui.com.com/x/react-data-grid/editing/#persistence) section about the topic.
  - The `editRowsModel` and `onEditRowsModelChange` props were removed. The [`cellModesModel`](https://mui.com.com/x/react-data-grid/editing/#controlled-mode) or [`rowModesModel`](https://mui.com.com/x/react-data-grid/editing/#controlled-mode) props can be used to achieve the same goal.
  - The following API methods were removed:
    ...
    - Use the [`cellModesModel`](https://mui.com.com/x/react-data-grid/editing/#controlled-mode) or [`rowModesModel`](https://mui.com.com/x/react-data-grid/editing/#controlled-mode) props to replace `apiRef.current.setEditRowsModel`
...
- The deprecated `hide` column property has been removed in favor of the `columnVisibilityModel` prop and initial state.
  ...
  You can find more information about this new API on our [documentation](https://mui.com.com/x/react-data-grid/column-visibility/).
...
You can find more information about the new api, including how to set those translations on all your components at once in the [documentation](https://mui.com.com/x/react-date-pickers/localization/)
