...
The MUI X v4.0.0 release supports [MUI Core](https://github.com/mui/mui) v4 and has partial support for v5-beta. With the soon-to-be-released v5 version of the core components, we are moving ongoing work to the v5 release line (Core and X).
...
- 💅 Update the customization API to be closer to Material-UI v5.
  ...
  See the [RFC](https://github.com/mui/mui/issues/21453) for more details.
