...
#### `@mui/x-date-pickers@v7.27.2`

Internal changes.

#### `@mui/x-date-pickers-pro@v7.27.2` [![pro](https://mui.com/r/x-pro-svg)](https://mui.com/r/x-pro-svg-link 'Pro plan')

Same changes as in `@mui/x-date-pickers@v7.27.2`.

### Charts

#### `@mui/x-charts@v7.27.2`

Internal changes.

#### `@mui/x-charts-pro@v7.27.2` [![pro](https://mui.com/r/x-pro-svg)](https://mui.com/r/x-pro-svg-link 'Pro plan')

Same changes as in `@mui/x-charts@v7.27.2`.

### Tree View

#### `@mui/x-tree-view@v7.27.2`

Internal changes.

#### `@mui/x-tree-view-pro@v7.27.2` [![pro](https://mui.com/r/x-pro-svg)](https://mui.com/r/x-pro-svg-link 'Pro plan')

Same changes as in `@mui/x-tree-view@v7.27.2`.
