...
var SingleInputDateRangeField_1 = require("../SingleInputDateRangeField");
 ...
 */
var MobileDateRangePicker = React.forwardRef(function MobileDateRangePicker(inProps, ref) {
    var _a, _b;
    var adapter = (0, hooks_1.usePickerAdapter)();
    // Props with the default values common to all date time pickers
    var defaultizedProps = (0, shared_1.useDateRangePickerDefaultizedProps)(inProps, 'MuiMobileDateRangePicker');
    var viewRenderers = __assign({ day: dateRangeViewRenderers_1.renderDateRangeViewCalendar }, defaultizedProps.viewRenderers);
    var props = __assign(__assign({}, defaultizedProps), { viewRenderers: viewRenderers, 
        // TODO: Replace with resolveDateFormat() once we support month and year views
        format: (_a = defaultizedProps.format) !== null && _a !== void 0 ? _a : adapter.formats.keyboardDate, 
        // Force one calendar on mobile to avoid layout issues
        calendars: 1, 
        // force current calendar position, since we only have one calendar
        currentMonthCalendarPosition: 1, views: ['day'], openTo: 'day', slots: __assign({ field: SingleInputDateRangeField_1.SingleInputDateRangeField }, defaultizedProps.slots), slotProps: __assign(__assign({}, defaultizedProps.slotProps), { field: function (ownerState) {
                var _a;
            ...
            }, toolbar: __assign({ hidden: false }, (_b = defaultizedProps.slotProps) === null || _b === void 0 ? void 0 : _b.toolbar) }) });
    var renderPicker = (0, useMobileRangePicker_1.useMobileRangePicker)({
        ref: ref,
        props: props,
        valueManager: valueManagers_1.rangeValueManager,
        valueType: 'date',
        validator: validation_2.validateDateRange,
        steps: null,
    }).renderPicker;
    return renderPicker();
});
