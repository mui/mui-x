...
describe('<DesktopNextDateRangePicker />', () => {
  ...
  describeConformance(<DesktopNextDateRangePicker />, () => ({
    classes: {},
  ...
  describe('picker state', () => {
    it('should open when clicking the start input', () => {
      ...
      render(<DesktopNextDateRangePicker onOpen={onOpen} />);
    ...
    it('should call onClose when clicking outside of the picker without prior change', () => {
      ...
      render(
        <div>
          <DesktopNextDateRangePicker onChange={onChange} onAccept={onAccept} onClose={onClose} />
          <input id="test-id" />
        </div>,
      );
  ...
  describe('disabled dates', () => {
    it('should respect the disablePast prop', () => {
      render(<DesktopNextDateRangePicker disablePast />);
    ...
    it('should respect the disableFuture prop', () => {
      render(<DesktopNextDateRangePicker disableFuture />);
    ...
    it('should respect the minDate prop', () => {
      render(<DesktopNextDateRangePicker minDate={adapterToUse.date(new Date(2018, 0, 15))} />);
    ...
    it('should respect the maxDate prop', () => {
      render(<DesktopNextDateRangePicker maxDate={adapterToUse.date(new Date(2018, 0, 15))} />);
