...
>(
  ...
  if (isTimeView) {
    return (
      <DateTimeRangePickerTimeWrapper
        {...finalProps}
        viewRenderer={viewRenderer as PickerViewRenderer<true, TimeViewWithMeridiem, any, {}>}
  ...
  const typedViewRenderer = viewRenderer as PickerViewRenderer<true, 'day', any, any>;
