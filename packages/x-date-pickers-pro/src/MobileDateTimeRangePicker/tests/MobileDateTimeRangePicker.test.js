...
describe('<MobileDateTimeRangePicker />', function () {
    ...
    describe('value selection', function () {
        ...
        it('should cycle focused views among the visible step after selection', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, day, minutes, meridiem, sectionsContainer;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render(<MobileDateTimeRangePicker_1.MobileDateTimeRangePicker />).user;
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, user.click(internal_test_utils_1.screen.getByRole('option', { name: '12 hours' }))];
                    case 4:
                        _a.sent();
