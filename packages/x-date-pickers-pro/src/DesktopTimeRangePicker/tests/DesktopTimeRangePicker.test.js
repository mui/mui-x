...
describe('<DesktopTimeRangePicker />', function () {
    ...
    describe('value selection', function () {
        it('should work with separate start and end "reference" dates', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render(<DesktopTimeRangePicker_1.DesktopTimeRangePicker referenceDate={[
                    ...
                    case 1:
                        _a.sent();
                        expect(document.activeElement).to.equal(internal_test_utils_1.screen.getByRole('option', { name: '10 hours' }));
                    ...
                    case 4:
                        _a.sent(); // Move focus to the end time hour from the "Next" button
                        expect(document.activeElement).to.equal(internal_test_utils_1.screen.getByRole('option', { name: '2 hours' }));
