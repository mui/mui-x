...
var rendererInterceptor = function RendererInterceptor(props) {
    ...
    var finalProps = __assign(__assign({}, otherProps), { sx: [
            (_a = {},
                _a["&.".concat(MultiSectionDigitalClock_1.multiSectionDigitalClockClasses.root)] = (_b = {},
                    _b[".".concat(MultiSectionDigitalClock_1.multiSectionDigitalClockSectionClasses.root)] = {
                        flex: 1,
                    },
                    _b[".".concat(MultiSectionDigitalClock_1.multiSectionDigitalClockSectionClasses.item)] = {
                        ...
                        minWidth: internals_1.MULTI_SECTION_CLOCK_SECTION_WIDTH,
                    },
                    _b),
                _a["&.".concat(DigitalClock_1.digitalClockClasses.root, " .").concat(DigitalClock_1.digitalClockClasses.item)] = {
    ...
    return (<TimeRangePickerTimeWrapper_1.TimeRangePickerTimeWrapper {...finalProps} view={popperView} viewRenderer={viewRenderer}/>);
};
var DesktopTimeRangePicker = React.forwardRef(function DesktopTimeRangePicker(inProps, ref) {
    var _a;
    var _b, _c, _d, _e, _f, _g;
    var adapter = (0, hooks_1.usePickerAdapter)();
    // Props with the default values common to all time range pickers
    var defaultizedProps = (0, shared_1.useTimeRangePickerDefaultizedProps)(inProps, 'MuiDesktopTimeRangePicker');
    ...
    var props = __assign(__assign({}, defaultizedProps), { views: views, viewRenderers: viewRenderers, ampmInClock: true, format: (0, internals_1.resolveTimeFormat)(adapter, defaultizedProps), slots: __assign({ field: SingleInputTimeRangeField_1.SingleInputTimeRangeField }, defaultizedProps.slots), slotProps: __assign(__assign({}, defaultizedProps.slotProps), { field: function (ownerState) {
                var _a;
            ...
            }, tabs: __assign({ hidden: true }, (_c = defaultizedProps.slotProps) === null || _c === void 0 ? void 0 : _c.tabs), toolbar: __assign({ hidden: true }, (_d = defaultizedProps.slotProps) === null || _d === void 0 ? void 0 : _d.toolbar), layout: __assign(__assign({}, (_e = defaultizedProps.slotProps) === null || _e === void 0 ? void 0 : _e.layout), { sx: (0, internals_1.mergeSx)((_g = (_f = defaultizedProps.slotProps) === null || _f === void 0 ? void 0 : _f.layout) === null || _g === void 0 ? void 0 : _g.sx, (_a = {},
                    // Allow content wrapper to take full width when shortcuts are not present
                    _a["&:not(:has(.".concat(PickersLayout_1.pickersLayoutClasses.shortcuts, ")) .").concat(PickersLayout_1.pickersLayoutClasses.contentWrapper)] = {
                        gridColumn: '1 /4',
                    },
                    _a)) }) }) });
...
exports.DesktopTimeRangePicker = DesktopTimeRangePicker;
