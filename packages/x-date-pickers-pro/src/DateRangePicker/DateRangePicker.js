...
var DesktopDateRangePicker_1 = require("../DesktopDateRangePicker");
var MobileDateRangePicker_1 = require("../MobileDateRangePicker");
/**
 * Demos:
 *
 ...
 */
var DateRangePicker = React.forwardRef(function DateRangePicker(inProps, ref) {
    var props = (0, styles_1.useThemeProps)({ props: inProps, name: 'MuiDateRangePicker' });
    ...
    if (isDesktop) {
        return <DesktopDateRangePicker_1.DesktopDateRangePicker ref={ref} {...other}/>;
    }
    return <MobileDateRangePicker_1.MobileDateRangePicker ref={ref} {...other}/>;
});
