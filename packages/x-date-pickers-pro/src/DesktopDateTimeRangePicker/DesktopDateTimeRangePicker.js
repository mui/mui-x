...
var useDesktopRangePicker_1 = require("../internals/hooks/useDesktopRangePicker");
var validation_2 = require("../validation");
var shared_1 = require("../DateTimeRangePicker/shared");
var SingleInputDateTimeRangeField_1 = require("../SingleInputDateTimeRangeField");
var DateTimeRangePickerTimeWrapper_1 = require("../DateTimeRangePicker/DateTimeRangePickerTimeWrapper");
...
var rendererInterceptor = function RendererInterceptor(props) {
    ...
    var openTo = rendererProps.openTo, otherProps = __rest(rendererProps, ["openTo"]);
    var rangePosition = (0, hooks_2.usePickerRangePositionContext)().rangePosition;
    var finalProps = __assign(__assign({}, otherProps), { sx: [
            (_a = {},
    ...
    var isTimeViewActive = (0, internals_1.isInternalTimeView)(popperView);
    var referenceDate = (0, date_range_manager_1.resolveReferenceDate)(rendererProps.referenceDate, rangePosition);
    return (<React.Fragment>
      {(_b = viewRenderers.day) === null || _b === void 0 ? void 0 : _b.call(viewRenderers, __assign(__assign({}, rendererProps), { referenceDate: referenceDate, rangePosition: rangePosition, availableRangePositions: [rangePosition], view: !isTimeViewActive ? popperView : 'day', views: rendererProps.views.filter(internals_1.isDatePickerView), sx: __spreadArray([{ gridColumn: 1 }], finalProps.sx, true) }))}
      <Divider_1.default orientation="vertical" sx={{ gridColumn: 2 }}/>
      <DateTimeRangePickerTimeWrapper_1.DateTimeRangePickerTimeWrapper {...finalProps} referenceDate={referenceDate} view={isTimeViewActive ? popperView : 'hours'} views={finalProps.views.filter(internals_1.isInternalTimeView)} openTo={(0, internals_1.isInternalTimeView)(openTo) ? openTo : 'hours'} viewRenderer={viewRenderers[isTimeViewActive ? popperView : 'hours']} sx={__spreadArray([{ gridColumn: 3 }], finalProps.sx, true)}/>
    </React.Fragment>);
};
/**
 * Demos:
 ...
 */
var DesktopDateTimeRangePicker = React.forwardRef(function DesktopDateTimeRangePicker(inProps, ref) {
    var _a, _b, _c, _d;
    var adapter = (0, hooks_1.usePickerAdapter)();
    // Props with the default values common to all date time range pickers
    var defaultizedProps = (0, shared_1.useDateTimeRangePickerDefaultizedProps)(inProps, 'MuiDesktopDateTimeRangePicker');
    ...
    var viewRenderers = __assign({ day: dateRangeViewRenderers_1.renderDateRangeViewCalendar, hours: renderTimeView, minutes: renderTimeView, seconds: renderTimeView, meridiem: renderTimeView }, defaultizedProps.viewRenderers);
    // Need to avoid adding the `meridiem` view when unexpected renderer is specified
    var shouldHoursRendererContainMeridiemView = ((_a = viewRenderers.hours) === null || _a === void 0 ? void 0 : _a.name) === timeViewRenderers_1.renderMultiSectionDigitalClockTimeView.name;
    ...
    var props = __assign(__assign({}, defaultizedProps), { views: views, viewRenderers: viewRenderers, format: (0, internals_1.resolveDateTimeFormat)(adapter, defaultizedProps, true), 
        // force true to correctly handle `renderTimeViewClock` as a renderer
        ampmInClock: true, calendars: (_b = defaultizedProps.calendars) !== null && _b !== void 0 ? _b : 1, slots: __assign({ field: SingleInputDateTimeRangeField_1.SingleInputDateTimeRangeField, layout: DesktopDateTimePicker_1.DesktopDateTimePickerLayout }, defaultizedProps.slots), slotProps: __assign(__assign({}, defaultizedProps.slotProps), { field: function (ownerState) {
                var _a;
            ...
            }, tabs: __assign({ hidden: true }, (_c = defaultizedProps.slotProps) === null || _c === void 0 ? void 0 : _c.tabs), toolbar: __assign({ hidden: true }, (_d = defaultizedProps.slotProps) === null || _d === void 0 ? void 0 : _d.toolbar) }) });
    var renderPicker = (0, useDesktopRangePicker_1.useDesktopRangePicker)({
        ref: ref,
        props: props,
        valueManager: valueManagers_1.rangeValueManager,
        valueType: 'date-time',
        validator: validation_2.validateDateTimeRange,
        rendererInterceptor: rendererInterceptor,
        steps: STEPS,
    }).renderPicker;
    return renderPicker();
});
exports.DesktopDateTimeRangePicker = DesktopDateTimeRangePicker;
