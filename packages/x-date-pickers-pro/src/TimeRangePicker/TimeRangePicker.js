...
var DesktopTimeRangePicker_1 = require("../DesktopTimeRangePicker");
var MobileTimeRangePicker_1 = require("../MobileTimeRangePicker");
/**
 * Demos:
 *
 ...
 */
var TimeRangePicker = React.forwardRef(function TimeRangePicker(inProps, ref) {
    var props = (0, styles_1.useThemeProps)({ props: inProps, name: 'MuiTimeRangePicker' });
    ...
    if (isDesktop) {
        return <DesktopTimeRangePicker_1.DesktopTimeRangePicker ref={ref} {...other}/>;
    }
    return <MobileTimeRangePicker_1.MobileTimeRangePicker ref={ref} {...other}/>;
});
