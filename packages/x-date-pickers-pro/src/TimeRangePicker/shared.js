...
function useTimeRangePickerDefaultizedProps(props, name) {
    ...
    var validationProps = (0, internals_1.useApplyDefaultValuesToTimeValidationProps)(themeProps);
    ...
    var localeText = React.useMemo(function () {
        ...
        return __assign(__assign({}, themeProps.localeText), { timeRangePickerToolbarTitle: themeProps.localeText.toolbarTitle });
    ...
    return __assign(__assign(__assign({}, themeProps), validationProps), { localeText: localeText, timeSteps: timeSteps, openTo: openTo, shouldRenderTimeInASingleColumn: shouldRenderTimeInASingleColumn, thresholdToRenderTimeInASingleColumn: thresholdToRenderTimeInASingleColumn, views: views, ampm: ampm, slots: __assign({ tabs: TimeRangePickerTabs_1.TimeRangePickerTabs, toolbar: TimeRangePickerToolbar_1.TimeRangePickerToolbar }, themeProps.slots), slotProps: __assign(__assign({}, themeProps.slotProps), { toolbar: __assign({ ampm: ampm }, (_b = themeProps.slotProps) === null || _b === void 0 ? void 0 : _b.toolbar) }) });
}
