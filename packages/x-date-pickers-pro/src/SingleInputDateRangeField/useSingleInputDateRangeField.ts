...
> = {
  ...
  getValueStrFromSections: (sections) => {
    ...
    const startDateStr = createDateStrFromSections(dateRangeSections.startDate, false);
    const endDateStr = createDateStrFromSections(dateRangeSections.endDate, false);
