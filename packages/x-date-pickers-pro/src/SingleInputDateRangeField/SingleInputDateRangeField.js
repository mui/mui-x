...
var useSingleInputDateRangeField_1 = require("./useSingleInputDateRangeField");
/**
 * Demos:
 *
 ...
 */
var SingleInputDateRangeField = React.forwardRef(function SingleInputDateRangeField(inProps, inRef) {
    ...
    var textFieldProps = (0, internals_1.useFieldTextFieldProps)({
        slotProps: slotProps,
        ref: inRef,
        externalForwardedProps: other,
    });
    var fieldResponse = (0, useSingleInputDateRangeField_1.useSingleInputDateRangeField)(textFieldProps);
    return (<internals_1.PickerFieldUI slots={slots} slotProps={slotProps} fieldResponse={fieldResponse} defaultOpenPickerIcon={icons_1.DateRangeIcon}/>);
});
