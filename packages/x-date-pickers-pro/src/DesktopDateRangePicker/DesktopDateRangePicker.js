 ...
 */
var DesktopDateRangePicker = React.forwardRef(function DesktopDateRangePicker(inProps, ref) {
    var _a, _b, _c, _d;
    var adapter = (0, hooks_1.usePickerAdapter)();
    // Props with the default values common to all date time pickers
    var defaultizedProps = (0, shared_1.useDateRangePickerDefaultizedProps)(inProps, 'MuiDesktopDateRangePicker');
    var viewRenderers = __assign({ day: dateRangeViewRenderers_1.renderDateRangeViewCalendar }, defaultizedProps.viewRenderers);
    var props = __assign(__assign({}, defaultizedProps), { closeOnSelect: (_a = defaultizedProps.closeOnSelect) !== null && _a !== void 0 ? _a : true, viewRenderers: viewRenderers, 
        // TODO: Replace with resolveDateFormat() once we support month and year views
        format: (_b = defaultizedProps.format) !== null && _b !== void 0 ? _b : adapter.formats.keyboardDate, calendars: (_c = defaultizedProps.calendars) !== null && _c !== void 0 ? _c : 2, views: ['day'], openTo: 'day', slots: __assign({ field: SingleInputDateRangeField_1.SingleInputDateRangeField }, defaultizedProps.slots), slotProps: __assign(__assign({}, defaultizedProps.slotProps), { field: function (ownerState) {
                var _a;
            ...
            }, toolbar: __assign({ hidden: true }, (_d = defaultizedProps.slotProps) === null || _d === void 0 ? void 0 : _d.toolbar) }) });
