...
describe('<DesktopDateRangePicker />', () => {
  ...
  it('should allow partial date enter', () => {
    ...
    expect((screen.getAllByRole('textbox')[0] as HTMLInputElement).value).to.equal('0');
  ...
  it('should allow partial year without adding zeros', () => {
    ...
    expect(handleChange.callCount).to.equal(1);
    expect((screen.getAllByRole('textbox')[0] as HTMLInputElement).value).to.equal('01/01/19');
  });
