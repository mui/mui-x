...
import { Unstable_DesktopNextDateRangePicker as DesktopNextDateRangePicker } from '../DesktopNextDateRangePicker';
import { Unstable_MobileNextDateRangePicker as MobileNextDateRangePicker } from '../MobileNextDateRangePicker';
import { NextDateRangePickerProps } from './NextDateRangePicker.types';
...
const NextDateRangePicker = React.forwardRef(function NextDateRangePicker<TDate>(
  ...
  if (isDesktop) {
    return <DesktopNextDateRangePicker ref={ref} {...other} />;
  }
