...
var useSingleInputTimeRangeField_1 = require("./useSingleInputTimeRangeField");
/**
 * Demos:
 *
 ...
 */
var SingleInputTimeRangeField = React.forwardRef(function SingleInputTimeRangeField(inProps, inRef) {
    ...
    var fieldResponse = (0, useSingleInputTimeRangeField_1.useSingleInputTimeRangeField)(textFieldProps);
    return (<internals_1.PickerFieldUI slots={slots} slotProps={slotProps} fieldResponse={fieldResponse} defaultOpenPickerIcon={icons_1.ClockIcon}/>);
});
