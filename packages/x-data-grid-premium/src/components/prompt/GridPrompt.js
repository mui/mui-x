...
function GridPrompt(props) {
    ...
    var getChartChanges = React.useCallback(function (chart) {
        return {
    ...
    return ((0, jsx_runtime_1.jsxs)(PromptItem, { ownerState: ownerState, className: classes.root, children: [(0, jsx_runtime_1.jsx)(PromptIconContainer, { ownerState: ownerState, className: classes.iconContainer, children: !response && variant !== 'error' ? ((0, jsx_runtime_1.jsx)(rootProps.slots.baseCircularProgress, { size: 20 })) : ((0, jsx_runtime_1.jsx)(PromptIcon, { as: rootProps.slots.promptIcon, ownerState: ownerState, className: classes.icon, fontSize: "small" })) }), (0, jsx_runtime_1.jsxs)(PromptContent, { ownerState: ownerState, className: classes.content, children: [(0, jsx_runtime_1.jsx)(PromptText, { ownerState: ownerState, className: classes.text, children: value }), (0, jsx_runtime_1.jsx)(PromptFeedback, { ownerState: ownerState, className: classes.feedback, children: helperText }), changeList.length > 0 ? ((0, jsx_runtime_1.jsxs)(React.Fragment, { children: [(0, jsx_runtime_1.jsxs)(PromptChangesToggle, { ownerState: ownerState, className: classes.changesToggle, "aria-expanded": showChanges, "aria-controls": changesListId, onClick: function () { return setShowChanges(!showChanges); }, children: [apiRef.current.getLocaleText('promptAppliedChanges'), (0, jsx_runtime_1.jsx)(PromptChangesToggleIcon, { as: rootProps.slots.promptChangesToggleIcon, ownerState: ownerState, fontSize: "small" })] }), showChanges && ((0, jsx_runtime_1.jsx)(PromptChangeList, { id: changesListId, ownerState: ownerState, className: classes.changeList, children: changeList.map(function (change) { return ((0, jsx_runtime_1.jsx)(rootProps.slots.baseTooltip, { title: change.description, children: (0, jsx_runtime_1.jsx)(rootProps.slots.baseChip, { label: change.label, icon: (0, jsx_runtime_1.jsx)(change.icon, {}), size: "small" }) }, change.label)); }) }))] })) : null] }), (0, jsx_runtime_1.jsx)(rootProps.slots.baseTooltip, { title: apiRef.current.getLocaleText('promptRerun'), enterDelay: 500, children: (0, jsx_runtime_1.jsx)(rootProps.slots.baseIconButton, { size: "small", className: classes.action, onClick: onRerun, children: (0, jsx_runtime_1.jsx)(rootProps.slots.promptRerunIcon, { fontSize: "small" }) }) })] }));
}
