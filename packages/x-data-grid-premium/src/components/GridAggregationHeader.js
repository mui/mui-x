...
function GridAggregationHeader(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(GridAggregationHeaderRoot, { ownerState: ownerState, className: classes.root, children: [renderHeader ? (renderHeader(params)) : ((0, jsx_runtime_1.jsx)(x_data_grid_1.GridColumnHeaderTitle, { label: (_a = colDef.headerName) !== null && _a !== void 0 ? _a : colDef.field, description: colDef.description, columnWidth: colDef.computedWidth })), (0, jsx_runtime_1.jsx)(GridAggregationFunctionLabel, { ownerState: ownerState, className: classes.aggregationLabel, children: aggregationLabel })] }));
}
