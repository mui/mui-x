...
function GridColumnMenuRowGroupItem(props) {
    ...
    var renderUnGroupingMenuItem = function (field) {
        ...
        return ((0, jsx_runtime_1.jsx)(rootProps.slots.baseMenuItem, { onClick: ungroupColumn, disabled: !groupedColumn.groupable, iconStart: (0, jsx_runtime_1.jsx)(rootProps.slots.columnMenuUngroupIcon, { fontSize: "small" }), children: apiRef.current.getLocaleText('unGroupColumn')(name) }, field));
    };
    ...
    if (colDef.field === gridRowGroupingUtils_1.GRID_ROW_GROUPING_SINGLE_GROUPING_FIELD) {
        return (0, jsx_runtime_1.jsx)(React.Fragment, { children: rowGroupingModel.map(renderUnGroupingMenuItem) });
    }
