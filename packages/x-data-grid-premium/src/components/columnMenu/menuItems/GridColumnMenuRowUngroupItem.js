...
function GridColumnMenuRowUngroupItem(props) {
    ...
    if (rowGroupingModel.includes(colDef.field)) {
        return ((0, jsx_runtime_1.jsx)(rootProps.slots.baseMenuItem, { onClick: ungroupColumn, iconStart: (0, jsx_runtime_1.jsx)(rootProps.slots.columnMenuUngroupIcon, { fontSize: "small" }), children: apiRef.current.getLocaleText('unGroupColumn')(name) }));
    }
    return ((0, jsx_runtime_1.jsx)(rootProps.slots.baseMenuItem, { onClick: groupColumn, iconStart: (0, jsx_runtime_1.jsx)(rootProps.slots.columnMenuGroupIcon, { fontSize: "small" }), children: apiRef.current.getLocaleText('groupColumn')(name) }));
}
