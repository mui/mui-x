...
function GridColumnMenuPivotItem(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(rootProps.slots.baseMenuItem, { onClick: openPivotSettings, iconStart: (0, jsx_runtime_1.jsx)(rootProps.slots.pivotIcon, { fontSize: "small" }), disabled: isPivotPanelOpen, children: apiRef.current.getLocaleText('columnMenuManagePivot') }));
}
