...
function GridColumnMenuAggregationItem(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(rootProps.slots.baseMenuItem, { inert: true, iconStart: (0, jsx_runtime_1.jsx)(rootProps.slots.columnMenuAggregationIcon, { fontSize: "small" }), onKeyDown: handleMenuItemKeyDown, children: (0, jsx_runtime_1.jsxs)(rootProps.slots.baseSelect, __assign({ labelId: "".concat(id, "-label"), id: "".concat(id, "-input"), value: selectedAggregationRule, label: label, onChange: handleAggregationItemChange, onKeyDown: handleSelectKeyDown, onBlur: function (event) { return event.stopPropagation(); }, native: isBaseSelectNative, fullWidth: true, size: "small", style: { minWidth: 150 }, slotProps: {
                htmlInput: {
                    ref: inputRef,
                },
            } }, baseSelectProps, { children: [(0, jsx_runtime_1.jsx)(rootProps.slots.baseSelectOption, __assign({}, baseSelectOptionProps, { native: isBaseSelectNative, value: "", children: "..." })), availableAggregationFunctions.map(function (aggFunc) { return ((0, react_1.createElement)(rootProps.slots.baseSelectOption, __assign({}, baseSelectOptionProps, { key: aggFunc, value: aggFunc, native: isBaseSelectNative }), (0, gridAggregationUtils_1.getAggregationFunctionLabel)({
                    apiRef: apiRef,
                    aggregationRule: {
