...
function GridPivotPanelHeader(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(sidebar_1.SidebarHeader, { children: [(0, jsx_runtime_1.jsxs)(GridPivotPanelHeaderRoot, { ownerState: rootProps, className: classes.root, children: [(0, jsx_runtime_1.jsx)(GridPivotPanelSwitch, __assign({ as: rootProps.slots.baseSwitch, ownerState: rootProps, className: classes.switch, checked: pivotActive, onChange: function (event) {
                            return apiRef.current.setPivotActive(event.target.checked);
                        }, size: "small", label: (0, jsx_runtime_1.jsx)(GridPivotPanelSwitchLabel, { ownerState: rootProps, className: classes.label, children: apiRef.current.getLocaleText('pivotToggleLabel') }) }, (_a = rootProps.slotProps) === null || _a === void 0 ? void 0 : _a.baseSwitch)), (0, jsx_runtime_1.jsx)(rootProps.slots.baseIconButton, __assign({ onClick: function () {
                            apiRef.current.hideSidebar();
                            if (isEmptyPivot) {
                                apiRef.current.setPivotActive(false);
                            }
                        }, "aria-label": apiRef.current.getLocaleText('pivotCloseButton') }, (_b = rootProps.slotProps) === null || _b === void 0 ? void 0 : _b.baseIconButton, { children: (0, jsx_runtime_1.jsx)(rootProps.slots.sidebarCloseIcon, { fontSize: "small" }) }))] }), (0, jsx_runtime_1.jsx)(GridPivotPanelSearch_1.GridPivotPanelSearch, { value: searchValue, onClear: function () { return onSearchValueChange(''); }, onChange: function (event) {
