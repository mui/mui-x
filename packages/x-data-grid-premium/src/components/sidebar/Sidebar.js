...
function Sidebar(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(SidebarRoot, __assign({ id: sidebarId, className: (0, clsx_1.default)(className, classes.root), ownerState: rootProps, "aria-labelledby": labelId }, other, { children: [(0, jsx_runtime_1.jsx)(resizablePanel_1.ResizablePanelHandle, {}), sidebarContent] })));
}
