...
function CollapsiblePanel(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(CollapsiblePanelRoot, __assign({ ownerState: rootProps, className: (0, clsx_1.default)(classes.root, className), id: id }, other, { children: children })));
}
