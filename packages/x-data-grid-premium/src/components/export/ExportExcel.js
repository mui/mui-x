 ...
 */
var ExportExcel = (0, forwardRef_1.forwardRef)(function ExportExcel(props, ref) {
    var _a;
    ...
    var element = (0, useComponentRenderer_1.useComponentRenderer)(rootProps.slots.baseButton, render, __assign(__assign(__assign({ onClick: handleClick }, (_a = rootProps.slotProps) === null || _a === void 0 ? void 0 : _a.baseButton), other), { ref: ref }));
