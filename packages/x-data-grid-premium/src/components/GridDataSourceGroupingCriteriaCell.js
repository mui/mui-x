...
function GridGroupingCriteriaCellIcon(props) {
    ...
    if (isDataLoading) {
        return ((0, jsx_runtime_1.jsx)("div", { className: classes.loadingContainer, children: (0, jsx_runtime_1.jsx)(rootProps.slots.baseCircularProgress, { size: "1rem", color: "inherit" }) }));
    }
    return descendantCount === -1 || descendantCount > 0 ? ((0, jsx_runtime_1.jsx)(rootProps.slots.baseIconButton, __assign({ size: "small", onClick: handleClick, tabIndex: -1, "aria-label": rowNode.childrenExpanded
            ? apiRef.current.getLocaleText('treeDataCollapse')
            : apiRef.current.getLocaleText('treeDataExpand') }, (_a = rootProps === null || rootProps === void 0 ? void 0 : rootProps.slotProps) === null || _a === void 0 ? void 0 : _a.baseIconButton, { children: (0, jsx_runtime_1.jsx)(rootProps.slots.baseTooltip, { title: (_b = error === null || error === void 0 ? void 0 : error.message) !== null && _b !== void 0 ? _b : null, children: (0, jsx_runtime_1.jsx)(rootProps.slots.baseBadge, { variant: "dot", color: "error", invisible: !error, children: (0, jsx_runtime_1.jsx)(Icon, { fontSize: "inherit" }) }) }) }))) : null;
}
function GridDataSourceGroupingCriteriaCell(props) {
    ...
    var rowGroupingModelLength = (0, x_data_grid_pro_1.useGridSelector)(apiRef, gridRowGroupingSelector_1.gridRowGroupingModelSelector).length;
    var classes = useUtilityClasses(rootProps);
    var shouldShowToggleContainer = !pivotActive || rowGroupingModelLength > 1;
    // Do not allow expand/collapse the last grouping criteria cell when in pivot mode
    var shouldShowToggleButton = !pivotActive || rowNode.depth < rowGroupingModelLength - 1;
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: classes.root, style: {
        ...
        }, children: [shouldShowToggleContainer && ((0, jsx_runtime_1.jsx)("div", { className: classes.toggle, children: shouldShowToggleButton && ((0, jsx_runtime_1.jsx)(GridGroupingCriteriaCellIcon, { id: id, field: field, rowNode: rowNode, row: row, descendantCount: descendantCount })) })), cellContent, !hideDescendantCount && descendantCount > 0 ? ((0, jsx_runtime_1.jsxs)("span", { style: { whiteSpace: 'pre' }, children: [" (", descendantCount, ")"] })) : null] }));
}
