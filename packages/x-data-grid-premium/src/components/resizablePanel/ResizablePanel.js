...
function ResizablePanel(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(ResizablePanelContext_1.ResizablePanelContext.Provider, { value: contextValue, children: (0, jsx_runtime_1.jsx)(ResizablePanelRoot, __assign({ className: (0, clsx_1.default)(classes.root, className), ownerState: rootProps }, other, { ref: ref, children: children })) }));
}
