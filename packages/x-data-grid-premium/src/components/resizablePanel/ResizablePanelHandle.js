...
function ResizablePanelHandle(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(ResizablePanelHandleRoot, __assign({ className: (0, clsx_1.default)(classes.root, className), ownerState: ownerState, direction: direction }, other, { ref: ref })));
}
