...
var iconsSlots = {
    ...
    promptChartsIcon: icons_1.GridChartsIcon,
    promptChangesToggleIcon: x_data_grid_1.GridExpandMoreIcon,
    chartsIcon: icons_1.GridChartsIcon,
    chartsSearchIcon: x_data_grid_1.GridSearchIcon,
    chartsSearchClearIcon: x_data_grid_1.GridClearIcon,
    chartsMenuMoveUpIcon: icons_1.GridExpandLessIcon,
    chartsMenuMoveDownIcon: x_data_grid_1.GridExpandMoreIcon,
    chartsMenuMoveToTopIcon: icons_1.GridMoveToTopIcon,
    chartsMenuMoveToBottomIcon: icons_1.GridMoveToBottomIcon,
    chartsMenuAddIcon: x_data_grid_1.GridAddIcon,
    chartsMenuRemoveIcon: x_data_grid_1.GridDeleteIcon,
    chartsSyncIcon: icons_1.GridSyncIcon,
    chartsSyncDisabledIcon: icons_1.GridSyncDisabledIcon,
};
