...
export const useGridRowsOverridableMethods = (apiRef, props) => {
    ...
    const { setRowIndex: setRowIndexPlain, setRowPosition: setRowPositionPlain } = useGridRowsOverridableMethodsCommunity(apiRef);
    const { setRowIndex: setRowIndexTreeData, setRowPosition: setRowPositionTreeData } = useGridRowsOverridableMethodsPro(apiRef, props);
