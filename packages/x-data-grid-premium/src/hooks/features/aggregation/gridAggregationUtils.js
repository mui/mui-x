...
export const canColumnHaveAggregationFunction = ({ colDef, aggregationFunctionName, aggregationFunction, isDataSource, }) => {
    if (!colDef) {
        return false;
    }
...
export const getAvailableAggregationFunctions = ({ aggregationFunctions, colDef, isDataSource, }) => Object.keys(aggregationFunctions).filter((aggregationFunctionName) => canColumnHaveAggregationFunction({
    colDef,
    aggregationFunctionName,
    aggregationFunction: aggregationFunctions[aggregationFunctionName],
    isDataSource,
}));
export const mergeStateWithAggregationModel = (aggregationModel) => (state) => ({
    ...state,
 ...
 */
export const addFooterRows = ({ groupingParams, apiRef, getAggregationPosition, hasAggregationRule, }) => {
    ...
    const updateRootGroupFooter = (groupNode) => {
        const shouldHaveFooter = hasAggregationRule &&
...
export const getAggregationFunctionLabel = ({ apiRef, aggregationRule, }) => {
