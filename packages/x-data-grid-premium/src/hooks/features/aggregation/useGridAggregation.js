...
var useGridAggregation = function (apiRef, props) {
    ...
    var applyAggregation = React.useCallback(function (reason) {
        ...
        var currentAggregationLookup = (0, gridAggregationSelectors_1.gridAggregationLookupSelector)(apiRef);
        ...
        if (aggregatedFields.length === 0 && !(0, isObjectEmpty_1.isObjectEmpty)(currentAggregationLookup)) {
            apiRef.current.setState(function (state) { return (__assign(__assign({}, state), { aggregation: __assign(__assign({}, state.aggregation), { lookup: {} }) })); });
        }
    }, [
        apiRef,
    ...
    var checkAggregationRulesDiff = React.useCallback(function () {
        ...
        if ((!props.dataSource || pivotingActive) &&
            !(0, gridAggregationUtils_1.areAggregationRulesEqual)(rulesOnLastRowHydration, aggregationRules)) {
