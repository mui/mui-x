...
var useGridPivoting = function (apiRef, props, originalColumnsProp, originalRowsProp) {
    ...
    var isLoading = (_a = props.loading) !== null && _a !== void 0 ? _a : (0, x_data_grid_pro_1.gridRowsLoadingSelector)(apiRef);
    var _b = apiRef.current.caches.pivoting, exportedStateRef = _b.exportedStateRef, nonPivotDataRef = _b.nonPivotDataRef;
    var isPivotingAvailable = !props.disablePivoting;
    ...
    var getInitialData = React.useCallback(function () {
        ...
        if (!props.dataSource) {
            ...
            var rowsLookup_1 = (0, x_data_grid_pro_1.gridRowsLookupSelector)(apiRef);
            rows = rowIds.map(function (id) { return rowsLookup_1[id]; });
        }
    ...
    var computePivotingState = React.useCallback(function (_a) {
        ...
        if (active && pivotModel) {
            ...
            var propsOverrides = (0, utils_1.getPivotForcedProps)(pivotModel, columns, props.groupingColDef);
            // without data source, add more props overrides based on the data
            if (!isLoading && !props.dataSource) {
                propsOverrides = __assign(__assign({}, propsOverrides), (0, utils_1.createPivotPropsFromRows)({
                    rows: rows,
                    columns: columns,
    ...
    (0, useOnMount_1.default)(function () {
        ...
        apiRef.current.setState(function (state) {
            var _a = computePivotingState(state.pivoting), initialColumns = _a.initialColumns, propsOverrides = _a.propsOverrides;
            var pivotingState = __assign(__assign({}, state.pivoting), { initialColumns: initialColumns || state.pivoting.initialColumns, propsOverrides: __assign(__assign({}, state.pivoting.propsOverrides), propsOverrides) });
    ...
    var setPivotModel = React.useCallback(function (callback) {
        ...
        apiRef.current.setState(function (state) {
            ...
            var _c = computePivotingState(__assign(__assign({}, state.pivoting), { model: newPivotModel })), initialColumns = _c.initialColumns, propsOverrides = _c.propsOverrides;
            var newPivotingState = __assign(__assign({}, state.pivoting), { initialColumns: initialColumns || state.pivoting.initialColumns, propsOverrides: __assign(__assign({}, state.pivoting.propsOverrides), propsOverrides), model: newPivotModel });
    ...
    var setPivotActive = React.useCallback(function (callback) {
        ...
        apiRef.current.setState(function (state) {
            ...
            var _c = computePivotingState(__assign(__assign({}, state.pivoting), { active: newPivotMode })), initialColumns = _c.initialColumns, propsOverrides = _c.propsOverrides;
            var newPivotingState = __assign(__assign({}, state.pivoting), { initialColumns: initialColumns || state.pivoting.initialColumns, propsOverrides: __assign(__assign({}, state.pivoting.propsOverrides), propsOverrides), active: newPivotMode });
    ...
    var updateNonPivotColumns = React.useCallback(function (columns, keepPreviousColumns) {
        ...
        apiRef.current.setState(function (state) {
            var _a;
            var propsOverrides = computePivotingState(state.pivoting).propsOverrides;
            return __assign(__assign({}, state), { pivoting: __assign(__assign({}, state.pivoting), { initialColumns: (_a = nonPivotDataRef.current) === null || _a === void 0 ? void 0 : _a.columns, propsOverrides: __assign(__assign({}, state.pivoting.propsOverrides), propsOverrides) }) });
        });
    }, [
        isPivotingAvailable,
        apiRef,
    ...
    var updateNonPivotRows = React.useCallback(function (rows, keepPreviousRows) {
        ...
        apiRef.current.setState(function (state) {
            var _a = computePivotingState(state.pivoting), initialColumns = _a.initialColumns, propsOverrides = _a.propsOverrides;
            return __assign(__assign({}, state), { pivoting: __assign(__assign({}, state.pivoting), { initialColumns: initialColumns || state.pivoting.initialColumns, propsOverrides: __assign(__assign({}, state.pivoting.propsOverrides), propsOverrides) }) });
        });
    ...
    var addPivotingPanel = React.useCallback(function (initialValue, value) {
        if (isPivotingAvailable && value === sidebar_1.GridSidebarValue.Pivot) {
            return (0, jsx_runtime_1.jsx)(pivotPanel_1.GridPivotPanel, {});
        }
        return initialValue;
    }, [isPivotingAvailable]);
    var addGetRowsParams = React.useCallback(function (params) {
        ...
        return __assign(__assign({}, params), { pivotModel: {
