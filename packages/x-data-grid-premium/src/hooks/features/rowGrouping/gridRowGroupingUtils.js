...
var filterRowTreeFromGroupingColumns = function (params) {
    var apiRef = params.apiRef, rowTree = params.rowTree, isRowMatchingFilters = params.isRowMatchingFilters, filterModel = params.filterModel, filterValueGetter = params.filterValueGetter;
    ...
    var filterTreeNode = function (node, areAncestorsExpanded, ancestorsResults) {
        ...
        if (isPassingFiltering === false) {
            if (node.type === 'group') {
                ...
                isPassingFiltering = (0, internals_1.passFilterLogic)(allResults.map(function (result) { return result.passingFilterItems; }), allResults.map(function (result) { return result.passingQuickFilterValues; }), filterModel, filterValueGetter, params.apiRef, filterCache);
            }
        }
...
var getGroupingRules = function (_a) {
    ...
    return sanitizedRowGroupingModel.map(function (field) {
        ...
        return ({
            ...
            groupingValueSetter: (_b = columnsLookup[field]) === null || _b === void 0 ? void 0 : _b.groupingValueSetter,
        });
    });
};
