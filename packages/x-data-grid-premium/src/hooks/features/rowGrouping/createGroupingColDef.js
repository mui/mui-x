...
var GROUPING_COL_DEF_DEFAULT_PROPERTIES = __assign(__assign({}, x_data_grid_pro_1.GRID_STRING_COL_DEF), { type: 'custom', disableReorder: true, chartable: false, aggregable: false });
...
function getGroupingCriteriaProperties(groupedByColDef, rowGroupingColumnMode, rowGroupingModel, columnsLookup) {
    var _a;
    if (rowGroupingModel === void 0) { rowGroupingModel = []; }
    if (columnsLookup === void 0) { columnsLookup = {}; }
    var valueFormatter;
    if (rowGroupingColumnMode === 'single' && rowGroupingModel.length > 1) {
        ...
        valueFormatter = function (value, row, column, apiRef) {
            var rowId = (0, x_data_grid_pro_1.gridRowIdSelector)(apiRef, row);
            var rowNode = (0, x_data_grid_pro_1.gridRowNodeSelector)(apiRef, rowId);
            if ((rowNode === null || rowNode === void 0 ? void 0 : rowNode.type) === 'group') {
                var originalColDef = rowNode.groupingField ? columnsLookup[rowNode.groupingField] : null;
                if ((originalColDef === null || originalColDef === void 0 ? void 0 : originalColDef.type) === 'singleSelect') {
                    // the default valueFormatter of a singleSelect colDef won't work with the grouping column values
                    return value;
                }
                var columnValueFormatter = originalColDef === null || originalColDef === void 0 ? void 0 : originalColDef.valueFormatter;
    ...
    var applyHeaderName = !(rowGroupingColumnMode === 'single' && rowGroupingModel.length > 1);
    if (applyHeaderName) {
    ...
    var commonProperties = {
        ...
        renderCell: function (params) {
            ...
            if (params.rowNode.type === 'footer' || params.rowNode.type === 'pinnedRow') {
                return (0, jsx_runtime_1.jsx)(GridGroupingColumnFooterCell_1.GridGroupingColumnFooterCell, __assign({}, params));
            }
            // Render leaves
            if (params.rowNode.type === 'leaf') {
                if (leafColDef) {
                    ...
                    return (0, jsx_runtime_1.jsx)(GridGroupingColumnLeafCell_1.GridGroupingColumnLeafCell, __assign({}, leafParams));
                }
                return '';
            }
            // Render current grouping criteria groups
            if (params.rowNode.groupingField === groupingCriteria) {
                return ((0, jsx_runtime_1.jsx)(CriteriaCell, __assign({}, params, { hideDescendantCount: hideDescendantCount })));
            }
            return '';
        },
