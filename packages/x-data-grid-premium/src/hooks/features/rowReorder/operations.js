                ...
                if (failed.length === 0) {
                    ...
                    if (!sourceParentNode) {
                        ...
                        if (updatedSourceParentChildren.length === 0) {
                            ...
                            const parentOfSourceParent = updatedTree[sourceNode.parent]
                                .parent;
                        ...
                        const existingGroup = sourceGroupNode.groupingKey !== null && sourceGroupNode.groupingField !== null
                            ? rowReorderUtils.findExistingGroupWithSameKey(targetParentNode, sourceGroupNode.groupingKey, sourceGroupNode.groupingField, updatedTree)
                            : null;
                        if (existingGroup) {
