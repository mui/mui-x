...
const validationRules = [
    ...
    },
    {
        ...
        applies: (ctx) => conditions.isGroupToGroup(ctx) &&
    ...
    },
    {
        ...
        isInvalid: (ctx) => {
            ...
            if (conditions.targetDepthIsSourceMinusOne(ctx) &&
                conditions.targetGroupExpanded(ctx) &&
    ...
    },
    {
        ...
        applies: (ctx) => conditions.isLeafToLeaf(ctx) &&
            conditions.sameDepth(ctx) &&
            !conditions.sameParent(ctx) &&
            conditions.isDropBelow(ctx),
        isInvalid: (ctx) => !(conditions.nextIsGroup(ctx) && ctx.sourceNode.depth > ctx.nextNode.depth) &&
    ...
    },
    {
        ...
        applies: (ctx) => conditions.isLeafToGroup(ctx) &&
            conditions.isDropAbove(ctx) &&
            conditions.prevIsLeaf(ctx) &&
