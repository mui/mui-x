...
var useDataGridPremiumComponent = function (apiRef, inProps, configuration) {
    ...
    (0, internals_1.useGridInitializeState)(useGridChartsIntegration_1.chartsIntegrationStateInitializer, apiRef, props);
    ...
    (0, internals_1.useGridRows)(apiRef, props, configuration);
    (0, internals_1.useGridRowSpanning)(apiRef, props);
    (0, internals_1.useGridParamsApi)(apiRef, props, configuration);
    ...
    (0, internals_1.useGridEditing)(apiRef, props, configuration);
    (0, internals_1.useGridFocus)(apiRef, props);
    (0, internals_1.useGridPreferencesPanel)(apiRef, props);
    (0, internals_1.useGridFilter)(apiRef, props, configuration);
    ...
    (0, useGridChartsIntegration_1.useGridChartsIntegration)(apiRef, props);
