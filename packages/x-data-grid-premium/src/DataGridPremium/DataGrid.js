...
export function DataGrid() {
    ...
    throw new Error('MUI X Data Grid: DataGrid is not exported from @mui/x-data-grid-premium. ' +
...
export function DataGridPro() {
    ...
    throw new Error('MUI X Data Grid: DataGridPro is not exported from @mui/x-data-grid-premium. ' +
        'The Premium package exports DataGridPremium instead. ' +
