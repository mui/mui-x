...
var useGridRowsOverridableMethods_1 = require("../hooks/features/rows/useGridRowsOverridableMethods");
var useGridParamsOverridableMethods_1 = require("../hooks/features/rows/useGridParamsOverridableMethods");
var sidebar_2 = require("../hooks/features/sidebar");
var useGridCellEditable_1 = require("../hooks/features/editing/useGridCellEditable");
var configuration = {
    hooks: {
        ...
        useFilterValueGetter: function (apiRef, props) { return function (row, column) {
            if (props.aggregationRowsScope === 'all') {
                return apiRef.current.getRowValue(row, column);
            }
            return (0, internals_1.getRowValue)(row, column, apiRef);
        }; },
        useIsCellEditable: useGridCellEditable_1.useIsCellEditable,
        useGridRowsOverridableMethods: useGridRowsOverridableMethods_1.useGridRowsOverridableMethods,
        useGridParamsOverridableMethods: useGridParamsOverridableMethods_1.useGridParamsOverridableMethods,
    },
};
var releaseInfo = '__RELEASE_INFO__';
var watermark = (0, jsx_runtime_1.jsx)(x_license_1.Watermark, { packageName: "x-data-grid-premium", releaseInfo: releaseInfo });
...
var DataGridPremiumRaw = (0, forwardRef_1.forwardRef)(function DataGridPremium(inProps, ref) {
    ...
    var props = (0, useDataGridPremiumComponent_1.useDataGridPremiumComponent)(privateApiRef, initialProps, configuration);
    ...
    var sidePanel = sidebarOpen ? (0, jsx_runtime_1.jsx)(sidebar_1.Sidebar, {}) : null;
    return ((0, jsx_runtime_1.jsx)(x_data_grid_pro_1.GridContextProvider, { privateApiRef: privateApiRef, configuration: configuration, props: props, children: (0, jsx_runtime_1.jsx)(x_data_grid_pro_1.GridRoot, __assign({ className: props.className, style: props.style, sx: props.sx }, (_a = props.slotProps) === null || _a === void 0 ? void 0 : _a.root, { ref: ref, sidePanel: sidePanel, children: watermark })) }));
});
DataGridPremiumRaw.propTypes = {
     ...
     */
    activeChartId: prop_types_1.default.string,
    /**
    ...
    aiAssistantConversations: prop_types_1.default.arrayOf(prop_types_1.default.shape({
        ...
        prompts: prop_types_1.default.arrayOf(prop_types_1.default.shape({
            ...
            response: prop_types_1.default.shape({
                ...
                chart: prop_types_1.default.object,
     ...
     * @default false
     */
    chartsIntegration: prop_types_1.default.bool,
    /**
     ...
     * @default false
     */
    disableRowSelectionExcludeModel: prop_types_1.default.bool,
    /**
    ...
    experimentalFeatures: prop_types_1.default.shape({
        charts: prop_types_1.default.bool,
     ...
     */
    onActiveChartIdChange: prop_types_1.default.func,
    /**
     ...
     */
    pinnedColumnsSectionSeparator: prop_types_1.default.oneOf(['border-and-shadow', 'border', 'shadow']),
    /**
     ...
     * @default 'border-and-shadow'
     */
    pinnedRowsSectionSeparator: prop_types_1.default.oneOf(['border-and-shadow', 'border']),
    /**
