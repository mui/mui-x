...
const watermark = _jsx(Watermark, { packageInfo: packageInfo });
...
const DataGridPremiumRaw = forwardRef(function DataGridPremium(inProps, ref) {
    ...
    const sidePanel = sidebarOpen ? _jsx(Sidebar, {}) : null;
    return (_jsx(GridContextProvider, { privateApiRef: privateApiRef, configuration: configuration, props: props, children: _jsx(GridRoot, { className: props.className, style: props.style, sx: props.sx, ...props.slotProps?.root, ref: ref, sidePanel: sidePanel, children: watermark }) }));
});
DataGridPremiumRaw.propTypes = {
     ...
     */
    historyValidationEvents: PropTypes.arrayOf(PropTypes.oneOf([
        'activeChartIdChange',
