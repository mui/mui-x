...
import { renderCountry, renderEmail, renderIncoterm, renderPnl, renderProgress, renderStatus, renderTotalPrice, renderEditCurrency, renderEditProgress, renderEditStatus, renderEditIncoterm, renderEditBoolean, renderEditCountry, } from '../renderer';
...
export const getCommodityColumns = (editable = false) => [
    ...
    },
    {
        ...
        valueGetter: (value, row) => row.feeRate == null || row.quantity == null || row.unitPrice == null
            ? null
