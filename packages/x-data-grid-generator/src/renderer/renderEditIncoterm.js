...
function EditIncoterm(props) {
    ...
    var handleChange = function (event) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, apiRef.current.setEditCellValue({ id: id, field: field, value: event.target.value }, event)];
                case 1:
                    _a.sent();
    ...
    return ((0, jsx_runtime_1.jsx)(Select_1.default, { value: value, onChange: handleChange, MenuProps: {
            onClose: handleClose,
        }, sx: {
            height: '100%',
            '& .MuiSelect-select': {
        ...
        }, autoFocus: true, fullWidth: true, open: true, children: static_data_1.INCOTERM_OPTIONS.map(function (option) {
            var tooltip = option.slice(option.indexOf('(') + 1, option.indexOf(')'));
            var code = option.slice(0, option.indexOf('(')).trim();
            return ((0, jsx_runtime_1.jsxs)(MenuItem_1.default, { value: option, children: [(0, jsx_runtime_1.jsx)(ListItemIcon_1.default, { sx: { minWidth: 36 }, children: code }), (0, jsx_runtime_1.jsx)(ListItemText_1.default, { primary: tooltip, sx: { overflow: 'hidden' } })] }, option));
        }) }));
}
function renderEditIncoterm(params) {
    return (0, jsx_runtime_1.jsx)(EditIncoterm, __assign({}, params));
}
