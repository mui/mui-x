...
function EditRating(props) {
    ...
    var changedThroughKeyboard = React.useRef(false);
    var handleChange = function (event) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, apiRef.current.setEditCellValue({ id: id, field: field, value: Number(event.target.value) }, event)];
                case 1:
                    _a.sent();
    ...
    var handleRef = function (element) {
        if (element) {
            if (value) {
                element.querySelector("input[value=\"".concat(Math.round(value), "\"]")).focus();
            }
            else {
    ...
    return ((0, jsx_runtime_1.jsxs)(Box_1.default, { sx: {
            ...
            mr: 1,
        }, children: [(0, jsx_runtime_1.jsx)(Rating_1.default, { ref: handleRef, name: "rating", value: Number(value), precision: 1, onChange: handleChange, sx: { mr: 1 }, onKeyDown: handleKeyDown }), Number(value)] }));
}
function renderEditRating(params) {
    return (0, jsx_runtime_1.jsx)(EditRating, __assign({}, params));
}
