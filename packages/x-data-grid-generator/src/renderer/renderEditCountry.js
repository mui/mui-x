...
function EditCountry(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(StyledAutocomplete, { value: value, onChange: handleChange, options: static_data_1.COUNTRY_ISO_OPTIONS, getOptionLabel: function (option) { return option.label; }, autoHighlight: true, fullWidth: true, open: true, disableClearable: true, renderOption: function (optionProps, option) { return ((0, react_1.createElement)(Box_1.default, __assign({ component: "li", sx: {
                '& > img': {
                    mr: 1.5,
                    flexShrink: 0,
                },
            } }, optionProps, { key: option.code }),
            (0, jsx_runtime_1.jsx)("img", { loading: "lazy", width: "20", src: "https://flagcdn.com/w20/".concat(option.code.toLowerCase(), ".png"), srcSet: "https://flagcdn.com/w40/".concat(option.code.toLowerCase(), ".png 2x"), alt: "" }),
            option.label)); }, renderInput: function (params) { return ((0, jsx_runtime_1.jsx)(InputBase_1.default, __assign({ autoFocus: true, fullWidth: true, id: params.id, inputProps: __assign(__assign({}, params.inputProps), { autoComplete: 'new-password' }) }, params.InputProps))); } }));
}
function renderEditCountry(params) {
    return (0, jsx_runtime_1.jsx)(EditCountry, __assign({}, params));
}
