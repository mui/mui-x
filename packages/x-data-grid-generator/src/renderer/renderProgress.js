...
const ProgressBar = React.memo(function ProgressBar(props) {
    ...
    return (_jsxs(Element, { children: [_jsx(Value, { children: `${valueInPercent.toLocaleString()} %` }), _jsx(Bar, { className: clsx({
...
export function renderProgress(params) {
    ...
    return (_jsx(Center, { children: _jsx(ProgressBar, { value: params.value }) }));
}
