...
function ValueLabelComponent(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(Tooltip_1.default, { open: open, enterTouchDelay: 0, placement: "top", title: value, children: children }));
}
function EditProgress(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(StyledSlider, { ref: handleRef, classes: {
...
function renderEditProgress(params) {
    return (0, jsx_runtime_1.jsx)(EditProgress, __assign({}, params));
}
