...
function EditCurrency(props) {
    ...
    return (<StyledAutocomplete value={value} onChange={handleChange} options={static_data_1.CURRENCY_OPTIONS} autoHighlight fullWidth open disableClearable renderOption={function (optionProps, option) { return (<Box_1.default component="li" sx={{
                '& > img': {
                    mr: 1.5,
                    flexShrink: 0,
                },
            }} {...optionProps}>
          <img loading="lazy" width="20" src={"https://flagcdn.com/w20/".concat(option.slice(0, -1).toLowerCase(), ".png")} srcSet={"https://flagcdn.com/w40/".concat(option.slice(0, -1).toLowerCase(), ".png 2x")} alt=""/>
          {option}
