...
var PressUserGesture_1 = require("./PressUserGesture");
(0, vitest_1.describe)('PressUserGesture', function () {
    var pointerManager;
    ...
    (0, vitest_1.it)('should throw an error if no target is provided', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    pressGesture = function () { return (0, PressUserGesture_1.press)(pointerManager, {}); };
                    return [4 /*yield*/, (0, vitest_1.expect)(pressGesture).rejects.toThrow('Target element is required for press gesture')];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    (0, vitest_1.it)('should perform a basic mouse press gesture with default duration', function () { return __awaiter(void 0, void 0, void 0, function () {
        var options, advanceTimers, downEvent, upEvent;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    options = {
                    ...
                    return [4 /*yield*/, (0, PressUserGesture_1.press)(pointerManager, options, advanceTimers)];
                case 1:
                    _a.sent();
                    (0, vitest_1.expect)(pointerDown).toHaveBeenCalledTimes(1);
                    (0, vitest_1.expect)(pointerUp).toHaveBeenCalledTimes(1);
                    (0, vitest_1.expect)(advanceTimers).toHaveBeenCalledTimes(1);
                    (0, vitest_1.expect)(advanceTimers).toHaveBeenCalledWith(500); // Default duration
    ...
    (0, vitest_1.it)('should perform a basic touch press gesture with default duration', function () { return __awaiter(void 0, void 0, void 0, function () {
        var options, advanceTimers, downEvent, upEvent;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    advanceTimers = vitest_1.vi.fn().mockResolvedValue(undefined);
                    return [4 /*yield*/, (0, PressUserGesture_1.press)(touchPointerManager, options, advanceTimers)];
                case 1:
                    _a.sent();
                    (0, vitest_1.expect)(pointerDown).toHaveBeenCalledTimes(1);
                    (0, vitest_1.expect)(pointerUp).toHaveBeenCalledTimes(1);
    ...
    (0, vitest_1.it)('should respect custom duration', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    (0, vitest_1.expect)(advanceTimers).toHaveBeenCalledTimes(1);
                    (0, vitest_1.expect)(advanceTimers).toHaveBeenCalledWith(1000);
                    return [2 /*return*/];
            }
        });
    }); });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, PressUserGesture_1.press)(pointerManager, options)];
                case 1:
                    _a.sent();
                    downEvent = pointerDown.mock.calls[0][0];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, PressUserGesture_1.press)(touchPointerManager, options)];
                case 1:
                    _a.sent();
