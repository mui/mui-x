 ...
 */
var pan = function (pointerManager, options, advanceTimers) { return __awaiter(void 0, void 0, void 0, function () {
    var target, distance, _a, duration, _b, steps, _c, angle, _d, releasePointers, rad, deltaX, deltaY, pointersArray, mousePointer, touchPointers, _i, pointersArray_1, pointer, stepDelayMs, step, progress, _e, pointersArray_2, pointer, startX, startY, currentX, currentY, _f, pointersArray_3, pointer, finalX, finalY, _g, pointersArray_4, pointer, finalX, finalY;
    return __generator(this, function (_h) {
        switch (_h.label) {
            case 0:
                target = options.target, distance = options.distance, _a = options.duration, duration = _a === void 0 ? 500 : _a, _b = options.steps, steps = _b === void 0 ? 10 : _b, _c = options.angle, angle = _c === void 0 ? 0 : _c, _d = options.releasePointers, releasePointers = _d === void 0 ? true : _d;
                if (!target) {
            ...
            case 1:
                ...
                progress = step / steps;
                for (_e = 0, pointersArray_2 = pointersArray; _e < pointersArray_2.length; _e++) {
                    pointer = pointersArray_2[_e];
                    startX = pointer.x;
                    startY = pointer.y;
            ...
            case 6:
                ...
                if (releasePointers === true) {
                    ...
                    for (_f = 0, pointersArray_3 = pointersArray; _f < pointersArray_3.length; _f++) {
                        pointer = pointersArray_3[_f];
                        finalX = pointer.x + deltaX;
                        finalY = pointer.y + deltaY;
                    ...
                    for (_g = 0, pointersArray_4 = pointersArray; _g < pointersArray_4.length; _g++) {
                        pointer = pointersArray_4[_g];
