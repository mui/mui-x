...
var createProxy = function (target) {
    var proxy = new Proxy(target, {
        get: function (obj, prop) {
            var _this = this;
            if (prop === 'setup') {
                return function (options) {
                    var mode = Reflect.get(obj, 'pointerManager').mode;
            ...
            return function () {
                ...
                return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        mode = Reflect.get(obj, 'pointerManager').mode;
                        // @ts-expect-error, constructor is a function...
                        return [2 /*return*/, (_a = new obj.constructor(mode))[prop].apply(_a, args)];
                    });
                });
            };
        },
