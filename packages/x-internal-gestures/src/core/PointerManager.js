...
var PointerManager = /** @class */ (function () {
    function PointerManager(options) {
        ...
        this.root = ((_a = options.root) !== null && _a !== void 0 ? _a : document.getRootNode({ composed: true }));
        this.touchAction = options.touchAction || 'auto';
        this.passive = (_b = options.passive) !== null && _b !== void 0 ? _b : false;
        this.preventEventInterruption = (_c = options.preventEventInterruption) !== null && _c !== void 0 ? _c : false;
