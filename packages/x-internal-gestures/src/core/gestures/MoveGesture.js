...
var MoveGesture = /** @class */ (function (_super) {
    ...
    function MoveGesture(options) {
        ...
        _this.handleElementEnterBound = _this.handleElementEnter.bind(_this);
        _this.handleElementLeaveBound = _this.handleElementLeave.bind(_this);
     ...
     */
    MoveGesture.prototype.handleElementEnter = function (event) {
        if (event.pointerType !== 'mouse' && event.pointerType !== 'pen') {
            return;
        }
        // Get pointers from the PointerManager
        var pointers = this.pointerManager.getPointers() || new Map();
     ...
     * @param event The original pointer event
     */
    MoveGesture.prototype.handleElementLeave = function (event) {
        if (event.pointerType !== 'mouse' && event.pointerType !== 'pen') {
            return;
        }
        if (!this.isActive) {
     ...
     * @param event The original pointer event
     */
    MoveGesture.prototype.handlePointerEvent = function (pointers, event) {
