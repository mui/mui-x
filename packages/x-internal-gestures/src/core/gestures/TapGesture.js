...
var TapGesture = /** @class */ (function (_super) {
     ...
     */
    TapGesture.prototype.handlePointerEvent = function (pointers, event) {
        var _this = this;
        ...
        switch (event.type) {
            case 'pointerdown':
                if (!this.isActive) {
                    ...
                    this.state.lastPosition = __assign({}, this.state.startCentroid);
                    this.isActive = true;
            ...
            case 'pointermove':
                if (this.isActive && this.state.startCentroid) {
                    ...
                    var deltaX = currentPosition.x - this.state.startCentroid.x;
                    var deltaY = currentPosition.y - this.state.startCentroid.y;
