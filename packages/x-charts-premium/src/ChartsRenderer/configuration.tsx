...
const getColors = (localeText: ChartsLocaleText) => [
  ...
  { key: 'signalDuoPalette', name: localeText.chartPaletteNameSignalDuo },
  { key: 'desertDunePalette', name: localeText.chartPaletteNameDesertDune },
  { key: 'tropicalPunchPalette', name: localeText.chartPaletteNameTropicalPunch },
  { key: 'sageGardenPalette', name: localeText.chartPaletteNameSageGarden },
  { key: 'neonCyberPalette', name: localeText.chartPaletteNameNeonCyber },
  { key: 'autumnSpicePalette', name: localeText.chartPaletteNameAutumnSpice },
  { key: 'sunsetCoralPalette', name: localeText.chartPaletteNameSunsetCoral },
  { key: 'candyPopPalette', name: localeText.chartPaletteNameCandyPop },
