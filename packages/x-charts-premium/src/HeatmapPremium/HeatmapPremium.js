...
var useHeatmapPremiumProps_1 = require("./useHeatmapPremiumProps");
var ChartsDataProviderPremium_1 = require("../ChartsDataProviderPremium");
var HeatmapPlotPremium_1 = require("./HeatmapPlotPremium");
var HeatmapPremium = React.forwardRef(function HeatmapPremium(inProps, ref) {
    var _a, _b, _c;
    var props = (0, styles_1.useThemeProps)({ props: inProps, name: 'MuiHeatmapPremium' });
    ...
    var _e = (0, useHeatmapPremiumProps_1.useHeatmapPremiumProps)(props), chartsDataProviderPremiumProps = _e.chartsDataProviderPremiumProps, chartsWrapperProps = _e.chartsWrapperProps, chartsAxisProps = _e.chartsAxisProps, clipPathProps = _e.clipPathProps, clipPathGroupProps = _e.clipPathGroupProps, legendProps = _e.legendProps, heatmapPlotPremiumProps = _e.heatmapPlotPremiumProps, overlayProps = _e.overlayProps, children = _e.children;
    var Tooltip = (_a = slots === null || slots === void 0 ? void 0 : slots.tooltip) !== null && _a !== void 0 ? _a : Heatmap_1.HeatmapTooltip;
    var Toolbar = (_b = slots === null || slots === void 0 ? void 0 : slots.toolbar) !== null && _b !== void 0 ? _b : ChartsToolbarPro_1.ChartsToolbarPro;
    var renderer = heatmapPlotPremiumProps.renderer;
    return ((0, jsx_runtime_1.jsx)(ChartsDataProviderPremium_1.ChartsDataProviderPremium, __assign({}, chartsDataProviderPremiumProps, { children: (0, jsx_runtime_1.jsxs)(ChartsWrapper_1.ChartsWrapper, __assign({}, chartsWrapperProps, { ref: ref, children: [showToolbar ? (0, jsx_runtime_1.jsx)(Toolbar, __assign({}, (_c = props.slotProps) === null || _c === void 0 ? void 0 : _c.toolbar)) : null, !hideLegend && (0, jsx_runtime_1.jsx)(ChartsLegend_1.ChartsLegend, __assign({}, legendProps)), (0, jsx_runtime_1.jsxs)(ChartsLayerContainer_1.ChartsLayerContainer, { children: [renderer === 'webgl' && ((0, jsx_runtime_1.jsx)(ChartsWebGLLayer_1.ChartsWebGLLayer, { children: (0, jsx_runtime_1.jsx)(HeatmapPlotPremium_1.HeatmapPlotPremium, __assign({}, heatmapPlotPremiumProps)) })), (0, jsx_runtime_1.jsxs)(ChartsSvgLayer_1.ChartsSvgLayer, { sx: sx, children: [(0, jsx_runtime_1.jsxs)("g", __assign({}, clipPathGroupProps, { children: [renderer !== 'webgl' && (0, jsx_runtime_1.jsx)(HeatmapPlotPremium_1.HeatmapPlotPremium, __assign({}, heatmapPlotPremiumProps)), (0, jsx_runtime_1.jsx)(Heatmap_1.FocusedHeatmapCell, {}), (0, jsx_runtime_1.jsx)(ChartsOverlay_1.ChartsOverlay, __assign({}, overlayProps))] })), (0, jsx_runtime_1.jsx)(ChartsAxis_1.ChartsAxis, __assign({}, chartsAxisProps)), (0, jsx_runtime_1.jsx)(ChartsClipPath_1.ChartsClipPath, __assign({}, clipPathProps)), (0, jsx_runtime_1.jsx)(ChartsBrushOverlay_1.ChartsBrushOverlay, {}), children] })] }), !loading && (0, jsx_runtime_1.jsx)(Tooltip, __assign({}, slotProps === null || slotProps === void 0 ? void 0 : slotProps.tooltip))] })) })));
});
exports.HeatmapPremium = HeatmapPremium;
HeatmapPremium.propTypes = {
     ...
     */
    renderer: prop_types_1.default.oneOf(['svg-single', 'webgl']),
    /**
