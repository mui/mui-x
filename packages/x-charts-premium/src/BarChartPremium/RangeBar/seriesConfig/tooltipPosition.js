...
var tooltipItemPositionGetter = function (params) {
    ...
    var itemSeries = (_a = series.rangeBar) === null || _a === void 0 ? void 0 : _a.series[identifier.seriesId];
    ...
    var dimensions = (0, createGetRangeBarDimensions_1.createGetRangeBarDimensions)({
    ...
    })(identifier.dataIndex, series.rangeBar.seriesOrder.findIndex(function (id) { return id === itemSeries.id; }));
    if (dimensions == null) {
        return null;
    }
