...
function FocusedRangeBar(props) {
    ...
    var rangeBarSeries = (0, useRangeBarSeries_1.useRangeBarSeriesContext)();
    ...
    var series = rangeBarSeries.series[focusedItem.seriesId];
    ...
    var verticalLayout = rangeBarSeries.series[focusedItem.seriesId].layout === 'vertical';
    var groupIndex = rangeBarSeries.seriesOrder.findIndex(function (seriesId) { return seriesId === focusedItem.seriesId; });
    var barDimensions = (0, createGetRangeBarDimensions_1.createGetRangeBarDimensions)({
