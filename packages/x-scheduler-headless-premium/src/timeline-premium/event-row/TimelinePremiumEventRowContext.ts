...
export interface TimelinePremiumEventRowContext {
  /**
...
export const TimelinePremiumEventRowContext = React.createContext<
  TimelinePremiumEventRowContext | undefined
>(undefined);

export function useTimelinePremiumEventRowContext() {
