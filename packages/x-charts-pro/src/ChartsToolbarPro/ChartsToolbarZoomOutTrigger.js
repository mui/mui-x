 ...
 */
var ChartsToolbarZoomOutTrigger = React.forwardRef(function ChartsToolbarZoomOutTrigger(_a, ref) {
    ...
    var disabled = (0, internals_1.useSelector)(store, useChartProZoom_1.selectorChartCanZoomOut);
    var element = (0, useComponentRenderer_1.useComponentRenderer)(slots.baseButton, render, __assign(__assign(__assign(__assign({}, slotProps.baseButton), { onClick: function () { return instance.zoomOut(); }, disabled: disabled }), other), { ref: ref }));
    return <React.Fragment>{element}</React.Fragment>;
});
exports.ChartsToolbarZoomOutTrigger = ChartsToolbarZoomOutTrigger;
