...
function ChartsMenu(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(Popper, __assign({ open: open, target: target, transition: true, placement: position, onClickAway: handleClickAway, onExited: onExited, clickAwayMouseEvent: "onMouseDown" }, other, slotProps === null || slotProps === void 0 ? void 0 : slotProps.basePopper, { children: children })));
}
