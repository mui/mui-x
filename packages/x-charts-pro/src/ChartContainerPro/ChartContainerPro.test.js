...
describe('<ChartContainerPro /> - License', function () {
    var render = (0, internal_test_utils_1.createRenderer)().render;
    it('should render watermark when the license is missing', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    expect(function () { return render(<ChartContainerPro_1.ChartContainerPro series={[]} width={100} height={100}/>); }).toErrorDev([
                        'MUI X: Missing license key.',
                    ]);
                    _a = expect;
                    return [4 /*yield*/, internal_test_utils_1.screen.findAllByText('MUI X Missing license key')];
                case 1:
