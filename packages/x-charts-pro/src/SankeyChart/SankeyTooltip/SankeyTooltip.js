...
var SankeyTooltipContent_1 = require("./SankeyTooltipContent");
...
function SankeyTooltip(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(ChartsTooltip_1.ChartsTooltipContainer, __assign({ trigger: "item" }, props, { classes: classes, children: (0, jsx_runtime_1.jsx)(SankeyTooltipContent_1.SankeyTooltipContent, { classes: classes }) })));
}
SankeyTooltip.propTypes = {
     ...
     */
    anchorEl: prop_types_1.default.oneOfType([
        ...
        prop_types_1.default.shape({
            ...
            getBoundingClientRect: prop_types_1.default.func.isRequired,
        }),
    ]),
    /**
     ...
     * @default 'item'
     */
    trigger: prop_types_1.default.oneOf(['item', 'none']),
};
