...
function computeAxisValue(_a) {
    ...
    allAxis.forEach(function (eachAxis, axisIndex) {
        ...
        var _o = (0, internals_1.getAxisExtrema)(axis, axisDirection, seriesConfig, axisIndex, formattedSeries), minData = _o[0], maxData = _o[1];
        ...
        if ((0, internals_1.isBandScaleConfig)(axis)) {
            ...
            completeAxis[axis.id] = __assign(__assign({ offset: 0, height: 0, categoryGapRatio: 0, barGapRatio: 0, triggerTooltip: triggerTooltip }, axis), { data: data, scale: (0, internals_1.scaleBand)(axis.data, scaleRange)
            ...
            if ((0, internals_1.isDateData)(axis.data)) {
                var dateFormatter = (0, internals_1.createDateFormatter)(axis.data, scaleRange, axis.tickNumber);
        ...
        if ((0, internals_1.isPointScaleConfig)(axis)) {
            throw new Error('MUI X Charts: Point scale is not supported in FunnelChart. Please use band scale instead.');
        }
        if ((0, internals_1.isContinuousScaleConfig)(axis)) {
            ...
            var rawTickNumber = (0, internals_1.getTickNumber)(axis, axisExtremums, (0, internals_1.getDefaultTickNumber)(Math.abs(range[1] - range[0])));
