...
var useChartFunnelAxis = function (_a) {
    ...
    var isInteractionEnabled = store.use(internals_1.selectorChartsInteractionIsInitialized);
    ...
    React.useEffect(function () {
        ...
        store.update({
            ...
            cartesianAxis: {
                axesGap: 0,
                x: (0, internals_1.defaultizeXAxis)(xAxis, dataset, 0),
                y: (0, internals_1.defaultizeYAxis)(yAxis, dataset, 0),
            },
        });
    ...
    React.useEffect(function () {
        ...
        var gestureHandler = function (event) {
            ...
            var svgPoint = (0, internals_1.getChartPoint)(element, srvEvent);
    ...
    React.useEffect(function () {
        ...
        var axisClickHandler = instance.addInteractionListener('tap', function (event) {
            var _a;
            var _b = (0, useChartFunnelAxisRendering_selectors_1.selectorChartXAxis)(store.state), xAxisWithScale = _b.axis, xAxisIds = _b.axisIds;
            var _c = (0, useChartFunnelAxisRendering_selectors_1.selectorChartYAxis)(store.state), yAxisWithScale = _c.axis, yAxisIds = _c.axisIds;
            var processedSeries = (0, internals_1.selectorChartSeriesProcessed)(store.state);
            var usedXAxis = xAxisIds[0];
            var usedYAxis = yAxisIds[0];
            var dataIndex = null;
            var isXAxis = false;
            var svgPoint = (0, internals_1.getChartPoint)(element, event.detail.srcEvent);
...
exports.useChartFunnelAxis.getDefaultizedParams = function (_a) {
    ...
    return __assign(__assign({}, params), { gap: (_b = params.gap) !== null && _b !== void 0 ? _b : 0, defaultizedXAxis: (0, internals_1.defaultizeXAxis)(params.xAxis, params.dataset, 0), defaultizedYAxis: (0, internals_1.defaultizeYAxis)(params.yAxis, params.dataset, 0) });
};
