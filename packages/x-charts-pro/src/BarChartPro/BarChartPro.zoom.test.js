...
describe.skipIf(skipIf_1.isJSDOM)('<BarChartPro /> - Zoom', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    user = render(<BarChartPro_1.BarChartPro {...barChartProps} onZoomChange={onZoomChange}/>, options).user;
        ...
        it("should pan on ".concat(pointerName, " drag"), function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        onZoomChange = sinon.spy();
                        user = render(<BarChartPro_1.BarChartPro {...barChartProps} initialZoom={[{ axisId: 'x', start: 75, end: 100 }]} onZoomChange={onZoomChange}/>, options).user;
