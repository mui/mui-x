...
var BarChartPro = React.forwardRef(function BarChartPro(inProps, ref) {
    ...
    var _g = (0, internals_1.useBarChartProps)(other), chartsWrapperProps = _g.chartsWrapperProps, chartsContainerProps = _g.chartsContainerProps, barPlotProps = _g.barPlotProps, gridProps = _g.gridProps, clipPathProps = _g.clipPathProps, clipPathGroupProps = _g.clipPathGroupProps, overlayProps = _g.overlayProps, chartsAxisProps = _g.chartsAxisProps, axisHighlightProps = _g.axisHighlightProps, legendProps = _g.legendProps, children = _g.children;
    var _h = (0, useChartsContainerProProps_1.useChartsContainerProProps)(__assign(__assign({}, chartsContainerProps), { initialZoom: initialZoom, zoomData: zoomData, onZoomChange: onZoomChange, apiRef: apiRef, plugins: BarChartPro_plugins_1.BAR_CHART_PRO_PLUGINS })), chartsDataProviderProProps = _h.chartsDataProviderProProps, chartsSurfaceProps = _h.chartsSurfaceProps;
