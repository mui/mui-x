...
var internals_2 = require("@mui/x-license/internals");
var material_1 = require("../internals/material");
var allPlugins_1 = require("../internals/plugins/allPlugins");
var useChartsDataProviderProProps_1 = require("./useChartsDataProviderProProps");
var ChartsWatermark_1 = require("../internals/ChartsWatermark");
var packageInfo = {
    releaseDate: '__RELEASE_INFO__',
    version: process.env.MUI_VERSION,
    name: 'x-charts-pro',
};
exports.defaultSeriesConfigPro = internals_1.defaultSeriesConfig;
/**
...
function ChartsDataProviderPro(props) {
    var _a, _b;
    var _c = (0, useChartsDataProviderProProps_1.useChartsDataProviderProProps)(__assign(__assign({}, props), { seriesConfig: (_a = props.seriesConfig) !== null && _a !== void 0 ? _a : exports.defaultSeriesConfigPro, plugins: (_b = props.plugins) !== null && _b !== void 0 ? _b : allPlugins_1.DEFAULT_PLUGINS })), children = _c.children, localeText = _c.localeText, chartProviderProps = _c.chartProviderProps, slots = _c.slots, slotProps = _c.slotProps;
    (0, internals_2.useLicenseVerifier)(packageInfo);
    return ((0, jsx_runtime_1.jsxs)(internals_1.ChartsProvider, __assign({}, chartProviderProps, { children: [(0, jsx_runtime_1.jsx)(ChartsLocalizationProvider_1.ChartsLocalizationProvider, { localeText: localeText, children: (0, jsx_runtime_1.jsx)(internals_1.ChartsSlotsProvider, { slots: slots, slotProps: slotProps, defaultSlots: material_1.defaultSlotsMaterial, children: children }) }), (0, jsx_runtime_1.jsx)(ChartsWatermark_1.ChartsWatermark, { packageInfo: packageInfo })] })));
}
