...
var HeatmapTooltipContent_1 = require("./HeatmapTooltipContent");
var HeatmapTooltip_classes_1 = require("./HeatmapTooltip.classes");
function HeatmapTooltip(props) {
    var classes = (0, HeatmapTooltip_classes_1.useUtilityClasses)({ classes: props.classes });
    return ((0, jsx_runtime_1.jsx)(ChartsTooltip_1.ChartsTooltipContainer, __assign({ trigger: "item" }, props, { classes: classes, children: (0, jsx_runtime_1.jsx)(HeatmapTooltipContent_1.HeatmapTooltipContent, { classes: classes }) })));
}
