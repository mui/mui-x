...
function HeatmapTooltip(props) {
    ...
    return (<ChartsTooltip_1.ChartsTooltipContainer trigger="item" {...props} classes={classes}>
      <HeatmapTooltipContent_1.HeatmapTooltipContent classes={classes}/>
    </ChartsTooltip_1.ChartsTooltipContainer>);
}
