...
var HeatmapSVGPlot_1 = require("./HeatmapSVGPlot");
function HeatmapPlot(_a) {
    var borderRadius = _a.borderRadius, props = __rest(_a, ["borderRadius"]);
    return (0, jsx_runtime_1.jsx)(HeatmapSVGPlot_1.HeatmapSVGPlot, __assign({ borderRadius: borderRadius }, props));
}
