...
export type HeatmapXAxis = Omit<MakeOptional<XAxis<'band'>, 'scaleType'>, 'zoom'>;
export type HeatmapYAxis = Omit<MakeOptional<XAxis<'band'>, 'scaleType'>, 'zoom'>;
...
export interface HeatmapProps
   ...
   * An array of [[HeatmapXAxis]] objects.
   */
  xAxis: ReadonlyArray<XAxis>;
  /**
   * The configuration of the y-axes.
   * If not provided, a default axis config is used.
   * An array of [[HeatmapYAxis]] objects.
   */
  yAxis: ReadonlyArray<YAxis>;
  /**
   * The series to display in the heatmap.
   * An array of [[HeatmapSeries]] objects.
   */
  series: ReadonlyArray<HeatmapSeries>;
  /**
