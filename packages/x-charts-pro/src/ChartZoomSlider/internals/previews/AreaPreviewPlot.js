...
function AreaPreviewPlot(_a) {
    ...
    return (<AreaPlotRoot>
      {completedData.map(function (_a) {
            ...
            return !!area && (<PreviewAreaElement key={seriesId} id={seriesId} d={d} color={color} gradientId={gradientId}/>);
        })}
    </AreaPlotRoot>);
}
/**
...
function PreviewAreaElement(_a) {
    ...
    return (<path fill={gradientId ? "url(#".concat(gradientId, ")") : color} stroke="none" data-series={id} {...other}/>);
}
