...
var LineChartPro = React.forwardRef(function LineChartPro(inProps, ref) {
    ...
    var _g = (0, internals_1.useLineChartProps)(other), chartsWrapperProps = _g.chartsWrapperProps, chartContainerProps = _g.chartContainerProps, gridProps = _g.gridProps, clipPathProps = _g.clipPathProps, clipPathGroupProps = _g.clipPathGroupProps, areaPlotProps = _g.areaPlotProps, linePlotProps = _g.linePlotProps, markPlotProps = _g.markPlotProps, overlayProps = _g.overlayProps, chartsAxisProps = _g.chartsAxisProps, axisHighlightProps = _g.axisHighlightProps, lineHighlightPlotProps = _g.lineHighlightPlotProps, legendProps = _g.legendProps, children = _g.children;
    var _h = (0, useChartContainerProProps_1.useChartContainerProProps)(__assign(__assign({}, chartContainerProps), { initialZoom: initialZoom, zoomData: zoomData, onZoomChange: onZoomChange, apiRef: apiRef, plugins: LineChartPro_plugins_1.LINE_CHART_PRO_PLUGINS }), ref), chartDataProviderProProps = _h.chartDataProviderProProps, chartsSurfaceProps = _h.chartsSurfaceProps;
      ...
      <ChartsWrapper_1.ChartsWrapper {...chartsWrapperProps}>
        ...
        <ChartsSurface_1.ChartsSurface {...chartsSurfaceProps}>
          ...
          <g {...clipPathGroupProps}>
            <LineChart_1.AreaPlot {...areaPlotProps}/>
            <LineChart_1.LinePlot {...linePlotProps}/>
          ...
          <g data-drawing-container>
            ...
            <LineChart_1.MarkPlot {...markPlotProps}/>
          </g>
          <LineChart_1.LineHighlightPlot {...lineHighlightPlotProps}/>
