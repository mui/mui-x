 ...
 */
export declare const zoomAtPoint: (
  centerRatio: number,
  scaleRatio: number,
 ...
 */
export declare function isSpanValid(
  minRange: number,
  maxRange: number,
  isZoomIn: boolean,
 ...
 */
export declare function getWheelScaleRatio(
  event: WheelEvent,
  step: number,
): {
  scaleRatio: number;
 ...
 */
export declare function getHorizontalCenterRatio(
  point: {
    x: number;
    y: number;
  },
 ...
 */
export declare function getVerticalCenterRatio(
  point: {
    x: number;
    y: number;
  },
 ...
 */
export declare function translateZoom(
