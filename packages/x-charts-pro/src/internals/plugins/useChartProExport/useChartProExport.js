...
var useChartProExport = function (_a) {
    ...
    var chartRootRef = instance.chartRootRef, chartsLayerContainerRef = instance.chartsLayerContainerRef;
    ...
    var exportAsImage = function (options) { return __awaiter(void 0, void 0, void 0, function () {
        var chartRoot, svg, enableAnimation, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    chartRoot = chartRootRef.current;
                    svg = chartsLayerContainerRef.current;
                    if (!(chartRoot && svg)) return [3 /*break*/, 6];
                    enableAnimation = instance.disableAnimation();
                    _a.label = 1;
                case 1:
                ...
                case 2:
                    // Wait for animation frame to ensure the animation finished
                    _a.sent();
                    return [4 /*yield*/, (0, exportImage_1.exportImage)(chartRoot, svg, options)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 6];
                case 4:
