...
function exportImage(element, svg, params) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, fileName, _b, type, _c, quality, _d, onBeforeExport, _e, copyStyles, nonce, drawDocumentPromise, doc, ratio, iframe, previousStyles, resolve, iframeLoadPromise, drawDocument, exportDocBodySize, canvas, resolveBlobPromise, blobPromise, blob, error_2, url;
        var _this = this;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    _a = params !== null && params !== void 0 ? params : {}, fileName = _a.fileName, _b = _a.type, type = _b === void 0 ? 'image/png' : _b, _c = _a.quality, quality = _c === void 0 ? 0.9 : _c, _d = _a.onBeforeExport, onBeforeExport = _d === void 0 ? defaults_1.defaultOnBeforeExport : _d, _e = _a.copyStyles, copyStyles = _e === void 0 ? true : _e, nonce = _a.nonce;
                    ...
                    previousStyles = (0, common_1.applyStyles)(svg, { width: "".concat(svg.getBoundingClientRect().width, "px") });
                    iframeLoadPromise = new Promise(function (res) {
                        resolve = res;
                    });
                    iframe.onload = function () { return __awaiter(_this, void 0, void 0, function () {
                        var exportDoc, elementClone, rootCandidate, root;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    exportDoc = iframe.contentDocument;
                                    elementClone = element.cloneNode(true);
                                    (0, common_1.applyStyles)(svg, previousStyles);
                                    ...
                                    return [4 /*yield*/, Promise.all((0, export_1.loadStyleSheets)(exportDoc, root, nonce))];
                                case 1:
                                    _a.sent();
                                    _a.label = 2;
                                case 2: return [4 /*yield*/, (0, common_1.copyCanvasesContent)(element, elementClone)];
                                case 3:
                                    _a.sent();
                                    resolve();
                                    return [2 /*return*/];
                ...
                case 3:
                    drawDocument = _f.sent();
                    exportDocBodySize = iframe.contentDocument.body.getBoundingClientRect();
                    canvas = document.createElement('canvas');
                    canvas.width = exportDocBodySize.width * ratio;
                    canvas.height = exportDocBodySize.height * ratio;
                    canvas.style.width = "".concat(exportDocBodySize.width, "px");
                    canvas.style.height = "".concat(exportDocBodySize.height, "px");
                    if (canvas.width === 0 || canvas.height === 0) {
                        doc.body.removeChild(iframe);
                        throw new Error("MUI X Charts: Cannot export an image with zero width or height. Width: ".concat(canvas.width, "px. Height: ").concat(canvas.height, "px."));
                    }
                    _f.label = 4;
                case 4:
                    _f.trys.push([4, , 6, 7]);
                ...
                case 8:
                    ...
                    canvas.toBlob(function (b) { return resolveBlobPromise(b); }, type, quality);
