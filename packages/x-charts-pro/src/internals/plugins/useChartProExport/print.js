...
function printChart(element, _a) {
    var _this = this;
    var _b = _a === void 0 ? {} : _a, fileName = _b.fileName, _c = _b.onBeforeExport, onBeforeExport = _c === void 0 ? defaults_1.defaultOnBeforeExport : _c, _d = _b.copyStyles, copyStyles = _d === void 0 ? true : _d, nonce = _b.nonce;
    ...
    printWindow.onload = function () { return __awaiter(_this, void 0, void 0, function () {
        var printDoc, elementClone, rootCandidate, root, mediaQueryList;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all((0, export_1.loadStyleSheets)(printDoc, root, nonce))];
                case 1:
                    _a.sent();
                    _a.label = 2;
