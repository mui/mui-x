...
import type { ChatConversationInputTextAreaProps } from '../ChatConversationInput/ChatConversationInputTextArea';
import type { ChatConversationInputSendButtonProps } from '../ChatConversationInput/ChatConversationInputSendButton';
import type { ChatConversationInputAttachButtonProps } from '../ChatConversationInput/ChatConversationInputAttachButton';
import type { ChatConversationInputToolbarProps } from '../ChatConversationInput/ChatConversationInputToolbar';
import type { ChatConversationInputHelperTextProps } from '../ChatConversationInput/ChatConversationInputHelperText';
...
export interface ChatBoxSlotProps {
  ...
  composerRoot?: Partial<ChatConversationInputProps>;
  composerInput?: Partial<ChatConversationInputTextAreaProps>;
  composerSendButton?: Partial<ChatConversationInputSendButtonProps>;
  composerAttachButton?: Partial<ChatConversationInputAttachButtonProps>;
  composerToolbar?: Partial<ChatConversationInputToolbarProps>;
  composerHelperText?: Partial<ChatConversationInputHelperTextProps>;
