...
describe('processEvent', () => {
  it('converts start and end to the render timezone', () => {
  ...
  it('converts exDates to the render timezone', () => {
  ...
  it('converts rrule.until to the render timezone when rrule is an object', () => {
    const event = EventBuilder.new(adapter)
      .rrule({
        freq: 'DAILY',
