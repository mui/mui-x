import {
  ...
  EventBuilder,
  getTimelinePremiumStateFromParameters,
...
describe('schedulerOccurrenceSelectors', () => {
  describe('isStartedOrEnded', () => {
    it('should return started=false and ended=false when now is before start', () => {
      const state = getTimelinePremiumStateFromParameters({ events: [] });
  ...
  describe('groupedByResource', () => {
    ...
    it('should return empty when there are no resources', () => {
      const state = getTimelinePremiumStateFromParameters({ events: [], resources: [] });
    ...
    it('should group single occurrence under a resource', () => {
      ...
      const state = getTimelinePremiumStateFromParameters({ events: [event], resources: [R1] });
      const response = schedulerOccurrenceSelectors.groupedByResourceList(state, start, end);
    ...
    it('should return empty occurrences for resources without matching events', () => {
      ...
      const state = getTimelinePremiumStateFromParameters({ events: [event], resources: [R1, R2] });
      const response = schedulerOccurrenceSelectors.groupedByResourceList(state, start, end);
    ...
    it('should sort resources alphabetically by title', () => {
      ...
      const state = getTimelinePremiumStateFromParameters({ events: [], resources: [R1, R3, R2] });
      const response = schedulerOccurrenceSelectors.groupedByResourceList(state, start, end);
    ...
    it('should include children immediately after their parent', () => {
      ...
      const state = getTimelinePremiumStateFromParameters({ events: [event], resources: [parent] });
      const response = schedulerOccurrenceSelectors.groupedByResourceList(state, start, end);
    ...
    it('should handle deep nested resource trees', () => {
      ...
      const state = getTimelinePremiumStateFromParameters({ events: [event], resources: [root] });
      const response = schedulerOccurrenceSelectors.groupedByResourceList(state, start, end);
