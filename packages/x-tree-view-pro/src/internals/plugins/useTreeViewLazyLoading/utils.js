...
exports.NestedDataManager = exports.RequestStatus = void 0;
...
var NestedDataManager = /** @class */ (function () {
    function NestedDataManager(instance, maxConcurrentRequests) {
        ...
        this.processQueue = function () { return __awaiter(_this, void 0, void 0, function () {
            var loopLength, fetchQueue, fetchPromises, i, id;
        ...
        this.setRequestSettled = function (id) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        this.clearPendingRequest = function (id) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.pendingRequests.delete(id);
