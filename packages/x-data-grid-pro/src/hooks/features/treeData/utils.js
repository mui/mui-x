...
import { BatchRowUpdater, collectAllDescendants, updateDescendantDepths, } from '../rowReorder/utils';
...
export function displaySetTreeDataPathWarning(operationName) {
    warnOnce(`MUI X: ${operationName} requires \`setTreeDataPath()\` prop to update row data paths. ` +
        'Please provide a `setTreeDataPath()` function to enable this feature.', 'warning');
}
