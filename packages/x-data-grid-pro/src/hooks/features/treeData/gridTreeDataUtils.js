...
var filterRowTreeFromTreeData = function (params) {
    ...
    var filterTreeNode = function (node, isParentMatchingFilters, areAncestorsExpanded) {
        ...
        if (shouldSkipFilters) {
            ...
            isMatchingFilters = (0, internals_1.passFilterLogic)([filterResults.passingFilterItems], [filterResults.passingQuickFilterValues], params.filterModel, params.filterValueGetter, params.apiRef, filterCache);
        }
