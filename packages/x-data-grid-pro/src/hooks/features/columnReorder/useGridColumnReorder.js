...
export const columnReorderStateInitializer = (state) => ({
    ...state,
    ...
    const handleDragOver = React.useCallback((params, event) => {
        ...
        if (params.field !== dragColField &&
            ...
            if (hasMovedLeft || hasMovedRight) {
                ...
                const canBeReorderedProcessed = apiRef.current.unstable_applyPipeProcessors('canBeReordered', canBeReordered, { targetIndex: targetColVisibleIndex });
