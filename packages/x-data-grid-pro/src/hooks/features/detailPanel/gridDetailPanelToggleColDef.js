...
exports.GRID_DETAIL_PANEL_TOGGLE_COL_DEF = __assign(__assign({}, x_data_grid_1.GRID_STRING_COL_DEF), { type: 'custom', field: internals_1.GRID_DETAIL_PANEL_TOGGLE_FIELD, editable: false, sortable: false, filterable: false, resizable: false, 
    // @ts-ignore
    aggregable: false, chartable: false, disableColumnMenu: true, disableReorder: true, disableExport: true, align: 'left', width: 40, valueGetter: function (value, row, column, apiRef) {
    ...
    }, rowSpanValueGetter: function (_, row, __, apiRef) { return (0, x_data_grid_1.gridRowIdSelector)(apiRef, row); }, renderCell: function (params) { return (0, jsx_runtime_1.jsx)(GridDetailPanelToggleCell_1.GridDetailPanelToggleCell, __assign({}, params)); }, renderHeader: function (_a) {
        var colDef = _a.colDef;
        return (0, jsx_runtime_1.jsx)("div", { "aria-label": colDef.headerName });
    } });
