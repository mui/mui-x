...
export const detailPanelStateInitializer = (state, props) => {
    return {
        ...
        detailPanel: {
            heightCache: {},
            expandedRowIds: props.detailPanelExpandedRowIds ??
    ...
    const updateCaches = React.useCallback(() => {
        ...
        apiRef.current.setState((state) => {
            return {
                ...
                detailPanel: {
                    ...state.detailPanel,
                    ...cacheContentAndHeight(apiRef, props.getDetailPanelContent, props.getDetailPanelHeight, state.detailPanel.heightCache),
                },
            };
        });
