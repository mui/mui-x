...
var useGridColumnHeadersPro = function (props) {
    ...
    var getColumnFilters = function (params) {
        ...
        for (var i = 0; i < renderedColumns.length; i += 1) {
            ...
            var showLeftBorder = (0, internals_1.shouldCellShowLeftBorder)(pinnedPosition, indexInSection, rootProps.showColumnVerticalBorder, rootProps.pinnedColumnsSectionSeparator);
            var showRightBorder = (0, internals_1.shouldCellShowRightBorder)(pinnedPosition, indexInSection, sectionLength, rootProps.showColumnVerticalBorder, gridHasFiller, rootProps.pinnedColumnsSectionSeparator);
            filters.push((0, jsx_runtime_1.jsx)(rootProps.slots.headerFilterCell, __assign({ colIndex: columnIndex, height: headerFilterHeight, width: colDef.computedWidth, colDef: colDef, hasFocus: hasFocus, tabIndex: tabIndex, headerFilterMenuRef: headerFilterMenuRef, headerClassName: headerClassName, "data-field": colDef.field, item: item, pinnedPosition: pinnedPosition, pinnedOffset: pinnedOffset, showLeftBorder: showLeftBorder, showRightBorder: showRightBorder }, (_a = rootProps.slotProps) === null || _a === void 0 ? void 0 : _a.headerFilterCell), "".concat(colDef.field, "-filter")));
        }
    ...
    var getColumnFiltersRow = function () {
        ...
        return ((0, jsx_runtime_1.jsxs)(internals_1.GridColumnHeaderRow, { ref: headerFiltersRef, className: classes.headerFilterRow, role: "row", "aria-rowindex": headerGroupingMaxDepth + 2, ownerState: rootProps, children: [leftRenderContext &&
                    getColumnFilters({
