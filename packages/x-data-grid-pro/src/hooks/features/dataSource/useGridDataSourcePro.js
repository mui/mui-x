...
var useGridDataSourcePro = function (apiRef, props) {
    var _a = (0, useGridDataSourceBasePro_1.useGridDataSourceBasePro)(apiRef, props, options), api = _a.api, flatTreeStrategyProcessor = _a.flatTreeStrategyProcessor, groupedDataStrategyProcessor = _a.groupedDataStrategyProcessor, events = _a.events, setStrategyAvailability = _a.setStrategyAvailability;
