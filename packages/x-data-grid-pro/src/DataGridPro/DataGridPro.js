...
var watermark = <x_license_1.Watermark packageName="x-data-grid-pro" releaseInfo={releaseInfo}/>;
var DataGridProRaw = (0, forwardRef_1.forwardRef)(function DataGridPro(inProps, ref) {
    ...
    (0, useDataGridProComponent_1.useDataGridProComponent)(privateApiRef, props);
    ...
    return (<x_data_grid_1.GridContextProvider privateApiRef={privateApiRef} configuration={configuration} props={props}>
      <x_data_grid_1.GridRoot className={props.className} style={props.style} sx={props.sx} {...(_a = props.slotProps) === null || _a === void 0 ? void 0 : _a.root} ref={ref}>
        {watermark}
      </x_data_grid_1.GridRoot>
    </x_data_grid_1.GridContextProvider>);
});
/**
 * Features:
