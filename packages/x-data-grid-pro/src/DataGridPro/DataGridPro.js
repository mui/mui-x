...
var useDataGridProComponent_1 = require("./useDataGridProComponent");
var useDataGridProProps_1 = require("./useDataGridProProps");
var propValidation_1 = require("../internals/propValidation");
...
var configuration = {
    hooks: {
        ...
        useGridAriaAttributes: useGridAriaAttributes_1.useGridAriaAttributesPro,
        useGridRowAriaAttributes: useGridRowAriaAttributes_1.useGridRowAriaAttributesPro,
        useGridRowsOverridableMethods: internals_1.useGridRowsOverridableMethods,
        useGridParamsOverridableMethods: internals_1.useGridParamsOverridableMethods,
        useIsCellEditable: internals_1.useIsCellEditable,
...
var watermark = (0, jsx_runtime_1.jsx)(x_license_1.Watermark, { packageName: "x-data-grid-pro", releaseInfo: releaseInfo });
var DataGridProRaw = (0, forwardRef_1.forwardRef)(function DataGridPro(inProps, ref) {
    var _a;
    var props = (0, useDataGridProProps_1.useDataGridProProps)(inProps);
    var privateApiRef = (0, internals_1.useGridApiInitialization)(props.apiRef, props);
    (0, useDataGridProComponent_1.useDataGridProComponent)(privateApiRef, props, configuration);
    (0, x_license_1.useLicenseVerifier)('x-data-grid-pro', releaseInfo);
    if (process.env.NODE_ENV !== 'production') {
        (0, internals_1.validateProps)(props, propValidation_1.propValidatorsDataGridPro);
    }
    return ((0, jsx_runtime_1.jsx)(x_data_grid_1.GridContextProvider, { privateApiRef: privateApiRef, configuration: configuration, props: props, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.GridRoot, __assign({ className: props.className, style: props.style, sx: props.sx }, (_a = props.slotProps) === null || _a === void 0 ? void 0 : _a.root, { ref: ref, children: watermark })) }));
});
/**
 * Features:
 ...
 */
exports.DataGridPro = React.memo(DataGridProRaw);
