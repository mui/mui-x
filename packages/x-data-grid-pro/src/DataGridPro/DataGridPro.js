...
const DataGridProRaw = forwardRef(function DataGridPro(inProps, ref) {
    ...
    return (_jsx(GridContextProvider, { privateApiRef: privateApiRef, configuration: configuration, props: props, children: _jsx(GridRoot, { className: props.className, style: props.style, sx: props.sx, ...props.slotProps?.root, ref: ref, children: watermark }) }));
});
/**
 * Features:
