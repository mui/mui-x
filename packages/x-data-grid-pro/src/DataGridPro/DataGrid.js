...
export function DataGrid() {
    ...
    throw new Error('MUI X Data Grid: DataGrid is not exported from @mui/x-data-grid-pro. ' +
...
export function DataGridPremium() {
    ...
    throw new Error('MUI X Data Grid: DataGridPremium is not exported from @mui/x-data-grid-pro. ' +
