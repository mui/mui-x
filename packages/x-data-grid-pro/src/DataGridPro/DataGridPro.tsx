...
import { fastMemo, validateProps } from '@mui/x-data-grid/internals';
...
export const DataGridProRaw = fastMemo(React.forwardRef(function DataGridPro<R extends GridValidRowModel>(
