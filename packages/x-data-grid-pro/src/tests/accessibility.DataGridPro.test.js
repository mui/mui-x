...
describe.skipIf(!/chrome/i.test(window.navigator.userAgent))('<DataGridPro /> - Accessibility', function () {
    var render = (0, internal_test_utils_1.createRenderer)().render;
    it('pinned columns should pass `aria-required-parent` rule', function () { return __awaiter(void 0, void 0, void 0, function () {
        function TestCase() {
            var data = (0, x_data_grid_generator_1.useBasicDemoData)(1, 3);
            return (<div style={{ width: 302, height: 300 }}>
            <x_data_grid_pro_1.DataGridPro {...data} columns={[{ field: 'id' }, { field: 'currencyPair' }, { field: 'price1M' }]} pinnedColumns={{ left: ['id'], right: ['currencyPair'] }}/>
          </div>);
        }
        var results;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axe_core_1.default.run()];
                case 1:
                    results = _a.sent();
