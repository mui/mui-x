...
var insertDataRowInTree = function (_a) {
    var _b, _c, _d, _e;
    var id = _a.id, path = _a.path, previousTree = _a.previousTree, tree = _a.tree, treeDepths = _a.treeDepths, onDuplicatePath = _a.onDuplicatePath, isGroupExpandedByDefault = _a.isGroupExpandedByDefault, defaultGroupingExpansionDepth = _a.defaultGroupingExpansionDepth, serverChildrenCount = _a.serverChildrenCount, groupsToFetch = _a.groupsToFetch, maxDepth = _a.maxDepth;
    var parentNodeId = x_data_grid_1.GRID_ROOT_GROUP_ID;
    for (var depth = 0; depth < path.length; depth += 1) {
        var _f = path[depth], key = _f.key, field = _f.field;
        ...
        if (depth === path.length - 1) {
            ...
            if (existingNodeIdWithPartialPath == null) {
                ...
                if (serverChildrenCount !== undefined && serverChildrenCount !== 0) {
                    ...
                    var shouldFetchChildren = (0, utils_1.checkGroupChildrenExpansion)(node, defaultGroupingExpansionDepth, maxDepth, isGroupExpandedByDefault);
        ...
        // We create an auto-generated group node.
            ...
            (0, utils_1.insertNodeInTree)((0, utils_1.updateGroupDefaultExpansion)(autoGeneratedGroupNode, defaultGroupingExpansionDepth, maxDepth, isGroupExpandedByDefault, (_d = previousTree === null || previousTree === void 0 ? void 0 : previousTree[nodeId]) === null || _d === void 0 ? void 0 : _d.childrenExpanded), tree, treeDepths, previousTree);
            parentNodeId = nodeId;
        }
        // For the intermediary steps of the path
        // If a node matches the partial path, we use it as parent for the next step
            ...
            if (currentGroupNode.type !== 'group') {
                ...
                tree[existingNodeIdWithPartialPath] = (0, utils_1.updateGroupDefaultExpansion)(groupNode, defaultGroupingExpansionDepth, maxDepth, isGroupExpandedByDefault, (_e = previousTree === null || previousTree === void 0 ? void 0 : previousTree[currentGroupNode.id]) === null || _e === void 0 ? void 0 : _e.childrenExpanded);
            }
