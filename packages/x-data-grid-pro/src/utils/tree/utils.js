...
export const getNodePathInTree = ({ id, tree, }) => {
    const path = [];
    let node = tree[id];
 ...
 */
export const removeNodeFromTree = ({ node, tree, treeDepths, }) => {
 ...
 */
export const updateGroupNodeIdAndAutoGenerated = ({ node, updatedNode, previousTree, tree, treeDepths, }) => {
...
export const getVisibleRowsLookup = ({ tree, filteredRowsLookup, }) => {
