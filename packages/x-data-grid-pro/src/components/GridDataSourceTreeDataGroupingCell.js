...
function GridDataSourceTreeDataGroupingCell(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: classes.root, style: { marginLeft: internals_1.vars.spacing(rowNode.depth * offsetMultiplier) }, children: [(0, jsx_runtime_1.jsx)("div", { className: classes.toggle, children: (0, jsx_runtime_1.jsx)(GridTreeDataGroupingCellIcon, { id: id, field: field, rowNode: rowNode, row: row, descendantCount: descendantCount }) }), (0, jsx_runtime_1.jsxs)("span", { children: [formattedValue === undefined ? rowNode.groupingKey : formattedValue, !hideDescendantCount && descendantCount > 0 ? " (".concat(descendantCount, ")") : ''] })] }));
}
