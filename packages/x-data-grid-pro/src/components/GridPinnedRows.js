...
function GridPinnedRows(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: (0, clsx_1.default)(classes.root, x_data_grid_1.gridClasses["pinnedRows--".concat(position)]), role: "presentation", children: pinnedRows }));
}
