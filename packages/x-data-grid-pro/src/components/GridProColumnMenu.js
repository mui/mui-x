...
exports.GridProColumnMenu = (0, forwardRef_1.forwardRef)(function GridProColumnMenu(props, ref) {
    return ((0, jsx_runtime_1.jsx)(x_data_grid_1.GridGenericColumnMenu, __assign({}, props, { defaultSlots: exports.GRID_COLUMN_MENU_SLOTS_PRO, defaultSlotProps: exports.GRID_COLUMN_MENU_SLOT_PROPS_PRO, ref: ref })));
});
