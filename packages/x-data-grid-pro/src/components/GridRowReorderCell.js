...
function GridRowReorderCell(params) {
    ...
    return (_jsxs("div", { ref: cellRef, className: classes.root, draggable: isDraggable, ...draggableEventHandlers, children: [_jsx(RowReorderIcon, { as: rootProps.slots.rowReorderIcon, ownerState: ownerState, className: classes.icon, fontSize: "small" }), _jsx("div", { className: classes.placeholder, children: cellValue })] }));
}
...
export const renderRowReorderCell = (params) => {
    ...
    return _jsx(GridRowReorderCell, { ...params });
};
