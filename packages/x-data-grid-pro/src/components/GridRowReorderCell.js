...
function GridRowReorderCell(params) {
    ...
    params.row.__reorder__ ||
        (params.rowNode.type === 'group' ? ((_a = params.rowNode.groupingKey) !== null && _a !== void 0 ? _a : params.id) : params.id);
    ...
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ ref: cellRef, className: classes.root, draggable: isDraggable }, draggableEventHandlers, { children: [(0, jsx_runtime_1.jsx)(RowReorderIcon, { as: rootProps.slots.rowReorderIcon, ownerState: ownerState, className: classes.icon, fontSize: "small" }), (0, jsx_runtime_1.jsx)("div", { className: classes.placeholder, children: cellValue })] })));
}
...
var renderRowReorderCell = function (params) {
    ...
    return (0, jsx_runtime_1.jsx)(GridRowReorderCell, __assign({}, params));
};
