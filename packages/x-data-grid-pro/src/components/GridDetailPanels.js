...
function GridDetailPanelsImpl(_a) {
    ...
    var getDetailPanel = React.useCallback(function (rowId) {
        ...
        return ((0, jsx_runtime_1.jsx)(GridDetailPanel_1.GridDetailPanel, { rowId: rowId, height: height, className: classes.detailPanel, children: content }, "panel-".concat(rowId)));
