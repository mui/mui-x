...
function GridTreeDataGroupingCell(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: classes.root, style: { marginLeft: internals_1.vars.spacing(rowNode.depth * offsetMultiplier) }, children: [(0, jsx_runtime_1.jsx)("div", { className: classes.toggle, children: filteredDescendantCount > 0 && ((0, jsx_runtime_1.jsx)(rootProps.slots.baseIconButton, __assign({ size: "small", onClick: handleClick, tabIndex: -1, "aria-label": rowNode.childrenExpanded
                        ? apiRef.current.getLocaleText('treeDataCollapse')
                        : apiRef.current.getLocaleText('treeDataExpand') }, (_b = rootProps === null || rootProps === void 0 ? void 0 : rootProps.slotProps) === null || _b === void 0 ? void 0 : _b.baseIconButton, { children: (0, jsx_runtime_1.jsx)(Icon, { fontSize: "inherit" }) }))) }), (0, jsx_runtime_1.jsxs)("span", { children: [formattedValue === undefined ? rowNode.groupingKey : formattedValue, !hideDescendantCount && filteredDescendantCount > 0 ? " (".concat(filteredDescendantCount, ")") : ''] })] }));
}
