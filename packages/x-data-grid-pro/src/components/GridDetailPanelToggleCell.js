...
function GridDetailPanelToggleCell(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(rootProps.slots.baseIconButton, __assign({ size: "small", tabIndex: -1, disabled: !hasContent, className: classes.root, "aria-expanded": isExpanded, "aria-label": isExpanded
            ? apiRef.current.getLocaleText('collapseDetailPanel')
            : apiRef.current.getLocaleText('expandDetailPanel') }, (_a = rootProps.slotProps) === null || _a === void 0 ? void 0 : _a.baseIconButton, { children: (0, jsx_runtime_1.jsx)(Icon, { fontSize: "inherit" }) })));
}
