...
var DEFAULT_INPUT_COMPONENTS = {
    ...
    text: x_data_grid_1.GridFilterInputValue,
...
var GridHeaderFilterCell = (0, forwardRef_1.forwardRef)(function (props, ref) {
    ...
    var headerFilterMenu = ((0, jsx_runtime_1.jsx)(GridHeaderFilterMenuContainer_1.GridHeaderFilterMenuContainer, { operators: filterOperators, item: item, field: colDef.field, disabled: isFilterReadOnly, applyFilterChanges: apiRef.current.upsertFilterItem, headerFilterMenuRef: headerFilterMenuRef, buttonRef: buttonRef, showClearItem: !showClearIcon && isApplied, clearFilterItem: clearFilterItem }));
    var clearButton = showClearIcon && isApplied ? ((0, jsx_runtime_1.jsx)(GridHeaderFilterClearButton_1.GridHeaderFilterClearButton, { onClick: clearFilterItem, disabled: isFilterReadOnly })) : null;
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: (0, clsx_1.default)(classes.root, headerClassName), style: (0, internals_1.attachPinnedStyle)(__assign({ height: height, width: width }, styleProp), isRtl, pinnedPosition, pinnedOffset), role: "columnheader", "aria-colindex": colIndex + 1, "aria-label": headerFilterComponent == null ? ((_c = colDef.headerName) !== null && _c !== void 0 ? _c : colDef.field) : undefined }, other, mouseEventsHandlers, { ref: handleRef, children: [headerFilterComponent, headerFilterComponent === undefined ? ((0, jsx_runtime_1.jsxs)(React.Fragment, { children: [isNoInputOperator ? ((0, jsx_runtime_1.jsxs)(React.Fragment, { children: [(0, jsx_runtime_1.jsx)(OperatorLabel, { className: classes.operatorLabel, children: label }), clearButton, headerFilterMenu] })) : null, InputComponent && !isNoInputOperator ? ((0, jsx_runtime_1.jsx)(StyledInputComponent, __assign({ as: InputComponent, className: classes.input, apiRef: apiRef, item: item, inputRef: inputRef, applyValue: apiRef.current.upsertFilterItem, onFocus: function () { return apiRef.current.startHeaderFilterEditMode(colDef.field); }, onBlur: function (event) {
                            var _a;
                            apiRef.current.stopHeaderFilterEditMode();
                        ...
                        } }, (isNoInputOperator ? { value: '' } : {}), currentOperator === null || currentOperator === void 0 ? void 0 : currentOperator.InputComponentProps, InputComponentProps))) : null] })) : null] })));
});
