...
function GridHeaderFilterMenu(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(x_data_grid_1.GridMenu, { position: "bottom-end", open: open, target: target, onClose: hideMenu, children: (0, jsx_runtime_1.jsxs)(rootProps.slots.baseMenuList, { "aria-labelledby": labelledBy, id: id, children: [showClearItem && [
                    (0, jsx_runtime_1.jsx)(rootProps.slots.baseMenuItem, { iconStart: (0, jsx_runtime_1.jsx)(rootProps.slots.columnMenuClearIcon, { fontSize: "small" }), onClick: function () {
                            clearFilterItem();
                            hideMenu();
                        }, children: apiRef.current.getLocaleText('headerFilterClear') }, "filter-menu-clear-filter"),
                    (0, jsx_runtime_1.jsx)(rootProps.slots.baseDivider, {}, "filter-menu-divider"),
                    ...
                    return ((0, jsx_runtime_1.jsx)(rootProps.slots.baseMenuItem, { iconStart: selected ? (0, jsx_runtime_1.jsx)(rootProps.slots.menuItemCheckIcon, { fontSize: "small" }) : (0, jsx_runtime_1.jsx)("span", {}), onClick: function () {
                            applyFilterChanges(__assign(__assign({}, item), { operator: op.value }));
                            hideMenu();
                        }, autoFocus: selected ? open : false, children: label }, "".concat(field, "-").concat(op.value)));
                })] }) }));
}
