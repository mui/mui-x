...
function GridHeaderFilterMenuContainer(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(React.Fragment, { children: [(0, jsx_runtime_1.jsx)(rootProps.slots.baseIconButton, __assign({ id: buttonId, ref: buttonRef, "aria-label": labelString, title: labelString, "aria-controls": menuId, "aria-expanded": open ? 'true' : undefined, "aria-haspopup": "true", tabIndex: -1, size: "small", onClick: handleClick, disabled: disabled }, (_a = rootProps.slotProps) === null || _a === void 0 ? void 0 : _a.baseIconButton, { children: (0, jsx_runtime_1.jsx)(rootProps.slots.baseBadge, { color: "primary", variant: "dot", badgeContent: showClearItem ? 1 : 0, children: (0, jsx_runtime_1.jsx)(rootProps.slots.openFilterButtonIcon, { fontSize: "inherit" }) }) })), (0, jsx_runtime_1.jsx)(rootProps.slots.headerFilterMenu, __assign({ field: field, open: open, item: item, target: headerFilterMenuRef.current, operators: operators, labelledBy: buttonId, id: menuId, clearFilterItem: clearFilterItem, showClearItem: showClearItem }, other))] }));
}
