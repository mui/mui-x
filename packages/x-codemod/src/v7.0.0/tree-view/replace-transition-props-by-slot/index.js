...
function transformer(file, api, options) {
    ...
    root
        .find(j.JSXElement)
        .filter(function (path) { return path.value.openingElement.name.name === 'TreeItem'; })
    ...
    (0, removeProps_1.default)({ root: root, componentNames: ['TreeItem'], props: Object.keys(propsToSlots), j: j });
