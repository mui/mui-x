...
describe('v8.0.0/charts', function () {
    describe('rename-legend-position-type', function () {
        TEST_FILES.forEach(function (testFile) {
            ...
            describe("".concat(testFile.replace(/-/g, ' ')), function () {
                it('transforms imports as needed', function () {
                    var actual = (0, index_1.default)({ source: read(actualPath) }, { jscodeshift: jscodeshift_1.default.withParser('tsx') }, {});
                    var expected = read(expectedPath);
                    expect(actual).to.equal(expected, 'The transformed version should be correct');
                });
                it('should be idempotent', function () {
                    var actual = (0, index_1.default)({ source: read(expectedPath) }, { jscodeshift: jscodeshift_1.default.withParser('tsx') }, {});
                    var expected = read(expectedPath);
                    expect(actual).to.equal(expected, 'The transformed version should be correct');
                });
            });
