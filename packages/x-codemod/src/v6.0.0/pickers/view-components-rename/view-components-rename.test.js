...
var TEST_FILES = ['community-nested-imports', 'community-root-imports', 'pro-root-imports'];
describe('v6.0.0/pickers', function () {
    describe('view-components-rename', function () {
        TEST_FILES.forEach(function (testFile) {
            ...
            describe("Package (".concat(testFile.replace(/-/g, ' '), ")"), function () {
