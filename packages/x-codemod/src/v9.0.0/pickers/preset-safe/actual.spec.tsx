...
function App() {
  ...
  return (
    <div>
      <DateField unstableFieldRef={fieldRef} enableAccessibleFieldDOMStructure={false} />
      <DatePicker slotProps={{ field: { unstableFieldRef: fieldRef } }} enableAccessibleFieldDOMStructure={false} />
      <DateRangePicker slotProps={{ field: { unstableFieldRef: fieldRef } }} enableAccessibleFieldDOMStructure={false} />
    </div>
  );
}
