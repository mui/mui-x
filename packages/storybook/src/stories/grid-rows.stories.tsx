...
import { GridCellParams, GridLoadIcon, GridRowData, useGridApiRef, XGrid } from '@material-ui/x-grid';
	...
	const editRow = React.useCallback(
		() => {
			...
			setEditRowsModel((state) => {
				...
				editRowState[selectedCell[0]] = editRowState[selectedCell[0]] ? editRowState[selectedCell[0]] : {};
