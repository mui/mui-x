...
import { DataGridPro, GridApiPro, GridSelectionModel, useGridApiRef } from '@mui/x-data-grid-pro';
...
export const ApiPreSelectedRows = () => {
  ...
  const [data, setData] = React.useState<GridData<GridApiPro>>({ rows: [], columns: [] });
