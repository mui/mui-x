...
export const AndWithRightBorder = () => <GridDataSet nbRows={20} nbCols={2} options={{extendRowFullWidth: false, showCellRightBorder: true}} />;
export const AndWithRightBorderAndSeparator = () => <GridDataSet nbRows={20} nbCols={2} options={{extendRowFullWidth: false, showCellRightBorder: true, showColumnSeparator: true}} />;
...
export const WithScrollAndRightBorder = () => <GridDataSet nbRows={20} nbCols={20} options={{extendRowFullWidth: false, showCellRightBorder: true}} />;
export const WithBothScroll = () => <GridDataSet nbRows={200} nbCols={20} />;
export const WithBothScrollAndRightBorder = () => <GridDataSet nbRows={200} nbCols={20} options={{extendRowFullWidth: false, showCellRightBorder: true}} />;
