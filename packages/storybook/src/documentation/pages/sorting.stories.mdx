...
- `onSortedColumns` - Event triggered after a column is sorted
...
- Server side sorting?
- Implement postSort?
- Talk about onColumnHeaderClick?: (param: ColumnHeaderClickParams) => void; ? => not good as API can trigger sort?
