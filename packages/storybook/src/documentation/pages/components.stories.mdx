...
As part of our customisation Api, XGrid allows to replace and override the following components.
...
```tsx
<XGrid rows={[]} columns={columns} components={{ noRowsOverlay: CustomReactComponent }} />
```
