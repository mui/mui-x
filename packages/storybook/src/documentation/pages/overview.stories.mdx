...
The Material-UI Data Grid Component allows to display and analyse tabular data. It leverages the power of React and TypeScript, to provide the best UX, while manipulating unlimited set of data.
...
## Features
- **Virtualization** is used to display unlimited set of elements, without clustering the DOM. Therefore you can set 1000s of rows or columns.
- **Sorting** can be applied on a single or multiple columns
- **Selection** brings user interaction in play, and let you manipulate small set of data.
...
- **Api** for advanced user that needs to manipulate the component, outside the react component properties. Great for real-time updates and streaming application.
