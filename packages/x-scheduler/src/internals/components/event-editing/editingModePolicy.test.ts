...
describe('getInitialEditingMode', () => {
  ...
  it('should open the form directly when creating, regardless of surface or pointer', () => {
  ...
  it('should open the surface directly for read-only events (nothing to arm)', () => {
    setCoarsePointer(true);
  ...
  it('should always arm on the compact drawer', () => {
  ...
  it('should arm the dialog only on a coarse pointer', () => {
    setCoarsePointer(true);
