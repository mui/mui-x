'use client';
// TODO: unify with EventTimelinePremiumSkeleton — diverges in props (`data-variant` required here), sizing (variant-based absolute positioning vs theme-derived height), and styled context. On unification, prefer the timeline's theme-derived sizing.
