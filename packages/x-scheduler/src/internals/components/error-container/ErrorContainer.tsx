'use client';
// TODO: unify with EventTimelinePremiumErrorContainer. The premium version adds a `dismissedErrors` GC effect and a stable key that should be preserved on unification.
