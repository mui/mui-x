...
const frFRDialog: Partial<EventDialogLocaleText> = {
  ...
  recurrenceCustomRepeat: 'Règle de répétition personnalisée',
  ...
  recurrenceMainSelectCustomLabel: 'Sélectionnez votre règle de récurrence',
  ...
  recurrenceMonthlyPresetLabel: (dayNumber) => `Se répète mensuellement le jour ${dayNumber}`,
  ...
  recurrenceYearlyPresetLabel: (date) => `Se répète annuellement le ${date}`,
  noResourceAriaLabel: 'Aucune ressource spécifique',
  ...
  radioGroupAriaLabel: 'Portée de modification des événements récurrents',
