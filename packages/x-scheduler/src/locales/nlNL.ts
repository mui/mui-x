...
const nlNLDialog: SchedulerEditingTranslations = {
  // EventDialog
...
const nlNLEvent: SchedulerEventTranslations = {
...
const nlNLCalendar: SchedulerCalendarTranslations = {
  // ResourcesTree
...
const nlNLTimeline: SchedulerTimelineTranslations = {
  // Timeline title sub grid
  // timelineResourceTitleHeader: 'Resource title',
};
