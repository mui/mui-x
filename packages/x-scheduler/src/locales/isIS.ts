...
const isISDialog: SchedulerEditingTranslations = {
  // EventDialog
...
const isISEvent: SchedulerEventTranslations = {
...
const isISCalendar: SchedulerCalendarTranslations = {
  // ResourcesTree
...
const isISTimeline: SchedulerTimelineTranslations = {
  // Timeline title sub grid
  // timelineResourceTitleHeader: 'Resource title',
};
