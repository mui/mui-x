...
const daDKDialog: SchedulerEditingTranslations = {
  // EventDialog
...
const daDKEvent: SchedulerEventTranslations = {
...
const daDKCalendar: SchedulerCalendarTranslations = {
  // ResourcesTree
...
const daDKTimeline: SchedulerTimelineTranslations = {
  // Timeline title sub grid
  // timelineResourceTitleHeader: 'Resource title',
};
