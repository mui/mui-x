...
const huHUDialog: SchedulerEditingTranslations = {
  // EventDialog
...
const huHUEvent: SchedulerEventTranslations = {
...
const huHUCalendar: SchedulerCalendarTranslations = {
  // ResourcesTree
...
const huHUTimeline: SchedulerTimelineTranslations = {
  // Timeline title sub grid
  // timelineResourceTitleHeader: 'Resource title',
};
