...
const jaJPDialog: SchedulerEditingTranslations = {
  // EventDialog
...
const jaJPEvent: SchedulerEventTranslations = {
...
const jaJPCalendar: SchedulerCalendarTranslations = {
  // ResourcesTree
...
const jaJPTimeline: SchedulerTimelineTranslations = {
  // Timeline title sub grid
  // timelineResourceTitleHeader: 'Resource title',
};
