...
const zhHKDialog: SchedulerEditingTranslations = {
  // EventDialog
...
const zhHKEvent: SchedulerEventTranslations = {
...
const zhHKCalendar: SchedulerCalendarTranslations = {
  // ResourcesTree
...
const zhHKTimeline: SchedulerTimelineTranslations = {
  // Timeline title sub grid
  // timelineResourceTitleHeader: 'Resource title',
};
