...
const caESDialog: SchedulerEditingTranslations = {
  // EventDialog
...
const caESEvent: SchedulerEventTranslations = {
...
const caESCalendar: SchedulerCalendarTranslations = {
  // ResourcesTree
...
const caESTimeline: SchedulerTimelineTranslations = {
  // Timeline title sub grid
  // timelineResourceTitleHeader: 'Resource title',
};
