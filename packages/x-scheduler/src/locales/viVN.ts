...
const viVNDialog: Partial<EventEditingLocaleText> = {
  // EventDialog
...
const viVNEvent: Partial<SchedulerEventLocaleText> = {
...
const viVNCalendar: Partial<Omit<EventCalendarLocaleText, keyof EventEditingLocaleText>> = {
  // ResourcesTree
...
const viVNTimeline: Partial<Omit<EventTimelineLocaleText, keyof EventEditingLocaleText>> = {
  // Timeline title sub grid
  // timelineResourceTitleHeader: 'Resource title',
};
