...
const viVNDialog: SchedulerEditingTranslations = {
  // EventDialog
...
const viVNEvent: SchedulerEventTranslations = {
...
const viVNCalendar: SchedulerCalendarTranslations = {
  // ResourcesTree
...
const viVNTimeline: SchedulerTimelineTranslations = {
  // Timeline title sub grid
  // timelineResourceTitleHeader: 'Resource title',
};
