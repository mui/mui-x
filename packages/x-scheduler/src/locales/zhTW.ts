...
const zhTWDialog: SchedulerEditingTranslations = {
  // EventDialog
...
const zhTWEvent: SchedulerEventTranslations = {
...
const zhTWCalendar: SchedulerCalendarTranslations = {
  // ResourcesTree
...
const zhTWTimeline: SchedulerTimelineTranslations = {
  // Timeline title sub grid
  // timelineResourceTitleHeader: 'Resource title',
};
