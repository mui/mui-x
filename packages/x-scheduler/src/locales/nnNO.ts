...
const nnNODialog: SchedulerEditingTranslations = {
  // EventDialog
...
const nnNOEvent: SchedulerEventTranslations = {
...
const nnNOCalendar: SchedulerCalendarTranslations = {
  // ResourcesTree
...
const nnNOTimeline: SchedulerTimelineTranslations = {
  // Timeline title sub grid
  // timelineResourceTitleHeader: 'Resource title',
};
