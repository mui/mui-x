...
const ukUADialog: SchedulerEditingTranslations = {
  // EventDialog
...
const ukUAEvent: SchedulerEventTranslations = {
...
const ukUACalendar: SchedulerCalendarTranslations = {
  // ResourcesTree
...
const ukUATimeline: SchedulerTimelineTranslations = {
  // Timeline title sub grid
  // timelineResourceTitleHeader: 'Resource title',
};
