...
const hrHRDialog: SchedulerEditingTranslations = {
  // EventDialog
...
const hrHREvent: SchedulerEventTranslations = {
...
const hrHRCalendar: SchedulerCalendarTranslations = {
  // ResourcesTree
...
const hrHRTimeline: SchedulerTimelineTranslations = {
  // Timeline title sub grid
  // timelineResourceTitleHeader: 'Resource title',
};
