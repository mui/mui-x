...
const hyAMDialog: SchedulerEditingTranslations = {
  // EventDialog
...
const hyAMEvent: SchedulerEventTranslations = {
...
const hyAMCalendar: SchedulerCalendarTranslations = {
  // ResourcesTree
...
const hyAMTimeline: SchedulerTimelineTranslations = {
  // Timeline title sub grid
  // timelineResourceTitleHeader: 'Resource title',
};
