...
describe('<Timeline.Cell />', function () {
    var render = (0, scheduler_1.createSchedulerRenderer)().render;
    (0, scheduler_1.describeConformance)(<timeline_1.Timeline.Cell />, function () { return ({
        refInstanceof: window.HTMLDivElement,
        render: function (node) {
            return render(<timeline_1.Timeline.Root items={[]}>
          <timeline_1.Timeline.Row>{node}</timeline_1.Timeline.Row>
