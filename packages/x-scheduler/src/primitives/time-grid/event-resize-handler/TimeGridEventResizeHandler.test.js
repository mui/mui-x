...
describe('<TimeGrid.EventResizeHandler />', function () {
    ...
    (0, scheduler_1.describeConformance)(<time_grid_1.TimeGrid.EventResizeHandler side="start"/>, function () { return ({
        refInstanceof: window.HTMLDivElement,
        render: function (node) {
            return render(<time_grid_1.TimeGrid.Root>
          <time_grid_1.TimeGrid.Column start={eventStart} end={eventEnd}>
            <time_grid_1.TimeGrid.Event eventId="fake-id" start={eventStart} end={eventEnd}>
              {node}
