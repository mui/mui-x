 ...
 */
export function buildOccurrencePositionLookupForDayGrid(
  parameters: BuildOccurrencePositionLookupForDayGridParameters,
) {
  const { adapter, days, occurrencesMap, shouldAddPosition } = parameters;
...
interface BuildOccurrencePositionLookupForDayGridParameters {
  /**
