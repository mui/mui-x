...
export type ExtractPluginColumnMeta<T> =
  T extends Plugin<infer TName, any, any, any, infer TColumnMeta, any, any>
...
// Order: TName, TState, TApi, TParams, TColumnMeta, TRequiredApi, TDeps
...
type PluginColumnMeta<T> = T extends Plugin<any, any, any, any, infer C, any, any> ? C : never;
