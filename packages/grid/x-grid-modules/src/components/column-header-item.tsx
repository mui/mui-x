...
export const ColumnHeaderItem = React.memo(
  ({ column, colIndex, onResizeColumn }: ColumnHeaderItemProps) => {
    ...
    const { headerHeight, showColumnRightBorder, disableColumnResize } = React.useContext(OptionsContext);
    ...
    return (
      ...
      >
        ...
        <ColumnHeaderSeparator resizable={disableColumnResize && column.resizable} onResize={handleResize} />
      </div>
    );
  },
);
