...
*Defined in [packages/grid/x-grid-modules/src/hooks/features/useSelection.tsx:23](https://github.com/mui-org/material-ui-x/blob/02342a6/packages/grid/x-grid-modules/src/hooks/features/useSelection.tsx#L23)*
