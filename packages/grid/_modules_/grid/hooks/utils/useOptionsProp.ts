...
export function useOptionsProp(apiRef: ApiRef, props: GridComponentProps): GridOptions {
  ...
  const options: GridOptionsProp = React.useMemo(
    ...
    [props.pageSize, props.logger, props.sortingMode, props.filterMode, props.autoHeight, props.autoPageSize, props.checkboxSelection, props.columnBuffer, props.columnTypes, props.disableSelectionOnClick, props.disableMultipleColumnsSorting, props.disableMultipleSelection, props.disableMultipleColumnsFiltering, props.disableColumnResize, props.disableColumnReorder, props.disableColumnFilter, props.disableColumnMenu, props.disableColumnSelector, props.disableExtendRowFullWidth, props.headerHeight, props.hideFooter, props.hideFooterPagination, props.hideFooterRowCount, props.hideFooterSelectedRowCount, props.hideToolbar, props.icons, props.logLevel, props.onCellClick, props.onCellHover, props.onColumnHeaderClick, props.onError, props.onPageChange, props.onPageSizeChange, props.onRowClick, props.onRowHover, props.onRowSelected, props.onSelectionChange, props.onSortModelChange, props.onFilterModelChange, props.onStateChange, props.page, props.pagination, props.paginationMode, props.rowCount, props.rowHeight, props.rowsPerPageOptions, props.scrollbarSize, props.showCellRightBorder, props.showColumnRightBorder, props.sortingOrder, props.sortModel, props.filterModel],
  );
