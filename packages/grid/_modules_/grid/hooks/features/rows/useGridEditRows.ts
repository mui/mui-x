...
export function useGridEditRows(
  ...
  useGridApiOptionHandler(apiRef, GridEvents.cellEditStart, options.onCellEditStart);
  useGridApiOptionHandler(apiRef, GridEvents.cellEditStop, options.onCellEditStop);
