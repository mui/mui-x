export enum GridEvents {
  ...
  /**
   * Fired when the amount of rows that could fit into the viewport changes. Called with a {number} variable.
   */
  maximumPageSizeWithoutScrollBarChange = 'maximumPageSizeWithoutScrollBarChange',
  /**
