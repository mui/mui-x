...
export const GRID_COLUMN_HEADER_DROP_ZONE_CSS_CLASS = `${GRID_ROOT_CSS_CLASS_SUFFIX}-columnHeader-dropZone`;
export const GRID_COLUMN_HEADER_DRAGGING_CSS_CLASS = `${GRID_ROOT_CSS_CLASS_SUFFIX}-columnHeader-dragging`;
