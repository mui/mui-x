...
export const GRID_DEFAULT_LOCALE_TEXT: GridLocaleText = {
  ...
  aggregationFunctionLabelAvg: (groupingKey) =>
    groupingKey == null ? 'Average' : `Average ${groupingKey}`,
  aggregationFunctionLabelMin: (groupingKey) =>
    groupingKey == null ? 'Minimum' : `Minimum ${groupingKey}`,
  aggregationFunctionLabelMax: (groupingKey) =>
    groupingKey == null ? 'Maximum' : `Maximum ${groupingKey}`,
  aggregationFunctionLabelSize: (groupingKey) =>
    groupingKey == null ? 'Size' : `Size ${groupingKey}`,
};
