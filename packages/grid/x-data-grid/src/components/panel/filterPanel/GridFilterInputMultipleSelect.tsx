...
export type GridFilterInputMultipleSelectProps = GridFilterInputValueProps &
  TextFieldProps &
  Pick<GridMultipleSelectColDef, 'getOptionLabel' | 'getOptionValue'> & {
    type?: 'multipleSelect';
  };

function GridFilterInputMultipleSelect(props: GridFilterInputMultipleSelectProps) {
  const {
    item,
    applyValue,
    type,
  ...
  if (!isMultipleSelectColDef(resolvedColumn)) {
    return null;
  }
...
GridFilterInputMultipleSelect.propTypes = {
  // ----------------------------- Warning --------------------------------
...
export { GridFilterInputMultipleSelect };
