...
import { isMultipleSelectColDef } from './filterPanelUtils';
import { useGridRootProps } from '../../../hooks/utils/useGridRootProps';
import { GridFilterInputValueProps } from './GridFilterInputValueProps';
import type { GridMultipleSelectColDef, ValueOptions } from '../../../models/colDef/gridColDef';

export interface GridFilterInputMultipleMultipleSelectProps
  extends Omit<
...
function GridFilterInputMultipleMultipleSelect(props: GridFilterInputMultipleMultipleSelectProps) {
  const {
    item,
    applyValue,
    type,
  ...
  if (item.field) {
    ...
    if (isMultipleSelectColDef(column)) {
...
GridFilterInputMultipleMultipleSelect.propTypes = {
  // ----------------------------- Warning --------------------------------
  ...
  type: PropTypes.oneOf(['multipleSelect']),
} as any;

export { GridFilterInputMultipleMultipleSelect };
