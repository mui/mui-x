...
export const gridRowIdsSelector = createSelector(gridRowsStateSelector, (rows) => [
  ...Object.values(rows.dataRowIdToIdLookup),
  ...Object.values(rows.autoGeneratedRowIdToIdLookup),
]);
