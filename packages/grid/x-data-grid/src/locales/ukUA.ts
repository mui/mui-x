...
const ukUAGrid: Partial<GridLocaleText> = {
  ...
  headerFilterOperatorAfter: 'Більше ніж',
  headerFilterOperatorOnOrAfter: 'Більше або дорвінює',
  headerFilterOperatorBefore: 'Менше ніж',
  headerFilterOperatorOnOrBefore: 'Менше або дорівнює',
  headerFilterOperatorIsEmpty: 'Порожнє',
  headerFilterOperatorIsNotEmpty: 'Не порожнє',
  headerFilterOperatorIsAnyOf: 'Будь-що із',
  'headerFilterOperator=': 'Рівні',
  'headerFilterOperator!=': 'Не рівні',
