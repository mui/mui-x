...
import { useDataGridProps as useDataGridDefaultProps, MAX_PAGE_SIZE } from './useDataGridProps';
import { DataGridVirtualScroller } from '../components/DataGridVirtualScroller';
import { DataGridColumnHeaders } from '../components/DataGridColumnHeaders';
import { GridValidRowModel } from '../models/gridRows';

export const createDataGrid = (useDataGridProps = useDataGridDefaultProps) => {
...
const DataGridUnstyled = React.memo(createDataGrid()) as DataGridComponent;

export default DataGridUnstyled;
