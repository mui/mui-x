...
import { Columns, DEFAULT_GRID_OPTIONS, ElementSize, GridOptions, RowsProp, GridApi } from '@material-ui/x-grid-modules';
...
const DataGrid: React.FC<GridProps> = React.memo(({ rows, columns, options, loading, children }) => {
