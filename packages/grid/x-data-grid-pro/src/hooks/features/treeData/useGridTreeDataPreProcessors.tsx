...
import {updateRowTree} from "@mui/x-data-grid-pro/utils/tree/updateRowTree";
import {ROW_GROUPING_STRATEGY} from "@mui/x-data-grid-premium/hooks/features/rowGrouping/gridRowGroupingUtils";
...
export const useGridTreeDataPreProcessors = (
  ...
  const createRowTreeForTreeData = React.useCallback<GridStrategyProcessor<'rowTreeCreation'>>(
    (params) => {
      ...
      const nodes = Object.values(params.dataRowIdToIdLookup)
          .map(getRowTreeBuilderNode)
