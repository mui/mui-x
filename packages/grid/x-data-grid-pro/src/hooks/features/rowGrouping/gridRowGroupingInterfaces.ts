...
export interface GridGroupingCriteriaRowGetterParams {
  /**
...
export interface GridRowGroupingApi {
   ...
   * @param {GridGroupingCriteriaRowGetterParams} params Object containing parameters for the getter.
   * @returns {GridRowId[]} The id of each row in the grouping criteria.
   */
  getGroupingCriteriaRows: (params: GridGroupingCriteriaRowGetterParams) => GridRowId[];
}
