    ...
    expect(response).to.deep.equal({
      ...
      tree: {
        ...
        0: {
          ...
          childrenFromPath: {
            __no_field__: {
              A: 'auto-generated-row-null/A-null/A',
            },
          },
          depth: 0,
  ...
  it('should allow to have two rows with the same field at various depth', () => {
    ...
    expect(response.tree).to.deep.equal({
      [GRID_ROOT_GROUP_ID]: {
        ...
        childrenFromPath: {
          field1: {
            'value-1-1': 'auto-generated-row-field1/value-1-1',
          },
          field2: {
            'value-2-1': 'auto-generated-row-field2/value-2-1',
          },
        },
        parent: null,
        childrenExpanded: true,
      ...
      'auto-generated-row-field1/value-1-1': {
        ...
        childrenFromPath: {
          field2: {
            'value-2-1': 'auto-generated-row-field1/value-1-1-field2/value-2-1',
          },
        },
        parent: GRID_ROOT_GROUP_ID,
