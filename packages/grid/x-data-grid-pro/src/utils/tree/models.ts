import {GridFooterNode, GridGroupNode, GridKeyValue, GridLeafNode, GridRowId} from "@mui/x-data-grid";
...
export interface RowTreeBuilderRow { id: GridRowId; path: RowTreeBuilderGroupingCriteria[] }
