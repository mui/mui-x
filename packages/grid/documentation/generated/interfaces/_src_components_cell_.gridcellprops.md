[@material-ui/x-grid-modules](../README.md) › [Globals](../globals.md) › ["src/components/cell"](../modules/_src_components_cell_.md) › [GridCellProps](_src_components_cell_.gridcellprops.md)
