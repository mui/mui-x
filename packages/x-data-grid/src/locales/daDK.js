...
var daDKGrid = {
    ...
    columnHeaderFiltersTooltipActive: function (count) {
        return count !== 1 ? "".concat(count, " aktive filtre") : "\u00C9t aktivt filter";
    },
    columnHeaderFiltersLabel: 'Vis filtre',
    columnHeaderSortIconLabel: 'Sorter',
    // Rows selected footer text
    footerRowSelected: function (count) {
        return count !== 1 ? "".concat(count.toLocaleString(), " r\u00E6kker valgt") : "\u00C9n r\u00E6kke valgt";
    },
    ...
    groupColumn: function (name) { return "Grupp\u00E9r efter ".concat(name); },
    unGroupColumn: function (name) { return "Fjern gruppering efter ".concat(name); },
    // Master/detail
...
exports.daDK = (0, getGridLocalization_1.getGridLocalization)(daDKGrid);
