...
var skSKGrid = {
    ...
    columnMenuAriaLabel: function (columnName) { return "Ponuka st\u013Apca ".concat(columnName); },
    ...
    groupColumn: function (name) { return "Zoskupi\u0165 pod\u013Ea ".concat(name); },
    unGroupColumn: function (name) { return "Presta\u0165 zoskupova\u0165 pod\u013Ea ".concat(name); },
    // Master/detail
    ...
    paginationDisplayedRows: function (_a) {
        ...
        var estimatedLabel = estimated && estimated > to ? "pribli\u017Ene ".concat(estimated) : "viac ako ".concat(to);
...
exports.skSK = (0, getGridLocalization_1.getGridLocalization)(skSKGrid);
