...
var zhTWGrid = {
    ...
    toolbarFiltersTooltipActive: function (count) { return "".concat(count, " \u500B\u7BE9\u9078\u5668"); },
    ...
    // Column menu text
    columnMenuLabel: '選單',
    columnMenuAriaLabel: function (columnName) { return "".concat(columnName, " \u6B04\u4F4D\u9078\u55AE"); },
    ...
    // Column header text
    columnHeaderFiltersTooltipActive: function (count) { return "".concat(count, " \u500B\u7BE9\u9078\u5668"); },
    columnHeaderFiltersLabel: '顯示篩選器',
    columnHeaderSortIconLabel: '排序',
    // Rows selected footer text
    footerRowSelected: function (count) { return "\u5DF2\u9078\u53D6 ".concat(count.toLocaleString(), " \u500B"); },
    ...
    groupColumn: function (name) { return "\u4EE5 ".concat(name, " \u5206\u7D44"); },
    unGroupColumn: function (name) { return "\u53D6\u6D88\u4EE5 ".concat(name, " \u5206\u7D44"); },
    // Master/detail
...
exports.zhTW = (0, getGridLocalization_1.getGridLocalization)(zhTWGrid);
