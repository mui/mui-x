...
var huHUGrid = {
    ...
    toolbarFiltersTooltipActive: function (count) { return "".concat(count, " akt\u00EDv sz\u0171r\u0151"); },
    ...
    // Column header text
    columnHeaderFiltersTooltipActive: function (count) { return "".concat(count, " akt\u00EDv sz\u0171r\u0151"); },
    columnHeaderFiltersLabel: 'Szűrők megjelenítése',
    columnHeaderSortIconLabel: 'Átrendezés',
    // Rows selected footer text
    footerRowSelected: function (count) { return "".concat(count.toLocaleString(), " sor kiv\u00E1lasztva"); },
    // Total row amount footer text
    footerTotalRows: 'Összesen:',
    // Total visible row amount footer text
    footerTotalVisibleRows: function (visibleCount, totalCount) {
        return "".concat(visibleCount.toLocaleString(), " (\u00F6sszesen: ").concat(totalCount.toLocaleString(), ")");
    },
    ...
    groupColumn: function (name) { return "Csoportos\u00EDt\u00E1s ".concat(name, " szerint"); },
    unGroupColumn: function (name) { return "".concat(name, " szerinti csoportos\u00EDt\u00E1s t\u00F6rl\u00E9se"); },
    // Master/detail
...
exports.huHU = (0, getGridLocalization_1.getGridLocalization)(huHUGrid);
