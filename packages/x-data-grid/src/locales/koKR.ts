...
const koKRGrid: Partial<GridLocaleText> = {
  ...
  columnsManagementNoColumns: '컬럼 없음',
  columnsManagementShowHideAllText: '전체 보이기/감추기',
  columnsManagementReset: '초기화',

  // Filter panel text
  filterPanelAddFilter: '필터 추가',
  filterPanelRemoveAll: '전체 삭제',
  ...
  headerFilterOperatorContains: '포함',
  headerFilterOperatorEquals: '같음',
  headerFilterOperatorStartsWith: '다음 단어로 시작하면',
  headerFilterOperatorEndsWith: '다음 단어로 끝나면',
  headerFilterOperatorIs: '다음과 같으면',
  headerFilterOperatorNot: '다음과 같지 않으면',
  headerFilterOperatorAfter: '다음이면',
  headerFilterOperatorOnOrAfter: '다음에 있거나 그 이후에 있으면',
  headerFilterOperatorBefore: '이전이면',
  headerFilterOperatorOnOrBefore: '이전에 있거나 그 이후에 있으면',
  headerFilterOperatorIsEmpty: '비어 있으면',
  headerFilterOperatorIsNotEmpty: '비어 있지 않으면',
  headerFilterOperatorIsAnyOf: '다음 중 하나이면',
  'headerFilterOperator=': '같음',
  'headerFilterOperator!=': '같지 않음',
  'headerFilterOperator>': '보다 큼',
  'headerFilterOperator>=': '보다 크거나 같음',
  'headerFilterOperator<': '보다 작음',
  'headerFilterOperator<=': '보다 작거나 같음',
