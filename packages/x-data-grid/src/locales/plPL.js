...
var plPLGrid = {
    ...
    toolbarFiltersTooltipActive: function (count) { return "Liczba aktywnych filtr\u00F3w: ".concat(count); },
    ...
    columnMenuAriaLabel: function (columnName) { return "Menu kolumny: ".concat(columnName); },
    ...
    // Column header text
    columnHeaderFiltersTooltipActive: function (count) { return "Liczba aktywnych filtr\u00F3w: ".concat(count); },
    columnHeaderFiltersLabel: 'Pokaż filtry',
    columnHeaderSortIconLabel: 'Sortuj',
    // Rows selected footer text
    footerRowSelected: function (count) { return "Liczba wybranych wierszy: ".concat(count.toLocaleString()); },
    ...
    groupColumn: function (name) { return "Grupuj wed\u0142ug ".concat(name); },
    unGroupColumn: function (name) { return "Rozgrupuj ".concat(name); },
    // Master/detail
    ...
    paginationDisplayedRows: function (_a) {
        ...
        if (!estimated) {
            return "".concat(from, "\u2013").concat(to, " z ").concat(count !== -1 ? count : "wi\u0119cej ni\u017C ".concat(to));
        }
        var estimatedLabel = estimated && estimated > to ? "oko\u0142o ".concat(estimated) : "wi\u0119cej ni\u017C ".concat(to);
        return "".concat(from, "\u2013").concat(to, " z ").concat(count !== -1 ? count : estimatedLabel);
    },
...
exports.plPL = (0, getGridLocalization_1.getGridLocalization)(plPLGrid);
