...
var itITGrid = {
    ...
    columnMenuAriaLabel: function (columnName) { return "Men\u00F9 della colonna ".concat(columnName); },
    ...
    footerRowSelected: function (count) {
        return count > 1
            ? "".concat(count.toLocaleString(), " record selezionati")
            : "".concat(count.toLocaleString(), " record selezionato");
    },
    ...
    groupColumn: function (name) { return "Raggruppa per ".concat(name); },
    unGroupColumn: function (name) { return "Annulla raggruppamento per ".concat(name); },
    // Master/detail
    ...
    paginationDisplayedRows: function (_a) {
        ...
        if (!estimated) {
            return "".concat(from, "\u2013").concat(to, " di ").concat(count !== -1 ? count : "pi\u00F9 di ".concat(to));
        }
        var estimatedLabel = estimated && estimated > to ? "circa ".concat(estimated) : "pi\u00F9 di ".concat(to);
        return "".concat(from, "\u2013").concat(to, " di ").concat(count !== -1 ? count : estimatedLabel);
    },
    ...
    chartsSeries: 'Serie',
    chartsMenuAddToDimensions: function (dimensionLabel) { return "Aggiungi a ".concat(dimensionLabel); },
    chartsMenuAddToValues: function (valuesLabel) { return "Aggiungi a ".concat(valuesLabel); },
    ...
    chartsDragToDimensions: function (dimensionLabel) {
        return "Trascina qui per usare la colonna come ".concat(dimensionLabel);
    },
    chartsDragToValues: function (valuesLabel) {
        return "Trascina qui per usare la colonna come ".concat(valuesLabel);
    },
    // AI Assistant panel
    ...
    // Prompt changes
    promptChangeGroupDescription: function (column) { return "Raggruppa per ".concat(column); },
    ...
    promptChangeAggregationDescription: function (column, aggregation) {
        return "Aggrega ".concat(column, " (").concat(aggregation, ")");
    },
    ...
    promptChangeSortDescription: function (column, direction) {
        return "Ordina per ".concat(column, " (").concat(direction, ")");
    },
    promptChangePivotEnableLabel: 'Pivota',
    promptChangePivotEnableDescription: 'Abilita pivoting',
    promptChangePivotColumnsLabel: function (count) { return "Colonne (".concat(count, ")"); },
    promptChangePivotColumnsDescription: function (column, direction) {
        return "".concat(column).concat(direction ? " (".concat(direction, ")") : '');
    },
    promptChangePivotRowsLabel: function (count) { return "Righe (".concat(count, ")"); },
    promptChangePivotValuesLabel: function (count) { return "Valori (".concat(count, ")"); },
    promptChangePivotValuesDescription: function (column, aggregation) {
        return "".concat(column, " (").concat(aggregation, ")");
    },
    // promptChangeChartsLabel: (dimensionsCount: number, valuesCount: number) => `Dimensions (${dimensionsCount}), Values (${valuesCount})`,
};
exports.itIT = (0, getGridLocalization_1.getGridLocalization)(itITGrid);
