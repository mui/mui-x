...
var koKRGrid = {
    ...
    toolbarFiltersTooltipActive: function (count) { return "".concat(count, "\uAC74\uC758 \uD544\uD130\uB97C \uC801\uC6A9\uC911"); },
    ...
    // Column menu text
    columnMenuLabel: '메뉴',
    columnMenuAriaLabel: function (columnName) { return "".concat(columnName, " \uC5F4 \uBA54\uB274"); },
    ...
    // Column header text
    columnHeaderFiltersTooltipActive: function (count) { return "".concat(count, "\uAC74\uC758 \uD544\uD130\uB97C \uC801\uC6A9\uC911"); },
    columnHeaderFiltersLabel: '필터 표시',
    columnHeaderSortIconLabel: '정렬',
    // Rows selected footer text
    footerRowSelected: function (count) { return "".concat(count, "\uD589 \uC120\uD0DD\uC911"); },
    ...
    groupColumn: function (name) { return "".concat(name, " \uAC12\uC73C\uB85C \uADF8\uB8F9 \uC0DD\uC131"); },
    unGroupColumn: function (name) { return "".concat(name, " \uAC12\uC73C\uB85C \uADF8\uB8F9 \uD574\uC81C"); },
    // Master/detail
    ...
    paginationDisplayedRows: function (_a) {
        ...
        if (!estimated) {
            return "".concat(from, "\u2013").concat(to, " of ").concat(count !== -1 ? count : "".concat(to, " \uC774\uC0C1"));
        }
        var estimatedLabel = estimated && estimated > to ? "\uC57D ".concat(estimated) : "".concat(to, " \uC774\uC0C1");
    ...
    // Prompt changes
    promptChangeGroupDescription: function (column) { return "".concat(column, " \uAC12\uC73C\uB85C \uADF8\uB8F9 \uC0DD\uC131"); },
    ...
    promptChangeAggregationDescription: function (column, aggregation) {
        return "".concat(column, " (").concat(aggregation, ") \uC9D1\uACC4");
    },
    ...
    promptChangeSortDescription: function (column, direction) {
        return "".concat(column, " (").concat(direction, ") \uAE30\uC900\uC73C\uB85C \uC815\uB82C");
    },
    promptChangePivotEnableLabel: '피벗',
    promptChangePivotEnableDescription: '피벗 활성화',
    promptChangePivotColumnsLabel: function (count) { return "(".concat(count, ") \uAC1C\uC758 \uC5F4"); },
    promptChangePivotColumnsDescription: function (column, direction) {
        return "".concat(column).concat(direction ? " (".concat(direction, ")") : '');
    },
    promptChangePivotRowsLabel: function (count) { return "(".concat(count, ") \uAC1C\uC758 \uD589"); },
    promptChangePivotValuesLabel: function (count) { return "(".concat(count, ") \uAC1C\uC758 \uAC12"); },
    promptChangePivotValuesDescription: function (column, aggregation) {
        return "".concat(column, " (").concat(aggregation, ")");
    },
};
exports.koKR = (0, getGridLocalization_1.getGridLocalization)(koKRGrid);
