...
var frFRGrid = {
    ...
    columnMenuAriaLabel: function (columnName) { return "Menu pour la colonne ".concat(columnName); },
    ...
    footerRowSelected: function (count) {
        return count > 1
            ? "".concat(count.toLocaleString(), " lignes s\u00E9lectionn\u00E9es")
            : "".concat(count.toLocaleString(), " ligne s\u00E9lectionn\u00E9e");
    },
    ...
    groupColumn: function (name) { return "Grouper par ".concat(name); },
    unGroupColumn: function (name) { return "Arr\u00EAter de grouper par ".concat(name); },
    // Master/detail
    ...
    paginationDisplayedRows: function (_a) {
        ...
        if (!estimated) {
            return "".concat(from, "\u2013").concat(to, " sur ").concat(count !== -1 ? count : "plus de ".concat(to));
        }
        var estimatedLabel = estimated && estimated > to ? "environ ".concat(estimated) : "plus de ".concat(to);
        return "".concat(from, "\u2013").concat(to, " sur ").concat(count !== -1 ? count : estimatedLabel);
    },
    ...
    chartsSeries: 'Séries',
    chartsMenuAddToDimensions: function (dimensionLabel) { return "Ajouter aux ".concat(dimensionLabel); },
    chartsMenuAddToValues: function (valuesLabel) { return "Ajouter aux ".concat(valuesLabel); },
    ...
    chartsDragToDimensions: function (dimensionLabel) {
        return "Faites glisser ici pour utiliser la colonne comme ".concat(dimensionLabel);
    },
    chartsDragToValues: function (valuesLabel) {
        return "Faites glisser ici pour utiliser la colonne comme ".concat(valuesLabel);
    },
    // AI Assistant panel
...
exports.frFR = (0, getGridLocalization_1.getGridLocalization)(frFRGrid);
