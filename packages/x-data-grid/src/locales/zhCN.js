...
var zhCNGrid = {
    ...
    toolbarFiltersTooltipActive: function (count) { return "".concat(count, " \u4E2A\u7B5B\u9009\u5668"); },
    ...
    // Column menu text
    columnMenuLabel: '菜单',
    columnMenuAriaLabel: function (columnName) { return "".concat(columnName, " \u5217\u83DC\u5355"); },
    ...
    footerRowSelected: function (count) { return "\u5171\u9009\u4E2D\u4E86".concat(count.toLocaleString(), "\u884C"); },
    ...
    groupColumn: function (name) { return "\u7528".concat(name, "\u5206\u7EC4"); },
    unGroupColumn: function (name) { return "\u4E0D\u518D\u7528".concat(name, "\u5206\u7EC4"); },
    // Master/detail
    ...
    paginationDisplayedRows: function (_a) {
        ...
        if (!estimated) {
            return "".concat(from, "\u2013").concat(to, " \u5171 ").concat(count !== -1 ? count : "\u8D85\u8FC7 ".concat(to));
        }
        var estimatedLabel = estimated && estimated > to ? "\u7EA6 ".concat(estimated) : "\u8D85\u8FC7 ".concat(to);
...
exports.zhCN = (0, getGridLocalization_1.getGridLocalization)(zhCNGrid);
