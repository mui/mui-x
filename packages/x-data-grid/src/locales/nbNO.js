...
var nbNOGrid = {
    ...
    columnMenuAriaLabel: function (columnName) { return "".concat(columnName, " kolonnemeny"); },
    ...
    paginationDisplayedRows: function (_a) {
        ...
        var estimatedLabel = estimated && estimated > to ? "omtrent ".concat(estimated) : "mer enn ".concat(to);
...
exports.nbNO = (0, getGridLocalization_1.getGridLocalization)(nbNOGrid);
