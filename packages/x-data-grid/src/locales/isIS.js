...
var isISGrid = {
    ...
    toolbarFiltersTooltipActive: function (count) {
        return count !== 1 ? "".concat(count, " virk s\u00EDa") : "".concat(count, " virkar s\u00EDur");
    },
    ...
    columnHeaderFiltersTooltipActive: function (count) {
        return count !== 1 ? "".concat(count, " virkar s\u00EDur") : "Ein virk s\u00EDa";
    },
    columnHeaderFiltersLabel: 'Sýna síur',
    columnHeaderSortIconLabel: 'Raða',
    // Rows selected footer text
    footerRowSelected: function (count) {
        return count !== 1 ? "".concat(count.toLocaleString(), " ra\u00F0ir valdar") : "Ein r\u00F6\u00F0 valin";
    },
    ...
    groupColumn: function (name) { return "H\u00F3pa eftir ".concat(name); },
    unGroupColumn: function (name) { return "Fjarl\u00E6gja h\u00F3pun eftir ".concat(name); },
    // Master/detail
...
exports.isIS = (0, getGridLocalization_1.getGridLocalization)(isISGrid);
