...
var arSDGrid = {
    ...
    paginationDisplayedRows: function (_a) {
        ...
        if (!estimated) {
            return "\u200E".concat(to, "-").concat(from, "\u200E \u0645\u0646 ").concat(count !== -1 ? count : "\u0623\u0643\u062B\u0631 \u0645\u0646 ".concat(to));
        }
        var estimatedLabel = estimated && estimated > to ? "\u062D\u0648\u0627\u0644\u064A ".concat(estimated) : "\u0623\u0643\u062B\u0631 \u0645\u0646 ".concat(to);
        return "\u200E".concat(to, "-").concat(from, "\u200E \u0645\u0646 ").concat(count !== -1 ? count : estimatedLabel);
    },
