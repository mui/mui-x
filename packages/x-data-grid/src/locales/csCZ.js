...
var csCZGrid = {
    ...
    columnMenuAriaLabel: function (columnName) { return "Mo\u017Enosti sloupce ".concat(columnName); },
    ...
    footerTotalVisibleRows: function (visibleCount, totalCount) {
        ...
        var op = ['4', '6', '7'].includes(firstDigit) || (firstDigit === '1' && str.length % 3 === 0)
            ? 'ze'
            : 'z';
    ...
    groupColumn: function (name) { return "Seskupit podle ".concat(name); },
    unGroupColumn: function (name) { return "P\u0159estat seskupovat podle ".concat(name); },
    // Master/detail
    ...
    paginationDisplayedRows: function (_a) {
        ...
        var estimatedLabel = estimated && estimated > to ? "p\u0159ibli\u017En\u011B ".concat(estimated) : "v\u00EDce ne\u017E ".concat(to);
...
exports.csCZ = (0, getGridLocalization_1.getGridLocalization)(csCZGrid);
