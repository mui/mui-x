...
var roROGrid = {
    ...
    footerRowSelected: function (count) {
        return count !== 1
            ? "".concat(count.toLocaleString(), " \u00CEnregistr\u0103ri selectate")
            : "".concat(count.toLocaleString(), " \u00CEnregistrare selectat\u0103");
    },
    ...
    groupColumn: function (name) { return "Grupare dup\u0103 ".concat(name); },
    unGroupColumn: function (name) { return "Anulare Grupare dup\u0103 ".concat(name); },
    // Master/detail
...
exports.roRO = (0, getGridLocalization_1.getGridLocalization)(roROGrid);
