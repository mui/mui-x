...
var hrHRGrid = {
    ...
    toolbarFiltersTooltipActive: function (count) {
        if (count === 1) {
            return "".concat(count, " aktivan filter");
        }
        if (count < 5) {
            return "".concat(count, " aktivna filtera");
        }
        return "".concat(count, " aktivnih filtera");
    },
    ...
    columnMenuAriaLabel: function (columnName) { return "Izbornik stupca ".concat(columnName); },
    ...
    footerRowSelected: function (count) {
        if (count === 1) {
            return "Odabran je ".concat(count.toLocaleString(), " redak");
        }
        if (count < 5) {
            return "Odabrana su ".concat(count.toLocaleString(), " retka");
        }
        return "Odabrano je ".concat(count.toLocaleString(), " redaka");
    },
    ...
    groupColumn: function (name) { return "Grupiraj prema ".concat(name); },
    unGroupColumn: function (name) { return "Zaustavi grupiranje prema ".concat(name); },
    // Master/detail
    ...
    paginationDisplayedRows: function (_a) {
        ...
        var estimatedLabel = estimated && estimated > to ? "oko ".concat(estimated) : "vi\u0161e nego ".concat(to);
        return "".concat(from, "\u2013").concat(to, " od ").concat(count !== -1 ? count : estimatedLabel);
    },
...
exports.hrHR = (0, getGridLocalization_1.getGridLocalization)(hrHRGrid);
