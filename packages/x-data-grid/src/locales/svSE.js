...
var svSEGrid = {
    ...
    footerRowSelected: function (count) {
        return count !== 1
            ? "".concat(count.toLocaleString(), " rader markerade")
            : "".concat(count.toLocaleString(), " rad markerad");
    },
    ...
    groupColumn: function (name) { return "Gruppera efter ".concat(name); },
    unGroupColumn: function (name) { return "Sluta gruppera efter ".concat(name); },
    // Master/detail
...
exports.svSE = (0, getGridLocalization_1.getGridLocalization)(svSEGrid);
