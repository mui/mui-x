...
var viVNGrid = {
    ...
    footerRowSelected: function (count) {
        return count > 1 ? "".concat(count.toLocaleString(), " h\u00E0ng \u0111\u00E3 ch\u1ECDn") : "".concat(count.toLocaleString(), " h\u00E0ng \u0111\u00E3 ch\u1ECDn");
    },
    ...
    groupColumn: function (name) { return "Nh\u00F3m theo ".concat(name); },
    unGroupColumn: function (name) { return "H\u1EE7y nh\u00F3m theo ".concat(name); },
    // Master/detail
...
exports.viVN = (0, getGridLocalization_1.getGridLocalization)(viVNGrid);
