...
var fiFIGrid = {
    ...
    footerRowSelected: function (count) {
        return count !== 1
            ? "".concat(count.toLocaleString(), " rivi\u00E4 valittu")
            : "".concat(count.toLocaleString(), " rivi valittu");
    },
    ...
    groupColumn: function (name) { return "Ryhmittelyperuste ".concat(name); },
    unGroupColumn: function (name) { return "Poista ryhmittelyperuste ".concat(name); },
    // Master/detail
...
exports.fiFI = (0, getGridLocalization_1.getGridLocalization)(fiFIGrid);
