...
function getPluralForm(count, options) {
    var penultimateDigit = Math.floor(count / 10) % 10;
...
var ukUAGrid = {
    ...
    groupColumn: function (name) { return "\u0413\u0440\u0443\u043F\u0443\u0432\u0430\u0442\u0438 \u0437\u0430 ".concat(name); },
    unGroupColumn: function (name) { return "\u0412\u0456\u0434\u043C\u0456\u043D\u0438\u0442\u0438 \u0433\u0440\u0443\u043F\u0443\u0432\u0430\u043D\u043D\u044F \u0437\u0430 ".concat(name); },
    // Master/detail
...
exports.ukUA = (0, getGridLocalization_1.getGridLocalization)(ukUAGrid);
