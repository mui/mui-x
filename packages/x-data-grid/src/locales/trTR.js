...
var trTRGrid = {
    ...
    toolbarFiltersTooltipActive: function (count) { return "".concat(count, " aktif filtre"); },
    ...
    // Column header text
    columnHeaderFiltersTooltipActive: function (count) { return "".concat(count, " filtre aktif"); },
    columnHeaderFiltersLabel: 'Filtreleri göster',
    columnHeaderSortIconLabel: 'Sırala',
    // Rows selected footer text
    footerRowSelected: function (count) { return "".concat(count.toLocaleString(), " sat\u0131r se\u00E7ildi"); },
    ...
    groupColumn: function (name) { return "".concat(name, " i\u00E7in grupla"); },
    unGroupColumn: function (name) { return "".concat(name, " i\u00E7in gruplamay\u0131 kald\u0131r"); },
    // Master/detail
...
exports.trTR = (0, getGridLocalization_1.getGridLocalization)(trTRGrid);
