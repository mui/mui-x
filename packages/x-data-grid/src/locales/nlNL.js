...
var nlNLGrid = {
    ...
    footerRowSelected: function (count) {
        return count > 1
            ? "".concat(count.toLocaleString(), " rijen geselecteerd")
            : "".concat(count.toLocaleString(), " rij geselecteerd");
    },
    ...
    groupColumn: function (name) { return "Groepeer op ".concat(name); },
    unGroupColumn: function (name) { return "Stop groeperen op ".concat(name); },
    // Master/detail
...
exports.nlNL = (0, getGridLocalization_1.getGridLocalization)(nlNLGrid);
