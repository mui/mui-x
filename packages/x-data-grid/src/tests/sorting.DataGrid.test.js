...
describe('<DataGrid /> - Sorting', function () {
    ...
    it('should keep the initial order', function () {
        ...
        render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { autoHeight: isJSDOM, columns: cols, rows: rows }) }));
    ...
    it('should allow sorting using `initialState` and `filterModel` for unsortable columns', function () {
        function TestCase(props) {
            ...
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ columns: cols, rows: rows, initialState: initialState }, props)) }));
        }
    ...
    it('should allow sorting using `apiRef` for unsortable columns', function () {
        ...
        function TestCase() {
            ...
            var cols = [{ field: 'id', sortable: false }];
            var rows = [{ id: 10 }, { id: 0 }, { id: 5 }];
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { apiRef: apiRef, columns: cols, rows: rows }) }));
        }
    ...
    it('should not keep the sort item with `item.sort = null`', function () {
        ...
        function TestCase() {
            ...
            var cols = [{ field: 'id' }];
            var rows = [{ id: 10 }, { id: 0 }, { id: 5 }];
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { apiRef: apiRef, columns: cols, rows: rows, onSortModelChange: onSortModelChange }) }));
        }
        render((0, jsx_runtime_1.jsx)(TestCase, {}));
        expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['10', '0', '5']);
        var header = (0, helperFn_1.getColumnHeaderCell)(0);
    ...
    it('should always set correct `aria-sort` attribute', function () {
        var cols = [{ field: 'id' }];
        var rows = [{ id: 10 }, { id: 0 }, { id: 5 }];
        render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: cols, rows: rows }) }));
        var header = (0, helperFn_1.getColumnHeaderCell)(0);
    ...
    it('should update the order server side', function () {
        ...
        var rows = [{ id: 10 }, { id: 0 }, { id: 5 }];
        function Demo(props) {
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ autoHeight: isJSDOM, columns: cols, sortingMode: "server" }, props)) }));
        }
        var setProps = render((0, jsx_runtime_1.jsx)(Demo, { rows: rows })).setProps;
        expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['10', '0', '5']);
    ...
    it('should sort string column when clicking the header cell', function () {
        render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps)) }));
        var header = (0, helperFn_1.getColumnHeaderCell)(0);
    ...
    it('should only allow ascending sorting using sortingOrder', function () {
        render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { sortingOrder: ['asc'] })) }));
        var header = (0, helperFn_1.getColumnHeaderCell)(0);
        expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['Nike', 'Adidas', 'Puma']);
        internal_test_utils_1.fireEvent.click(header);
        expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['Adidas', 'Nike', 'Puma']);
    ...
    it('should only allow ascending and initial sorting using sortingOrder', function () {
        render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { sortingOrder: ['asc', null] })) }));
        var header = (0, helperFn_1.getColumnHeaderCell)(0);
        expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['Nike', 'Adidas', 'Puma']);
        internal_test_utils_1.fireEvent.click(header);
        expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['Adidas', 'Nike', 'Puma']);
    ...
    it('should only allow ascending and descending sorting using sortingOrder', function () {
        render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { sortingOrder: ['desc', 'asc'] })) }));
        var header = (0, helperFn_1.getColumnHeaderCell)(0);
        expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['Nike', 'Adidas', 'Puma']);
        internal_test_utils_1.fireEvent.click(header);
        expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['Puma', 'Nike', 'Adidas']);
    ...
    it('should allow per-column sortingOrder override', function () {
        render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { sortingOrder: ['asc', 'desc'], columns: [{ field: 'brand', sortingOrder: ['desc', 'asc'] }] })) }));
        var header = (0, helperFn_1.getColumnHeaderCell)(0);
        expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['Nike', 'Adidas', 'Puma']);
        internal_test_utils_1.fireEvent.click(header);
        expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['Puma', 'Nike', 'Adidas']);
    ...
    it('should keep rows sorted when rows prop change', function () {
        function TestCase(props) {
            var rows = props.rows;
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { rows: rows, sortModel: [
                        {
                            field: 'brand',
                            sort: 'asc',
                        },
        ...
        var setProps = render((0, jsx_runtime_1.jsx)(TestCase, { rows: baselineProps.rows })).setProps;
        expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['Adidas', 'Nike', 'Puma']);
        setProps({
            rows: [
                {
    ...
    it('should support server-side sorting', function () {
        function TestCase(props) {
            var rows = props.rows;
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { sortingMode: "server", rows: rows, sortModel: [
                        {
                            field: 'brand',
                            sort: 'desc',
                        },
        ...
        var setProps = render((0, jsx_runtime_1.jsx)(TestCase, { rows: [rows[0], rows[1]] })).setProps;
    ...
    it('should support new dataset', function () {
        function TestCase(props) {
            ...
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { autoHeight: isJSDOM, rows: rows, columns: columns }) }));
        }
        var setProps = render((0, jsx_runtime_1.jsx)(TestCase, __assign({}, baselineProps))).setProps;
        var header = internal_test_utils_1.screen
    ...
    it('should support new dataset in control mode', function () {
        function TestCase(props) {
            ...
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { autoHeight: isJSDOM, rows: rows, columns: columns, sortModel: sortModel, onSortModelChange: function (newSortModel) { return setSortModel(newSortModel); } }) }));
        }
        var setProps = render((0, jsx_runtime_1.jsx)(TestCase, __assign({}, baselineProps))).setProps;
        var header = internal_test_utils_1.screen
            .getByRole('columnheader', { name: 'brand' })
    ...
    it('should clear the sorting col when passing an empty sortModel', function () {
        ...
        var setProps = render((0, jsx_runtime_1.jsx)(TestCase, { sortModel: [{ field: 'brand', sort: 'asc' }] })).setProps;
        expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['Adidas', 'Nike', 'Puma']);
        setProps({ sortModel: [] });
        expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['Nike', 'Adidas', 'Puma']);
    });
    describe('prop: initialState.sorting', function () {
        ...
        it('should allow to initialize the sortModel', function () {
            render((0, jsx_runtime_1.jsx)(Test, { initialState: {
                    sorting: {
                        sortModel: [
                            {
                                field: 'brand',
        ...
        it('should use the control state upon the initialize state when both are defined', function () {
            render((0, jsx_runtime_1.jsx)(Test, { sortModel: [
                    {
                        field: 'brand',
                        sort: 'desc',
                    },
        ...
        it('should not update the sort order when updating the initial state', function () {
            var setProps = render((0, jsx_runtime_1.jsx)(Test, { initialState: {
                    sorting: {
                        sortModel: [
                            {
                                field: 'brand',
        ...
        it('should not allow to initialize the sorting with several items', function () {
            expect(function () {
                render((0, jsx_runtime_1.jsx)(Test, { columns: [{ field: 'id', type: 'number' }, { field: 'brand' }], rows: [
                        {
                            id: 0,
                            brand: 'Nike',
                        },
    ...
    it('should apply the sortModel prop correctly on GridApiRef update row data', function () {
        ...
        function TestCase() {
            ...
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { apiRef: apiRef, sortModel: sortModel })) }));
        }
        render((0, jsx_runtime_1.jsx)(TestCase, {}));
    ...
    it('should update the sorting model on columns change', function () { return __awaiter(void 0, void 0, void 0, function () {
        function Demo(props) {
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ autoHeight: isJSDOM, columns: columns, sortModel: [{ field: 'brand', sort: 'asc' }], onSortModelChange: onSortModelChange }, props)) }));
        }
        ...
        return __generator(this, function (_a) {
            ...
            setProps = render((0, jsx_runtime_1.jsx)(Demo, { rows: rows })).setProps;
    ...
    describe('Header class names', function () {
        it('should have the sortable class when the column is sortable', function () {
            render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 500 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: [{ field: 'brand', sortable: true }] })) }));
        ...
        it('should not have the sortable class when the column is not sortable', function () {
            render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 500 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: [{ field: 'brand', sortable: false }] })) }));
        ...
        it('should not have the sortable class when column sorting is disabled', function () {
            render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 500 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { disableColumnSorting: true, columns: [{ field: 'brand' }] })) }));
            expect((0, helperFn_1.getColumnHeaderCell)(0)).not.to.have.class('MuiDataGrid-columnHeader--sortable');
        });
    });
});
