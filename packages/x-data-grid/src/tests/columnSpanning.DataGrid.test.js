...
describe('<DataGrid /> - Column spanning', function () {
    ...
    it('should support `colSpan` number signature', function () {
        render((0, jsx_runtime_1.jsx)("div", { style: { width: 500, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: [
    ...
    describe('key navigation', function () {
        ...
        it('should move to the cell right when pressing "ArrowRight"', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 500, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: columns })) })).user;
        ...
        it('should move to the cell below when pressing "ArrowDown"', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 500, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: columns, disableVirtualization: skipIf_1.isJSDOM })) })).user;
        ...
        it('should move down by the amount of rows visible on screen when pressing "PageDown"', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 500, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: columns, autoHeight: skipIf_1.isJSDOM, disableVirtualization: skipIf_1.isJSDOM })) })).user;
        ...
        it('should move up by the amount of rows visible on screen when pressing "PageUp"', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 500, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: columns, autoHeight: skipIf_1.isJSDOM })) })).user;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 500, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: editableColumns, autoHeight: skipIf_1.isJSDOM, disableVirtualization: skipIf_1.isJSDOM })) })).user;
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(1, 3))];
                    case 1:
                        _a.sent();
                        expect((0, helperFn_1.getActiveCell)()).to.equal('1-3');
        ...
        it('should move to the cell on the right when pressing "Tab" after editing', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        editableColumns = columns.map(function (column) { return (__assign(__assign({}, column), { editable: true })); });
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 500, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: editableColumns, disableVirtualization: skipIf_1.isJSDOM })) })).user;
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(1, 1))];
                    case 1:
                        _a.sent();
                        expect((0, helperFn_1.getActiveCell)()).to.equal('1-1');
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        rowHeight = 52;
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 500, height: (rows.length + 1) * rowHeight }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: [
                                    { field: 'brand', colSpan: function (value, row) { return (row.brand === 'Adidas' ? 2 : 1); } },
                                    { field: 'category' },
                                    { field: 'price' },
                                ], rows: rows, rowBufferPx: rowHeight, rowHeight: rowHeight }) })).user;
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(1, 1))];
                    case 1:
                        _a.sent();
                        expect((0, helperFn_1.getActiveCell)()).to.equal('1-1');
        ...
        it.skipIf(skipIf_1.isJSDOM)('should work with column virtualization', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 200, height: 200 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: [
                                    { field: 'col0', width: 100, colSpan: 3 },
                                    { field: 'col1', width: 100 },
                                    { field: 'col2', width: 100 },
                                    { field: 'col3', width: 100 },
                                ], rows: [{ id: 0, col0: '0-0', col1: '0-1', col2: '0-2', col3: '0-3' }], columnBufferPx: 100 }) })).user;
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(0, 0))];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, user.keyboard('{ArrowRight}')];
        ...
        it('should work with filtering', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 500, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: [
                                    { field: 'brand', colSpan: function (value, row) { return (row.brand === 'Nike' ? 2 : 1); } },
                                    { field: 'category' },
                                    { field: 'price' },
                                    { field: 'rating' },
                ...
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 200, height: 200 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: [
                                ...
                                ], rows: [{ id: 0, col0: '0-0', col1: '0-1', col2: '0-2', col3: '0-3', col4: '0-4' }], columnBufferPx: 100 }) })).user;
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(0, 0))];
                    case 1:
                        _a.sent();
    ...
    it('should work with pagination', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        function TestCase() {
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 500, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: columns, rows: rows, initialState: { pagination: { paginationModel: { pageSize: pageSize } } }, pageSizeOptions: [pageSize], disableVirtualization: skipIf_1.isJSDOM }) }));
        }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    pageSize = 2;
                    user = render((0, jsx_runtime_1.jsx)(TestCase, {})).user;
    ...
    it.skipIf(skipIf_1.isJSDOM)('should work with column virtualization', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    render((0, jsx_runtime_1.jsx)("div", { style: { width: 390, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: [
    ...
    it.skipIf(skipIf_1.isJSDOM)('should work with pagination and column virtualization', function () { return __awaiter(void 0, void 0, void 0, function () {
        function TestCase() {
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 390, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { pageSizeOptions: [3], initialState: { pagination: { paginationModel: { pageSize: 3 } } }, columns: [
