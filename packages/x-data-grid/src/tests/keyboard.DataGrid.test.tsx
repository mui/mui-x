...
describe('<DataGrid /> - Keyboard', () => {
  ...
  describe('column group header navigation', () => {
    ...
    it('should scroll horizontally when navigating between column group headers with arrows', async function test(t = {}) {
      if (isJSDOM) {
        // Need layouting for column virtualization
        // @ts-expect-error to support mocha and vitest
        // eslint-disable-next-line @typescript-eslint/no-unused-expressions
    ...
    it('should scroll horizontally when navigating between column headers with arrows even if rows are empty', async function test(t = {}) {
      if (isJSDOM) {
        // Need layouting for column virtualization
        // @ts-expect-error to support mocha and vitest
        // eslint-disable-next-line @typescript-eslint/no-unused-expressions
