...
function CustomToolbar(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(x_data_grid_1.Toolbar, { children: items.map(function (item) { return ((0, jsx_runtime_1.jsx)(x_data_grid_1.ToolbarButton, { children: item }, item)); }) }));
}
    ...
    describe('component', function () {
        it('should move focus to the next item when pressing ArrowRight', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { slots: { toolbar: CustomToolbar }, showToolbar: true }))).user;
        ...
        it('should maintain focus position when an item is removed', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        setProps = render((0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { slots: { toolbar: CustomToolbar }, showToolbar: true }))).setProps;
                        return [4 /*yield*/, (0, internal_test_utils_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        ...
        it('should preserve arrow key navigation after item removal', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = render((0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { slots: { toolbar: CustomToolbar }, showToolbar: true }))), user = _a.user, setProps = _a.setProps;
                        return [4 /*yield*/, (0, internal_test_utils_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                                return [2 /*return*/, internal_test_utils_1.screen.getByRole('button', { name: 'Item 1' }).focus()];
                            }); }); })];
                    case 1:
    ...
    describe('column selector', function () {
        it('should hide "id" column when hiding it from the column selector', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { showToolbar: true })) })).user;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: customColumns, showToolbar: true, initialState: {
                                    columns: {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: customColumns, showToolbar: true, slotProps: {
                                    columnsManagement: {
