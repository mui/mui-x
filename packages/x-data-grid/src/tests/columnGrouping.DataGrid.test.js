...
describe('<DataGrid /> - Column grouping', function () {
    ...
    function TestDataGrid(props) {
        ...
        return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, getDefaultProps(nbColumns), other)) }));
    }
    describe('Header grouping columns', function () {
        it('should add one header row when columns have a group', function () {
            render((0, jsx_runtime_1.jsx)(TestDataGrid, { nbColumns: 2, columnGroupingModel: [{ groupId: 'A', children: [{ field: 'col1' }, { field: 'col2' }] }] }));
        ...
        it('should add header rows to match max depth of column groups', function () {
            render((0, jsx_runtime_1.jsx)(TestDataGrid, { nbColumns: 3, columnGroupingModel: [
                    {
                        groupId: 'col123',
                        children: [
        ...
        it('should support non connexe groups', function () {
            render((0, jsx_runtime_1.jsx)(TestDataGrid, { nbColumns: 4, columnGroupingModel: [
                    {
                        groupId: 'col134',
                        children: [
        ...
        it('should only consider visible columns non connexe groups', function () {
            var setProps = render((0, jsx_runtime_1.jsx)(TestDataGrid, { nbColumns: 3, columnGroupingModel: [
                    {
                        groupId: 'col12',
        ...
        it('should not throw when both `columns` and `columnGroupingModel` are updated', function () {
            ...
            var setProps = render((0, jsx_runtime_1.jsx)(TestDataGrid, __assign({ nbColumns: 0 }, defaultProps, { columnGroupingModel: [
                    {
                        groupId: 'testGroup',
                        children: [{ field: 'col1' }, { field: 'col2' }],
                    },
        ...
        it('should not throw when both `columns` and `columnGroupingModel` are updated twice', function () {
            function Demo() {
                ...
                return ((0, jsx_runtime_1.jsxs)("div", { style: { width: 300, height: 300 }, children: [(0, jsx_runtime_1.jsx)("button", { onClick: handleClick, children: "Update columns" }), (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ rows: [{ id: 1, field_0: 'Value 0', field_1: 'Value 1' }] }, props))] }));
            }
            render((0, jsx_runtime_1.jsx)(Demo, {}));
    ...
    describe.skip('error messages', function () {
        function TestWithError(props) {
            return ((0, jsx_runtime_1.jsx)(internal_test_utils_1.ErrorBoundary, { children: (0, jsx_runtime_1.jsx)(TestDataGrid, __assign({}, props)) }));
        }
        it('should log an error if two groups have the same id', function () {
            expect(function () {
                render((0, jsx_runtime_1.jsx)(TestWithError, { nbColumns: 2, columnGroupingModel: [
                        {
                            groupId: 'col12',
        ...
        it('should log an error if a columns is referenced in two groups', function () {
            expect(function () {
                render((0, jsx_runtime_1.jsx)(TestWithError, { nbColumns: 3, columnGroupingModel: [
                        {
                            groupId: 'col12',
                            children: [{ field: 'col1' }, { field: 'col2' }],
                        },
