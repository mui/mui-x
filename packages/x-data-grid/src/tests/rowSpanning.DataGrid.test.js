...
describe.skipIf(skipIf_1.isJSDOM)('<DataGrid /> - Row spanning', function () {
    ...
    function TestDataGrid(props) {
        ...
        return ((0, jsx_runtime_1.jsx)("div", { style: { width: 500, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { apiRef: publicApiRef }, props)) }));
    }
    var rowHeight = 52;
    it('should span the repeating row values', function () {
        render((0, jsx_runtime_1.jsx)(TestDataGrid, {}));
    ...
    describe('sorting', function () {
        it('should work with sorting when initializing sorting', function () {
            render((0, jsx_runtime_1.jsx)(TestDataGrid, { initialState: { sorting: { sortModel: [{ field: 'code', sort: 'desc' }] } } }));
            var api = (0, internals_1.unwrapPrivateAPI)(publicApiRef.current);
            var store = api.virtualizer.store;
            var rowsWithSpannedCells = Object.keys(store.state.rowSpanning.caches.spannedCells);
            expect(rowsWithSpannedCells.length).to.equal(1);
        ...
        it('should work with sorting when controlling sorting', function () {
            render((0, jsx_runtime_1.jsx)(TestDataGrid, { sortModel: [{ field: 'code', sort: 'desc' }] }));
            var api = (0, internals_1.unwrapPrivateAPI)(publicApiRef.current);
            var store = api.virtualizer.store;
            var rowsWithSpannedCells = Object.keys(store.state.rowSpanning.caches.spannedCells);
            expect(rowsWithSpannedCells.length).to.equal(1);
    ...
    describe('filtering', function () {
        it('should work with filtering when initializing filter', function () {
        ...
        it('should work with filtering when controlling filter', function () {
            render((0, jsx_runtime_1.jsx)(TestDataGrid, { filterModel: {
                    items: [{ field: 'description', operator: 'contains', value: 'Upgrade' }],
                } }));
            var api = (0, internals_1.unwrapPrivateAPI)(publicApiRef.current);
            var store = api.virtualizer.store;
    ...
    describe('pagination', function () {
        it('should only compute the row spanning state for current page', function () { return __awaiter(void 0, void 0, void 0, function () {
            var api, store;
            return __generator(this, function (_a) {
                render((0, jsx_runtime_1.jsx)(TestDataGrid, { pagination: true, initialState: { pagination: { paginationModel: { pageSize: 4, page: 0 } } }, pageSizeOptions: [4] }));
    ...
    describe('rows update', function () {
        it('should update the row spanning state when the rows are updated', function () {
            ...
            var spannedCells = {};
            render((0, jsx_runtime_1.jsx)(TestDataGrid, { columns: [{ field: 'code', rowSpanValueGetter: rowSpanValueGetter }], rows: [{ id: 1, code: 'A101' }] }));
            var api = (0, internals_1.unwrapPrivateAPI)(publicApiRef.current);
            var store = api.virtualizer.store;
