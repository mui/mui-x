...
describe('<DataGrid /> - Quick filter', function () {
    ...
    function TestCase(props) {
        var _a;
        return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { showToolbar: true, disableColumnSelector: true, disableDensitySelector: true, disableColumnFilter: true }, props, { slotProps: __assign(__assign({}, props === null || props === void 0 ? void 0 : props.slotProps), { toolbar: __assign({ showQuickFilter: true }, (_a = props === null || props === void 0 ? void 0 : props.slotProps) === null || _a === void 0 ? void 0 : _a.toolbar) }) })) }));
    }
    describe('component', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        user = render((0, jsx_runtime_1.jsx)(TestCase, { onFilterModelChange: onFilterModelChange, slotProps: {
                                toolbar: {
                                    quickFilterProps: {
        ...
        it('should allow to customize input formatting', function () {
            var setProps = render((0, jsx_runtime_1.jsx)(TestCase, { slotProps: {
                    toolbar: {
                        quickFilterProps: {
        ...
        it('should be expanded by default if there is a value', function () {
            render((0, jsx_runtime_1.jsx)(TestCase, { filterModel: { items: [], quickFilterValues: ['adidas'] } }));
        ...
        it('should clear the value when the clear button is clicked and focus to `the input', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestCase, { filterModel: { items: [], quickFilterValues: ['adidas'] } })).user;
    ...
    describe('quick filter logic', function () {
        ...
        it('should return rows that match some values if quickFilterLogicOperator="or"', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestCase, { initialState: {
        ...
        it('should ignore hidden columns by default', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestCase, { columns: [{ field: 'id' }, { field: 'brand' }], initialState: {
        ...
        it('should apply filters on quickFilterExcludeHiddenColumns value change', function () {
            var setProps = render((0, jsx_runtime_1.jsx)(TestCase, { columns: [{ field: 'id' }, { field: 'brand' }], columnVisibilityModel: { brand: false }, filterModel: {
                    items: [],
        ...
        it('should apply filters on column visibility change when quickFilterExcludeHiddenColumns=true', function () {
            ...
            var setProps = render((0, jsx_runtime_1.jsx)(TestCase, { columns: [
                    {
                        field: 'id',
    ...
    describe('column type: string', function () {
        var getRows = function (_a) {
            ...
            var unmount = render((0, jsx_runtime_1.jsx)(TestCase, { filterModel: {
                    items: [],
        ...
        describe('ignoreDiacritics', function () {
            function DiacriticsTestCase(_a) {
                ...
                return ((0, jsx_runtime_1.jsx)(TestCase, __assign({}, props, { filterModel: {
                        items: [],
                        quickFilterValues: quickFilterValues,
                    }, rows: [{ id: 0, label: 'Apă' }], columns: [{ field: 'label', type: 'string' }] })));
            }
            it('should not ignore diacritics by default', function () {
                var unmount = render((0, jsx_runtime_1.jsx)(DiacriticsTestCase, { quickFilterValues: ['apa'] })).unmount;
                expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal([]);
                unmount();
                var unmount2 = render((0, jsx_runtime_1.jsx)(DiacriticsTestCase, { quickFilterValues: ['apă'] })).unmount;
            ...
            it('should ignore diacritics when `ignoreDiacritics` is enabled', function () {
                var unmount = render((0, jsx_runtime_1.jsx)(DiacriticsTestCase, { quickFilterValues: ['apa'], ignoreDiacritics: true })).unmount;
                expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['Apă']);
                unmount();
                var unmount2 = render((0, jsx_runtime_1.jsx)(DiacriticsTestCase, { quickFilterValues: ['apă'], ignoreDiacritics: true })).unmount;
                expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['Apă']);
                unmount2();
            });
        });
    ...
    it('should not override user input when typing', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    debounceMs = 50;
                    user = render((0, jsx_runtime_1.jsx)(TestCase, { slotProps: {
                            toolbar: {
