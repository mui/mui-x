...
describe('<DataGrid /> - Column headers', function () {
    ...
    describe('headerClassName', function () {
        it('should append the CSS class defined in headerClassName', function () {
            render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 500 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: [{ field: 'brand', headerClassName: 'foobar' }] })) }));
        ...
        it('should append the CSS class returned by headerClassName', function () {
            render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 500 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: [{ field: 'brand', headerClassName: function () { return 'foobar'; } }] })) }));
            expect((0, helperFn_1.getColumnHeaderCell)(0)).to.have.class('foobar');
        });
    });
    describe('Column menu', function () {
        it('should allow to hide column', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: [{ field: 'id' }, { field: 'brand', headerClassName: 'foobar' }] })) })).user;
        ...
        it('should not allow to hide the only visible column', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: [{ field: 'id' }, { field: 'brand', headerClassName: 'foobar' }], initialState: {
                                    columns: {
        ...
        it('should not allow to hide the only visible column that has menu', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: [
        ...
        it('menu icon button should close column menu when already open', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 500 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: [{ field: 'brand' }] })) })).user;
        ...
        it('should close the column menu when the grid is scrolled', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { height: 300, width: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: Array.from({ length: 50 }, function (_, id) { return ({ id: id, name: id }); }), columns: [{ field: 'brand' }] }) })).user;
                        return [4 /*yield*/, user.click((0, internal_test_utils_1.within)((0, helperFn_1.getColumnHeaderCell)(0)).getByLabelText('brand column menu'))];
                    case 1:
                        _a.sent();
    ...
    it("should use 'headerName' as the aria-label for the menu icon button", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 500 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { disableColumnSorting: true, columns: [{ headerName: 'brand header name', field: 'brand' }] })) }));
                    _a = expect;
    ...
    it('should display sort column menu items as per sortingOrder prop', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 500 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { sortingOrder: ['desc', 'asc'], columns: [{ field: 'brand', headerClassName: 'foobar' }] })) })).user;
