...
describe.skipIf(skipIf_1.isJSDOM)('<DataGrid /> - Data source', function () {
    ...
    function TestDataSource(props) {
        ...
        var dataSetOptionsProp = props.dataSetOptions, shouldRequestsFail = props.shouldRequestsFail, other = __rest(props, ["dataSetOptions", "shouldRequestsFail"]);
        ...
        return ((0, jsx_runtime_1.jsxs)("div", { style: { width: 300, height: 300 }, children: [(0, jsx_runtime_1.jsx)(Reset, {}), (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ apiRef: apiRef, columns: mockServer.columns, dataSource: dataSource, initialState: { pagination: { paginationModel: { page: 0, pageSize: 10 }, rowCount: 0 } }, pagination: true, pageSizeOptions: pageSizeOptions, disableVirtualization: true }, other))] }));
    }
    it('should fetch the data on initial render', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    render((0, jsx_runtime_1.jsx)(TestDataSource, {}));
    ...
    it('should re-fetch the data on filter change', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setProps = render((0, jsx_runtime_1.jsx)(TestDataSource, {})).setProps;
                    return [4 /*yield*/, (0, internal_test_utils_1.waitFor)(function () {
                            expect(fetchRowsSpy.callCount).to.equal(1);
                        })];
                case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        render((0, jsx_runtime_1.jsx)(TestDataSource, { onPaginationModelChange: pageChangeSpy }));
                        return [4 /*yield*/, (0, internal_test_utils_1.waitFor)(function () {
                                expect(fetchRowsSpy.callCount).to.equal(1);
                            })];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        render((0, jsx_runtime_1.jsx)(TestDataSource, { dataSourceCache: testCache }));
                        return [4 /*yield*/, (0, internal_test_utils_1.waitFor)(function () {
                                expect(fetchRowsSpy.callCount).to.equal(1);
                            })];
                    case 1:
        ...
        it('should cache the data in the chunks defined by the minimum page size', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        testCache = new utils_1.TestCache();
                        render((0, jsx_runtime_1.jsx)(TestDataSource, { dataSourceCache: testCache, paginationModel: { page: 0, pageSize: 20 } }));
                        return [4 /*yield*/, (0, internal_test_utils_1.waitFor)(function () {
                                expect(fetchRowsSpy.callCount).to.equal(1);
                            })];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        testCache = new utils_1.TestCache();
                        pageChangeSpy = (0, sinon_1.spy)();
                        render((0, jsx_runtime_1.jsx)(TestDataSource, { dataSourceCache: testCache, onPaginationModelChange: pageChangeSpy }));
                        return [4 /*yield*/, (0, internal_test_utils_1.waitFor)(function () {
                                expect(fetchRowsSpy.callCount).to.equal(1);
                            })];
                    case 1:
        ...
        it('should allow to disable the default cache', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        pageChangeSpy = (0, sinon_1.spy)();
                        render((0, jsx_runtime_1.jsx)(TestDataSource, { dataSourceCache: null, onPaginationModelChange: pageChangeSpy }));
                        return [4 /*yield*/, (0, internal_test_utils_1.waitFor)(function () {
                                expect(fetchRowsSpy.callCount).to.equal(1);
                            })];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        render((0, jsx_runtime_1.jsx)(TestDataSource, { onDataSourceError: onDataSourceError, shouldRequestsFail: true }));
                        return [4 /*yield*/, (0, internal_test_utils_1.waitFor)(function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        unmount = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: [{ field: 'id' }], dataSource: dataSource, onDataSourceError: onDataSourceError, initialState: {
                                    pagination: { paginationModel: { page: 0, pageSize: 10 }, rowCount: 0 },
                                }, pagination: true, pageSizeOptions: pageSizeOptions, disableVirtualization: true }) })).unmount;
                        return [4 /*yield*/, (0, internal_test_utils_1.waitFor)(function () {
    ...
    describe('Editing', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        user = render((0, jsx_runtime_1.jsx)(TestDataSource, { dataSourceCache: dataSourceCache, dataSetOptions: __assign(__assign({}, dataSetOptions), { maxColumns: 3 }) })).user;
                        return [4 /*yield*/, (0, internal_test_utils_1.waitFor)(function () {
                                expect(fetchRowsSpy.callCount).to.equal(1);
                            })];
                    case 1:
        ...
        it('should call `editRow()` when a computed column is updated', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestDataSource, { dataSetOptions: __assign(__assign({}, dataSetOptions), { maxColumns: 3 }), columns: [
                                {
                                    field: 'commodity',
                                },
                                {
