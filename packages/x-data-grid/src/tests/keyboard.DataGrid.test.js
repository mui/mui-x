...
describe('<DataGrid /> - Keyboard', function () {
    ...
    function NavigationTestCaseNoScrollX(props) {
        ...
        return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: HEIGHT }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ autoHeight: skipIf_1.isJSDOM, rows: data.rows, columns: transformColSizes(data.columns), initialState: { pagination: { paginationModel: { pageSize: PAGE_SIZE } } }, pageSizeOptions: [PAGE_SIZE], rowBufferPx: PAGE_SIZE * ROW_HEIGHT, rowHeight: ROW_HEIGHT, columnHeaderHeight: HEADER_HEIGHT, hideFooter: true, filterModel: { items: [{ field: 'id', operator: '>', value: 10 }] }, 
    ...
    describe('cell navigation', function () {
        it('should move to cell below when pressing "ArrowDown" on a cell on the 1st page', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(NavigationTestCaseNoScrollX, {})).user;
        ...
        it('should move to cell below when pressing "ArrowDown" on a cell on the 2nd page', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(NavigationTestCaseNoScrollX, { paginationModel: { page: 1, pageSize: PAGE_SIZE } })).user;
        ...
        it('should move to the cell below when pressing "ArrowDown" on the checkbox selection cell', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(NavigationTestCaseNoScrollX, { checkboxSelection: true })).user;
        ...
        it.skipIf(skipIf_1.isJSDOM)('should move to the first row before moving to column header when pressing "PageUp" on page > 0', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(NavigationTestCaseNoScrollX, { hideFooter: false })).user;
    ...
    describe('column header navigation', function () {
        ...
        it.skipIf(skipIf_1.isJSDOM)('should scroll horizontally when navigating between column headers with arrows', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 60, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ autoHeight: skipIf_1.isJSDOM }, (0, x_data_grid_generator_1.getBasicGridData)(10, 10))) })).user;
                        return [4 /*yield*/, (0, internal_test_utils_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        ...
        it.skipIf(skipIf_1.isJSDOM)('should scroll horizontally when navigating between column headers with arrows even if rows are empty', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 60, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ autoHeight: skipIf_1.isJSDOM }, (0, x_data_grid_generator_1.getBasicGridData)(10, 10), { rows: [] })) })).user;
                        return [4 /*yield*/, (0, internal_test_utils_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                                return [2 /*return*/, (0, helperFn_1.getColumnHeaderCell)(0).focus()];
                            }); }); })];
                    case 1: return [4 /*yield*/, _a.sent()];
        ...
        it('should move to the first row when pressing "ArrowDown" on a column header on the 1st page', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render((0, jsx_runtime_1.jsx)(NavigationTestCaseNoScrollX, {}));
                        return [4 /*yield*/, (0, internal_test_utils_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        ...
        it('should move to the first row when pressing "ArrowDown" on a column header on the 2nd page', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render((0, jsx_runtime_1.jsx)(NavigationTestCaseNoScrollX, { paginationModel: { page: 1, pageSize: PAGE_SIZE } }));
                        return [4 /*yield*/, (0, internal_test_utils_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                                return [2 /*return*/, (0, helperFn_1.getColumnHeaderCell)(1).focus()];
                            }); }); })];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        columns = [
                            {
                                ...
                                headerName: 'Name',
                                width: 200,
                                renderHeader: function () { return (0, jsx_runtime_1.jsx)("input", { type: "text", "data-testid": "custom-input" }); },
                            },
                        ];
                        rows = [
                            {
                        ...
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: rows, columns: columns }) })).user;
    ...
    describe('column group header navigation', function () {
        ...
        function NavigationTestGroupingCaseNoScrollX(props) {
            ...
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: HEIGHT }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ autoHeight: skipIf_1.isJSDOM, rows: data.rows, columns: transformColSizes(data.columns), paginationModel: { pageSize: PAGE_SIZE, page: 0 }, pageSizeOptions: [PAGE_SIZE], rowBufferPx: PAGE_SIZE * ROW_HEIGHT, rowHeight: ROW_HEIGHT, columnHeaderHeight: HEADER_HEIGHT, hideFooter: true, disableVirtualization: true, columnGroupingModel: columnGroupingModel, experimentalFeatures: { warnIfFocusStateIsNotSynced: true } }, props)) }));
        }
        ...
        it.skipIf(skipIf_1.isJSDOM)('should scroll horizontally when navigating between column group headers with arrows', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 100, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ columnGroupingModel: columnGroupingModel }, (0, x_data_grid_generator_1.getBasicGridData)(10, 10))) })).user;
        ...
        it.skipIf(skipIf_1.isJSDOM)('should scroll horizontally when navigating between column headers with arrows even if rows are empty', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 100, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ columnGroupingModel: columnGroupingModel }, (0, x_data_grid_generator_1.getBasicGridData)(10, 10), { rows: [] })) })).user;
                        // Tab to the first column header
                        return [4 /*yield*/, user.keyboard('{Tab}')];
                    case 1:
                        // Tab to the first column header
        ...
        it('should move to the group header below when pressing "ArrowDown" on a column group header', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(NavigationTestGroupingCaseNoScrollX, {})).user;
        ...
        it('should go to group header when pressing "ArrowUp" from column header', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render((0, jsx_runtime_1.jsx)(NavigationTestGroupingCaseNoScrollX, {}));
                        return [4 /*yield*/, (0, internal_test_utils_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    rows = [{ id: 1, name: 'John' }];
                    user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, onKeyDown: handleKeyDown, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: rows, columns: columns }) })).user;
    ...
    it('should select a row when pressing Space key + shiftKey', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    user = render((0, jsx_runtime_1.jsx)(NavigationTestCaseNoScrollX, { disableRowSelectionOnClick: true })).user;
                    cell = (0, helperFn_1.getCell)(0, 0);
                    return [4 /*yield*/, user.click(cell)];
                case 1:
                    _a.sent();
    ...
    it('should not rerender when pressing a key inside an already focused cell', function () {
        var renderCell = (0, sinon_1.spy)(function () { return (0, jsx_runtime_1.jsx)("input", { type: "text", "data-testid": "custom-input" }); });
                    ...
                    columns = [
                        {
                            ...
                            getActions: function () { return [
                                (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { label: "Test", icon: (0, jsx_runtime_1.jsx)(Restore_1.default, {}), id: 'action_1', disabled: true }),
                                (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { label: "Test", icon: (0, jsx_runtime_1.jsx)(Restore_1.default, {}), id: 'action_2' }),
                            ]; },
                        },
                        { field: 'id', width: 400 },
                        { field: 'name' },
                    ...
                    columns = [
                        {
                            ...
                            getActions: function () { return [
                                (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { label: "Test", icon: (0, jsx_runtime_1.jsx)(Restore_1.default, {}), id: 'action_1', disabled: true }),
                                (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { label: "Test", icon: (0, jsx_runtime_1.jsx)(Restore_1.default, {}), id: 'action_2', disabled: true }),
                            ]; },
                        },
                        { field: 'id', width: 400 },
                        { field: 'name' },
                    ...
                    columns = [
                        {
                            ...
                            getActions: function () { return [
                                (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { label: "Test", icon: (0, jsx_runtime_1.jsx)(Restore_1.default, {}), id: 'action_1', disabled: true }),
                                (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { label: "Test", icon: (0, jsx_runtime_1.jsx)(Restore_1.default, {}), id: 'action_2' }),
                                (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { label: "Test", icon: (0, jsx_runtime_1.jsx)(Restore_1.default, {}), id: 'action_3', disabled: true }),
                                (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { label: "Test", icon: (0, jsx_runtime_1.jsx)(Restore_1.default, {}), id: 'action_4', disabled: true }),
                                (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { label: "Test", icon: (0, jsx_runtime_1.jsx)(Restore_1.default, {}), id: 'action_5' }),
                            ]; },
                        },
                        { field: 'id', width: 400 },
                        { field: 'name' },
    ...
    describe('After pressing the backspace/delete key, the reset value type should match the column type', function () {
        function setupTest(rows, columns, editMode) {
            ...
            var view = render((0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: rows, columns: columns, editMode: editMode, autoHeight: true }));
