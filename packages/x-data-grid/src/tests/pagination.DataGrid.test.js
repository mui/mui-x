...
describe('<DataGrid /> - Pagination', function () {
    ...
    function BaselineTestCase(props) {
        ...
        return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: height }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, basicData, { apiRef: apiRef, autoHeight: skipIf_1.isJSDOM }, other)) }));
    }
    // Need layouting
    describe.skipIf(skipIf_1.isJSDOM)('prop: paginationModel and onPaginationModelChange', function () {
        it('should display the rows of page given in props', function () {
            render((0, jsx_runtime_1.jsx)(BaselineTestCase, { paginationModel: { page: 1, pageSize: 1 }, pageSizeOptions: [1] }));
        ...
        it('should not call onPaginationModelChange on initialisation', function () {
            ...
            render((0, jsx_runtime_1.jsx)(BaselineTestCase, { paginationModel: { page: 0, pageSize: 1 }, onPaginationModelChange: onPaginationModelChange, pageSizeOptions: [1] }));
        ...
        it('should allow to update the paginationModel from the outside', function () {
            var setProps = render((0, jsx_runtime_1.jsx)(BaselineTestCase, { paginationModel: { page: 0, pageSize: 1 }, pageSizeOptions: [1] })).setProps;
        ...
        it('should not apply new page when clicking on next / previous button and onPaginationModelChange is not defined and paginationModel is controlled', function () {
            render((0, jsx_runtime_1.jsx)(BaselineTestCase, { paginationModel: { pageSize: 1, page: 0 }, pageSizeOptions: [1] }));
        ...
        it('should call onPaginationModelChange and apply new page when clicking on next / previous button', function () {
            var onPaginationModelChange = (0, sinon_1.spy)();
            render((0, jsx_runtime_1.jsx)(BaselineTestCase, { onPaginationModelChange: onPaginationModelChange, initialState: { pagination: { paginationModel: { pageSize: 1 } } }, pageSizeOptions: [1] }));
            internal_test_utils_1.fireEvent.click(internal_test_utils_1.screen.getByRole('button', { name: /next page/i }));
        ...
        it('should apply the new pageSize when clicking on a page size option and onPaginationModelChange is not defined and paginationModel is not controlled', function () {
            render((0, jsx_runtime_1.jsx)(BaselineTestCase, { pageSizeOptions: [1, 2, 3, 100] }));
        ...
        it('should call onPaginationModelChange and apply the new pageSize when clicking on a page size option and paginationModel is not controlled', function () {
            var onPaginationModelChange = (0, sinon_1.spy)();
            render((0, jsx_runtime_1.jsx)(BaselineTestCase, { onPaginationModelChange: onPaginationModelChange, pageSizeOptions: [1, 2, 3, 100] }));
            internal_test_utils_1.fireEvent.mouseDown(internal_test_utils_1.screen.getByLabelText('Rows per page:'));
            expect(internal_test_utils_1.screen.queryAllByRole('option').length).to.equal(4);
            internal_test_utils_1.fireEvent.click(internal_test_utils_1.screen.queryAllByRole('option')[1]);
            expect(onPaginationModelChange.callCount).to.equal(1);
        ...
        it('should call onPaginationModelChange with the correct paginationModel when clicking on next / previous button when paginationModel is controlled', function () {
            ...
            function TestCase(_a) {
                ...
                return ((0, jsx_runtime_1.jsx)(BaselineTestCase, { onPaginationModelChange: function (newModel) {
                        handlePaginationModelChange(newModel);
                        setPaginationModel(newModel);
                    }, paginationModel: paginationModel, pageSizeOptions: [1] }));
            }
            render((0, jsx_runtime_1.jsx)(TestCase, { handlePaginationModelChange: onPaginationModelChange }));
            internal_test_utils_1.fireEvent.click(internal_test_utils_1.screen.getByRole('button', { name: /next page/i }));
        ...
        it('should call onPaginationModelChange when clicking on next / previous button in "server" mode', function () {
            var onPaginationModelChange = (0, sinon_1.spy)();
            render((0, jsx_runtime_1.jsx)(BaselineTestCase, { onPaginationModelChange: onPaginationModelChange, initialState: { pagination: { paginationModel: { pageSize: 1 } } }, pageSizeOptions: [1], paginationMode: "server", rowCount: 4 }));
            internal_test_utils_1.fireEvent.click(internal_test_utils_1.screen.getByRole('button', { name: /next page/i }));
            expect(onPaginationModelChange.callCount).to.equal(1);
            expect(onPaginationModelChange.lastCall.args[0]).to.deep.equal({ page: 1, pageSize: 1 });
            internal_test_utils_1.fireEvent.click(internal_test_utils_1.screen.getByRole('button', { name: /previous page/i }));
        ...
        it('should control `paginationModel` state when the prop and the onChange are set', function () {
            function ControlCase() {
                ...
                return ((0, jsx_runtime_1.jsx)(BaselineTestCase, { paginationModel: paginationModel, onPaginationModelChange: function (newPaginationModel) { return setPaginationModel(newPaginationModel); }, pageSizeOptions: [1] }));
            }
        ...
        it('should go to last page when paginationModel is controlled and the current page is greater than the last page', function () {
            ...
            function TestCasePaginationFilteredData(props) {
                ...
                return ((0, jsx_runtime_1.jsx)(BaselineTestCase, __assign({ paginationModel: paginationModel, onPaginationModelChange: handlePaginationModelChange, pageSizeOptions: [5] }, props)));
            }
            var setProps = render((0, jsx_runtime_1.jsx)(TestCasePaginationFilteredData, {})).setProps;
            expect(onPaginationModelChange.callCount).to.equal(0);
            setProps({
                filterModel: {
        ...
        it('should scroll to the top of the page when changing page', function () {
            var setProps = render((0, jsx_runtime_1.jsx)(BaselineTestCase, { paginationModel: { page: 0, pageSize: 5 }, pageSizeOptions: [5] })).setProps;
        ...
        it('should display the amount of rows given in props', function () {
            render((0, jsx_runtime_1.jsx)(BaselineTestCase, { paginationModel: { page: 0, pageSize: 2 }, pageSizeOptions: [2] }));
            expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['0', '1']);
        });
        it('should throw if pageSize exceeds 100', function () {
            render((0, jsx_runtime_1.jsx)(BaselineTestCase, { paginationModel: { pageSize: 1, page: 0 }, pageSizeOptions: [1, 2, 101] }));
        ...
        it('should call onPaginationModelChange with the correct page when clicking on a page size option when paginationModel is controlled', function () {
            var onPaginationModelChange = (0, sinon_1.spy)();
            render((0, jsx_runtime_1.jsx)(BaselineTestCase, { onPaginationModelChange: onPaginationModelChange, paginationModel: { pageSize: 1, page: 0 }, pageSizeOptions: [1, 2, 3] }));
            internal_test_utils_1.fireEvent.mouseDown(internal_test_utils_1.screen.getByLabelText('Rows per page:'));
        ...
        it('should not change the pageSize state when clicking on a page size option when paginationModel prop is provided', function () {
            render((0, jsx_runtime_1.jsx)(BaselineTestCase, { paginationModel: { pageSize: 1, page: 0 }, pageSizeOptions: [1, 2, 3] }));
            internal_test_utils_1.fireEvent.mouseDown(internal_test_utils_1.screen.getByLabelText('Rows per page:'));
            expect(internal_test_utils_1.screen.queryAllByRole('option').length).to.equal(3);
            internal_test_utils_1.fireEvent.click(internal_test_utils_1.screen.queryAllByRole('option')[1]);
            expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['0']);
        ...
        it('should display a warning if the prop pageSize is not in the prop pageSizeOptions', function () {
            var pageSize = 12;
            expect(function () {
                render((0, jsx_runtime_1.jsx)(BaselineTestCase, { paginationModel: { pageSize: pageSize, page: 0 }, pageSizeOptions: [25, 50, 100] }));
            }).toWarnDev([
        ...
        it('should not display a warning if the prop pageSize is in the prop pageSizeOptions when it is an array of objects.', function () {
            var pageSize = 10;
            expect(function () {
                render((0, jsx_runtime_1.jsx)(BaselineTestCase, { paginationModel: { pageSize: pageSize, page: 0 }, pageSizeOptions: [
                        { label: '10', value: 10 },
                        { label: '20', value: 20 },
                        { label: '30', value: 30 },
                    ] }));
        ...
        it('should display a warning if the prop pageSize is not in the default pageSizeOptions', function () {
            var pageSize = 12;
            expect(function () {
                render((0, jsx_runtime_1.jsx)(BaselineTestCase, { paginationModel: { pageSize: pageSize, page: 0 } }));
            }).toWarnDev([
                "MUI X: The page size `".concat(pageSize, "` is not present in the `pageSizeOptions`"),
                internal_test_utils_1.reactMajor < 19 &&
                    "MUI X: The page size `".concat(pageSize, "` is not present in the `pageSizeOptions`"),
        ...
        it('should display a warning if the default pageSize given as props is not in the prop pageSizeOptions', function () {
            expect(function () {
                render((0, jsx_runtime_1.jsx)(BaselineTestCase, { pageSizeOptions: [25, 50] }));
            }).toWarnDev([
        ...
        it('should update the pageCount state when updating the paginationModel prop with a lower pageSize value', function () {
            function TestCase(props) {
                ...
                return ((0, jsx_runtime_1.jsx)(BaselineTestCase, __assign({ pageSizeOptions: [10, 20], paginationModel: paginationModel, onPaginationModelChange: setPaginationModel, disableVirtualization: true }, props)));
            }
    ...
    describe.skipIf(skipIf_1.isJSDOM)('prop: autoPageSize', function () {
        function TestCaseAutoPageSize(props) {
            ...
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: props.height }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ columns: data.columns, rows: data.rows, autoPageSize: true }, other)) }));
        }
        it('should give priority to the controlled paginationModel', function () {
            render((0, jsx_runtime_1.jsx)(BaselineTestCase, { autoPageSize: true, paginationModel: { pageSize: 3, page: 2 }, pageSizeOptions: [3] }));
        ...
        it('should always render the same amount of rows and fit the viewport', function () {
            ...
            var rowHeight = 52;
            render((0, jsx_runtime_1.jsx)(TestCaseAutoPageSize, { nbRows: nbRows, height: height, columnHeaderHeight: columnHeaderHeight, rowHeight: rowHeight }));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        rowHeight = 52;
                        setProps = render((0, jsx_runtime_1.jsx)(TestCaseAutoPageSize, { nbRows: nbRows, height: heightBefore, columnHeaderHeight: columnHeaderHeight, rowHeight: rowHeight, onPaginationModelChange: onPaginationModelChange })).setProps;
    ...
    it('should react to an update of rowCount when `paginationMode = server`', function () {
        var setProps = render((0, jsx_runtime_1.jsx)(BaselineTestCase, { rowCount: 5, paginationModel: { page: 0, pageSize: 1 }, pageSizeOptions: [1], paginationMode: "server" })).setProps;
    ...
    describe('server-side pagination', function () {
        function ServerPaginationGrid(props) {
            ...
            return ((0, jsx_runtime_1.jsx)("div", { style: { height: 300, width: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ columns: [{ field: 'id' }], rows: rows, paginationMeta: { hasNextPage: props.rowCount === -1 }, paginationModel: paginationModel, pageSizeOptions: [1], paginationMode: "server", onPaginationModelChange: handlePaginationModelChange }, props)) }));
        }
        it('should support server side pagination with known row count', function () {
            render((0, jsx_runtime_1.jsx)(ServerPaginationGrid, { rowCount: 3 }));
            expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['0']);
            internal_test_utils_1.fireEvent.click(internal_test_utils_1.screen.getByRole('button', { name: /next page/i }));
            expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['1']);
        });
        it('should support server side pagination with unknown row count', function () {
            var setProps = render((0, jsx_runtime_1.jsx)(ServerPaginationGrid, { rowCount: -1 })).setProps;
            expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['0']);
        ...
        it('should support server side pagination with estimated row count', function () {
            var setProps = render((0, jsx_runtime_1.jsx)(ServerPaginationGrid, { rowCount: -1, estimatedRowCount: 2 })).setProps;
            expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['0']);
    ...
    it('should reset page to 0 and scroll to top if sort or filter is applied', function () { return __awaiter(void 0, void 0, void 0, function () {
        var randomScrollTopPostion;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    render((0, jsx_runtime_1.jsx)(BaselineTestCase, { initialState: { pagination: { paginationModel: { page: 0, pageSize: 50 }, rowCount: 0 } }, pageSizeOptions: [50] }));
                    randomScrollTopPostion = 500;
    ...
    it('should make the first cell focusable after changing the page', function () {
        render((0, jsx_runtime_1.jsx)(BaselineTestCase, { initialState: { pagination: { paginationModel: { pageSize: 1 } } }, pageSizeOptions: [1] }));
    ...
    describe.skipIf(skipIf_1.isJSDOM)('prop: initialState.pagination', function () {
        it('should allow to initialize the paginationModel', function () {
            render((0, jsx_runtime_1.jsx)(BaselineTestCase, { initialState: {
                    pagination: {
        ...
        it('should use the paginationModel control state upon the initialize state when both are defined', function () {
            render((0, jsx_runtime_1.jsx)(BaselineTestCase, { paginationModel: { pageSize: 5, page: 0 }, initialState: {
                    pagination: {
                        paginationModel: { pageSize: 2, page: 0 },
                    },
                }, pageSizeOptions: [2, 5] }));
        ...
        it('should not update the paginationModel when updating the initial state', function () {
            var setProps = render((0, jsx_runtime_1.jsx)(BaselineTestCase, { initialState: {
                    pagination: {
                        paginationModel: { pageSize: 2, page: 0 },
                    },
    ...
    it('should not throw on deleting the last row of a page > 0', function () {
        ...
        expect(function () {
            var setProps = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: columns, rows: rows, initialState: { pagination: { paginationModel: { pageSize: 2, page: 1 } } }, pageSizeOptions: [2] }) })).setProps;
            setProps({ rows: rows.slice(0, 2) });
        }).not.to.throw();
    });
    it('should log an error if rowCount is used with client-side pagination', function () {
        expect(function () {
            render((0, jsx_runtime_1.jsx)(BaselineTestCase, { paginationMode: "client", rowCount: 100 }));
        }).toErrorDev([
