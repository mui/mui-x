...
describe('<DataGrid /> - Filter', function () {
    ...
    function TestCase(props) {
        return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, props, { disableEval: disableEval })) }));
    }
    describe('prop: filterModel', function () {
        it('should throw for more than one filter item', function () {
            expect(function () {
                render((0, jsx_runtime_1.jsx)(TestCase, { rows: [], columns: [], filterModel: {
                        items: [
        ...
        it('should apply the model for `filterable: false` columns but the applied filter should be readonly', function () {
            render((0, jsx_runtime_1.jsx)(TestCase, { columns: [{ field: 'brand', filterable: false }], filterModel: { items: [{ field: 'brand', operator: 'contains', value: 'Adidas' }] }, initialState: {
                    preferencePanel: {
                        open: true,
        ...
        it('should apply the model', function () {
            render((0, jsx_runtime_1.jsx)(TestCase, { filterModel: { items: [{ field: 'brand', operator: 'contains', value: 'a' }] } }));
            expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['Adidas', 'Puma']);
        });
        it('should apply the model when row prop changes', function () {
            render((0, jsx_runtime_1.jsx)(TestCase, { filterModel: { items: [{ field: 'brand', operator: 'contains', value: 'a' }] }, rows: [
                    {
                        id: 3,
                        brand: 'Asics',
                    },
        ...
        it('should support new dataset', function () {
            var setProps = render((0, jsx_runtime_1.jsx)(TestCase, { filterModel: { items: [{ field: 'brand', operator: 'contains', value: 'a' }] } })).setProps;
            expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['Adidas', 'Puma']);
            setProps({
                rows: [
                    {
    ...
    describe('prop: initialState.filter', function () {
        ...
        it('should allow to initialize the filterModel for non-filterable columns', function () {
            render((0, jsx_runtime_1.jsx)(TestCase, { columns: [{ field: 'brand', filterable: false }], initialState: {
                    filter: {
                        filterModel: {
                            items: [{ field: 'brand', operator: 'equals', value: 'Adidas' }],
                        },
        ...
        it('should use the control state upon the initialize state when both are defined', function () {
            render((0, jsx_runtime_1.jsx)(TestCase, { filterModel: {
                    items: [{ field: 'brand', operator: 'equals', value: 'Adidas' }],
                }, initialState: {
                    filter: {
                        filterModel: {
        ...
        it('should not update the filters when updating the initial state', function () {
            var setProps = render((0, jsx_runtime_1.jsx)(TestCase, { initialState: {
                    filter: {
                        filterModel: {
                            items: [{ field: 'brand', operator: 'equals', value: 'Adidas' }],
                        },
    ...
    describe('prop: getRowId', function () {
        it('works with filter', function () {
            render((0, jsx_runtime_1.jsx)(TestCase, { getRowId: function (row) { return row.brand; }, filterModel: {
    ...
    describe('column type: string', function () {
        ...
        describe('ignoreDiacritics', function () {
            function DiacriticsTestCase(_a) {
                ...
                return ((0, jsx_runtime_1.jsx)(TestCase, __assign({ filterModel: {
            ...
            it('should not ignore diacritics by default', function () {
                testEval(function () {
                    var unmount = render((0, jsx_runtime_1.jsx)(DiacriticsTestCase, { filterValue: "apa" })).unmount;
                    expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal([]);
                    unmount();
                });
                testEval(function () {
                    var unmount = render((0, jsx_runtime_1.jsx)(DiacriticsTestCase, { filterValue: "ap\u0103" })).unmount;
            ...
            it('should ignore diacritics when `ignoreDiacritics` is enabled', function () {
                testEval(function () {
                    var unmount = render((0, jsx_runtime_1.jsx)(DiacriticsTestCase, { filterValue: "apa", ignoreDiacritics: true })).unmount;
                    expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['Apă']);
                    unmount();
                });
                testEval(function () {
                    var unmount = render((0, jsx_runtime_1.jsx)(DiacriticsTestCase, { filterValue: "ap\u0103", ignoreDiacritics: true })).unmount;
                    expect((0, helperFn_1.getColumnValues)(0)).to.deep.equal(['Apă']);
                    unmount();
                });
            });
    ...
    describe('column type: singleSelect', function () {
        ...
        it('should support `valueParser`', function () {
            ...
            var setProps = render((0, jsx_runtime_1.jsx)(TestCase, { filterModel: {
    ...
    describe('toolbar active filter count', function () {
        it('should not include operators with value when the value is empty', function () {
            var getFilterCount = function (item) {
                var unmount = render((0, jsx_runtime_1.jsx)(TestCase, { rows: [], columns: [
        ...
        it('should include value-less operators', function () {
            render((0, jsx_runtime_1.jsx)(TestCase, { rows: [], columns: [{ field: 'brand', type: 'string' }], filterModel: {
                    items: [
                        {
                            field: 'brand',
                            operator: 'isNotEmpty',
    ...
    describe('filter button tooltip', function () {
        it('should display `falsy` value', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = render((0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { filterModel: {
                                items: [{ id: 0, field: 'isAdmin', operator: 'is', value: false }],
                            }, autoHeight: true, rows: [
                                {
                                    id: 0,
                                    isAdmin: false,
                                    level: 0,
                            ...
                            ], slots: { toolbar: x_data_grid_1.GridToolbarFilterButton }, showToolbar: true })), setProps = _a.setProps, user = _a.user;
    ...
    describe('custom `filterOperators`', function () {
        it('should allow to customize filter tooltip using `filterOperator.getValueAsString`', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: '100%', height: '400px' }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { filterModel: {
                                ...
                                ], slots: { toolbar: x_data_grid_1.GridToolbarFilterButton }, showToolbar: true }) })).user;
                        filterButton = document.querySelector('button[aria-label="Show filters"]');
                        expect(internal_test_utils_1.screen.queryByRole('tooltip')).to.equal(null);
                        return [4 /*yield*/, user.hover(filterButton)];
                    case 1:
    ...
    it('should translate operators dynamically in toolbar without crashing ', function () {
        expect(function () {
            return ((0, jsx_runtime_1.jsx)("div", { style: { height: 400, width: '100%' }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: [
                        {
                            id: 1,
                            quantity: 1,
                        },
    ...
    it('should update the filter model on columns change', function () {
        ...
        function Demo(props) {
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ autoHeight: skipIf_1.isJSDOM, columns: columns, filterModel: {
                        items: [{ field: 'brand', operator: 'equals', value: 'Puma' }],
