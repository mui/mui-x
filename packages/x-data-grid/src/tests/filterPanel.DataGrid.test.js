...
function CustomInputValue(props) {
    ...
    return ((0, jsx_runtime_1.jsx)("input", { name: "custom-filter-operator", placeholder: "Filter value", value: item.value, onChange: handleFilterChange, "data-testid": "customInput" }));
}
...
describe('<DataGrid /> - Filter panel', function () {
    ...
    it('should show an empty string as the default filter input value', function () {
        render((0, jsx_runtime_1.jsx)(TestCase, { initialState: {
                preferencePanel: {
                    open: true,
    ...
    it('should reset filter value if not available in the new valueOptions', function () {
        render((0, jsx_runtime_1.jsx)(TestCase, { rows: [
