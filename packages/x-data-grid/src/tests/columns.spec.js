...
function RenderCellParamsExplicitTyping() {
    return ((0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: [], columns: [
            {
                field: 'price1',
...
function CellParamsFromRowModel() {
    ...
    return (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: [], columns: columns });
}
function CellParamsValue() {
    return ((0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: [], columns: [{ field: 'brand' }], onCellClick: function (params) {
...
var constEmptyRows = [];
function ConstProps() {
    return (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: constEmptyRows, columns: constBrandColumns });
}
