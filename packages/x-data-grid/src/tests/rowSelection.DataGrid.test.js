...
describe('<DataGrid /> - Row selection', function () {
    ...
    function TestDataGridSelection(props) {
        return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, defaultData, props, { autoHeight: skipIf_1.isJSDOM, experimentalFeatures: __assign({ 
    ...
    it('should not call `onRowSelectionModelChange` twice when using filterMode="server"', function () { return __awaiter(void 0, void 0, void 0, function () {
        function TestDataGrid() {
            ...
            return ((0, jsx_runtime_1.jsx)(TestDataGridSelection, { getRowId: function (row) { return row.id; }, checkboxSelection: true, onRowSelectionModelChange: handleRowSelectionModelChange, filterMode: "server" }));
        }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    user = render((0, jsx_runtime_1.jsx)(TestDataGrid, {})).user;
    ...
    describe('prop: checkboxSelection = false (single selection)', function () {
        it('should select one row at a time on click WITHOUT ctrl or meta pressed', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, {})).user;
    ...
    describe('prop: checkboxSelection = false (single selection), with keyboard events', function () {
        it('should select one row at a time on Shift + Space', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { disableRowSelectionOnClick: true })).user;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { columns: [
                                    { field: 'id', type: 'number' },
                                    { field: 'name', editable: true },
                                ], rows: [
                                    { id: 0, name: 'React' },
                                    { id: 1, name: 'Vue' },
                                ], onCellEditStart: onCellEditStart, editMode: editMode, disableRowSelectionOnClick: true })).user;
    ...
    describe('prop: checkboxSelection = true (multi selection)', function () {
        it('should allow to toggle prop.checkboxSelection', function () {
            var setProps = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, {})).setProps;
        ...
        it('should check then uncheck when clicking twice the row', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { checkboxSelection: true })).user;
                        expect(getSelectedRowIds()).to.deep.equal([]);
        ...
        it('should return all row IDs when selection type is exclude with empty ids', function () { return __awaiter(void 0, void 0, void 0, function () {
            function TestWithApiRef() {
                return ((0, jsx_runtime_1.jsx)(TestDataGridSelection, { checkboxSelection: true, apiRef: apiRef, onRowSelectionModelChange: onRowSelectionModelChange }));
            }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        onRowSelectionModelChange = (0, sinon_1.spy)();
                        apiRef = { current: null };
                        user = render((0, jsx_runtime_1.jsx)(TestWithApiRef, {})).user;
        ...
        it('should handle exclude type selection when deselecting a single row after select all', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        onRowSelectionModelChange = (0, sinon_1.spy)();
                        user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { checkboxSelection: true, onRowSelectionModelChange: onRowSelectionModelChange })).user;
                        selectAllCheckbox = internal_test_utils_1.screen.getByRole('checkbox', { name: 'Select all rows' });
                        return [4 /*yield*/, user.click(selectAllCheckbox)];
                    case 1:
                        _a.sent();
        ...
        it('should select all visible rows regardless of pagination', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { checkboxSelection: true, initialState: { pagination: { paginationModel: { pageSize: 1 } } }, pageSizeOptions: [1] })).user;
                        selectAllCheckbox = internal_test_utils_1.screen.getByRole('checkbox', { name: 'Select all rows' });
                        return [4 /*yield*/, user.click(selectAllCheckbox)];
                    case 1:
                        _a.sent();
        ...
        it('should check the checkbox when there is no rows', function () {
            render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { rows: [], checkboxSelection: true }));
        ...
        it('should disable the checkbox if isRowSelectable returns false', function () {
            render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { isRowSelectable: function (params) { return params.id === 0; }, checkboxSelection: true }));
        ...
        it('should unselect from last clicked cell to cell after clicked cell if clicking inside a selected range', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { checkboxSelection: true, disableVirtualization: true })).user;
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(0, 0).querySelector('input'))];
                    case 1:
                        _a.sent();
                        expect(getSelectedRowIds()).to.deep.equal([0]);
        ...
        it('should reset selected rows when turning off checkboxSelection', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { checkboxSelection: true })), setProps = _a.setProps, user = _a.user;
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(0, 0).querySelector('input'))];
                    case 1:
                        _b.sent();
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(1, 0).querySelector('input'))];
        ...
        it('should reset row selection in the current page as selected when turning off checkboxSelection', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { checkboxSelection: true, pagination: true, initialState: { pagination: { paginationModel: { pageSize: 2 } } }, pageSizeOptions: [2] })), setProps = _a.setProps, user = _a.user;
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(0, 0).querySelector('input'))];
                    case 1:
                        _b.sent();
                        expect(getSelectedRowIds()).to.deep.equal([0]);
        ...
        it('should set the correct aria-label on the cell checkbox', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { checkboxSelection: true, rows: [{ id: 0, name: 'React' }] })).user;
        ...
        it('should not select more than one row when disableMultipleRowSelection = true', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { checkboxSelection: true, disableMultipleRowSelection: true })).user;
    ...
    describe('prop: checkboxSelection = true (multi selection), with keyboard events', function () {
        ...
        it('should add new row to the selection when pressing Shift+Space', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { checkboxSelection: true, disableRowSelectionOnClick: true })).user;
                        expect(getSelectedRowIds()).to.deep.equal([]);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, __assign({}, data, { rowHeight: 50, checkboxSelection: true, hideFooter: true }))).user;
    ...
    describe('prop: isRowSelectable', function () {
        it('should update the selected rows when the isRowSelectable prop changes', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { isRowSelectable: function () { return true; }, checkboxSelection: true })), setProps = _a.setProps, user = _a.user;
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(0, 0).querySelector('input'))];
                    case 1:
                        _b.sent();
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(1, 0).querySelector('input'))];
        ...
        it('should not select unselectable rows given in rowSelectionModel', function () {
            var setProps = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { rowSelectionModel: (0, helperFn_1.includeRowSelection)([0, 1]), isRowSelectable: function (params) { return Number(params.id) % 2 === 0; }, checkboxSelection: true })).setProps;
            expect(getSelectedRowIds()).to.deep.equal([0]);
        ...
        it('should filter out unselectable rows when the rowSelectionModel prop changes', function () {
            var setProps = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { rowSelectionModel: (0, helperFn_1.includeRowSelection)([1]), isRowSelectable: function (params) { return Number(params.id) > 0; }, checkboxSelection: true })).setProps;
            expect(getSelectedRowIds()).to.deep.equal([1]);
        ...
        it('should not crash when paginationMode="server" and some selected rows are not provided to the grid', function () {
            expect(function () {
                render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { paginationMode: "server", rowCount: 4, rowSelectionModel: (0, helperFn_1.includeRowSelection)([1, 4]), isRowSelectable: function (params) { return Number(params.id) > 0; }, checkboxSelection: true }));
            }).not.toErrorDev();
        });
        it('should set the "Select all" checkbox to selected state on clicking even when some rows are not selectable', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { checkboxSelection: true, isRowSelectable: function (_a) {
                                var id = _a.id;
    ...
    describe('prop: rows', function () {
        it('should remove the outdated selected rows when rows prop changes', function () {
            ...
            var setProps = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, __assign({ rowSelectionModel: (0, helperFn_1.includeRowSelection)([0, 1, 2]), checkboxSelection: true }, data))).setProps;
            expect(getSelectedRowIds()).to.deep.equal([0, 1, 2]);
            setProps({
        ...
        it('should call `onRowSelectionModelChange` when outdated selected rows are removed', function () {
            ...
            var setProps = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, __assign({ rowSelectionModel: (0, helperFn_1.includeRowSelection)([0, 1, 2]), onRowSelectionModelChange: onRowSelectionModelChangeSpy, checkboxSelection: true }, data))).setProps;
            setProps({
                rows: data.rows.slice(0, 1),
            });
        ...
        it('should retain the outdated selected rows when the rows prop changes when keepNonExistentRowsSelected is true', function () {
            ...
            var setProps = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, __assign({ rowSelectionModel: (0, helperFn_1.includeRowSelection)([0, 1, 2]), checkboxSelection: true, keepNonExistentRowsSelected: true, onRowSelectionModelChange: onRowSelectionModelChange }, data))).setProps;
            expect(getSelectedRowIds()).to.deep.equal([0, 1, 2]);
    ...
    describe('prop: rowSelectionModel and onRowSelectionModelChange', function () {
        it('should select rows when initialised', function () {
            render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { rowSelectionModel: (0, helperFn_1.includeRowSelection)([1]) }));
            expect(getSelectedRowIds()).to.deep.equal([1]);
        });
        it('should not call onRowSelectionModelChange on initialization or on rowSelectionModel prop change', function () {
            var onRowSelectionModelChange = (0, sinon_1.spy)();
            var setProps = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { onRowSelectionModelChange: onRowSelectionModelChange, rowSelectionModel: (0, helperFn_1.includeRowSelection)([0]) })).setProps;
        ...
        it('should call onRowSelectionModelChange with an empty array if no row is selectable in the current page when turning off checkboxSelection', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        onRowSelectionModelChange = (0, sinon_1.spy)();
                        _a = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { checkboxSelection: true, pagination: true, initialState: { pagination: { paginationModel: { pageSize: 2 } } }, pageSizeOptions: [2], onRowSelectionModelChange: onRowSelectionModelChange })), setProps = _a.setProps, user = _a.user;
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(0, 0).querySelector('input'))];
                    case 1:
                        _b.sent();
        ...
        it('should call onRowSelectionModelChange with the correct reason when clicking on a row', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        onRowSelectionModelChange = (0, sinon_1.spy)();
                        user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { checkboxSelection: true, pagination: true, onRowSelectionModelChange: onRowSelectionModelChange })).user;
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(0, 0).querySelector('input'))];
                    case 1:
                        _a.sent();
        ...
        it('should call onRowSelectionModelChange with an empty array if there is no selected row in the current page when turning off checkboxSelection', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        onRowSelectionModelChange = (0, sinon_1.spy)();
                        _a = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { checkboxSelection: true, initialState: { pagination: { paginationModel: { pageSize: 2 } } }, pageSizeOptions: [2], onRowSelectionModelChange: onRowSelectionModelChange })), setProps = _a.setProps, user = _a.user;
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(0, 0).querySelector('input'))];
                    case 1:
                        _b.sent();
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(1, 0).querySelector('input'))];
        ...
        it('should deselect the old selected rows when updating rowSelectionModel', function () {
            var setProps = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { rowSelectionModel: (0, helperFn_1.includeRowSelection)([0]) })).setProps;
            expect(getSelectedRowIds()).to.deep.equal([0]);
            setProps({ rowSelectionModel: (0, helperFn_1.includeRowSelection)([1]) });
            expect(getSelectedRowIds()).to.deep.equal([1]);
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { rowSelectionModel: rowSelectionModel })).user;
                        expect(getSelectedRowIds()).to.deep.equal([1]);
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(0, 0))];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { onRowSelectionModelChange: onModelChange })).user;
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(0, 0))];
                    case 1:
                        _a.sent();
                        expect(getSelectedRowIds()).to.deep.equal([0]);
        ...
        it('should control selection state when the model and the onChange are set', function () { return __awaiter(void 0, void 0, void 0, function () {
            function ControlCase() {
                ...
                return ((0, jsx_runtime_1.jsx)(TestDataGridSelection, { rowSelectionModel: rowSelectionModel, onRowSelectionModelChange: handleSelectionChange, checkboxSelection: true }));
            }
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(ControlCase, {})).user;
                        expect(getSelectedRowIds()).to.deep.equal([]);
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(1, 1))];
                    case 1:
                        _a.sent();
        ...
        it('should throw if rowSelectionModel contains more than 1 row', function () {
            ...
            function ControlCase() {
                ...
                return (0, jsx_runtime_1.jsx)(TestDataGridSelection, { apiRef: apiRef });
            }
            render((0, jsx_runtime_1.jsx)(ControlCase, {}));
        ...
        it('should not throw if rowSelectionModel contains more than 1 item with checkbox selection', function () {
            ...
            function ControlCase() {
                apiRef = (0, x_data_grid_1.useGridApiRef)();
                return (0, jsx_runtime_1.jsx)(TestDataGridSelection, { apiRef: apiRef, checkboxSelection: true });
            }
            render((0, jsx_runtime_1.jsx)(ControlCase, {}));
            expect(function () {
    ...
    describe('prop: rowSelection = false', function () {
        it('should not select rows when clicking the checkbox', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { rowSelection: false, checkboxSelection: true })).user;
                        expect(getSelectedRowIds()).to.deep.equal([]);
                        expect((0, helperFn_1.getRow)(0).querySelector('input')).to.have.property('checked', false);
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(0, 1))];
                    case 1:
        ...
        it('should not select rows with Shift + Space', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { rowSelection: false, disableRowSelectionOnClick: true })).user;
                        cell0 = (0, helperFn_1.getCell)(0, 0);
                        return [4 /*yield*/, user.click(cell0)];
                    case 1:
                        _a.sent();
        ...
        it('should not select rows passed in the rowSelectionModel prop', function () {
            render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { rowSelection: false, rowSelectionModel: (0, helperFn_1.includeRowSelection)([0]) }));
            expect(getSelectedRowIds()).to.deep.equal([]);
        });
    });
    describe('accessibility', function () {
        ...
        it('should not add aria-selected attributes if the row selection is disabled', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { rowSelection: false })).user;
    ...
    describe('prop: disableRowSelectionExcludeModel', function () {
        it('should use include model when disableRowSelectionExcludeModel is true', function () { return __awaiter(void 0, void 0, void 0, function () {
            var onRowSelectionModelChange, user, selectAllCheckbox, selectionModel;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        onRowSelectionModelChange = (0, sinon_1.spy)();
                        user = render((0, jsx_runtime_1.jsx)(TestDataGridSelection, { checkboxSelection: true, disableRowSelectionExcludeModel: true, onRowSelectionModelChange: onRowSelectionModelChange })).user;
                        selectAllCheckbox = internal_test_utils_1.screen.getByRole('checkbox', { name: 'Select all rows' });
                        return [4 /*yield*/, user.click(selectAllCheckbox)];
                    case 1:
                        _a.sent();
                        expect(onRowSelectionModelChange.callCount).to.equal(1);
                        selectionModel = onRowSelectionModelChange.lastCall.args[0];
        ...
        it('should use exclude model by default when conditions are met', function () { return __awaiter(void 0, void 0, void 0, function () {
            var onRowSelectionModelChange, user, selectAllCheckbox, selectionModel;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 0:
                        ...
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: [
                                    { field: 'id', headerName: 'id', type: 'number' },
                                    {
                                        ...
                                        renderCell: function (params) { return (0, jsx_runtime_1.jsx)(CustomCell, __assign({}, params)); },
                                    },
                                ], rows: [
                                    { id: 0, currencyPair: 'USDGBP' },
                                    { id: 1, currencyPair: 'USDEUR' },
                                ], autoHeight: skipIf_1.isJSDOM, checkboxSelection: true }) })).user;
                        expect(getSelectedRowIds()).to.deep.equal([]);
                        expect((0, helperFn_1.getRow)(0).querySelector('input')).to.have.property('checked', false);
                        commits = [];
                        return [4 /*yield*/, user.click((0, helperFn_1.getCell)(0, 1))];
