...
describe('<DataGrid /> - Accessibility', () => {
  ...
  it('should use the `label` prop as the `aria-label` attribute of role="grid"', async () => {
  ...
  it('should only use the `label` prop as the `aria-label` attribute of role="grid" if `aria-label` is not provided', async () => {
  ...
  it('should only use the `label` prop as the `aria-label` attribute of role="grid" if `aria-labelledby` is not provided', async () => {
    render(
