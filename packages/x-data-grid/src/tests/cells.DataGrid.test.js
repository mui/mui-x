...
describe('<DataGrid /> - Cells', function () {
    ...
    describe('cellClassName', function () {
        it('should append the CSS class defined in cellClassName', function () {
            render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 500 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: [{ field: 'brand', cellClassName: 'foobar' }] })) }));
            expect((0, helperFn_1.getCell)(0, 0)).to.have.class('foobar');
        });
        it('should append the CSS class returned by cellClassName', function () {
            render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 500 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: [{ field: 'brand', cellClassName: function () { return 'foobar'; } }] })) }));
            expect((0, helperFn_1.getCell)(0, 0)).to.have.class('foobar');
        });
    });
    ...
    describe.skipIf(skipIf_1.isJSDOM)('prop: showCellVerticalBorder', function () {
        ...
        it('should add right border to cells', function () {
            render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 500 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: [{ field: 'id' }, { field: 'brand' }], showCellVerticalBorder: true })) }));
        ...
        it('should add right border to cells in the last row', function () {
            render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 500 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { autoHeight: true, columns: [{ field: 'id' }, { field: 'brand' }], showCellVerticalBorder: true })) }));
            expectRightBorder((0, helperFn_1.getCell)(2, 0));
        });
    });
    it('should append the CSS class returned by cellClassName', function () {
        render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 500 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: [{ field: 'brand' }], getCellClassName: function () { return 'foobar'; } })) }));
        expect((0, helperFn_1.getCell)(0, 0)).to.have.class('foobar');
    });
    it('should allow renderCell to return a false-ish value', function () {
        render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 500 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { autoHeight: skipIf_1.isJSDOM, columns: [{ field: 'brand', renderCell: function () { return 0; } }], rows: [{ id: 1, brand: 'Nike' }] }) }));
    ...
    it('should render nothing in cell when renderCell returns a `null` value', function () {
        render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 500 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { autoHeight: skipIf_1.isJSDOM, columns: [{ field: 'brand', renderCell: function () { return null; } }], rows: [{ id: 1, brand: 'Nike' }] }) }));
    ...
    it('should call the valueFormatter with the correct params', function () {
        ...
        render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: [
                    {
                        field: 'isActive',
    ...
    it('should throw when focusing cell without updating the state', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 500 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: [{ field: 'brand', cellClassName: 'foobar' }], experimentalFeatures: { warnIfFocusStateIsNotSynced: true } })) }));
            expect(function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: defaultData.columns, rows: defaultData.rows, rowHeight: rowHeight }) })).user;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: columns, rows: rows, rowHeight: rowHeight }) })).user;
                    virtualScroller = document.querySelector('.MuiDataGrid-virtualScroller');
