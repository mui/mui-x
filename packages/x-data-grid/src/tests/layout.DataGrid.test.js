...
import { createRenderer, screen, ErrorBoundary, waitFor, reactMajor, act, } from '@mui/internal-test-utils';
import { stub, spy } from 'sinon';
import { DataGrid, gridClasses, useGridApiRef, } from '@mui/x-data-grid';
import { ptBR } from '@mui/x-data-grid/locales';
import { useBasicDemoData } from '@mui/x-data-grid-generator';
import { createTheme, ThemeProvider } from '@mui/material/styles';
import { $, grid, gridVar, getColumnHeaderCell, getColumnValues, getCell, getRow, sleep, } from 'test/utils/helperFn';
import { isJSDOM, isOSX } from 'test/utils/skipIf';
const getVariable = (name) => $('.MuiDataGrid-root').style.getPropertyValue(name);
describe('<DataGrid /> - Layout & warnings', () => {
    ...
    describe('immutable rows', () => {
        it('should throw an error if rows props is being mutated', () => {
            expect(() => {
                ...
                render(_jsx("div", { style: { width: 300, height: 300 }, children: _jsx(DataGrid, { ...baselineProps, rows: rows }) }));
    ...
    describe.skipIf(isJSDOM)('Layout', () => {
        it('should resize the width of the columns', async () => {
            function TestCase(props) {
                ...
                return (_jsx("div", { style: { width, height: 300 }, children: _jsx(DataGrid, { ...baselineProps }) }));
            }
            const { setProps } = render(_jsx(TestCase, { width: 300 }));
            let rect;
            rect = screen
                .getAllByRole('row')
        ...
        describe('MUI component API', () => {
            it(`attaches the ref`, () => {
                ...
                const { container } = render(_jsx("div", { style: { width: 300, height: 300 }, children: _jsx(DataGrid, { ...baselineProps, ref: ref }) }));
            ...
            describe('`classes` prop', () => {
                it("should apply the `root` rule name's value as a class to the root grid component", () => {
                    ...
                    const { container } = render(_jsx("div", { style: { width: 300, height: 300 }, children: _jsx(DataGrid, { ...baselineProps, classes: { root: classes.root } }) }));
                    expect(container.firstChild?.firstChild).to.have.class(classes.root);
                });
                it('should support class names with underscores', () => {
                    render(_jsx("div", { style: { width: 300, height: 300 }, children: _jsx(DataGrid, { ...baselineProps, classes: { 'columnHeader--sortable': 'foobar' } }) }));
            ...
            it('applies the className to the root component', () => {
                ...
                const { container } = render(_jsx("div", { style: { width: 300, height: 300 }, children: _jsx(DataGrid, { ...baselineProps, className: className }) }));
            ...
            it('should support columns.valueGetter using direct row access', () => {
                ...
                render(_jsx("div", { style: { width: 300, height: 300 }, children: _jsx(DataGrid, { rows: rows, columns: columns }) }));
        ...
        describe('layout warnings', () => {
            it('should error if the container has no intrinsic height', () => {
                expect(() => {
                    render(_jsx("div", { style: { width: 300, height: 0 }, children: _jsx(DataGrid, { ...baselineProps }) }));
            ...
            it('should error if the container has no intrinsic width', () => {
                expect(() => {
                    render(_jsx("div", { style: { width: 0 }, children: _jsx("div", { style: { width: '100%', height: 300 }, children: _jsx(DataGrid, { ...baselineProps }) }) }));
                    // Use timeout to allow simpler tests in JSDOM.
        ...
        describe('swallow warnings', () => {
            ...
            it('should have a stable height if the parent container has no intrinsic height', () => {
                render(_jsxs("div", { children: [_jsx("p", { children: "The table keeps growing... and growing..." }), _jsx(DataGrid, { ...baselineProps })] }));
        ...
        describe('column width', () => {
            it('should set the columns width to 100px by default', () => {
                ...
                render(_jsx("div", { style: { width: 300, height: 300 }, children: _jsx(DataGrid, { columns: columns, rows: rows }) }));
            ...
            it('should set the columns width value to what is provided', () => {
                ...
                render(_jsx("div", { style: { width: 300, height: 300 }, children: _jsx(DataGrid, { columns: columns, rows: rows }) }));
                screen.getAllByRole('columnheader').forEach((col, index) => {
            ...
            it('should set the first column to be twice as wide as the second one', () => {
                ...
                render(_jsx("div", { style: { width: 602, height: 300 }, children: _jsx(DataGrid, { columns: columns, rows: rows }) }));
            ...
            it('should set the first column to its `minWidth` and the second one to the remaining space', () => {
                ...
                render(_jsx("div", { style: { width: 400, height: 300 }, children: _jsx(DataGrid, { columns: columns, rows: rows }) }));
            ...
            it('should respect `minWidth` when a column is fluid', () => {
                ...
                render(_jsx("div", { style: { width: 200, height: 300 }, children: _jsx(DataGrid, { columns: columns, rows: rows }) }));
            ...
            it('should use `minWidth` on flex columns if there is no more space to distribute', () => {
                ...
                render(_jsx("div", { style: { width: 100, height: 200 }, children: _jsx(DataGrid, { columns: columns, rows: rows }) }));
            ...
            it('should ignore `minWidth` on flex columns when computed width is greater', () => {
                ...
                render(_jsx("div", { style: { width: 852, height: 200 }, children: _jsx(DataGrid, { columns: columns, rows: rows }) }));
            ...
            it('should split the columns equally if they are all flex', () => {
                ...
                render(_jsx("div", { style: { width: containerWidth + 2, height: 300 }, children: _jsx(DataGrid, { columns: columns, rows: rows }) }));
            ...
            it('should handle hidden columns', () => {
                ...
                render(_jsx("div", { style: { width: 200, height: 300 }, children: _jsx(DataGrid, { rows: rows, columns: columns, initialState: { columns: { columnVisibilityModel: { firstName: false } } } }) }));
                const firstColumn = getColumnHeaderCell(0);
                expect(firstColumn).toHaveInlineStyle({
            ...
            it('should resize flex: 1 column when changing columnVisibilityModel to avoid exceeding grid width', () => {
                function TestCase(props) {
                    return (_jsx("div", { style: { width: 300, height: 500 }, children: _jsx(DataGrid, { ...props }) }));
                }
                const { setProps } = render(_jsx(TestCase, { rows: [
                        {
                            id: 1,
                            first: 'Mike',
                            age: 11,
            ...
            it('should be rerender invariant', () => {
                function Test() {
                    ...
                    return (_jsx("div", { style: { width: 200, height: 300 }, children: _jsx(DataGrid, { rows: [], columns: columns }) }));
                }
            ...
            it('should set the columns width so that if fills the remaining width when "checkboxSelection" is used and the columns have "flex" set', () => {
                ...
                render(_jsx("div", { style: { width: totalWidth, height: 300 }, children: _jsx(DataGrid, { columns: columns, rows: rows, checkboxSelection: true }) }));
                expect(Array.from(document.querySelectorAll('[role="columnheader"]')).reduce((width, item) => width + item.clientWidth, 0)).to.equal(totalWidth - 2);
            });
        });
        describe('autoHeight', () => {
            it('should have the correct intrinsic height', () => {
                ...
                const rowHeight = 30;
                render(_jsx("div", { style: { width: 300 }, children: _jsx(DataGrid, { ...baselineProps, columnHeaderHeight: columnHeaderHeight, rowHeight: rowHeight, autoHeight: true }) }));
                ...
                expect($('.MuiDataGrid-virtualScroller').clientHeight).to.equal(columnHeaderHeight + rowsHeight);
            });
            it('should have the correct intrinsic height inside of a flex container', () => {
                const columnHeaderHeight = 40;
                const rowHeight = 30;
                render(_jsx("div", { style: { display: 'flex' }, children: _jsx(DataGrid, { ...baselineProps, columnHeaderHeight: columnHeaderHeight, rowHeight: rowHeight, autoHeight: true }) }));
                const rowsHeight = rowHeight * baselineProps.rows.length;
                expect($('.MuiDataGrid-main').clientHeight).to.equal(columnHeaderHeight + rowsHeight);
                expect($('.MuiDataGrid-virtualScroller').clientHeight).to.equal(columnHeaderHeight + rowsHeight);
            });
            // On MacOS the scrollbar has zero width
            it.skipIf(isOSX)('should include the scrollbar in the intrinsic height when there are more columns to show', () => {
                const columnHeaderHeight = 40;
                const rowHeight = 30;
                let apiRef;
                function Test() {
                    apiRef = useGridApiRef();
                    return (_jsx("div", { style: { width: 150 }, children: _jsx(DataGrid, { ...baselineProps, apiRef: apiRef, columnHeaderHeight: columnHeaderHeight, rowHeight: rowHeight, columns: [{ field: 'brand' }, { field: 'year' }], autoHeight: true }) }));
                }
                render(_jsx(Test, {}));
                const scrollbarSize = apiRef.current?.state.dimensions.scrollbarSize || 0;
                expect(scrollbarSize).not.to.equal(0);
                expect(grid('main').clientHeight).to.equal(scrollbarSize + columnHeaderHeight + rowHeight * baselineProps.rows.length);
            });
            it('should give some space to the noRows overlay', () => {
                const rowHeight = 30;
                render(_jsx("div", { style: { width: 300 }, children: _jsx(DataGrid, { ...baselineProps, rows: [], rowHeight: rowHeight, autoHeight: true }) }));
                expect($('.MuiDataGrid-overlay').clientHeight).to.equal(rowHeight * 2);
            });
            it('should allow to override the noRows overlay height', () => {
                render(_jsx("div", { style: { width: 300 }, children: _jsx(DataGrid, { ...baselineProps, rows: [], autoHeight: true, sx: { '--DataGrid-overlayHeight': '300px' } }) }));
            ...
            it('should render loading overlay the same height as the content', () => {
                const rowHeight = 30;
                render(_jsx("div", { style: { width: 300 }, children: _jsx(DataGrid, { ...baselineProps, rowHeight: rowHeight, autoHeight: true, loading: true }) }));
                expect($('.MuiDataGrid-overlay').clientHeight).to.equal(rowHeight * baselineProps.rows.length);
            });
            it('should apply the autoHeight class to the root element', () => {
                render(_jsx("div", { style: { width: 300 }, children: _jsx(DataGrid, { ...baselineProps, autoHeight: true }) }));
        ...
        it('should not have a horizontal scrollbar if not needed', () => {
            function TestCase() {
                ...
                return (_jsx("div", { style: { width: 500, height: 300 }, children: _jsx(DataGrid, { ...data }) }));
            }
        ...
        // On MacOS the scrollbar has zero width
        it.skipIf(isOSX)('should have a horizontal scrollbar when there are more columns to show and no rows', () => {
            render(_jsx("div", { style: { width: 150, height: 300 }, children: _jsx(DataGrid, { columns: [{ field: 'brand' }, { field: 'year' }], rows: [] }) }));
        ...
        it('should not place the overlay on top of the horizontal scrollbar when rows=[]', () => {
            ...
            function Test() {
                apiRef = useGridApiRef();
                return (_jsx("div", { style: { width: 100 + 2 * border, height: height + 2 * border }, children: _jsx(DataGrid, { apiRef: apiRef, rows: [], columns: [{ field: 'brand' }, { field: 'price' }], columnHeaderHeight: columnHeaderHeight, hideFooter: true }) }));
            }
            render(_jsx(Test, {}));
            const scrollbarSize = apiRef.current?.state.dimensions.scrollbarSize || 0;
        ...
        it('should respect the maxHeight of the flex parent', () => {
            render(_jsx("div", { style: {
                    ...
                    maxHeight: 200,
                }, children: _jsx(DataGrid, { columns: [{ field: 'id' }], rows: [{ id: 1 }, { id: 2 }, { id: 3 }, { id: 4 }, { id: 5 }, { id: 6 }] }) }));
        ...
        it('should respect the minHeight of the flex parent', () => {
            render(_jsx("div", { style: {
                    ...
                    flexDirection: 'column',
                    minHeight: 600,
                }, children: _jsx(DataGrid, { columns: [{ field: 'id' }], rows: [{ id: 1 }] }) }));
        ...
        it('should update the height on rows count change', async () => {
            ...
            function Test() {
                ...
                const rows = React.useMemo(() => Array.from({ length: rowCount }, (_, id) => ({ id })), [rowCount]);
                return (_jsxs("div", { children: [_jsx("button", { onClick: () => setRowCount((prev) => prev + 1), children: "Add row" }), _jsx("button", { onClick: () => setRowCount((prev) => prev - 1), children: "Delete row" }), _jsx("div", { style: {
                                display: 'flex',
                                flexDirection: 'column',
                                maxHeight: 250,
                            }, children: _jsx(DataGrid, { columns: [{ field: 'id' }], rows: rows, hideFooter: true, rowHeight: rowHeight, columnHeaderHeight: columnHeaderHeight }) })] }));
            }
            ...
            await user.click(screen.getByText('Add row'));
            expect(grid('root').offsetHeight).to.equal(columnHeaderHeight + 3 * rowHeight + 2 * borderWidth);
            await user.click(screen.getByText('Add row'));
            ...
            await user.click(screen.getByText('Delete row'));
            await user.click(screen.getByText('Delete row'));
            expect(grid('root').offsetHeight).to.equal(columnHeaderHeight + 1 * rowHeight + 2 * borderWidth);
        });
    });
    describe('warnings', () => {
        ...
        it.todo('should raise a warning if trying to use an enterprise feature', () => {
            expect(() => {
                render(_jsx("div", { style: { width: 150, height: 300 }, children: _jsx(DataGrid, { pagination: false, columns: [], rows: [] }) }));
        ...
        it('should throw if the rows has no id', () => {
            ...
            expect(() => {
                render(_jsx(ErrorBoundary, { ref: errorRef, children: _jsx(DataGrid, { ...baselineProps, rows: rows }) }));
            }).toErrorDev([
                reactMajor >= 19 &&
    ...
    describe('localeText', () => {
        it('should support translations in the theme', () => {
            render(_jsx(ThemeProvider, { theme: createTheme({}, ptBR), children: _jsx("div", { style: { width: 300, height: 300 }, children: _jsx(DataGrid, { ...baselineProps }) }) }));
            expect(document.querySelector('[aria-label="Ordenar"]')).not.to.equal(null);
        });
        it('should allow to change localeText on the fly', () => {
            function TestCase(props) {
                return (_jsx("div", { style: { width: 300, height: 300 }, children: _jsx(DataGrid, { ...baselineProps, showToolbar: true, ...props }) }));
            }
            const { setProps } = render(_jsx(TestCase, { localeText: { toolbarQuickFilterPlaceholder: 'Recherche' } }));
    ...
    describe('non-strict mode', () => {
        ...
        it('should render in JSDOM', () => {
            innerRender(_jsx("div", { style: { width: 300, height: 300 }, children: _jsx(DataGrid, { ...baselineProps }) }));
    ...
    it.skipIf(isJSDOM)('should allow style customization using the theme', () => {
        ...
        render(_jsx(ThemeProvider, { theme: theme, children: _jsx("div", { style: { width: 300, height: 300 }, children: _jsx(DataGrid, { ...baselineProps }) }) }));
        expect(window.getComputedStyle(grid('root')).backgroundColor).to.equal('rgb(255, 0, 0)');
        expect(window.getComputedStyle(getColumnHeaderCell(0)).backgroundColor).to.equal('rgb(255, 255, 0)');
    ...
    it.skipIf(isJSDOM)('should support the sx prop', () => {
        ...
        render(_jsx(ThemeProvider, { theme: theme, children: _jsx("div", { style: { width: 300, height: 300 }, children: _jsx(DataGrid, { columns: [], rows: [], sx: { color: 'primary.main' } }) }) }));
        expect(grid('root')).toHaveComputedStyle({
            color: 'rgb(0, 0, 255)',
        });
    });
    it('should have ownerState in the theme style overrides', () => {
        expect(() => render(_jsx(ThemeProvider, { theme: createTheme({
                components: {
                    MuiDataGrid: {
                        styleOverrides: {
                            root: ({ ownerState }) => ({
            ...
            }), children: _jsx("div", { style: { width: 300, height: 300 }, children: _jsx(DataGrid, { ...baselineProps }) }) }))).not.to.throw();
    });
    it('should not render the "no rows" overlay when transitioning the loading prop from false to true', () => {
        ...
        function TestCase(props) {
            return (_jsx("div", { style: { width: 300, height: 500 }, children: _jsx(DataGrid, { ...baselineProps, slots: { noRowsOverlay: NoRowsOverlay }, ...props }) }));
        }
        const { setProps } = render(_jsx(TestCase, { rows: [], loading: true }));
    ...
    it('should render the "no rows" overlay when changing the loading to false but not changing the rows prop', () => {
        ...
        const rows = [];
        const { setProps } = render(_jsx(TestCase, { rows: rows, loading: true }));
        expect(NoRowsOverlay.callCount).to.equal(0);
    ...
    describe.skipIf(isJSDOM)('should not overflow parent', () => {
        ...
        it('grid container', () => {
            render(_jsx("div", { style: { maxWidth: 400 }, children: _jsx("div", { style: { display: 'grid' }, children: _jsx(DataGrid, { autoHeight: true, columns: columns, rows: rows }) }) }));
            expect(grid('root')).toHaveComputedStyle({ width: '400px' });
        });
        it('flex container', () => {
            render(_jsx("div", { style: { maxWidth: 400 }, children: _jsx("div", { style: { display: 'flex' }, children: _jsx(DataGrid, { autoHeight: true, columns: columns, rows: rows }) }) }));
            expect(grid('root')).toHaveComputedStyle({ width: '400px' });
        });
    });
    // See https://github.com/mui/mui-x/issues/8737
    // Need layout
    it.skipIf(isJSDOM)('should not add horizontal scrollbar when .MuiDataGrid-main has border', async () => {
        render(_jsx("div", { style: { height: 300, width: 400, display: 'flex' }, children: _jsx(DataGrid, { rows: [{ id: 1 }], columns: [{ field: 'id', flex: 1 }], sx: { '.MuiDataGrid-main': { border: '2px solid red' } } }) }));
    ...
    // Need layout
    it.skipIf(isJSDOM)('should not add scrollbars when the parent container has fractional size', async () => {
        render(_jsx("div", { style: { height: 300.5, width: 400 }, children: _jsx(DataGrid, { rows: [], columns: [{ field: 'id', flex: 1 }] }) }));
        // It should not have a horizontal scrollbar
        expect(getVariable('--DataGrid-hasScrollX')).to.equal('0');
    ...
    // Need layout
    it.skipIf(isJSDOM)('should not exceed maximum call stack size when the parent container has fractional width', () => {
        render(_jsx("div", { style: { height: 300, width: 400.6 }, children: _jsx(DataGrid, { rows: [{ id: 1 }], columns: [{ field: 'id', flex: 1 }] }) }));
    });
    // See https://github.com/mui/mui-x/issues/9550
    // Need layout
    it.skipIf(isJSDOM)('should not exceed maximum call stack size with duplicated flex fields', () => {
        expect(() => {
            render(_jsx("div", { style: { height: 200, width: 400 }, children: _jsx(DataGrid, { rows: [{ id: 1 }], columns: [
                        { field: 'id', flex: 1 },
                        { field: 'id', flex: 1 },
                    ] }) }));
        }).toErrorDev([
    ...
    // Need layout
    it.skipIf(isJSDOM)('should not exceed maximum call stack size caused by floating point precision error', () => {
        render(_jsx("div", { style: { height: 300, width: 1584 }, children: _jsx(DataGrid, { rows: [{ id: 1 }], columns: [
                    { field: '1', flex: 1 },
                    { field: '2', flex: 1 },
                    { field: '3', flex: 1 },
                    { field: '4', flex: 1 },
    ...
    // Need layout
    it.skipIf(isJSDOM)('should not exceed maximum call stack size caused by subpixel rendering', () => {
        render(_jsx("div", { style: { width: 702.37 }, children: _jsx(DataGrid, { columns: [
                    { field: '1', flex: 1 },
                    { field: '2', flex: 1 },
                ], rows: [] }) }));
    });
