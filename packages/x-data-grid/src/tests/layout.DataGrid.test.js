...
describe('<DataGrid /> - Layout & warnings', function () {
    ...
    describe('immutable rows', function () {
        it('should throw an error if rows props is being mutated', function () {
            expect(function () {
                ...
                render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { rows: rows })) }));
    ...
    describe.skipIf(skipIf_1.isJSDOM)('Layout', function () {
        it('should resize the width of the columns', function () { return __awaiter(void 0, void 0, void 0, function () {
            function TestCase(props) {
                ...
                return ((0, jsx_runtime_1.jsx)("div", { style: { width: width, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps)) }));
            }
            var setProps, rect;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        setProps = render((0, jsx_runtime_1.jsx)(TestCase, { width: 300 })).setProps;
                        rect = internal_test_utils_1.screen
                            .getAllByRole('row')
                            .find(function (el) { return el.dataset.rowindex === '0'; })
        ...
        describe('MUI component API', function () {
            it("attaches the ref", function () {
                ...
                var container = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { ref: ref })) })).container;
            ...
            describe('`classes` prop', function () {
                it("should apply the `root` rule name's value as a class to the root grid component", function () {
                    ...
                    var container = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { classes: { root: classes.root } })) })).container;
                ...
                it('should support class names with underscores', function () {
                    render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { classes: { 'columnHeader--sortable': 'foobar' } })) }));
            ...
            it('applies the className to the root component', function () {
                ...
                var container = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { className: className })) })).container;
            ...
            it('should support columns.valueGetter using direct row access', function () {
                ...
                render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: rows, columns: columns }) }));
        ...
        describe('layout warnings', function () {
            it('should error if the container has no intrinsic height', function () {
                expect(function () {
                    render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 0 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps)) }));
            ...
            it('should error if the container has no intrinsic width', function () {
                expect(function () {
                    render((0, jsx_runtime_1.jsx)("div", { style: { width: 0 }, children: (0, jsx_runtime_1.jsx)("div", { style: { width: '100%', height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps)) }) }));
                    // Use timeout to allow simpler tests in JSDOM.
        ...
        describe('swallow warnings', function () {
            ...
            it('should have a stable height if the parent container has no intrinsic height', function () {
                var _a, _b;
                render((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("p", { children: "The table keeps growing... and growing..." }), (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps))] }));
        ...
        describe('column width', function () {
            it('should set the columns width to 100px by default', function () {
                ...
                render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: columns, rows: rows }) }));
            ...
            it('should set the first column to be twice as wide as the second one', function () {
                ...
                render((0, jsx_runtime_1.jsx)("div", { style: { width: 602, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: columns, rows: rows }) }));
            ...
            it('should set the first column to its `minWidth` and the second one to the remaining space', function () {
                ...
                render((0, jsx_runtime_1.jsx)("div", { style: { width: 400, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: columns, rows: rows }) }));
            ...
            it('should respect `minWidth` when a column is fluid', function () {
                ...
                render((0, jsx_runtime_1.jsx)("div", { style: { width: 200, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: columns, rows: rows }) }));
            ...
            it('should use `minWidth` on flex columns if there is no more space to distribute', function () {
                ...
                render((0, jsx_runtime_1.jsx)("div", { style: { width: 100, height: 200 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: columns, rows: rows }) }));
            ...
            it('should ignore `minWidth` on flex columns when computed width is greater', function () {
                ...
                (0, jsx_runtime_1.jsx)("div", { style: { width: 852, height: 200 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: columns, rows: rows }) }));
            ...
            it('should split the columns equally if they are all flex', function () {
                ...
                render(
                // 2px border
                (0, jsx_runtime_1.jsx)("div", { style: { width: containerWidth + 2, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: columns, rows: rows }) }));
            ...
            it('should handle hidden columns', function () {
                ...
                render((0, jsx_runtime_1.jsx)("div", { style: { width: 200, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: rows, columns: columns, initialState: { columns: { columnVisibilityModel: { firstName: false } } } }) }));
                var firstColumn = (0, helperFn_1.getColumnHeaderCell)(0);
                expect(firstColumn).toHaveInlineStyle({
            ...
            it('should resize flex: 1 column when changing columnVisibilityModel to avoid exceeding grid width', function () {
                function TestCase(props) {
                    return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 500 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, props)) }));
                }
                var setProps = render((0, jsx_runtime_1.jsx)(TestCase, { rows: [
                        {
                            id: 1,
                            first: 'Mike',
                            age: 11,
            ...
            it('should be rerender invariant', function () {
                function Test() {
                    ...
                    return ((0, jsx_runtime_1.jsx)("div", { style: { width: 200, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: [], columns: columns }) }));
                }
            ...
            it('should set the columns width so that if fills the remaining width when "checkboxSelection" is used and the columns have "flex" set', function () {
                ...
                var totalWidth = 700;
                render((0, jsx_runtime_1.jsx)("div", { style: { width: totalWidth, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: columns, rows: rows, checkboxSelection: true }) }));
        ...
        describe('autoHeight', function () {
            it('should have the correct intrinsic height', function () {
                ...
                var rowHeight = 30;
                render((0, jsx_runtime_1.jsx)("div", { style: { width: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columnHeaderHeight: columnHeaderHeight, rowHeight: rowHeight, autoHeight: true })) }));
            ...
            it('should have the correct intrinsic height inside of a flex container', function () {
                var columnHeaderHeight = 40;
                var rowHeight = 30;
                render((0, jsx_runtime_1.jsx)("div", { style: { display: 'flex' }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columnHeaderHeight: columnHeaderHeight, rowHeight: rowHeight, autoHeight: true })) }));
                var rowsHeight = rowHeight * baselineProps.rows.length;
                expect((0, helperFn_1.$)('.MuiDataGrid-main').clientHeight).to.equal(columnHeaderHeight + rowsHeight);
                expect((0, helperFn_1.$)('.MuiDataGrid-virtualScroller').clientHeight).to.equal(columnHeaderHeight + rowsHeight);
            });
            ...
            it.skipIf(skipIf_1.isOSX)('should include the scrollbar in the intrinsic height when there are more columns to show', function () {
                ...
                function Test() {
                    ...
                    return ((0, jsx_runtime_1.jsx)("div", { style: { width: 150 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { apiRef: apiRef, columnHeaderHeight: columnHeaderHeight, rowHeight: rowHeight, columns: [{ field: 'brand' }, { field: 'year' }], autoHeight: true })) }));
                }
            ...
            it('should give some space to the noRows overlay', function () {
                var rowHeight = 30;
                render((0, jsx_runtime_1.jsx)("div", { style: { width: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { rows: [], rowHeight: rowHeight, autoHeight: true })) }));
            ...
            it('should allow to override the noRows overlay height', function () {
                render((0, jsx_runtime_1.jsx)("div", { style: { width: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { rows: [], autoHeight: true, sx: { '--DataGrid-overlayHeight': '300px' } })) }));
            ...
            it('should render loading overlay the same height as the content', function () {
                var rowHeight = 30;
                render((0, jsx_runtime_1.jsx)("div", { style: { width: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { rowHeight: rowHeight, autoHeight: true, loading: true })) }));
            ...
            it('should apply the autoHeight class to the root element', function () {
                render((0, jsx_runtime_1.jsx)("div", { style: { width: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { autoHeight: true })) }));
        ...
        it('should not have a horizontal scrollbar if not needed', function () {
            function TestCase() {
                ...
                return ((0, jsx_runtime_1.jsx)("div", { style: { width: 500, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, data)) }));
            }
            render((0, jsx_runtime_1.jsx)(TestCase, {}));
        ...
        it.skipIf(skipIf_1.isOSX)('should have a horizontal scrollbar when there are more columns to show and no rows', function () {
            render((0, jsx_runtime_1.jsx)("div", { style: { width: 150, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: [{ field: 'brand' }, { field: 'year' }], rows: [] }) }));
        ...
        it('should not place the overlay on top of the horizontal scrollbar when rows=[]', function () {
            ...
            function Test() {
                apiRef = (0, x_data_grid_1.useGridApiRef)();
                return ((0, jsx_runtime_1.jsx)("div", { style: { width: 100 + 2 * border, height: height + 2 * border }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { apiRef: apiRef, rows: [], columns: [{ field: 'brand' }, { field: 'price' }], columnHeaderHeight: columnHeaderHeight, hideFooter: true }) }));
            }
            render((0, jsx_runtime_1.jsx)(Test, {}));
            var scrollbarSize = ((_a = apiRef.current) === null || _a === void 0 ? void 0 : _a.state.dimensions.scrollbarSize) || 0;
        ...
        it('should respect the maxHeight of the flex parent', function () {
            render((0, jsx_runtime_1.jsx)("div", { style: {
                    ...
                    maxHeight: 200,
                }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: [{ field: 'id' }], rows: [{ id: 1 }, { id: 2 }, { id: 3 }, { id: 4 }, { id: 5 }, { id: 6 }] }) }));
        ...
        it('should respect the minHeight of the flex parent', function () {
            render((0, jsx_runtime_1.jsx)("div", { style: {
                    ...
                    flexDirection: 'column',
                    minHeight: 600,
                }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: [{ field: 'id' }], rows: [{ id: 1 }] }) }));
        ...
        it('should update the height on rows count change', function () { return __awaiter(void 0, void 0, void 0, function () {
            function Test() {
                ...
                return ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("button", { onClick: function () { return setRowCount(function (prev) { return prev + 1; }); }, children: "Add row" }), (0, jsx_runtime_1.jsx)("button", { onClick: function () { return setRowCount(function (prev) { return prev - 1; }); }, children: "Delete row" }), (0, jsx_runtime_1.jsx)("div", { style: {
                                display: 'flex',
                                flexDirection: 'column',
                                maxHeight: 250,
                            }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: [{ field: 'id' }], rows: rows, hideFooter: true, rowHeight: rowHeight, columnHeaderHeight: columnHeaderHeight }) })] }));
            }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        borderWidth = 1;
                        user = render((0, jsx_runtime_1.jsx)(Test, {})).user;
    ...
    describe('warnings', function () {
        ...
        it.skip('should raise a warning if trying to use an enterprise feature', function () {
            expect(function () {
                render((0, jsx_runtime_1.jsx)("div", { style: { width: 150, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { pagination: false, columns: [], rows: [] }) }));
        ...
        it.skipIf(!skipIf_1.isJSDOM)('should throw if the rows has no id', function () {
            ...
            expect(function () {
                render((0, jsx_runtime_1.jsx)(internal_test_utils_1.ErrorBoundary, { ref: errorRef, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { rows: rows })) }));
            }).toErrorDev([
    ...
    describe('localeText', function () {
        it('should support translations in the theme', function () {
            render((0, jsx_runtime_1.jsx)(styles_1.ThemeProvider, { theme: (0, styles_1.createTheme)({}, locales_1.ptBR), children: (0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps)) }) }));
            expect(document.querySelector('[title="Ordenar"]')).not.to.equal(null);
        });
        it('should allow to change localeText on the fly', function () {
            function TestCase(props) {
                return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { showToolbar: true }, props)) }));
            }
            var setProps = render((0, jsx_runtime_1.jsx)(TestCase, { localeText: { toolbarQuickFilterPlaceholder: 'Recherche' } })).setProps;
    ...
    describe('non-strict mode', function () {
        ...
        it.skipIf(!skipIf_1.isJSDOM)('should render in JSDOM', function () {
            innerRender((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps)) }));
    ...
    it.skipIf(skipIf_1.isJSDOM)('should allow style customization using the theme', function () {
        ...
        render((0, jsx_runtime_1.jsx)(styles_1.ThemeProvider, { theme: theme, children: (0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps)) }) }));
    ...
    it.skipIf(skipIf_1.isJSDOM)('should support the sx prop', function () {
        ...
        render((0, jsx_runtime_1.jsx)(styles_1.ThemeProvider, { theme: theme, children: (0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: [], rows: [], sx: { color: 'primary.main' } }) }) }));
    ...
    it('should have ownerState in the theme style overrides', function () {
        expect(function () {
            return render((0, jsx_runtime_1.jsx)(styles_1.ThemeProvider, { theme: (0, styles_1.createTheme)({
                    components: {
                        MuiDataGrid: {
                            styleOverrides: {
                                root: function (_a) {
                ...
                }), children: (0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps)) }) }));
        }).not.to.throw();
    });
    it('should not render the "no rows" overlay when transitioning the loading prop from false to true', function () {
        ...
        function TestCase(props) {
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 500 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { slots: { noRowsOverlay: NoRowsOverlay } }, props)) }));
        }
        var setProps = render((0, jsx_runtime_1.jsx)(TestCase, { rows: [], loading: true })).setProps;
    ...
    it('should render the "no rows" overlay when changing the loading to false but not changing the rows prop', function () {
        ...
        var rows = [];
        var setProps = render((0, jsx_runtime_1.jsx)(TestCase, { rows: rows, loading: true })).setProps;
        expect(NoRowsOverlay.callCount).to.equal(0);
    ...
    describe.skipIf(skipIf_1.isJSDOM)('should not overflow parent', function () {
        ...
        it('grid container', function () {
            render((0, jsx_runtime_1.jsx)("div", { style: { maxWidth: 400 }, children: (0, jsx_runtime_1.jsx)("div", { style: { display: 'grid' }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { autoHeight: true, columns: columns, rows: rows }) }) }));
            expect((0, helperFn_1.grid)('root')).toHaveComputedStyle({ width: '400px' });
        });
        it('flex container', function () {
            render((0, jsx_runtime_1.jsx)("div", { style: { maxWidth: 400 }, children: (0, jsx_runtime_1.jsx)("div", { style: { display: 'flex' }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { autoHeight: true, columns: columns, rows: rows }) }) }));
            expect((0, helperFn_1.grid)('root')).toHaveComputedStyle({ width: '400px' });
        });
    });
    ...
    it.skipIf(skipIf_1.isJSDOM)('should not add horizontal scrollbar when .MuiDataGrid-main has border', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    render((0, jsx_runtime_1.jsx)("div", { style: { height: 300, width: 400, display: 'flex' }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: [{ id: 1 }], columns: [{ field: 'id', flex: 1 }], sx: { '.MuiDataGrid-main': { border: '2px solid red' } } }) }));
    ...
    it.skipIf(skipIf_1.isJSDOM)('should not add scrollbars when the parent container has fractional size', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            render((0, jsx_runtime_1.jsx)("div", { style: { height: 300.5, width: 400 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: [], columns: [{ field: 'id', flex: 1 }] }) }));
            // It should not have a horizontal scrollbar
            expect(getVariable('--DataGrid-hasScrollX')).to.equal('0');
    ...
    it.skipIf(skipIf_1.isJSDOM)('should not exceed maximum call stack size when the parent container has fractional width', function () {
        render((0, jsx_runtime_1.jsx)("div", { style: { height: 300, width: 400.6 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: [{ id: 1 }], columns: [{ field: 'id', flex: 1 }] }) }));
    });
    ...
    it.skipIf(skipIf_1.isJSDOM)('should not exceed maximum call stack size with duplicated flex fields', function () {
        expect(function () {
            render((0, jsx_runtime_1.jsx)("div", { style: { height: 200, width: 400 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: [{ id: 1 }], columns: [
                        { field: 'id', flex: 1 },
                        { field: 'id', flex: 1 },
                    ] }) }));
        }).toErrorDev([
    ...
    it.skipIf(skipIf_1.isJSDOM)('should not exceed maximum call stack size caused by floating point precision error', function () {
        render((0, jsx_runtime_1.jsx)("div", { style: { height: 300, width: 1584 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: [{ id: 1 }], columns: [
                    { field: '1', flex: 1 },
                    { field: '2', flex: 1 },
                    { field: '3', flex: 1 },
                    { field: '4', flex: 1 },
    ...
    it.skipIf(skipIf_1.isJSDOM)('should not exceed maximum call stack size caused by subpixel rendering', function () {
        render((0, jsx_runtime_1.jsx)("div", { style: { width: 702.37 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: [
                    { field: '1', flex: 1 },
                    { field: '2', flex: 1 },
                ], rows: [] }) }));
    });
