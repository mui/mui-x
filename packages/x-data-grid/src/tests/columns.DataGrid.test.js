...
describe('<DataGrid /> - Columns', function () {
    ...
    function TestDataGrid(props) {
        return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ columns: columns, rows: rows }, props, { autoHeight: skipIf_1.isJSDOM })) }));
    }
    describe('prop: initialState.columns.orderedFields / initialState.columns.dimensions', function () {
        ...
        it('should not add a column when present in the initial state but not in the props', function () {
            render((0, jsx_runtime_1.jsx)(TestDataGrid, { initialState: { columns: { orderedFields: ['idTres'] } } }));
        ...
        it('should move the columns not present in the initial state after the one present in it', function () {
            render((0, jsx_runtime_1.jsx)(TestDataGrid, { initialState: { columns: { orderedFields: ['idBis'] } } }));
            expect((0, helperFn_1.getColumnHeadersTextContent)()).to.deep.equal(['idBis', 'id']);
        });
        it('should allow to remove the sizing properties by setting them to `undefined`', function () {
            render((0, jsx_runtime_1.jsx)(TestDataGrid, { columns: [{ field: 'id', flex: 1 }], initialState: { columns: { dimensions: { id: { flex: undefined } } } } }));
    ...
    it('should allow to change the column type', function () {
        var setProps = render((0, jsx_runtime_1.jsx)(TestDataGrid, { columns: [{ field: 'id', type: 'string' }, { field: 'idBis' }] })).setProps;
    ...
    it('should not persist valueFormatter on column type change', function () {
        var setProps = render((0, jsx_runtime_1.jsx)(TestDataGrid, { columns: [{ field: 'price', type: 'number', valueFormatter: function (value) { return "$".concat(value); } }], rows: [{ id: 0, price: 1 }] })).setProps;
    ...
    it('should not override column properties when changing column type', function () {
        var setProps = render((0, jsx_runtime_1.jsx)(TestDataGrid, { columns: [
                {
                    field: 'id',
                    type: 'string',
                    width: 200,
    ...
    it.skipIf(skipIf_1.isJSDOM)('should not crash when updating columns immediately after scrolling', function () { return __awaiter(void 0, void 0, void 0, function () {
        function DynamicVirtualizationRange() {
            ...
            return ((0, jsx_runtime_1.jsxs)("div", { style: { width: '100%' }, children: [(0, jsx_runtime_1.jsx)("button", { onClick: function () { return setCols([{ field: 'id' }]); }, children: "Update columns" }), (0, jsx_runtime_1.jsx)("div", { style: { height: 400 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: data, columns: cols }) })] }));
        }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    user = render((0, jsx_runtime_1.jsx)(DynamicVirtualizationRange, {})).user;
    ...
    it('should revert to the default column properties if not specified otherwise', function () { return __awaiter(void 0, void 0, void 0, function () {
        function Component(props) {
            return ((0, jsx_runtime_1.jsx)("div", { style: { height: 560, width: '100%' }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ apiRef: apiRef, rows: [{ id: 1, status: 'pending' }] }, props)) }));
        }
        ...
        return __generator(this, function (_a) {
            ...
            apiRef = { current: null };
            setProps = render((0, jsx_runtime_1.jsx)(Component, { columns: columns1 })).setProps;
