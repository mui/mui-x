...
describe('<DataGrid /> - Rows', function () {
    ...
    describe('prop: getRowId', function () {
        it('should allow to select a field as id', function () {
            ...
            render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { getRowId: getRowId })) }));
    ...
    describe('prop: rows', function () {
        it('should support new dataset', function () {
            ...
            function Test(props) {
                return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, props, { columns: columns, disableVirtualization: true })) }));
            }
            var setProps = render((0, jsx_runtime_1.jsx)(Test, { rows: rows.slice(0, 2) })).setProps;
    ...
    it('should ignore events coming from a portal in the cell', function () { return __awaiter(void 0, void 0, void 0, function () {
        function InputCell() {
            return (0, jsx_runtime_1.jsx)("input", { type: "text", name: "input" });
        }
        function PortalCell() {
            return ((0, jsx_runtime_1.jsx)(Portal_1.default, { children: (0, jsx_runtime_1.jsx)("input", { type: "text", name: "portal-input" }) }));
        }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: [{ id: '1' }], onRowClick: handleRowClick, columns: [
                                {
                                    field: 'id',
                                    renderCell: function () { return (0, jsx_runtime_1.jsx)(PortalCell, {}); },
                                },
                                {
                                    field: 'input',
                                    renderCell: function () { return (0, jsx_runtime_1.jsx)(InputCell, {}); },
                                },
                            ] }) })).user;
    ...
    it('should not throw when clicking the cell in the nested grid in a portal', function () {
        ...
        function NestedGridDialog() {
            return ((0, jsx_runtime_1.jsx)(Dialog_1.default, { open: true, children: (0, jsx_runtime_1.jsx)("div", { style: { height: 300, width: '100%' }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: rows, columns: [{ field: 'id' }, { field: 'age' }] }) }) }));
        }
        expect(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: [
                                    { field: 'id' },
                                    { field: 'firstName', renderCell: function () { return (0, jsx_runtime_1.jsx)(NestedGridDialog, {}); } },
                                ], rows: rows }) })).user;
    ...
    describe('prop: getRowClassName', function () {
        it('should apply the CSS class returned by getRowClassName', function () {
            ...
            render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ getRowClassName: handleRowClassName, getRowId: getRowId }, baselineProps)) }));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { rows: rows, columns: columns, getRowClassName: getRowClassName, initialState: { pagination: { paginationModel: { pageSize: 3, page: 0 } } }, pageSizeOptions: [3] }) })).user;
    ...
    describe('columnType: actions', function () {
        function TestCase(_a) {
            ...
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { rows: [{ id: 1 }], columns: [
                        {
                            field: 'id',
                        },
                        {
        ...
        it.skipIf(!skipIf_1.isJSDOM)('should throw an error if getActions is missing', function () {
            expect(function () {
                render((0, jsx_runtime_1.jsx)(internal_test_utils_1.ErrorBoundary, { children: (0, jsx_runtime_1.jsx)(TestCase, {}) }));
            }).toErrorDev([
        ...
        it('should call getActions with the row params', function () {
            ...
            render((0, jsx_runtime_1.jsx)(TestCase, { getActions: getActions }));
        ...
        it('should always show the actions not marked as showInMenu', function () {
            render((0, jsx_runtime_1.jsx)(TestCase, { getActions: function () { return [
                    (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { icon: (0, jsx_runtime_1.jsx)("span", {}), label: "delete" }),
                    (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { label: "print", showInMenu: true }),
                ]; } }));
        ...
        it('should show in a menu the actions marked as showInMenu', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestCase, { getActions: function () { return [(0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { label: "print", showInMenu: true })]; } })).user;
                        expect(internal_test_utils_1.screen.queryByText('print')).to.equal(null);
        ...
        it('should not select the row when clicking in an action', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestCase, { getActions: function () { return [(0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { icon: (0, jsx_runtime_1.jsx)("span", {}), label: "print" })]; } })).user;
        ...
        it('should not select the row when clicking in a menu action', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestCase, { getActions: function () { return [(0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { icon: (0, jsx_runtime_1.jsx)("span", {}), label: "print", showInMenu: true })]; } })).user;
                        expect((0, helperFn_1.getRow)(0)).not.to.have.class('Mui-selected');
                        return [4 /*yield*/, user.click(internal_test_utils_1.screen.getByRole('menuitem', { name: 'more' }))];
                    case 1:
                        _a.sent();
        ...
        it('should close other menus before opening a new one', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestCase, { rows: [{ id: 1 }, { id: 2 }], getActions: function () { return [(0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { label: "print", showInMenu: true })]; } })).user;
        ...
        it('should focus the first item when opening the menu', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestCase, { getActions: function () { return [
                                (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { icon: (0, jsx_runtime_1.jsx)("span", {}), label: "print", showInMenu: true }),
                                (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { icon: (0, jsx_runtime_1.jsx)("span", {}), label: "delete", showInMenu: true }),
                            ]; } })).user;
        ...
        it('should allow to navigate between actions using the arrow keys', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render((0, jsx_runtime_1.jsx)(TestCase, { getActions: function () { return [
                                (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { icon: (0, jsx_runtime_1.jsx)("span", {}), label: "print" }),
                                (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { icon: (0, jsx_runtime_1.jsx)("span", {}), label: "delete" }),
                            ]; } })).user;
        ...
        it('should focus the last button if the clicked button removes itself', function () { return __awaiter(void 0, void 0, void 0, function () {
            function Test() {
                return ((0, jsx_runtime_1.jsx)(TestCase, { getActions: function () {
                        return canDelete
                            ? [
                                (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { icon: (0, jsx_runtime_1.jsx)("span", {}), label: "print" }),
                                (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { icon: (0, jsx_runtime_1.jsx)("span", {}), label: "delete", onClick: function () {
                                        canDelete = false;
                                    } }),
                            ]
                            : [(0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { icon: (0, jsx_runtime_1.jsx)("span", {}), label: "print" })];
        ...
        it('should focus the last button if the currently focused button is removed', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = render((0, jsx_runtime_1.jsx)(TestCase, { getActions: function () { return [
                                (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { icon: (0, jsx_runtime_1.jsx)("span", {}), label: "print" }),
                                (0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { icon: (0, jsx_runtime_1.jsx)("span", {}), label: "delete" }),
                    ...
                    case 1:
                        ...
                        setProps({ getActions: function () { return [(0, jsx_runtime_1.jsx)(x_data_grid_1.GridActionsCellItem, { icon: (0, jsx_runtime_1.jsx)("span", {}), label: "print" })]; } }); // Sets focusedButtonIndex=0
                        expect(internal_test_utils_1.screen.getByRole('menuitem', { name: 'print' })).toHaveFocus();
                        return [2 /*return*/];
                }
            });
    ...
    describe.skipIf(skipIf_1.isJSDOM)('prop: getRowHeight', function () {
        describe('static row height', function () {
            ...
            function TestCase(props) {
                ...
                return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ apiRef: apiRef }, baselineProps, props, { getRowId: getRowId })) }));
            }
            it('should set each row height whe rowHeight prop is used', function () {
                var setProps = render((0, jsx_runtime_1.jsx)(TestCase, {})).setProps;
            ...
            it('should set the second row to have a different row height than the others', function () {
                render((0, jsx_runtime_1.jsx)(TestCase, { getRowHeight: function (_a) {
                        var id = _a.id;
            ...
            it('should set density to all but the row with variable row height', function () {
                var setProps = render((0, jsx_runtime_1.jsx)(TestCase, { getRowHeight: function (_a) {
                        var id = _a.id;
                        return (id === 'c2' ? 100 : null);
                    } })).setProps;
                expect((0, helperFn_1.getRow)(0).clientHeight).to.equal(ROW_HEIGHT);
        ...
        describe('dynamic row height', function () {
            ...
            function TestCase(props) {
                ...
                var customCellRenderer = React.useCallback(function (_a) {
                    var row = _a.row;
                    return ((0, jsx_runtime_1.jsx)("div", { style: { width: 100, height: getBioContentHeight(row) } }));
                }, [getBioContentHeight]);
                var columns = React.useMemo(function () { return [{ field: 'clientId' }, { field: 'bio', renderCell: customCellRenderer }]; }, [customCellRenderer]);
                return ((0, jsx_runtime_1.jsx)("div", { style: { width: width, height: height }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({}, baselineProps, { columns: columns, getRowId: function (row) { return "".concat(row.clientId); }, hideFooter: true }, other)) }));
            }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            border = 1;
                            contentHeight = 100;
                            render((0, jsx_runtime_1.jsx)(TestCase, { getBioContentHeight: function () { return contentHeight; }, getRowHeight: function () { return 'auto'; } }));
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            render((0, jsx_runtime_1.jsx)(TestCase, { columnHeaderHeight: columnHeaderHeight, height: columnHeaderHeight + 20 + border * 2, getBioContentHeight: function () { return measuredRowHeight; }, getRowHeight: function () { return 'auto'; }, rowBufferPx: 0 }));
                            virtualScrollerContent = document.querySelector('.MuiDataGrid-virtualScrollerContent');
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            render((0, jsx_runtime_1.jsx)(TestCase, { columnHeaderHeight: columnHeaderHeight, height: columnHeaderHeight + 20 + border * 2, getBioContentHeight: function () { return measuredRowHeight; }, getEstimatedRowHeight: function () { return estimatedRowHeight; }, getRowHeight: function () { return 'auto'; }, rowBufferPx: 0 }));
                            virtualScrollerContent = document.querySelector('.MuiDataGrid-virtualScrollerContent');
            ...
            it('should recalculate the content size when the rows prop changes', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            setProps = render((0, jsx_runtime_1.jsx)(TestCase, { getBioContentHeight: function (row) { return (row.expanded ? 200 : 100); }, rows: [{ clientId: 'c1', expanded: false }], getRowHeight: function () { return 'auto'; }, rowBufferPx: 0 })).setProps;
                            virtualScrollerContent = document.querySelector('.MuiDataGrid-virtualScrollerContent');
                            return [4 /*yield*/, (0, internal_test_utils_1.waitFor)(function () {
            ...
            it('should set minHeight to "auto" in all rows with dynamic row height', function () {
                render((0, jsx_runtime_1.jsx)(TestCase, { getBioContentHeight: function () { return 50; }, getRowHeight: function (_a) {
                        var id = _a.id;
            ...
            it('should not virtualize columns if a row has auto height', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            render((0, jsx_runtime_1.jsx)(TestCase, { rows: baselineProps.rows.slice(0, 1), getBioContentHeight: function () { return 100; }, getRowHeight: function () { return 'auto'; }, columnBufferPx: 0, width: 100 }));
                            return [4 /*yield*/, (0, internal_test_utils_1.waitFor)(function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            render((0, jsx_runtime_1.jsx)(TestCase, { getBioContentHeight: function () { return 100; }, getRowHeight: function () { return 'auto'; }, rowBufferPx: 0, columnHeaderHeight: columnHeaderHeight, height: cellHeight * 2 }));
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            render((0, jsx_runtime_1.jsx)(TestCase, { getBioContentHeight: function (_a) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            columnHeaderHeight = 50;
                            measuredRowHeight = 100;
                            user = render((0, jsx_runtime_1.jsx)(TestCase, __assign({ getBioContentHeight: function () { return measuredRowHeight; }, getRowHeight: function () { return 'auto'; }, rowBufferPx: 0, columnHeaderHeight: columnHeaderHeight, getRowId: function (row) { return row.id; }, hideFooter: false }, data))).user;
    ...
    describe('prop: getRowSpacing', function () {
        ...
        function TestCase(props) {
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ rows: rows, columns: columns }, props)) }));
        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        user = render((0, jsx_runtime_1.jsx)(TestCase, { getRowSpacing: getRowSpacing, initialState: { pagination: { paginationModel: { pageSize: 2, page: 0 } } }, pageSizeOptions: [2] })).user;
        ...
        it.skipIf(skipIf_1.isJSDOM)('should consider the spacing when computing the content size', function () {
            ...
            var rowHeight = 50;
            render((0, jsx_runtime_1.jsx)(TestCase, { rowHeight: rowHeight, getRowSpacing: function () { return ({ top: spacingTop, bottom: spacingBottom }); }, disableVirtualization: true }));
        ...
        it.skipIf(skipIf_1.isJSDOM)('should update the content size when getRowSpacing is removed', function () {
            ...
            var spacingBottom = 10;
            var rowHeight = 50;
            var setProps = render((0, jsx_runtime_1.jsx)(TestCase, { rowHeight: rowHeight, getRowSpacing: function () { return ({ top: spacingTop, bottom: spacingBottom }); }, disableVirtualization: true })).setProps;
            var virtualScrollerContent = document.querySelector('.MuiDataGrid-virtualScrollerContent');
            var expectedHeight = rows.length * (rowHeight + spacingTop + spacingBottom);
            expect(virtualScrollerContent).toHaveComputedStyle({ height: "".concat(expectedHeight, "px") });
            expect(virtualScrollerContent).toHaveInlineStyle({ width: 'auto' });
        ...
        it('should set the row margin to the value returned by getRowSpacing if rowSpacingType is not defined', function () {
            var spacingTop = 5;
            var spacingBottom = 10;
            render((0, jsx_runtime_1.jsx)(TestCase, { getRowSpacing: function () { return ({ top: spacingTop, bottom: spacingBottom }); }, disableVirtualization: true }));
        ...
        it('should set the row border to the value returned by getRowSpacing if rowSpacingType=border', function () {
            var borderTop = 5;
            var borderBottom = 10;
            render((0, jsx_runtime_1.jsx)(TestCase, { rowSpacingType: "border", getRowSpacing: function () { return ({ top: borderTop, bottom: borderBottom }); }, disableVirtualization: true }));
            expect((0, helperFn_1.getRow)(0)).toHaveInlineStyle({
    ...
    describe('apiRef: updateRows', function () {
        ...
        function TestCase(props) {
            apiRef = (0, x_data_grid_1.useGridApiRef)();
            return ((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, __assign({ autoHeight: skipIf_1.isJSDOM, apiRef: apiRef, rows: rows, columns: columns }, props, { disableVirtualization: true })) }));
        }
        ...
        it('should throw a console error if autoPageSize is used with autoHeight', function () {
            expect(function () {
                render((0, jsx_runtime_1.jsx)(TestCase, { autoPageSize: true, autoHeight: true }));
            }).toErrorDev([
    ...
    it.skipIf(skipIf_1.isJSDOM)('should set proper `data-rowindex` and `aria-rowindex` when focused row is out of the viewport', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    user = render((0, jsx_runtime_1.jsx)("div", { style: { width: 300, height: 300 }, children: (0, jsx_runtime_1.jsx)(x_data_grid_1.DataGrid, { columns: [{ field: 'id' }], rows: [
                                { id: 0 },
                                { id: 1 },
                                { id: 2 },
                                { id: 3 },
