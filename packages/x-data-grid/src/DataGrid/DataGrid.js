...
const DataGridRaw = function DataGrid(inProps, ref) {
    ...
    return (_jsx(GridContextProvider, { privateApiRef: privateApiRef, configuration: configuration, props: props, children: _jsx(GridRoot, { className: props.className, style: props.style, sx: props.sx, ...props.slotProps?.root, ref: ref }) }));
};
/**
 * Features:
 ...
 */
export const DataGrid = React.memo(forwardRef(DataGridRaw));
