...
var configuration = {
    hooks: {
        ...
        useFilterValueGetter: function (apiRef) { return apiRef.current.getRowValue; },
    },
};
var DataGridRaw = function DataGrid(inProps, ref) {
    ...
    (0, useDataGridComponent_1.useDataGridComponent)(privateApiRef, props, configuration);
    if (process.env.NODE_ENV !== 'production') {
        (0, propValidation_1.validateProps)(props, propValidation_1.propValidatorsDataGrid);
    }
    return ((0, jsx_runtime_1.jsx)(GridContextProvider_1.GridContextProvider, { privateApiRef: privateApiRef, configuration: configuration, props: props, children: (0, jsx_runtime_1.jsx)(components_1.GridRoot, __assign({ className: props.className, style: props.style, sx: props.sx }, (_a = props.slotProps) === null || _a === void 0 ? void 0 : _a.root, { ref: ref })) }));
};
/**
 * Features:
