...
exports.gridExpandedSortedRowIndexLookupSelector = exports.gridFilterActiveItemsLookupSelector = exports.gridFilterActiveItemsSelector = exports.gridFilteredDescendantRowCountSelector = exports.gridFilteredRowCountSelector = exports.gridFilteredTopLevelRowCountSelector = exports.gridExpandedRowCountSelector = exports.gridFilteredSortedTopLevelRowEntriesSelector = exports.gridFilteredSortedDepthRowEntriesSelector = exports.gridExpandedSortedRowTreeLevelPositionLookupSelector = exports.gridFilteredSortedRowIdsSelector = exports.gridFilteredSortedRowEntriesSelector = exports.gridExpandedSortedRowIdsSelector = exports.gridExpandedSortedRowEntriesSelector = exports.gridFilteredDescendantCountLookupSelector = exports.gridFilteredChildrenCountLookupSelector = exports.gridFilteredRowsLookupSelector = exports.gridVisibleRowsLookupSelector = exports.gridQuickFilterValuesSelector = exports.gridFilterModelSelector = void 0;
 ...
 * @category Filtering
 */
exports.gridFilteredSortedDepthRowEntriesSelector = (0, createSelector_1.createSelectorMemoized)(exports.gridFilteredSortedRowEntriesSelector, gridRowsSelector_1.gridRowTreeSelector, gridRowsSelector_1.gridRowMaximumTreeDepthSelector, function (sortedRows, rowTree, rowTreeDepth) {
    if (rowTreeDepth < 2) {
        return [sortedRows];
    }
    return sortedRows.reduce(function (acc, row) {
        var _a;
 ...
 * @category Filtering
 */
exports.gridFilteredSortedTopLevelRowEntriesSelector = (0, createSelector_1.createSelector)(exports.gridFilteredSortedDepthRowEntriesSelector, function (filteredSortedDepthRows) { var _a; return (_a = filteredSortedDepthRows[0]) !== null && _a !== void 0 ? _a : []; });
/**
 ...
 * @ignore - do not document.
 */
exports.gridExpandedSortedRowIndexLookupSelector = (0, createSelector_1.createSelectorMemoized)(exports.gridExpandedSortedRowIdsSelector, function (expandedSortedIds) {
    return expandedSortedIds.reduce(function (acc, id, index) {
        acc[id] = index;
        return acc;
    }, Object.create(null));
});
