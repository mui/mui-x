 ...
 */
var useGridFilter = function (apiRef, props, configuration) {
    var _a, _b, _c;
    ...
    var getFilterState = React.useCallback(function (inputFilterModel) {
        ...
        var filterValueGetter = configuration.hooks.useFilterValueGetter(apiRef, props);
        var isRowMatchingFilters = props.filterMode === 'client'
            ? (0, gridFilterUtils_1.buildAggregatedFilterApplier)(filterModel, filterValueGetter, apiRef, props.disableEval)
            : null;
    ...
    var preferencePanelPreProcessing = React.useCallback(function (initialValue, value) {
        ...
        if (value === gridPreferencePanelsValue_1.GridPreferencePanelsValue.filters) {
            ...
            return (0, jsx_runtime_1.jsx)(FilterPanel, __assign({}, (_a = props.slotProps) === null || _a === void 0 ? void 0 : _a.filterPanel));
        }
        return initialValue;
    ...
    var flatFilteringMethod = React.useCallback(function (params) {
        ...
        for (var i = 0; i < rows.length; i += 1) {
            ...
            var isRowPassing = (0, gridFilterUtils_1.passFilterLogic)([result.passingFilterItems], [result.passingQuickFilterValues], params.filterModel, params.filterValueGetter, apiRef, filterCache);
            if (!isRowPassing) {
