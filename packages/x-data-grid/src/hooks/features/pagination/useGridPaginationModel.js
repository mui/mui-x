...
var useGridPaginationModel = function (apiRef, props) {
    ...
    var debouncedNavigateToStart = React.useMemo(function () { return (0, debounce_1.default)(navigateToStart, 0); }, [navigateToStart]);
    /**
    ...
    (0, utils_1.useGridEvent)(apiRef, 'sortModelChange', debouncedNavigateToStart);
