...
function useGridParamsApi(apiRef, props, configuration) {
    ...
    var getCellParamsForRow = React.useCallback(function (id, field, row, _a) {
        var cellMode = _a.cellMode, colDef = _a.colDef, hasFocus = _a.hasFocus, rowNode = _a.rowNode, tabIndex = _a.tabIndex, forcedValue = _a.value, forcedFormattedValue = _a.formattedValue;
        var value = row[field];
        if (forcedValue !== undefined) {
            value = forcedValue;
        }
        else if (colDef === null || colDef === void 0 ? void 0 : colDef.valueGetter) {
        ...
        else if (colDef === null || colDef === void 0 ? void 0 : colDef.valueFormatter) {
    ...
    var overridableParamsMethods = configuration.hooks.useGridParamsOverridableMethods(apiRef);
    var paramsApi = {
