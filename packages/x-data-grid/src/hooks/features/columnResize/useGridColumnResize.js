...
var useGridColumnResize = function (apiRef, props) {
    ...
    var updateWidth = function (newWidth) {
        ...
        if (pinnedPosition === gridColumnsInterfaces_1.GridPinnedColumnPosition.LEFT) {
            ...
            (_d = (_c = apiRef.current.rootElementRef) === null || _c === void 0 ? void 0 : _c.current) === null || _d === void 0 ? void 0 : _d.style.setProperty(getPinnedWidthProperty(isRtl, pinnedPosition), "".concat(getPinnedWidth(dimensions, isRtl, pinnedPosition) + columnWidthDiff, "px"));
        }
        if (pinnedPosition === gridColumnsInterfaces_1.GridPinnedColumnPosition.RIGHT) {
            ...
            (_f = (_e = apiRef.current.rootElementRef) === null || _e === void 0 ? void 0 : _e.current) === null || _f === void 0 ? void 0 : _f.style.setProperty(getPinnedWidthProperty(isRtl, pinnedPosition), "".concat(getPinnedWidth(dimensions, isRtl, pinnedPosition) + columnWidthDiff, "px"));
        }
    };
...
function updateProperty(element, property, delta) {
    ...
    element.style[property] = "".concat(Math.round(parseFloat(element.style[property])) + delta, "px");
}
