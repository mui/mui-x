...
import { gridPivotActiveSelector, gridPivotInitialColumnsSelector, } from '../pivoting/gridPivotingSelectors';
...
export function useGridColumns(apiRef, props) {
    ...
    const setColumnWidth = React.useCallback((field, width) => {
        ...
        const newColumn = { ...column, width, hasBeenResized: true };
        setGridColumnsState(hydrateColumnsWidth({
            ...columnsState,
            lookup: {
                ...columnsState.lookup,
                [field]: newColumn,
    ...
    const columnReorderApi = { setColumnIndex };
    ...
    const preferencePanelPreProcessing = React.useCallback((initialValue, value) => {
        if (value === GridPreferencePanelsValue.columns) {
            ...
            return _jsx(ColumnsPanel, { ...props.slotProps?.columnsPanel });
        }
        return initialValue;
