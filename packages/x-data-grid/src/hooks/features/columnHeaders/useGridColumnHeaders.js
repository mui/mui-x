...
var useGridColumnHeaders = function (props) {
    ...
    var getFillers = function (params, children, leftOverflow, borderBottom) {
        ...
        return ((0, jsx_runtime_1.jsxs)(React.Fragment, { children: [isNotPinned && (0, jsx_runtime_1.jsx)("div", { role: "presentation", style: { width: leftOffsetWidth } }), children, isNotPinned && ((0, jsx_runtime_1.jsx)("div", { role: "presentation", className: (0, clsx_1.default)(gridClasses_1.gridClasses.filler, borderBottom && gridClasses_1.gridClasses['filler--borderBottom']) })), hasScrollbarFiller && (0, jsx_runtime_1.jsx)(GridScrollbarFillerCell_1.GridScrollbarFillerCell, { pinnedRight: isPinnedRight })] }));
    };
    var getColumnHeaders = function (params, other) {
        ...
        for (var i = 0; i < renderedColumns.length; i += 1) {
            ...
            var showLeftBorder = (0, cellBorderUtils_1.shouldCellShowLeftBorder)(pinnedPosition, indexInSection, rootProps.showColumnVerticalBorder, rootProps.pinnedColumnsSectionSeparator);
            var showRightBorder = (0, cellBorderUtils_1.shouldCellShowRightBorder)(pinnedPosition, indexInSection, sectionLength, rootProps.showColumnVerticalBorder, gridHasFiller, rootProps.pinnedColumnsSectionSeparator);
            columns.push((0, jsx_runtime_1.jsx)(GridColumnHeaderItem_1.GridColumnHeaderItem, __assign({}, sortColumnLookup[colDef.field], { columnMenuOpen: open_1, filterItemsCounter: filterColumnLookup[colDef.field] && filterColumnLookup[colDef.field].length, headerHeight: headerHeight, isDragging: colDef.field === dragCol, colDef: colDef, colIndex: columnIndex, isResizing: resizeCol === colDef.field, isLast: columnIndex === columnPositions.length - 1, hasFocus: hasFocus, tabIndex: tabIndex, pinnedPosition: pinnedPosition, pinnedOffset: pinnedOffset, isSiblingFocused: isSiblingFocused, showLeftBorder: showLeftBorder, showRightBorder: showRightBorder }, other), colDef.field));
        }
        return getFillers(params, columns, 0);
    };
    var getColumnHeadersRow = function () {
        return ((0, jsx_runtime_1.jsxs)(exports.GridColumnHeaderRow, { role: "row", "aria-rowindex": headerGroupingMaxDepth + 1, ownerState: rootProps, className: gridClasses_1.gridClasses['row--borderBottom'], style: { height: headerHeight }, children: [leftRenderContext &&
                    getColumnHeaders({
    ...
    var getColumnGroupHeaders = function (_a) {
        ...
        var children = visibleColumnGroupHeader.map(function (_a, index) {
            ...
            return ((0, jsx_runtime_1.jsx)(GridColumnGroupHeader_1.GridColumnGroupHeader, { groupId: groupId, width: headerInfo.width, fields: headerInfo.fields, colIndex: headerInfo.colIndex, depth: depth, isLastColumn: index === visibleColumnGroupHeader.length - 1, maxDepth: headerGroupingMaxDepth, height: groupHeaderHeight, hasFocus: hasFocus, tabIndex: tabIndex, pinnedPosition: pinnedPosition, pinnedOffset: pinnedOffset, showLeftBorder: (0, cellBorderUtils_1.shouldCellShowLeftBorder)(pinnedPosition, indexInSection, rootProps.showColumnVerticalBorder, rootProps.pinnedColumnsSectionSeparator), showRightBorder: (0, cellBorderUtils_1.shouldCellShowRightBorder)(pinnedPosition, indexInSection, visibleColumnGroupHeader.length, rootProps.showColumnVerticalBorder, gridHasFiller, rootProps.pinnedColumnsSectionSeparator) }, index));
        });
    ...
    var getColumnGroupHeadersRows = function () {
        ...
        for (var depth = 0; depth < headerGroupingMaxDepth; depth += 1) {
            headerRows.push((0, jsx_runtime_1.jsxs)(exports.GridColumnHeaderRow, { role: "row", "aria-rowindex": depth + 1, ownerState: rootProps, style: { height: groupHeaderHeight }, children: [leftRenderContext &&
                        ...
                        }), getColumnGroupHeaders({ depth: depth, params: { renderContext: renderContext } }), rightRenderContext &&
                        getColumnGroupHeaders({
                            depth: depth,
                            params: {
                                position: constants_1.PinnedColumnPosition.RIGHT,
