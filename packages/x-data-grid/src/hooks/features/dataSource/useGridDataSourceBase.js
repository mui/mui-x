...
var useGridDataSourceBase = function (apiRef, props, options) {
    ...
    var _c = React.useState(apiRef.current.getActiveStrategy(strategyProcessing_1.GridStrategyGroup.DataSource)), currentStrategy = _c[0], setCurrentStrategy = _c[1];
    var standardRowsUpdateStrategyActive = React.useMemo(function () {
        return (currentStrategy === utils_2.DataSourceRowsUpdateStrategy.Default ||
            currentStrategy === utils_2.DataSourceRowsUpdateStrategy.GroupedData);
    }, [currentStrategy]);
    ...
    var fetchRows = React.useCallback(function (parentId, params) { return __awaiter(void 0, void 0, void 0, function () {
        var getRows, _a, skipCache, keepChildrenExpanded, getRowsParams, fetchParams, cacheKeys, responses, requestId, getRowsResponse, cacheResponses, originalError_1;
        var _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    _a = params || {}, skipCache = _a.skipCache, keepChildrenExpanded = _a.keepChildrenExpanded, getRowsParams = __rest(_a, ["skipCache", "keepChildrenExpanded"]);
                    ...
                    if (!skipCache && responses.every(function (response) { return response !== undefined; })) {
                        apiRef.current.applyStrategyProcessor('dataSourceRowsUpdate', {
                            ...
                            options: { skipCache: skipCache, keepChildrenExpanded: keepChildrenExpanded },
                        });
                        return [2 /*return*/];
                    }
    ...
    var handleStrategyActivityChange = React.useCallback(function () {
        setCurrentStrategy(apiRef.current.getActiveStrategy(strategyProcessing_1.GridStrategyGroup.DataSource));
    }, [apiRef]);
    ...
    React.useEffect(function () {
        ...
        if (currentStrategy !== utils_2.DataSourceRowsUpdateStrategy.Default &&
            currentStrategy !== utils_2.DataSourceRowsUpdateStrategy.LazyLoading &&
            currentStrategy !== utils_2.DataSourceRowsUpdateStrategy.GroupedData) {
            return undefined;
        }
        if (props.dataSource) {
    ...
    return {
        ...
        events: {
            ...
            sortModelChange: (0, utils_1.runIf)(standardRowsUpdateStrategyActive, function () { return debouncedFetchRows(); }),
            filterModelChange: (0, utils_1.runIf)(standardRowsUpdateStrategyActive, function () { return debouncedFetchRows(); }),
            paginationModelChange: (0, utils_1.runIf)(standardRowsUpdateStrategyActive, function () { return debouncedFetchRows(); }),
        },
    };
};
