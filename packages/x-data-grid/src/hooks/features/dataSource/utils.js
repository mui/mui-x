...
var CacheChunkManager = /** @class */ (function () {
    ...
    CacheChunkManager.mergeResponses = function (responses) {
        ...
        return responses.reduce(function (acc, response) { return (__assign(__assign({}, response), { rows: __spreadArray(__spreadArray([], acc.rows, true), response.rows, true) })); }, { rows: [], rowCount: 0, pageInfo: {} });
    };
