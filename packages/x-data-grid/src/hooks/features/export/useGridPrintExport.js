...
export const useGridPrintExport = (apiRef, props) => {
    ...
    const handlePrintWindowLoad = React.useCallback((printWindow, options) => {
        ...
        if (!(virtualScrollerContent.nextSibling instanceof HTMLElement &&
        ...
        const defaultPageStyle = typeof normalizeOptions.pageStyle === 'function'
    ...
    const exportDataAsPrint = React.useCallback(async (options) => {
        ...
        if (!apiRef.current.rootElementRef.current) {
            throw new Error('MUI X Data Grid: No grid root element available for print export. ' +
    ...
    const addExportMenuButtons = React.useCallback((initialValue, options) => {
        ...
        return [
            ...initialValue,
            {
                component: _jsx(GridPrintExportMenuItem, { options: options.printOptions }),
