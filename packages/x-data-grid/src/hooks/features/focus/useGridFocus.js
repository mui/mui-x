...
var useGridFocus = function (apiRef, props) {
    ...
    var handleRowsSet = React.useCallback(function () {
        var _a;
        var cell = (0, gridFocusStateSelector_1.gridFocusCellSelector)(apiRef);
    ...
    var debouncedHandleRowsSet = React.useMemo(function () { return (0, debounce_1.default)(handleRowsSet, 0); }, [handleRowsSet]);
    ...
    (0, useGridEvent_1.useGridEvent)(apiRef, 'rowsSet', debouncedHandleRowsSet);
