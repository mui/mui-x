...
import { gridHasFillerSelector, gridVerticalScrollbarWidthSelector, } from '../features/dimensions/gridDimensionsSelectors';
import { gridDensityFactorSelector } from '../features/density';
import { gridVisibleColumnDefinitionsSelector, gridVisiblePinnedColumnDefinitionsSelector, gridColumnPositionsSelector, gridHasColSpanSelector, } from '../features/columns/gridColumnsSelector';
...
import { getValidRowHeight, minimalContentHeight, rowHeightWarning, } from '../features/rows/gridRowsUtils';
...
export function useGridVirtualizer() {
    ...
    const virtualizer = useVirtualizer({
        ...
        getEstimatedRowHeight: React.useMemo(() => getEstimatedRowHeight
        ...
        renderInfiniteLoadingTrigger: React.useCallback((id) => apiRef.current.getInfiniteLoadingTriggerElement?.({ lastRowId: id }), [apiRef]),
    });
