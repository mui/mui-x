...
var useGridOverlays_1 = require("../features/overlays/useGridOverlays");
function identity(x) {
    return x;
}
...
function useGridVirtualizer(apiRef, rootProps) {
    ...
    var isRowSelected = React.useCallback(function (id) { return rowSelectionManager.has(id) && apiRef.current.isRowSelectable(id); }, [rowSelectionManager, apiRef]);
    ...
    var overlayState = (0, useGridOverlays_1.useGridOverlays)(apiRef, rootProps);
    ...
    var RowSlot = rootProps.slots.row;
    var rowSlotProps = (_c = rootProps.slotProps) === null || _c === void 0 ? void 0 : _c.row;
    var virtualizer = (0, x_virtualizer_1.useVirtualizer)({
        ...
        colspan: {
            enabled: hasColSpan,
            getColspan: React.useCallback(function (rowId, column) {
                var _a, _b;
        ...
        initialState: {
            scroll: (_d = rootProps.initialState) === null || _d === void 0 ? void 0 : _d.scroll,
        ...
        disableVerticalScroll: overlayState.overlayType === 'noColumnsOverlay' ||
        ...
        onScrollChange: React.useCallback(function (scrollPosition, nextRenderContext) {
        ...
        renderRow: React.useCallback(function (params) { return ((0, jsx_runtime_1.jsx)(RowSlot, __assign({ row: params.model, rowId: params.id, index: params.rowIndex, selected: isRowSelected(params.id), offsetLeft: params.offsetLeft, columnsTotalWidth: columnsTotalWidth, rowHeight: params.baseRowHeight, pinnedColumns: pinnedColumns, visibleColumns: visibleColumns, firstColumnIndex: params.firstColumnIndex, lastColumnIndex: params.lastColumnIndex, focusedColumnIndex: params.focusedColumnIndex, isFirstVisible: params.isFirstVisible, isLastVisible: params.isLastVisible, isNotVisible: params.isVirtualFocusRow, showBottomBorder: params.showBottomBorder, scrollbarWidth: verticalScrollbarWidth, gridHasFiller: hasFiller }, rowSlotProps), params.id)); }, [
            columnsTotalWidth,
            hasFiller,
            isRowSelected,
            pinnedColumns,
        ...
        renderInfiniteLoadingTrigger: React.useCallback(function (id) { var _a, _b; return (_b = (_a = apiRef.current).getInfiniteLoadingTriggerElement) === null || _b === void 0 ? void 0 : _b.call(_a, { lastRowId: id }); }, [apiRef]),
    });
