...
describe('useGridEvent', () => {
    ...
    describe('FinalizationRegistry-based implementation', () => {
        ...
        it.skipIf(!isJSDOM || typeof FinalizationRegistry === 'undefined' || typeof global.gc === 'undefined')('should unsubscribe event listeners registered by uncommitted components', async () => {
            ...
            function Test() {
                useGridEvent(apiRef, 'cellClick', noop);
                return null;
            }
            const { unmount } = render(_jsx(Test, {}));
