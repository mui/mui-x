...
function TailwindDemoContainer(props) {
    ...
    return isLoaded ? (children) : ((0, jsx_runtime_1.jsx)(Box_1.default, { sx: { display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%' }, children: (0, jsx_runtime_1.jsx)(CircularProgress_1.default, {}) }));
}
