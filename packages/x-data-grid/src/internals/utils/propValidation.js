...
export const propValidatorsDataGrid = [
    (props) => (props.autoPageSize &&
        props.autoHeight &&
        [
        ...
        undefined,
    (props) => (props.paginationMode === 'client' &&
        ...
        undefined,
    (props) => (props.signature === GridSignature.DataGrid &&
        ...
        undefined,
    (props) => (props.paginationMode === 'server' &&
        props.rowCount == null &&
        !props.dataSource &&
