...
function useMaterialCSSVariables() {
    ...
    return React.useMemo(function () {
        var id = (0, hash_1.hash)(stringifyTheme(theme));
...
function transformTheme(t) {
    ...
    var backgroundBase = (_b = dataGridPalette === null || dataGridPalette === void 0 ? void 0 : dataGridPalette.bg) !== null && _b !== void 0 ? _b : (t.palette.mode === 'dark'
    ...
    var backgroundOverlay = t.palette.mode === 'dark'
        ? "color-mix(in srgb, ".concat((t.vars || t).palette.background.paper, " 90%, #fff)")
        : (t.vars || t).palette.background.paper;
...
function formatFont(font) {
    ...
    var fontSize = typeof font.fontSize === 'number' ? "".concat(font.fontSize, "px") : font.fontSize;
