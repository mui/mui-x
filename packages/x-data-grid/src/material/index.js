...
var BaseSelect = (0, forwardRef_1.forwardRef)(function BaseSelect(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)(FormControl_1.default, { size: size, fullWidth: fullWidth, style: style, disabled: disabled, ref: ref, children: [(0, jsx_runtime_1.jsx)(InputLabel_1.default, { id: labelId, htmlFor: id, shrink: true, variant: "outlined", children: label }), (0, jsx_runtime_1.jsx)(Select_1.default, __assign({ id: id, labelId: labelId, label: label, displayEmpty: true, onChange: onChange, variant: "outlined" }, other, { notched: true, inputProps: slotProps === null || slotProps === void 0 ? void 0 : slotProps.htmlInput, onOpen: onOpen, MenuProps: menuProps, size: size }, material))] }));
});
...
var BasePagination = (0, forwardRef_1.forwardRef)(function BasePagination(props, ref) {
    var onRowsPerPageChange = props.onRowsPerPageChange, material = props.material, disabled = props.disabled, other = __rest(props, ["onRowsPerPageChange", "material", "disabled"]);
    ...
    return ((0, jsx_runtime_1.jsx)(StyledPagination, __assign({ component: "div", onRowsPerPageChange: (0, useEventCallback_1.default)(function (event) {
...
var BaseBadge = (0, forwardRef_1.forwardRef)(function BaseBadge(props, ref) {
    var material = props.material, other = __rest(props, ["material"]);
    return (0, jsx_runtime_1.jsx)(Badge_1.default, __assign({}, other, material, { ref: ref }));
});
var BaseCheckbox = (0, forwardRef_1.forwardRef)(function BaseCheckbox(props, ref) {
    ...
    if (!label) {
        return ((0, jsx_runtime_1.jsx)(Checkbox, __assign({}, other, material, { className: (0, clsx_1.default)(className, material === null || material === void 0 ? void 0 : material.className), inputProps: slotProps === null || slotProps === void 0 ? void 0 : slotProps.htmlInput, ref: handleRef, touchRippleRef: rippleRef })));
    }
    return ((0, jsx_runtime_1.jsx)(FormControlLabel, { className: className, control: (0, jsx_runtime_1.jsx)(Checkbox, __assign({}, other, material, { inputProps: slotProps === null || slotProps === void 0 ? void 0 : slotProps.htmlInput, ref: handleRef, touchRippleRef: rippleRef })), label: label, fullWidth: fullWidth }));
});
var BaseCircularProgress = (0, forwardRef_1.forwardRef)(function BaseCircularProgress(props, ref) {
    var material = props.material, other = __rest(props, ["material"]);
    return (0, jsx_runtime_1.jsx)(CircularProgress_1.default, __assign({}, other, material, { ref: ref }));
});
var BaseDivider = (0, forwardRef_1.forwardRef)(function BaseDivider(props, ref) {
    var material = props.material, other = __rest(props, ["material"]);
    return (0, jsx_runtime_1.jsx)(Divider_1.default, __assign({}, other, material, { ref: ref }));
});
var BaseLinearProgress = (0, forwardRef_1.forwardRef)(function BaseLinearProgress(props, ref) {
    var material = props.material, other = __rest(props, ["material"]);
    return (0, jsx_runtime_1.jsx)(LinearProgress_1.default, __assign({}, other, material, { ref: ref }));
});
var BaseButton = (0, forwardRef_1.forwardRef)(function BaseButton(props, ref) {
    var material = props.material, other = __rest(props, ["material"]);
    return (0, jsx_runtime_1.jsx)(Button_1.default, __assign({}, other, material, { ref: ref }));
});
var StyledToggleButton = (0, styles_1.styled)(ToggleButton_1.default)(function (_a) {
    var theme = _a.theme;
    return ({
        gap: theme.spacing(1),
        border: 0,
...
var BaseToggleButton = (0, forwardRef_1.forwardRef)(function BaseToggleButton(props, ref) {
    var material = props.material, rest = __rest(props, ["material"]);
    return (0, jsx_runtime_1.jsx)(StyledToggleButton, __assign({ size: "small", color: "primary" }, rest, material, { ref: ref }));
});
var BaseChip = (0, forwardRef_1.forwardRef)(function BaseChip(props, ref) {
    var material = props.material, other = __rest(props, ["material"]);
    return (0, jsx_runtime_1.jsx)(Chip_1.default, __assign({}, other, material, { ref: ref }));
});
var BaseIconButton = (0, forwardRef_1.forwardRef)(function BaseIconButton(props, ref) {
    var material = props.material, other = __rest(props, ["material"]);
    return (0, jsx_runtime_1.jsx)(IconButton_1.default, __assign({}, other, material, { ref: ref }));
});
var BaseTooltip = (0, forwardRef_1.forwardRef)(function BaseTooltip(props, ref) {
    var material = props.material, other = __rest(props, ["material"]);
    return (0, jsx_runtime_1.jsx)(Tooltip_1.default, __assign({}, other, material, { ref: ref }));
});
var BaseSkeleton = (0, forwardRef_1.forwardRef)(function BaseSkeleton(props, ref) {
    var material = props.material, other = __rest(props, ["material"]);
    return (0, jsx_runtime_1.jsx)(Skeleton_1.default, __assign({}, other, material, { ref: ref }));
});
var BaseSwitch = (0, forwardRef_1.forwardRef)(function BaseSwitch(props, ref) {
    var material = props.material, label = props.label, className = props.className, other = __rest(props, ["material", "label", "className"]);
    if (!label) {
        return (0, jsx_runtime_1.jsx)(Switch_1.default, __assign({}, other, material, { className: className, ref: ref }));
    }
    return ((0, jsx_runtime_1.jsx)(FormControlLabel, { className: className, control: (0, jsx_runtime_1.jsx)(Switch_1.default, __assign({}, other, material, { ref: ref })), label: label }));
});
var BaseMenuList = (0, forwardRef_1.forwardRef)(function BaseMenuList(props, ref) {
    var material = props.material, other = __rest(props, ["material"]);
    return (0, jsx_runtime_1.jsx)(MenuList_1.default, __assign({}, other, material, { ref: ref }));
});
function BaseMenuItem(props) {
    ...
    return React.createElement(MenuItem_1.default, __assign(__assign({}, other), material), [
        iconStart && (0, jsx_runtime_1.jsx)(ListItemIcon_1.default, { children: iconStart }, "1"),
        (0, jsx_runtime_1.jsx)(ListItemText, { children: children }, "2"),
        iconEnd && (0, jsx_runtime_1.jsx)(ListItemIcon_1.default, { children: iconEnd }, "3"),
    ]);
}
function BaseTextField(props) {
    // MaterialUI v5 doesn't support slotProps, until we drop v5 support we need to
    // translate the pattern.
    var slotProps = props.slotProps, material = props.material, other = __rest(props, ["slotProps", "material"]);
    return ((0, jsx_runtime_1.jsx)(TextField_1.default, __assign({ variant: "outlined" }, other, material, { inputProps: slotProps === null || slotProps === void 0 ? void 0 : slotProps.htmlInput, InputProps: transformInputProps(slotProps === null || slotProps === void 0 ? void 0 : slotProps.input), InputLabelProps: __assign({ shrink: true }, slotProps === null || slotProps === void 0 ? void 0 : slotProps.inputLabel) })));
}
function BaseAutocomplete(props) {
    var rootProps = (0, useGridRootProps_1.useGridRootProps)();
    var id = props.id, multiple = props.multiple, freeSolo = props.freeSolo, options = props.options, getOptionLabel = props.getOptionLabel, isOptionEqualToValue = props.isOptionEqualToValue, value = props.value, onChange = props.onChange, label = props.label, placeholder = props.placeholder, slotProps = props.slotProps, material = props.material, other = __rest(props, ["id", "multiple", "freeSolo", "options", "getOptionLabel", "isOptionEqualToValue", "value", "onChange", "label", "placeholder", "slotProps", "material"]);
    return ((0, jsx_runtime_1.jsx)(Autocomplete_1.default, __assign({ id: id, multiple: multiple, freeSolo: freeSolo, options: options, getOptionLabel: getOptionLabel, isOptionEqualToValue: isOptionEqualToValue, value: value, onChange: onChange, renderTags: function (currentValue, getTagProps) {
            return currentValue.map(function (option, index) {
                var _a = getTagProps({ index: index }), key = _a.key, tagProps = __rest(_a, ["key"]);
                return ((0, jsx_runtime_1.jsx)(Chip_1.default, __assign({ variant: "outlined", size: "small", label: typeof option === 'string' ? option : getOptionLabel === null || getOptionLabel === void 0 ? void 0 : getOptionLabel(option) }, tagProps), key));
            });
            ...
            return ((0, jsx_runtime_1.jsx)(TextField_1.default, __assign({}, inputRest, { label: label, placeholder: placeholder, inputProps: inputProps, InputProps: transformInputProps(InputProps, false), InputLabelProps: __assign({ shrink: true }, InputLabelProps) }, slotProps === null || slotProps === void 0 ? void 0 : slotProps.textField, (_a = rootProps.slotProps) === null || _a === void 0 ? void 0 : _a.baseTextField)));
        } }, other, material)));
}
function BaseInput(props) {
    return (0, jsx_runtime_1.jsx)(InputBase_1.default, __assign({}, transformInputProps(props)));
}
function transformInputProps(props, wrapAdornments) {
    ...
    if (wrapAdornments) {
        if (result.startAdornment) {
            result.startAdornment = ((0, jsx_runtime_1.jsx)(InputAdornment, { position: "start", children: result.startAdornment }));
        }
        if (result.endAdornment) {
            result.endAdornment = (0, jsx_runtime_1.jsx)(InputAdornment, { position: "end", children: result.endAdornment });
        }
    }
...
function BasePopper(props) {
    var ref = props.ref, open = props.open, children = props.children, className = props.className, clickAwayTouchEvent = props.clickAwayTouchEvent, clickAwayMouseEvent = props.clickAwayMouseEvent, flip = props.flip, focusTrap = props.focusTrap, onExited = props.onExited, onClickAway = props.onClickAway, onDidShow = props.onDidShow, onDidHide = props.onDidHide, id = props.id, target = props.target, transition = props.transition, placement = props.placement, material = props.material, other = __rest(props, ["ref", "open", "children", "className", "clickAwayTouchEvent", "clickAwayMouseEvent", "flip", "focusTrap", "onExited", "onClickAway", "onDidShow", "onDidHide", "id", "target", "transition", "placement", "material"]);
    ...
    return ((0, jsx_runtime_1.jsx)(Popper_1.default, __assign({ id: id, className: className, open: open, anchorEl: target, transition: transition, placement: placement, modifiers: modifiers }, other, material, { children: content })));
}
...
function BaseSelectOption(_a) {
    ...
    if (native) {
        return (0, jsx_runtime_1.jsx)("option", __assign({}, props));
    }
    return (0, jsx_runtime_1.jsx)(MenuItem_1.default, __assign({}, props));
}
var StyledTabs = (0, styles_1.styled)(Tabs_1.default, {
    name: 'MuiDataGrid',
    slot: 'Tabs',
})(function (_a) {
    var theme = _a.theme;
...
var StyledTab = (0, styles_1.styled)(Tab_1.default, {
    name: 'MuiDataGrid',
    slot: 'Tab',
})({
    flex: 1,
...
var StyledTabPanel = (0, styles_1.styled)('div', {
    name: 'MuiDataGrid',
    slot: 'TabPanel',
})({
    flex: 1,
...
function TabPanel(props) {
    var children = props.children, value = props.value, active = props.active, other = __rest(props, ["children", "value", "active"]);
    return ((0, jsx_runtime_1.jsx)(StyledTabPanel, __assign({ role: "tabpanel", style: { display: active ? 'flex' : 'none' } }, other, { children: children })));
}
function BaseTabs(_a) {
    var items = _a.items, value = _a.value, material = _a.material, props = __rest(_a, ["items", "value", "material"]);
    var id = (0, useId_1.default)();
    var labelId = "".concat(id, "-tab-").concat(value);
    var panelId = "".concat(id, "-tabpanel-").concat(value);
    return ((0, jsx_runtime_1.jsxs)(React.Fragment, { children: [(0, jsx_runtime_1.jsx)(StyledTabs, __assign({}, props, { value: value, variant: "scrollable", scrollButtons: "auto" }, material, { children: items.map(function (item) { return ((0, jsx_runtime_1.jsx)(StyledTab, { value: item.value, label: item.label, id: labelId, "aria-controls": panelId }, item.value)); }) })), items.map(function (item) { return ((0, jsx_runtime_1.jsx)(TabPanel, { value: item.value, active: value === item.value, id: panelId, "aria-labelledby": labelId, children: item.children }, item.value)); })] }));
}
var iconSlots = {
