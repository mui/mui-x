...
import {
  ...
  GridPanel,
  GridRow,
  GridColumnHeaderFilterButton,
  GridRowCount,
  GridColumnsManagement,
  GridColumnHeaderSortButton,
...
export const DATA_GRID_DEFAULT_SLOTS_COMPONENTS: GridSlotsComponent = {
  ...
  columnHeaderFilterButton: GridColumnHeaderFilterButton,
  columnHeaderSortButton: GridColumnHeaderSortButton,
