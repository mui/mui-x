...
exports.GRID_DEFAULT_LOCALE_TEXT = {
    ...
    chartsSeries: 'Series',
    chartsMenuAddToDimensions: function (dimensionLabel) { return "Add to ".concat(dimensionLabel); },
    chartsMenuAddToValues: function (valuesLabel) { return "Add to ".concat(valuesLabel); },
    ...
    chartsDragToDimensions: function (dimensionLabel) {
        return "Drag here to use column as ".concat(dimensionLabel);
    },
    chartsDragToValues: function (valuesLabel) { return "Drag here to use column as ".concat(valuesLabel); },
    // AI Assistant panel
    ...
    promptChangeChartsLabel: function (dimensionsCount, valuesCount) {
        return "Dimensions (".concat(dimensionsCount, "), Values (").concat(valuesCount, ")");
    },
};
