 ...
 */
var ColumnsPanelTrigger = (0, forwardRef_1.forwardRef)(function ColumnsPanelTrigger(props, ref) {
    var _a;
    ...
    var open = panelState.open && panelState.openedPanelValue === hooks_1.GridPreferencePanelsValue.columns;
    var state = { open: open };
    ...
    var handleClick = function (event) {
        if (open) {
            ...
            apiRef.current.showPreferences(hooks_1.GridPreferencePanelsValue.columns, panelId, buttonId);
        }
