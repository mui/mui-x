...
var isRowReorderingEnabledSelector = (0, createSelector_1.createSelector)(gridEditingSelectors_1.gridEditRowsStateSelector, function (editRows, _a) {
    var rowReordering = _a.rowReordering, treeData = _a.treeData;
...
var GridRow = (0, forwardRef_1.forwardRef)(function GridRow(props, refProp) {
    ...
    var treeData = rootProps.treeData;
    var isRowReorderingEnabled = (0, useGridSelector_1.useGridSelector)(apiRef, isRowReorderingEnabledSelector, {
    ...
    var getCell = function (column, indexInSection, indexRelativeToAllColumns, sectionLength, pinnedPosition) {
        ...
        if (rowNode.type === 'skeletonRow') {
            return ((0, jsx_runtime_1.jsx)(slots.skeletonCell, { type: column.type, width: width, height: rowHeight, field: column.field, align: column.align }, column.field));
        }
        ...
        var canReorderRow = isRowReorderingEnabled && !sortModel.length;
        ...
        var showLeftBorder = (0, cellBorderUtils_1.shouldCellShowLeftBorder)(pinnedPosition, indexInSection, rootProps.showCellVerticalBorder, rootProps.pinnedColumnsSectionSeparator);
        var showRightBorder = (0, cellBorderUtils_1.shouldCellShowRightBorder)(pinnedPosition, indexInSection, sectionLength, rootProps.showCellVerticalBorder, gridHasFiller, rootProps.pinnedColumnsSectionSeparator);
        return ((0, jsx_runtime_1.jsx)(slots.cell, __assign({ column: column, width: width, rowId: rowId, align: column.align || 'left', colIndex: indexRelativeToAllColumns, colSpan: colSpan, disableDragEvents: disableDragEvents, isNotVisible: cellIsNotVisible, pinnedOffset: pinnedOffset, pinnedPosition: pinnedPosition, showLeftBorder: showLeftBorder, showRightBorder: showRightBorder, row: row, rowNode: rowNode }, slotProps === null || slotProps === void 0 ? void 0 : slotProps.cell), column.field));
    };
    ...
    var eventHandlers = row
        ...
        : null;
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ "data-id": rowId, "data-rowindex": index, role: "row", className: clsx_1.default.apply(void 0, __spreadArray(__spreadArray([], rowClassNames, false), [classes.root, className], false)), style: style }, ariaAttributes, eventHandlers, other, { ref: handleRef, children: [leftCells, (0, jsx_runtime_1.jsx)("div", { role: "presentation", className: gridClasses_1.gridClasses.cellOffsetLeft, style: { width: offsetLeft } }), cells, (0, jsx_runtime_1.jsx)("div", { role: "presentation", className: (0, clsx_1.default)(gridClasses_1.gridClasses.cell, gridClasses_1.gridClasses.cellEmpty) }), rightCells] })));
});
GridRow.propTypes = {
    // ----------------------------- Warning --------------------------------
