...
var GridGenericColumnHeaderItem = (0, forwardRef_1.forwardRef)(function GridGenericColumnHeaderItem(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: (0, clsx_1.default)(classes.root, headerClassName), style: __assign(__assign({}, style), { width: width }), role: "columnheader", tabIndex: tabIndex, "aria-colindex": colIndex + 1, "aria-sort": ariaSort }, other, { ref: handleRef, children: [(0, jsx_runtime_1.jsxs)("div", __assign({ className: classes.draggableContainer, draggable: isDraggable, role: "presentation" }, draggableContainerProps, { children: [(0, jsx_runtime_1.jsxs)("div", { className: classes.titleContainer, role: "presentation", children: [(0, jsx_runtime_1.jsx)("div", { className: classes.titleContainerContent, children: headerComponent !== undefined ? (headerComponent) : ((0, jsx_runtime_1.jsx)(GridColumnHeaderTitle_1.GridColumnHeaderTitle, { label: label, description: description, columnWidth: width })) }), columnTitleIconButtons] }), columnMenuIconButton] })), (0, jsx_runtime_1.jsx)(GridColumnHeaderSeparator_1.GridColumnHeaderSeparator, __assign({ resizable: !rootProps.disableColumnResize && !!resizable, resizing: isResizing, height: height, side: separatorSide }, columnHeaderSeparatorProps)), columnMenu] })));
});
