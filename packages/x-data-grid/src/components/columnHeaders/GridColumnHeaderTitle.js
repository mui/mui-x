...
var ColumnHeaderInnerTitle = (0, forwardRef_1.forwardRef)(function ColumnHeaderInnerTitle(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(GridColumnHeaderTitleRoot, __assign({ className: (0, clsx_1.default)(classes.root, className), ownerState: rootProps }, other, { ref: ref })));
});
...
function GridColumnHeaderTitle(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(rootProps.slots.baseTooltip, __assign({ title: description || tooltip }, (_a = rootProps.slotProps) === null || _a === void 0 ? void 0 : _a.baseTooltip, { children: (0, jsx_runtime_1.jsx)(ColumnHeaderInnerTitle, { onMouseOver: handleMouseOver, ref: titleRef, children: label }) })));
}
