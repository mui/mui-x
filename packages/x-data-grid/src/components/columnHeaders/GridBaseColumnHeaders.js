...
exports.GridBaseColumnHeaders = (0, forwardRef_1.forwardRef)(function GridColumnHeaders(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(GridColumnHeadersRoot, __assign({ className: (0, clsx_1.default)(classes.root, className), ownerState: rootProps }, other, { role: "presentation", ref: ref })));
});
