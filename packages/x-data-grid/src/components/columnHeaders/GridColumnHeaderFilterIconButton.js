...
function GridColumnHeaderFilterIconButtonWrapped(props) {
    ...
    return (0, jsx_runtime_1.jsx)(GridColumnHeaderFilterIconButton, __assign({}, props));
}
...
function GridColumnHeaderFilterIconButton(props) {
    ...
    var iconButton = ((0, jsx_runtime_1.jsx)(rootProps.slots.baseIconButton, __assign({ id: labelId, onClick: toggleFilter, "aria-label": apiRef.current.getLocaleText('columnHeaderFiltersLabel'), size: "small", tabIndex: -1, "aria-haspopup": "menu", "aria-expanded": isOpen, "aria-controls": isOpen ? panelId : undefined }, (_a = rootProps.slotProps) === null || _a === void 0 ? void 0 : _a.baseIconButton, { children: (0, jsx_runtime_1.jsx)(rootProps.slots.columnFilteredIcon, { className: classes.icon, fontSize: "small" }) })));
    return ((0, jsx_runtime_1.jsx)(rootProps.slots.baseTooltip, __assign({ title: apiRef.current.getLocaleText('columnHeaderFiltersTooltipActive')(counter), enterDelay: 1000 }, (_b = rootProps.slotProps) === null || _b === void 0 ? void 0 : _b.baseTooltip, { children: (0, jsx_runtime_1.jsxs)(GridIconButtonContainer_1.GridIconButtonContainer, { children: [counter > 1 && ((0, jsx_runtime_1.jsx)(rootProps.slots.baseBadge, { badgeContent: counter, color: "default", children: iconButton })), counter === 1 && iconButton] }) })));
}
