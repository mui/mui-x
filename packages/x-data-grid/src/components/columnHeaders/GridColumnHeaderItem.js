...
function GridColumnHeaderItem(props) {
    ...
    const columnMenuIconButton = !rootProps.disableColumnMenu &&
        ...
        hasColumnMenuItems && (_jsx(ColumnHeaderMenuIcon, { colDef: colDef, columnMenuId: columnMenuId, columnMenuButtonId: columnMenuButtonId, open: showColumnMenuIcon, iconButtonRef: iconButtonRef }));
    const columnMenu = (_jsx(GridColumnHeaderMenu, { columnMenuId: columnMenuId, columnMenuButtonId: columnMenuButtonId, field: colDef.field, open: columnMenuOpen, target: iconButtonRef.current, ContentComponent: rootProps.slots.columnMenu, contentComponentProps: rootProps.slotProps?.columnMenu, onExited: handleExited }));
    const sortingOrder = colDef.sortingOrder ?? rootProps.sortingOrder;
    const showSortIcon = (colDef.sortable || sortDirection != null) &&
        !colDef.hideSortIcons &&
        !rootProps.disableColumnSorting;
    const columnTitleIconButtons = (_jsxs(React.Fragment, { children: [!rootProps.disableColumnFilter && (_jsx(rootProps.slots.columnHeaderFilterIconButton, { field: colDef.field, counter: filterItemsCounter, ...rootProps.slotProps?.columnHeaderFilterIconButton })), showSortIcon && (_jsx(rootProps.slots.columnHeaderSortIcon, { field: colDef.field, direction: sortDirection, index: sortIndex, sortingOrder: sortingOrder, disabled: !colDef.sortable, ...rootProps.slotProps?.columnHeaderSortIcon }))] }));
