...
function GridColumnHeaderItem(props) {
    ...
    var columnMenuIconButton = !rootProps.disableColumnMenu && !colDef.disableColumnMenu && ((0, jsx_runtime_1.jsx)(ColumnHeaderMenuIcon_1.ColumnHeaderMenuIcon, { colDef: colDef, columnMenuId: columnMenuId, columnMenuButtonId: columnMenuButtonId, open: showColumnMenuIcon, iconButtonRef: iconButtonRef }));
    var columnMenu = ((0, jsx_runtime_1.jsx)(GridColumnHeaderMenu_1.GridColumnHeaderMenu, { columnMenuId: columnMenuId, columnMenuButtonId: columnMenuButtonId, field: colDef.field, open: columnMenuOpen, target: iconButtonRef.current, ContentComponent: rootProps.slots.columnMenu, contentComponentProps: (_a = rootProps.slotProps) === null || _a === void 0 ? void 0 : _a.columnMenu, onExited: handleExited }));
    ...
    var columnTitleIconButtons = ((0, jsx_runtime_1.jsxs)(React.Fragment, { children: [!rootProps.disableColumnFilter && ((0, jsx_runtime_1.jsx)(rootProps.slots.columnHeaderFilterIconButton, __assign({ field: colDef.field, counter: filterItemsCounter }, (_c = rootProps.slotProps) === null || _c === void 0 ? void 0 : _c.columnHeaderFilterIconButton))), showSortIcon && ((0, jsx_runtime_1.jsx)(rootProps.slots.columnHeaderSortIcon, __assign({ field: colDef.field, direction: sortDirection, index: sortIndex, sortingOrder: sortingOrder, disabled: !colDef.sortable }, (_d = rootProps.slotProps) === null || _d === void 0 ? void 0 : _d.columnHeaderSortIcon)))] }));
