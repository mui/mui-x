...
function GridColumnHeaderSeparatorRaw(props) {
    ...
    (0, jsx_runtime_1.jsx)("div", __assign({ className: classes.root, style: { minHeight: height } }, other, { onClick: stopClick, children: (0, jsx_runtime_1.jsx)(rootProps.slots.columnResizeIcon, { className: classes.icon }) })));
}
