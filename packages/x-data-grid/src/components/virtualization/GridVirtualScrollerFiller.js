...
function GridVirtualScrollerFiller(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(Filler, { className: constants_1.gridClasses.filler, role: "presentation", style: {
            height: height,
            '--rowBorderColor': rowsLength === 0 ? 'transparent' : 'var(--DataGrid-rowBorderColor)',
        }, children: [leftPinnedWidth > 0 && ((0, jsx_runtime_1.jsx)(PinnedLeft, { className: constants_1.gridClasses['filler--pinnedLeft'], style: { width: leftPinnedWidth } })), (0, jsx_runtime_1.jsx)(Main, {}), rightPinnedWidth > 0 && ((0, jsx_runtime_1.jsx)(PinnedRight, { className: constants_1.gridClasses['filler--pinnedRight'], style: { width: rightPinnedWidth + (hasScrollY ? scrollbarSize : 0) } }))] }));
}
