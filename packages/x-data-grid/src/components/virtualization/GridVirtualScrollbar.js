...
exports.GridVirtualScrollbar = exports.ScrollbarCorner = void 0;
...
exports.ScrollbarCorner = (0, system_1.styled)(Scrollbar)({
    width: 'var(--size)',
    height: 'var(--size)',
    right: 0,
    bottom: 0,
...
var GridVirtualScrollbar = (0, forwardRef_1.forwardRef)(function GridVirtualScrollbar(props, ref) {
    ...
    var scrollbarInnerSize = props.position === 'horizontal'
    ...
    var scrollbarInnerStyle = React.useMemo(function () {
        var _a;
        return (_a = {},
            _a[propertyDimension] = "".concat(scrollbarInnerSize, "px"),
            _a);
    }, [propertyDimension, scrollbarInnerSize]);
    return ((0, jsx_runtime_1.jsx)(Container, { ref: (0, useForkRef_1.default)(ref, scrollbarRef), className: classes.root, tabIndex: -1, "aria-hidden": "true", 
        // tabIndex does not prevent focus with a mouse click, throwing a console error
        // https://github.com/mui/mui-x/issues/16706
        onFocus: function (event) {
            event.target.blur();
        }, children: (0, jsx_runtime_1.jsx)("div", { className: classes.content, style: scrollbarInnerStyle }) }));
});
