...
const GridVirtualScrollbar = forwardRef(function GridVirtualScrollbar(props, ref) {
    ...
    const scrollbarInnerSize = props.position === 'horizontal'
    ...
    return (_jsx(Container, { ref: ref, className: classes.root, tabIndex: -1, "aria-hidden": "true", 
        // tabIndex does not prevent focus with a mouse click, throwing a console error
        // https://github.com/mui/mui-x/issues/16706
        onFocus: (event) => {
            event.target.blur();
        }, children: _jsx("div", { className: classes.content, style: scrollbarInnerStyle }) }));
});
