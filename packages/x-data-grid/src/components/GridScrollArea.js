...
function GridScrollAreaWrapper(props) {
    ...
    if (dragDirection === 'horizontal') {
        return (0, jsx_runtime_1.jsx)(GridHorizontalScrollAreaContent, __assign({}, props));
    }
    return (0, jsx_runtime_1.jsx)(GridVerticalScrollAreaContent, __assign({}, props));
}
function GridHorizontalScrollAreaContent(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(GridScrollAreaContent, __assign({}, props, { ref: rootRef, getCanScrollMore: getCanScrollMore, style: style, handleDragOver: handleDragOver })));
}
...
var GridScrollAreaContent = (0, forwardRef_1.forwardRef)(function GridScrollAreaContent(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(GridScrollAreaRawRoot, { ref: ref, className: classes.root, ownerState: ownerState, onDragOver: handleDragOver, style: style }));
});
