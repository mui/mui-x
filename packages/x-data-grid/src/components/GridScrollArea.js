...
import { gridDimensionsSelector, gridColumnsTotalWidthSelector, } from '../hooks/features/dimensions/gridDimensionsSelectors';
...
function GridScrollAreaWrapper(props) {
    ...
    if (dragDirection === 'horizontal') {
        return _jsx(GridHorizontalScrollAreaContent, { ...props });
    }
    return _jsx(GridVerticalScrollAreaContent, { ...props });
}
function GridHorizontalScrollAreaContent(props) {
    ...
    return (_jsx(GridScrollAreaContent, { ...props, ref: rootRef, getCanScrollMore: getCanScrollMore, style: style, handleDragOver: handleDragOver }));
}
function GridVerticalScrollAreaContent(props) {
    ...
    const getCanScrollMore = () => {
        ...
        if (scrollDirection === 'down') {
            ...
            const maxScrollTop = totalRowsHeight -
...
const GridScrollAreaContent = forwardRef(function GridScrollAreaContent(props, ref) {
    ...
    return (_jsx(GridScrollAreaRawRoot, { ref: ref, className: classes.root, ownerState: ownerState, onDragOver: handleDragOver, style: style }));
});
