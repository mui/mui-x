...
var GridColumnMenuContainer = (0, forwardRef_1.forwardRef)(function GridColumnMenuContainer(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(StyledMenuList, __assign({ as: rootProps.slots.baseMenuList, id: id, className: (0, clsx_1.default)(gridClasses_1.gridClasses.menuList, className), "aria-labelledby": labelledby, onKeyDown: handleListKeyDown, onWheel: handleMenuScrollCapture, onTouchMove: handleMenuScrollCapture, autoFocus: open }, other, { ref: ref, children: children })));
});
