...
var GridGenericColumnMenu = (0, forwardRef_1.forwardRef)(function GridGenericColumnMenu(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(GridColumnMenuContainer_1.GridColumnMenuContainer, __assign({}, other, { ref: ref, children: orderedSlots.map(function (_a, index) {
            var Component = _a[0], otherProps = _a[1];
            return ((0, jsx_runtime_1.jsx)(Component, __assign({}, otherProps), index));
        }) })));
});
...
var GridColumnMenu = (0, forwardRef_1.forwardRef)(function GridColumnMenu(props, ref) {
    return ((0, jsx_runtime_1.jsx)(GridGenericColumnMenu, __assign({}, props, { ref: ref, defaultSlots: exports.GRID_COLUMN_MENU_SLOTS, defaultSlotProps: exports.GRID_COLUMN_MENU_SLOT_PROPS })));
});
