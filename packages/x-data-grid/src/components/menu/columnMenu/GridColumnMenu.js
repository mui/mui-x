...
const GridGenericColumnMenu = forwardRef(function GridGenericColumnMenu(props, ref) {
    ...
    return (_jsx(GridColumnMenuContainer, { ...other, ref: ref, children: orderedSlots.map(([Component, otherProps], index) => (_jsx(Component, { ...otherProps }, index))) }));
});
...
const GridColumnMenu = forwardRef(function GridColumnMenu(props, ref) {
    return (_jsx(GridGenericColumnMenu, { ...props, ref: ref, defaultSlots: GRID_COLUMN_MENU_SLOTS, defaultSlotProps: GRID_COLUMN_MENU_SLOT_PROPS }));
});
