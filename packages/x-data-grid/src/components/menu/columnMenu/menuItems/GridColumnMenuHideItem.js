...
function GridColumnMenuHideItem(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(rootProps.slots.baseMenuItem, { onClick: toggleColumn, disabled: disabled, iconStart: (0, jsx_runtime_1.jsx)(rootProps.slots.columnMenuHideIcon, { fontSize: "small" }), children: apiRef.current.getLocaleText('columnMenuHideColumn') }));
}
