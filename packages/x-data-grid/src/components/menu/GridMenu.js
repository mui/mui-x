...
function GridMenu(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(GridMenuRoot, __assign({ as: rootProps.slots.basePopper, className: (0, clsx_1.default)(classes.root, className, variablesClass), ownerState: rootProps, open: open, target: target, transition: true, placement: position, onClickAway: handleClickAway, onExited: onExited, clickAwayMouseEvent: "onMouseDown", onKeyDown: handleKeyDown }, other, (_a = rootProps.slotProps) === null || _a === void 0 ? void 0 : _a.basePopper, { children: children })));
}
GridMenu.propTypes = {
    // ----------------------------- Warning --------------------------------
