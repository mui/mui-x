...
function getIcon(icons, direction, className, sortingOrder) {
    ...
    return Icon ? (0, jsx_runtime_1.jsx)(Icon, __assign({ fontSize: "small", className: className }, iconProps)) : null;
}
function GridColumnSortButton(props) {
    ...
    var iconButton = ((0, jsx_runtime_1.jsx)(GridColumnSortButtonRoot, __assign({ as: rootProps.slots.baseIconButton, ownerState: ownerState, "aria-label": apiRef.current.getLocaleText('columnHeaderSortIconLabel'), title: apiRef.current.getLocaleText('columnHeaderSortIconLabel'), size: "small", disabled: disabled, className: (0, clsx_1.default)(classes.root, className) }, (_a = rootProps.slotProps) === null || _a === void 0 ? void 0 : _a.baseIconButton, other, { children: iconElement })));
    return ((0, jsx_runtime_1.jsxs)(React.Fragment, { children: [index != null && ((0, jsx_runtime_1.jsx)(rootProps.slots.baseBadge, { badgeContent: index, color: "default", overlap: "circular", children: iconButton })), index == null && iconButton] }));
}
