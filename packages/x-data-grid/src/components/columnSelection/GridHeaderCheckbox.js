...
var GridHeaderCheckbox = (0, forwardRef_1.forwardRef)(function GridHeaderCheckbox(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(rootProps.slots.baseCheckbox, __assign({ indeterminate: isIndeterminate, checked: isChecked && !isIndeterminate, onChange: handleChange, className: classes.root, slotProps: {
