...
var GridCellCheckboxForwardRef = (0, forwardRef_1.forwardRef)(function GridCellCheckboxRenderer(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(rootProps.slots.baseCheckbox, __assign({ tabIndex: tabIndex, checked: isChecked && !isIndeterminate, onChange: handleChange, className: classes.root, slotProps: {
