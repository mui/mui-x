...
const GridCellCheckboxForwardRef = forwardRef(function GridCellCheckboxRenderer(props, ref) {
    const { field, id, formattedValue, row, rowNode, colDef, isEditable, cellMode, hasFocus, tabIndex, api, ...other } = props;
    ...
    return (_jsx(rootProps.slots.rowCheckbox, { rowId: id, tabIndex: disabled ? -1 : tabIndex, checked: isChecked && !isIndeterminate, onChange: handleChange, onClick: handleClick, onMouseDown: handleMouseDown, className: clsx(classes.root, disabled && 'Mui-disabled'), disabled: disabled, slotProps: {
            htmlInput: {
                'aria-disabled': disabled || undefined,
                'aria-label': label,
                name: 'select_row',
            },
        }, onKeyDown: handleKeyDown, indeterminate: isIndeterminate, ...rootProps.slotProps?.rowCheckbox, ...other, ref: ref }));
});
