...
function QuickFilter(props) {
    ...
    const { render, className, parser = DEFAULT_PARSER, formatter = DEFAULT_FORMATTER, debounceMs = rootProps.filterDebounceMs, defaultExpanded, expanded, onExpandedChange, ...other } = props;
    ...
    React.useEffect(() => {
        if (!isDeepEqual(prevQuickFilterValuesRef.current, quickFilterValues)) {
            ...
            setValue((prevSearchValue) => isDeepEqual(parser(prevSearchValue), quickFilterValues)
                ? prevSearchValue
    ...
    return _jsx(QuickFilterContext.Provider, { value: contextValue, children: element });
}
