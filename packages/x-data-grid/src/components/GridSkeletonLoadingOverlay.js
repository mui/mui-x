...
exports.GridSkeletonLoadingOverlayInner = (0, forwardRef_1.forwardRef)(function GridSkeletonLoadingOverlayInner(props, forwardedRef) {
    ...
    var skeletonRowsCount = props.skeletonRowsCount, visibleColumns = props.visibleColumns, showFirstRowBorder = props.showFirstRowBorder, other = __rest(props, ["skeletonRowsCount", "visibleColumns", "showFirstRowBorder"]);
    ...
    var children = React.useMemo(function () {
        ...
        for (var i = 0; i < skeletonRowsCount; i += 1) {
            ...
            var _loop_1 = function (colIndex) {
                ...
                var showRightBorder = (0, cellBorderUtils_1.shouldCellShowRightBorder)(pinnedPosition, sectionIndex, sectionLength, rootProps.showCellVerticalBorder, gridHasFiller, rootProps.pinnedColumnsSectionSeparator);
                var showLeftBorder = (0, cellBorderUtils_1.shouldCellShowLeftBorder)(pinnedPosition, sectionIndex, rootProps.showCellVerticalBorder, rootProps.pinnedColumnsSectionSeparator);
                ...
                var emptyCell = ((0, jsx_runtime_1.jsx)(slots.skeletonCell, { width: emptyCellWidth, empty: true }, "skeleton-filler-column-".concat(i)));
                if (hasFillerBefore) {
                    rowCells.push(emptyCell);
                }
                rowCells.push((0, jsx_runtime_1.jsx)(slots.skeletonCell, { field: column.field, type: column.type, align: column.align, width: "var(--width)", height: dimensions.rowHeight, "data-colindex": colIndex, empty: visibleColumns && !visibleColumns.has(column.field), className: (0, clsx_1.default)(isPinnedLeft && gridClasses_1.gridClasses['cell--pinnedLeft'], isPinnedRight && gridClasses_1.gridClasses['cell--pinnedRight'], showRightBorder && gridClasses_1.gridClasses['cell--withRightBorder'], showLeftBorder && gridClasses_1.gridClasses['cell--withLeftBorder']), style: __assign({ '--width': "".concat(column.computedWidth, "px") }, pinnedStyle) }, "skeleton-column-".concat(i, "-").concat(column.field)));
                if (hasFillerAfter) {
                    rowCells.push(emptyCell);
                }
            };
            ...
            array.push((0, jsx_runtime_1.jsx)("div", { className: (0, clsx_1.default)(gridClasses_1.gridClasses.row, gridClasses_1.gridClasses.rowSkeleton, i === 0 && !showFirstRowBorder && gridClasses_1.gridClasses['row--firstVisible']), children: rowCells }, "skeleton-row-".concat(i)));
        }
        return array;
    }, [
        skeletonRowsCount,
    ...
    return ((0, jsx_runtime_1.jsx)(SkeletonOverlay, __assign({ className: classes.root }, other, { ref: handleRef, children: children })));
});
exports.GridSkeletonLoadingOverlay = (0, forwardRef_1.forwardRef)(function GridSkeletonLoadingOverlay(props, forwardedRef) {
    ...
    return ((0, jsx_runtime_1.jsx)(exports.GridSkeletonLoadingOverlayInner, __assign({}, props, { skeletonRowsCount: skeletonRowsCount, ref: forwardedRef })));
});
