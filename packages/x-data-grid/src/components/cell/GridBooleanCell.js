...
function GridBooleanCellRaw(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(Icon, __assign({ fontSize: "small", className: classes.root, titleAccess: apiRef.current.getLocaleText(value ? 'booleanCellTrueLabel' : 'booleanCellFalseLabel'), "data-value": Boolean(value) }, other)));
}
...
var renderBooleanCell = function (params) {
    ...
    return (0, jsx_runtime_1.jsx)(GridBooleanCell, __assign({}, params));
};
