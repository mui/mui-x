...
function GridBooleanCellRaw(props) {
    const { id, value, formattedValue, api, field, row, rowNode, colDef, cellMode, isEditable, hasFocus, tabIndex, hideDescendantCount, ...other } = props;
    ...
    return (_jsx(Icon, { fontSize: "small", className: classes.root, titleAccess: apiRef.current.getLocaleText(value ? 'booleanCellTrueLabel' : 'booleanCellFalseLabel'), "data-value": Boolean(value), ...other }));
}
...
export const renderBooleanCell = (params) => {
    ...
    return _jsx(GridBooleanCell, { ...params });
};
