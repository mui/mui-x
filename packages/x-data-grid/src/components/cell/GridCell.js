...
var GridCell = (0, forwardRef_1.forwardRef)(function GridCell(props, ref) {
    ...
    var _h = cellAggregationResult || {}, forcedValue = _h.value, forcedFormattedValue = _h.formattedValue;
    ...
    (0, useGridSelector_1.useGridSelector)(apiRef, function () { return apiRef.current.isCellEditable(cellParams); });
    ...
    var hasFocus = cellParams.hasFocus, _j = cellParams.isEditable, isEditable = _j === void 0 ? false : _j, value = cellParams.value;
    var canManageOwnFocus = column.type === 'actions' &&
        'getActions' in column &&
        typeof column.getActions === 'function' &&
        column.getActions(apiRef.current.getRowParams(rowId)).some(function (action) { return !action.props.disabled; });
    ...
    var valueToRender = (_a = cellParams.formattedValue) !== null && _a !== void 0 ? _a : value;
    var cellRef = React.useRef(null);
    var handleRef = (0, useForkRef_1.default)(ref, cellRef);
    var focusElementRef = React.useRef(null);
    var isSelectionMode = (_b = rootProps.cellSelection) !== null && _b !== void 0 ? _b : false;
    var ownerState = {
        align: align,
    ...
    var isCellRowSpanned = (_d = (_c = hiddenCells[rowId]) === null || _c === void 0 ? void 0 : _c[colIndex]) !== null && _d !== void 0 ? _d : false;
    var rowSpan = (_f = (_e = spannedCells[rowId]) === null || _e === void 0 ? void 0 : _e[colIndex]) !== null && _f !== void 0 ? _f : 1;
    ...
    if (isCellRowSpanned) {
        return ((0, jsx_runtime_1.jsx)("div", { "data-colindex": colIndex, role: "presentation", style: __assign({ width: 'var(--width)' }, style) }));
    }
    var handleFocus = other.onFocus;
    if (process.env.NODE_ENV === 'test' &&
        ((_g = rootProps.experimentalFeatures) === null || _g === void 0 ? void 0 : _g.warnIfFocusStateIsNotSynced)) {
