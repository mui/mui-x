...
function GridSkeletonCell(props) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", __assign({ "data-field": field, className: (0, clsx_1.default)(classes.root, className), style: __assign({ height: height, maxWidth: width, minWidth: width }, style) }, other, { children: !empty && (0, jsx_runtime_1.jsx)(rootProps.slots.baseSkeleton, __assign({}, skeletonProps)) })));
}
