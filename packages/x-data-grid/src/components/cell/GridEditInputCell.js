...
var GridEditInputCell = (0, forwardRef_1.forwardRef)(function (props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(GridEditInputCellRoot, __assign({ as: rootProps.slots.baseInput, inputRef: inputRef, className: classes.root, ownerState: rootProps, fullWidth: true, type: colDef.type === 'number' ? colDef.type : 'text', value: valueState !== null && valueState !== void 0 ? valueState : '', onChange: handleChange, endAdornment: isProcessingProps ? (0, jsx_runtime_1.jsx)(rootProps.slots.loadIcon, { fontSize: "small", color: "action" }) : undefined }, other, slotProps === null || slotProps === void 0 ? void 0 : slotProps.root, { ref: ref })));
});
exports.GridEditInputCell = GridEditInputCell;
var renderEditInputCell = function (params) { return ((0, jsx_runtime_1.jsx)(GridEditInputCell, __assign({}, params))); };
