...
function GridEditDateCell(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(StyledInputBase, __assign({ as: rootProps.slots.baseInput, inputRef: inputRef, fullWidth: true, className: classes.root, type: isDateTime ? 'datetime-local' : 'date', value: valueState.formatted, onChange: handleChange }, other, slotProps === null || slotProps === void 0 ? void 0 : slotProps.root, { slotProps: {
...
var renderEditDateCell = function (params) { return ((0, jsx_runtime_1.jsx)(GridEditDateCell, __assign({}, params))); };
