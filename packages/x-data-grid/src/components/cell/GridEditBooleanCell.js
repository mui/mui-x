...
function GridEditBooleanCell(props) {
    ...
    return ((0, jsx_runtime_1.jsx)("label", __assign({ htmlFor: id, className: (0, clsx_1.default)(classes.root, className) }, other, { children: (0, jsx_runtime_1.jsx)(rootProps.slots.baseCheckbox, __assign({ id: id, inputRef: inputRef, checked: Boolean(valueState), onChange: handleChange, size: "small" }, (_a = rootProps.slotProps) === null || _a === void 0 ? void 0 : _a.baseCheckbox)) })));
}
...
var renderEditBooleanCell = function (params) { return ((0, jsx_runtime_1.jsx)(GridEditBooleanCell, __assign({}, params))); };
