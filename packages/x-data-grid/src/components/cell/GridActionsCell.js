...
function GridActionsCell(props) {
    ...
    var attributes = numberOfButtons > 0
        ? {
            role: 'menu',
            onKeyDown: handleRootKeyDown,
        }
        : undefined;
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ ref: rootRef, tabIndex: -1, className: gridClasses_1.gridClasses.actionsCell }, attributes, other, { children: [iconButtons.map(function (button, index) {
            ...
            }), menuButtons.length > 0 && buttonId && ((0, jsx_runtime_1.jsx)(rootProps.slots.baseIconButton, __assign({ ref: buttonRef, id: buttonId, "aria-label": apiRef.current.getLocaleText('actionsCellMore'), "aria-haspopup": "menu", "aria-expanded": open, "aria-controls": open ? menuId : undefined, role: "menuitem", size: "small", onClick: toggleMenu, touchRippleRef: handleTouchRippleRef(buttonId), tabIndex: focusedButtonIndex === iconButtons.length ? tabIndex : -1 }, (_a = rootProps.slotProps) === null || _a === void 0 ? void 0 : _a.baseIconButton, { children: (0, jsx_runtime_1.jsx)(rootProps.slots.moreActionsIcon, { fontSize: "small" }) }))), menuButtons.length > 0 && ((0, jsx_runtime_1.jsx)(GridMenu_1.GridMenu, { open: open, target: buttonRef.current, position: position, onClose: hideMenu, children: (0, jsx_runtime_1.jsx)(rootProps.slots.baseMenuList, { id: menuId, className: gridClasses_1.gridClasses.menuList, "aria-labelledby": buttonId, autoFocusItem: true, children: menuButtons.map(function (button, index) {
...
var renderActionsCell = function (params) { return (0, jsx_runtime_1.jsx)(GridActionsCell, __assign({}, params)); };
