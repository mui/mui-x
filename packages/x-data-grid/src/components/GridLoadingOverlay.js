...
var GridLoadingOverlay = (0, forwardRef_1.forwardRef)(function GridLoadingOverlay(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(GridOverlay_1.GridOverlay, __assign({ style: __assign(__assign({}, activeVariant.style), style) }, other, { ref: ref, children: (0, jsx_runtime_1.jsx)(Component, {}) })));
});
