...
var GridColumnHeaders = (0, forwardRef_1.forwardRef)(function GridColumnHeaders(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)(GridBaseColumnHeaders_1.GridBaseColumnHeaders, __assign({}, other, getInnerProps(), { ref: ref, children: [getColumnGroupHeadersRows(), getColumnHeadersRow()] })));
});
