...
var GridRoot = (0, forwardRef_1.forwardRef)(function GridRoot(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)(GridRootStyles_1.GridRootStyles, __assign({ className: (0, clsx_1.default)(classes.root, className, cssVariables.className, sidePanel && gridClasses_1.gridClasses.withSidePanel), ownerState: ownerState }, other, { ref: handleRef, children: [(0, jsx_runtime_1.jsxs)("div", { className: gridClasses_1.gridClasses.mainContent, role: "presentation", children: [(0, jsx_runtime_1.jsx)(GridHeader_1.GridHeader, {}), (0, jsx_runtime_1.jsx)(base_1.GridBody, { children: children }), (0, jsx_runtime_1.jsx)(base_1.GridFooterPlaceholder, {})] }), sidePanel, cssVariables.tag] })));
});
GridRoot.propTypes = {
    // ----------------------------- Warning --------------------------------
