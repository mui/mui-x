...
// FIXME: We will want to set the CSS variables on the :root scope for perf reasons.
export const GridCSSVariables = styled('div')(({ theme: t }) => transformMaterialUITheme(t));

export const gridCSSVariables = transformMaterialUITheme;
