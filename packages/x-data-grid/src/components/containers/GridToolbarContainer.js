...
var GridToolbarContainerRoot = (0, system_1.styled)(toolbarV8_1.Toolbar, {
    name: 'MuiDataGrid',
    ...
    padding: cssVariables_1.vars.spacing(0.5),
    minHeight: 'auto',
});
/**
 ...
 */
var GridToolbarContainer = (0, forwardRef_1.forwardRef)(function GridToolbarContainer(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(GridToolbarContainerRoot, __assign({ className: (0, clsx_1.default)(classes.root, className), ownerState: rootProps }, other, { ref: ref, children: children })));
});
