...
export interface GridToolbarExportToggleButtonProps {
...
const GridToolbarExportToggleButton = React.forwardRef<
  HTMLButtonElement,
  GridToolbarExportToggleButtonProps
>(function GridToolbarExportToggleButton(props, ref) {
...
GridToolbarExportToggleButton.propTypes = {
  // ----------------------------- Warning --------------------------------
...
export { GridToolbarExportToggleButton };
