...
var GridToolbarFilterButton = (0, forwardRef_1.forwardRef)(function GridToolbarFilterButton(props, ref) {
    ...
    var tooltipContentNode = React.useMemo(function () {
        ...
        return ((0, jsx_runtime_1.jsxs)("div", { children: [apiRef.current.getLocaleText('toolbarFiltersTooltipActive')(activeFilters.length), (0, jsx_runtime_1.jsx)(GridToolbarFilterListRoot, { className: classes.root, ownerState: rootProps, children: activeFilters.map(function (item, index) { return (__assign({}, (lookup[item.field] && ((0, jsx_runtime_1.jsx)("li", { children: "".concat(lookup[item.field].headerName || item.field, "\n                  ").concat(getOperatorLabel(item), "\n                  ").concat(
    ...
    return ((0, jsx_runtime_1.jsx)(rootProps.slots.baseTooltip, __assign({ title: tooltipContentNode, enterDelay: 1000 }, (_a = rootProps.slotProps) === null || _a === void 0 ? void 0 : _a.baseTooltip, tooltipProps, { children: (0, jsx_runtime_1.jsx)(rootProps.slots.baseButton, __assign({ id: filterButtonId, size: "small", "aria-label": apiRef.current.getLocaleText('toolbarFiltersLabel'), "aria-controls": isOpen ? filterPanelId : undefined, "aria-expanded": isOpen, "aria-haspopup": true, startIcon: (0, jsx_runtime_1.jsx)(rootProps.slots.baseBadge, __assign({ badgeContent: activeFilters.length, color: "primary" }, (_b = rootProps.slotProps) === null || _b === void 0 ? void 0 : _b.baseBadge, badgeProps, { children: (0, jsx_runtime_1.jsx)(rootProps.slots.openFilterButtonIcon, {}) })) }, (_c = rootProps.slotProps) === null || _c === void 0 ? void 0 : _c.baseButton, buttonProps, { onClick: toggleFilter, onPointerUp: function (event) {
                var _a;
                if (preferencePanel.open) {
