...
function GridToolbarQuickFilter(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(quickFilter_1.QuickFilter, { parser: quickFilterParser, formatter: quickFilterFormatter, debounceMs: debounceMs, render: function (quickFilterProps, state) {
            var currentOwnerState = __assign(__assign({}, ownerState), { expanded: state.expanded });
            return ((0, jsx_runtime_1.jsxs)(GridQuickFilterRoot, __assign({}, quickFilterProps, { className: (0, clsx_1.default)(classes.root, className), children: [(0, jsx_runtime_1.jsx)(quickFilter_1.QuickFilterTrigger, { render: function (triggerProps) { return ((0, jsx_runtime_1.jsx)(rootProps.slots.baseTooltip, { title: apiRef.current.getLocaleText('toolbarQuickFilterLabel'), enterDelay: 0, children: (0, jsx_runtime_1.jsx)(GridQuickFilterTrigger, __assign({ className: classes.trigger }, triggerProps, { ownerState: currentOwnerState, color: "default", "aria-disabled": state.expanded, children: (0, jsx_runtime_1.jsx)(rootProps.slots.quickFilterIcon, { fontSize: "small" }) })) })); } }), (0, jsx_runtime_1.jsx)(quickFilter_1.QuickFilterControl, { render: function (_a) {
                            var _b;
                            var ref = _a.ref, controlSlotProps = _a.slotProps, controlProps = __rest(_a, ["ref", "slotProps"]);
                            return ((0, jsx_runtime_1.jsx)(GridQuickFilterTextField, __assign({ as: rootProps.slots.baseTextField, className: classes.control, ownerState: currentOwnerState, inputRef: ref, "aria-label": apiRef.current.getLocaleText('toolbarQuickFilterLabel'), placeholder: apiRef.current.getLocaleText('toolbarQuickFilterPlaceholder'), size: "small", slotProps: __assign({ input: __assign({ startAdornment: (0, jsx_runtime_1.jsx)(rootProps.slots.quickFilterIcon, { fontSize: "small" }), endAdornment: controlProps.value ? ((0, jsx_runtime_1.jsx)(quickFilter_1.QuickFilterClear, { render: (0, jsx_runtime_1.jsx)(rootProps.slots.baseIconButton, { size: "small", edge: "end", "aria-label": apiRef.current.getLocaleText('toolbarQuickFilterDeleteIconLabel'), children: (0, jsx_runtime_1.jsx)(rootProps.slots.quickFilterClearIcon, { fontSize: "small" }) }) })) : null }, controlSlotProps === null || controlSlotProps === void 0 ? void 0 : controlSlotProps.input) }, controlSlotProps) }, (_b = rootProps.slotProps) === null || _b === void 0 ? void 0 : _b.baseTextField, controlProps, slotProps === null || slotProps === void 0 ? void 0 : slotProps.root, other)));
                        } })] })));
        } }));
}
