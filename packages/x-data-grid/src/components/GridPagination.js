...
function GridPagination() {
    ...
    const pageSizeOptions = isPageSizeIncludedInPageSizeOptions(paginationModel.pageSize)
        ...
        : [];
    return (_jsx(GridPaginationRoot, { as: rootProps.slots.basePagination, count: rowCount ?? -1, page: computedPage, rowsPerPageOptions: pageSizeOptions, rowsPerPage: paginationModel.pageSize, onPageChange: handlePageChange, onRowsPerPageChange: handlePageSizeChange, disabled: disabled, ...rootProps.slotProps?.basePagination }));
}
