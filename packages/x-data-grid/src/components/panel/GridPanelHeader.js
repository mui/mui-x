...
var GridPanelHeaderRoot = (0, system_1.styled)('div', {
    name: 'MuiDataGrid',
    slot: 'PanelHeader',
})({
    padding: cssVariables_1.vars.spacing(1),
});
function GridPanelHeader(props) {
    var className = props.className, other = __rest(props, ["className"]);
    var rootProps = (0, useGridRootProps_1.useGridRootProps)();
    var classes = useUtilityClasses(rootProps);
    return ((0, jsx_runtime_1.jsx)(GridPanelHeaderRoot, __assign({ className: (0, clsx_1.default)(classes.root, className), ownerState: rootProps }, other)));
}
