...
export function GridPreferencesPanel() {
    ...
    return (_jsx(rootProps.slots.panel, { id: preferencePanelState.panelId, open: columns.length > 0 && preferencePanelState.open, "aria-labelledby": preferencePanelState.labelId, target: target, onClose: () => apiRef.current.hidePreferences(), ...rootProps.slotProps?.panel, children: panelContent }));
}
