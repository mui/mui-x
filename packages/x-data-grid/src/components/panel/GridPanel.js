...
var GridPanel = (0, forwardRef_1.forwardRef)(function (props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(GridPanelRoot, __assign({ as: rootProps.slots.basePopper, ownerState: rootProps, placement: "bottom-end", className: (0, clsx_1.default)(classes.panel, className, variablesClass), flip: true, onDidShow: onDidShow, onDidHide: onDidHide, onClickAway: handleClickAway, clickAwayMouseEvent: "onPointerUp", clickAwayTouchEvent: false, focusTrap: true }, other, (_a = rootProps.slotProps) === null || _a === void 0 ? void 0 : _a.basePopper, { target: (_b = props.target) !== null && _b !== void 0 ? _b : fallbackTarget, ref: ref, children: (0, jsx_runtime_1.jsx)(GridPanelContent, { className: classes.paper, ownerState: rootProps, onKeyDown: handleKeyDown, children: isPlaced && children }) })));
});
