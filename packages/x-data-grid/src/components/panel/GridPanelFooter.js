...
var GridPanelFooterRoot = (0, styles_1.styled)('div', {
    name: 'MuiDataGrid',
    slot: 'PanelFooter',
})({
...
function GridPanelFooter(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(GridPanelFooterRoot, __assign({ className: (0, clsx_1.default)(classes.root, className), ownerState: rootProps }, other)));
}
