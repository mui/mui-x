...
var GridPanelContentRoot = (0, system_1.styled)('div', {
    name: 'MuiDataGrid',
    slot: 'PanelContent',
})({
    display: 'flex',
    ...
    flex: '1 1',
    maxHeight: 400,
    padding: cssVariables_1.vars.spacing(2.5, 1.5, 2, 1),
    gap: cssVariables_1.vars.spacing(2.5),
});
function GridPanelContent(props) {
    var className = props.className, other = __rest(props, ["className"]);
    var rootProps = (0, useGridRootProps_1.useGridRootProps)();
    var classes = useUtilityClasses(rootProps);
    return ((0, jsx_runtime_1.jsx)(GridPanelContentRoot, __assign({ className: (0, clsx_1.default)(classes.root, className), ownerState: rootProps }, other)));
}
