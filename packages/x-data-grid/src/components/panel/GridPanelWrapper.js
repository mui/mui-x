...
var GridPanelWrapper = (0, forwardRef_1.forwardRef)(function GridPanelWrapper(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(GridPanelWrapperRoot, __assign({ tabIndex: -1, className: (0, clsx_1.default)(classes.root, className), ownerState: rootProps }, other, { ref: ref })));
});
