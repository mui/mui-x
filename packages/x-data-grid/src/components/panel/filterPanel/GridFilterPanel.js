...
var GridFilterPanel = (0, forwardRef_1.forwardRef)(function GridFilterPanel(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)(GridPanelWrapper_1.GridPanelWrapper, __assign({}, other, { ref: ref, children: [(0, jsx_runtime_1.jsxs)(GridPanelContent_1.GridPanelContent, { children: [readOnlyFilters.map(function (item, index) { return ((0, jsx_runtime_1.jsx)(GridFilterForm_1.GridFilterForm, __assign({ item: item, applyFilterChanges: applyFilter, deleteFilter: deleteFilter, hasMultipleFilters: hasMultipleFilters, showMultiFilterOperators: index > 0, disableMultiFilterOperator: index !== 1, applyMultiFilterOperatorChanges: applyFilterLogicOperator, focusElementRef: null, readOnly: true, logicOperators: logicOperators, columnsSort: columnsSort }, filterFormProps), item.id == null ? index : item.id)); }), validFilters.map(function (item, index) { return ((0, jsx_runtime_1.jsx)(GridFilterForm_1.GridFilterForm, __assign({ item: item, applyFilterChanges: applyFilter, deleteFilter: deleteFilter, hasMultipleFilters: hasMultipleFilters, showMultiFilterOperators: readOnlyFilters.length + index > 0, disableMultiFilterOperator: readOnlyFilters.length + index !== 1, applyMultiFilterOperatorChanges: applyFilterLogicOperator, focusElementRef: index === validFilters.length - 1 ? lastFilterRef : null, logicOperators: logicOperators, columnsSort: columnsSort }, filterFormProps), item.id == null ? index + readOnlyFilters.length : item.id)); })] }), !rootProps.disableMultipleColumnsFiltering &&
                !(disableAddFilterButton && disableRemoveAllButton) ? ((0, jsx_runtime_1.jsxs)(GridPanelFooter_1.GridPanelFooter, { children: [!disableAddFilterButton ? ((0, jsx_runtime_1.jsx)(rootProps.slots.baseButton, __assign({ onClick: addNewFilter, startIcon: (0, jsx_runtime_1.jsx)(rootProps.slots.filterPanelAddIcon, {}) }, (_a = rootProps.slotProps) === null || _a === void 0 ? void 0 : _a.baseButton, { children: apiRef.current.getLocaleText('filterPanelAddFilter') }))) : ((0, jsx_runtime_1.jsx)("span", {})), !disableRemoveAllButton && validFilters.length > 0 ? ((0, jsx_runtime_1.jsx)(rootProps.slots.baseButton, __assign({ onClick: handleRemoveAll, startIcon: (0, jsx_runtime_1.jsx)(rootProps.slots.filterPanelRemoveAllIcon, {}) }, (_b = rootProps.slotProps) === null || _b === void 0 ? void 0 : _b.baseButton, { children: apiRef.current.getLocaleText('filterPanelRemoveAll') }))) : null] })) : null] })));
});
