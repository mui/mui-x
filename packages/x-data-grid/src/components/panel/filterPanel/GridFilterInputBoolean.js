...
function GridFilterInputBoolean(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(React.Fragment, { children: [(0, jsx_runtime_1.jsxs)(rootProps.slots.baseSelect, __assign({ fullWidth: true, labelId: labelId, id: selectId, label: label, value: filterValueState === undefined ? '' : String(filterValueState), onChange: onFilterChange, native: isSelectNative, slotProps: {
                ...
                } }, baseSelectProps, other, slotProps === null || slotProps === void 0 ? void 0 : slotProps.root, { children: [(0, jsx_runtime_1.jsx)(rootProps.slots.baseSelectOption, __assign({}, baseSelectOptionProps, { native: isSelectNative, value: "", children: apiRef.current.getLocaleText('filterValueAny') })), (0, jsx_runtime_1.jsx)(rootProps.slots.baseSelectOption, __assign({}, baseSelectOptionProps, { native: isSelectNative, value: "true", children: apiRef.current.getLocaleText('filterValueTrue') })), (0, jsx_runtime_1.jsx)(rootProps.slots.baseSelectOption, __assign({}, baseSelectOptionProps, { native: isSelectNative, value: "false", children: apiRef.current.getLocaleText('filterValueFalse') }))] })), headerFilterMenu, clearButton] }));
}
