...
function GridFilterInputSingleSelect(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(React.Fragment, { children: [(0, jsx_runtime_1.jsx)(rootProps.slots.baseSelect, __assign({ fullWidth: true, id: id, label: label, labelId: labelId, value: filterValue, onChange: onFilterChange, slotProps: {
                ...
                }, native: isSelectNative }, (_h = rootProps.slotProps) === null || _h === void 0 ? void 0 : _h.baseSelect, other, slotProps === null || slotProps === void 0 ? void 0 : slotProps.root, { children: renderSingleSelectOptions({
