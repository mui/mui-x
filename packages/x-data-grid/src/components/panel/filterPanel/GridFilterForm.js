...
var GridFilterForm = (0, forwardRef_1.forwardRef)(function GridFilterForm(props, ref) {
    ...
    var changeColumn = React.useCallback(function (event) {
        ...
        if (column.type === 'singleSelect' && filterValue !== undefined) {
            ...
            else if ((0, filterPanelUtils_1.getValueFromValueOptions)(item.value, valueOptions_1, colDef_1 === null || colDef_1 === void 0 ? void 0 : colDef_1.getOptionValue) === undefined) {
    ...
    return ((0, jsx_runtime_1.jsxs)(GridFilterFormRoot, __assign({ className: classes.root, "data-id": item.id, ownerState: rootProps }, other, { ref: ref, children: [(0, jsx_runtime_1.jsx)(FilterFormDeleteIcon, __assign({}, deleteIconProps, { className: (0, clsx_1.default)(classes.deleteIcon, deleteIconProps.className), ownerState: rootProps, children: (0, jsx_runtime_1.jsx)(rootProps.slots.baseIconButton, __assign({ "aria-label": apiRef.current.getLocaleText('filterPanelDeleteIconLabel'), title: apiRef.current.getLocaleText('filterPanelDeleteIconLabel'), onClick: handleDeleteFilter, size: "small", disabled: readOnly }, (_e = rootProps.slotProps) === null || _e === void 0 ? void 0 : _e.baseIconButton, { children: (0, jsx_runtime_1.jsx)(rootProps.slots.filterPanelDeleteIcon, { fontSize: "small" }) })) })), (0, jsx_runtime_1.jsx)(FilterFormLogicOperatorInput, __assign({ as: rootProps.slots.baseSelect, sx: [
                ...
                }, value: multiFilterOperator !== null && multiFilterOperator !== void 0 ? multiFilterOperator : '', onChange: changeLogicOperator, disabled: !!disableMultiFilterOperator || logicOperators.length === 1, native: isBaseSelectNative }, (_f = rootProps.slotProps) === null || _f === void 0 ? void 0 : _f.baseSelect, { children: logicOperators.map(function (logicOperator) { return ((0, react_1.createElement)(rootProps.slots.baseSelectOption, __assign({}, baseSelectOptionProps, { native: isBaseSelectNative, key: logicOperator.toString(), value: logicOperator.toString() }), apiRef.current.getLocaleText(getLogicOperatorLocaleKey(logicOperator)))); }) })), (0, jsx_runtime_1.jsx)(FilterFormColumnInput, __assign({ as: rootProps.slots.baseSelect }, columnInputProps, { className: (0, clsx_1.default)(classes.columnInput, columnInputProps.className), ownerState: rootProps, size: "small", labelId: columnSelectLabelId, id: columnSelectId, label: apiRef.current.getLocaleText('filterPanelColumns'), value: selectedField !== null && selectedField !== void 0 ? selectedField : '', onChange: changeColumn, native: isBaseSelectNative, disabled: readOnly }, (_g = rootProps.slotProps) === null || _g === void 0 ? void 0 : _g.baseSelect, { children: sortedFilteredColumns.map(function (col) { return ((0, react_1.createElement)(rootProps.slots.baseSelectOption, __assign({}, baseSelectOptionProps, { native: isBaseSelectNative, key: col.field, value: col.field }), getColumnLabel(col))); }) })), (0, jsx_runtime_1.jsx)(FilterFormOperatorInput, __assign({ as: rootProps.slots.baseSelect, size: "small" }, operatorInputProps, { className: (0, clsx_1.default)(classes.operatorInput, operatorInputProps.className), ownerState: rootProps, labelId: operatorSelectLabelId, label: apiRef.current.getLocaleText('filterPanelOperator'), id: operatorSelectId, value: item.operator, onChange: changeOperator, native: isBaseSelectNative, inputRef: filterSelectorRef, disabled: readOnly }, (_h = rootProps.slotProps) === null || _h === void 0 ? void 0 : _h.baseSelect, { children: (_j = currentColumn === null || currentColumn === void 0 ? void 0 : currentColumn.filterOperators) === null || _j === void 0 ? void 0 : _j.map(function (operator) { return ((0, react_1.createElement)(rootProps.slots.baseSelectOption, __assign({}, baseSelectOptionProps, { native: isBaseSelectNative, key: operator.value, value: operator.value }), operator.label ||
                    apiRef.current.getLocaleText("filterOperator".concat((0, capitalize_1.default)(operator.value))))); }) })), (0, jsx_runtime_1.jsx)(FilterFormValueInput, __assign({}, valueInputPropsOther, { className: (0, clsx_1.default)(classes.valueInput, valueInputPropsOther.className), ownerState: rootProps, children: (currentOperator === null || currentOperator === void 0 ? void 0 : currentOperator.InputComponent) ? ((0, jsx_runtime_1.jsx)(currentOperator.InputComponent, __assign({ apiRef: apiRef, item: item, applyValue: applyFilterChanges, focusElementRef: valueRef, disabled: readOnly, slotProps: {
                        root: { size: 'small' },
