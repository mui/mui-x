...
function GridFilterInputDate(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(React.Fragment, { children: [(0, jsx_runtime_1.jsx)(rootProps.slots.baseTextField, __assign({ fullWidth: true, id: id, label: apiRef.current.getLocaleText('filterPanelInputLabel'), placeholder: apiRef.current.getLocaleText('filterPanelInputPlaceholder'), value: filterValueState, onChange: onFilterChange, type: type || 'text', disabled: disabled, inputRef: focusElementRef, slotProps: __assign(__assign({}, rootSlotProps), { input: __assign({ endAdornment: applying ? ((0, jsx_runtime_1.jsx)(rootProps.slots.loadIcon, { fontSize: "small", color: "action" })) : null }, rootSlotProps === null || rootSlotProps === void 0 ? void 0 : rootSlotProps.input), htmlInput: __assign({ max: type === 'datetime-local' ? '9999-12-31T23:59' : '9999-12-31', tabIndex: tabIndex }, rootSlotProps === null || rootSlotProps === void 0 ? void 0 : rootSlotProps.htmlInput) }) }, (_a = rootProps.slotProps) === null || _a === void 0 ? void 0 : _a.baseTextField, other, slotProps === null || slotProps === void 0 ? void 0 : slotProps.root)), headerFilterMenu, clearButton] }));
}
