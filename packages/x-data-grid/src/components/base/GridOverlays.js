...
function GridOverlayWrapper(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(GridOverlayWrapperRoot, __assign({ className: classes.root }, props, { right: dimensions.columnsTotalWidth - dimensions.viewportOuterSize.width, children: (0, jsx_runtime_1.jsx)(GridOverlayWrapperInner, __assign({ className: classes.inner, style: {
                height: height,
