...
exports.GRID_ACTIONS_COL_DEF = __assign(__assign({}, gridStringColDef_1.GRID_STRING_COL_DEF), { sortable: false, filterable: false, 
    // @ts-ignore
    aggregable: false, chartable: false, width: 100, display: 'flex', align: 'center', headerAlign: 'center', headerName: '', disableColumnMenu: true, disableExport: true, renderCell: GridActionsCell_1.renderActionsCell, getApplyQuickFilterFn: function () { return null; } });
