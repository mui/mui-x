...
var _setFunctionName = _interopRequireDefault(require("./setFunctionName.js"));
...
function applyDecs2203RFactory() {
  ...
  function memberDec(e, t, r, n, a, i, o, s) {
    ...
    var l,
      ...
      f = {
        kind: c,
        name: o ? "#" + t : (0, _toPropertyKey.default)(t),
        "static": i,
        "private": o
      },
      p = {
  ...
  function applyMemberDec(e, t, r, n, a, i, o, s) {
    ...
    if (o ? (0 === a || 1 === a ? (c = {
      ...
      value: r[3]
    }, 0 !== a && (1 === a && (0, _setFunctionName.default)(r[4], "#" + n, "set"), (0, _setFunctionName.default)(r[3], "#" + n, u))) : 0 !== a && (c = Object.getOwnPropertyDescriptor(t, n)), 1 === a ? f = {
      get: c.get,
      set: c.set
...
function applyDecs2203R(e, t, r) {
  return (exports.default = applyDecs2203R = applyDecs2203RFactory())(e, t, r);
}