...
exports.init = init;
exports.set = set;
var _index = require("../../../../lib-vendor/d3-dispatch/src/index.js");
var _index2 = require("../../../../lib-vendor/d3-timer/src/index.js");
var emptyOn = (0, _index.dispatch)("start", "end", "cancel", "interrupt");
var emptyTween = [];
...
function create(node, id, self) {
  ...
  schedules[id] = self;
  self.timer = (0, _index2.timer)(schedule, 0, self.time);
  ...
  function start(elapsed) {
    ...
    for (i in schedules) {
      ...
      if (o.state === STARTED) return (0, _index2.timeout)(start);
