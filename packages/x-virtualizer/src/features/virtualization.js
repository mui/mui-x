...
function useVirtualization(store, params, api) {
    ...
    var triggerUpdateRenderContext = (0, useEventCallback_1.default)(function () {
        ...
        var maxScrollTop = Math.ceil(dimensions.contentSize.height - dimensions.viewportInnerSize.height);
        var maxScrollLeft = Math.ceil(dimensions.contentSize.width - dimensions.viewportInnerSize.width);
