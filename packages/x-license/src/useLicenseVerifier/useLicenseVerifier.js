...
function useLicenseVerifier(packageInfo) {
    ...
    return React.useMemo(function () {
        ...
        (0, x_telemetry_1.sendMuiXTelemetryEvent)(x_telemetry_1.muiXTelemetryEvents.licenseVerification({ licenseKey: licenseKey, xLicenseClientVersion: packageVersion }, {
        ...
        if (licenseStatus.status === licenseStatus_1.LICENSE_STATUS.Valid) {
            ...
            (0, licenseErrorMessageUtils_1.showLicenseKeyPlanMismatchError)({ packageName: fullPackageName });
        }
        ...
        else if (licenseStatus.status === licenseStatus_1.LICENSE_STATUS.NotValidForPackage) {
            (0, licenseErrorMessageUtils_1.showLicenseKeyVersionMismatchError)();
        }
