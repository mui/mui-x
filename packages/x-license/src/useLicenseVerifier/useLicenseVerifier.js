...
import { showExpiredAnnualGraceLicenseKeyError, showExpiredAnnualLicenseKeyError, showInvalidLicenseKeyError, showMissingLicenseKeyError, showLicenseKeyPlanMismatchError, showExpiredPackageVersionError, showNotAvailableInInitialProPlanError, showLicenseKeyVersionMismatchError, } from '../utils/licenseErrorMessageUtils';
...
export function useLicenseVerifier(packageInfo) {
    ...
    return React.useMemo(() => {
        ...
        if (sharedLicenseStatuses[packageName] &&
        ...
        sendMuiXTelemetryEvent(muiXTelemetryEvents.licenseVerification({ licenseKey, xLicenseClientVersion: packageVersion }, {
            packageName,
