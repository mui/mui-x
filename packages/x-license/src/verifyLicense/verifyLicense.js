...
import { PLAN_SCOPES, isPlanVersionOlderOrEqual, } from '../utils/licensePlan';
import { LICENSE_MODELS } from '../utils/licenseModel';
...
export function verifyLicense({ packageInfo, licenseKey, }) {
    ...
    if (license.licenseModel === 'perpetual' || process.env.NODE_ENV === 'production') {
        ...
        if (license.expiryTimestamp < pkgTimestamp) {
            ...
            if (packageMajorVersion != null &&
                ...
                isPlanVersionOlderOrEqual(license.planVersion, MAX_V8_PLAN_VERSION)) {
