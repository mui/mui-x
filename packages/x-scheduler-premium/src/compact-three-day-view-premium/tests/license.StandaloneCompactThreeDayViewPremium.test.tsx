...
describe('<StandaloneCompactThreeDayViewPremium /> - License', () => {
  ...
  it('should throw out of scope error when using StandaloneCompactThreeDayViewPremium with a pro license', () => {
