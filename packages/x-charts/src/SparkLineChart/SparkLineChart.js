...
var FocusedMark_1 = require("../LineChart/FocusedMark");
...
var SparkLineChart = React.forwardRef(function SparkLineChart(props, ref) {
    ...
    return (<ChartDataProvider_1.ChartDataProvider series={series} width={width} height={height} margin={margin} xAxis={xAxis} yAxis={yAxis} colors={colors} disableAxisListener={onHighlightedAxisChange === undefined &&
            ...
            (axisHighlight === null || axisHighlight === void 0 ? void 0 : axisHighlight.y) === 'none'} onHighlightChange={onHighlightChange} onHighlightedAxisChange={onHighlightedAxisChange} highlightedAxis={highlightedAxis} highlightedItem={highlightedItem}>
      <ChartsSurface_1.ChartsSurface className={className} ref={ref} sx={sx} {...other}>
        <g clipPath={"url(#".concat(clipPathId, ")")}>
          {plotType === 'bar' && <BarChart_1.BarPlot skipAnimation slots={slots} slotProps={slotProps}/>}

          {plotType === 'line' && (<React.Fragment>
              <LineChart_1.AreaPlot skipAnimation slots={slots} slotProps={slotProps}/>
              <LineChart_1.LinePlot skipAnimation slots={slots} slotProps={slotProps}/>
            </React.Fragment>)}
        </g>
        {plotType === 'line' && (<React.Fragment>
            <LineChart_1.LineHighlightPlot slots={slots} slotProps={slotProps}/>
            <FocusedMark_1.FocusedMark />
          </React.Fragment>)}
        {disableClipping ? null : <ChartsClipPath_1.ChartsClipPath id={clipPathId} offset={clipPathOffset}/>}
        <ChartsAxisHighlight_1.ChartsAxisHighlight {...axisHighlight}/>
        {children}
      </ChartsSurface_1.ChartsSurface>
      {showTooltip && <Tooltip {...(_d = props.slotProps) === null || _d === void 0 ? void 0 : _d.tooltip}/>}
