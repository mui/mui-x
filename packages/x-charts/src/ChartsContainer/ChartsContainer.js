...
var ChartsContainer = React.forwardRef(function ChartsContainer(props, ref) {
    var _a = (0, useChartsContainerProps_1.useChartsContainerProps)(props), chartDataProviderProps = _a.chartDataProviderProps, children = _a.children, chartsSurfaceProps = _a.chartsSurfaceProps;
    return ((0, jsx_runtime_1.jsx)(ChartDataProvider_1.ChartDataProvider, __assign({}, chartDataProviderProps, { children: (0, jsx_runtime_1.jsx)(ChartsSurface_1.ChartsSurface, __assign({}, chartsSurfaceProps, { ref: ref, children: children })) })));
});
...
ChartsContainer.propTypes = {
    ...
    hiddenItems: prop_types_1.default.arrayOf(prop_types_1.default.shape({
        dataIndex: prop_types_1.default.any,
        seriesId: prop_types_1.default.object.isRequired,
    ...
    tooltipItem: prop_types_1.default.shape({
        dataIndex: prop_types_1.default.number,
        seriesId: prop_types_1.default.string.isRequired,
        type: prop_types_1.default.oneOf(['bar', 'line', 'pie', 'radar', 'scatter']),
    }),
    /**
