...
describe.skipIf(skipIf_1.isJSDOM)('<ChartsSurface />', function () {
    ...
    it('should pass ref when it is added directly to component', function () {
        ...
        expect(((_b = (_a = ref.current) === null || _a === void 0 ? void 0 : _a.lastElementChild) === null || _b === void 0 ? void 0 : _b.lastElementChild) instanceof SVGRectElement, 'ref last child is a SVGRectElement').to.equal(true);
    });
});
