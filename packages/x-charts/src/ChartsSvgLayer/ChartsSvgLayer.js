...
var ChartsSvgLayer = React.forwardRef(function ChartsSvgLayer(inProps, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)(ChartsSvgLayerStyles, __assign({ viewBox: "0 0 ".concat(svgWidth, " ").concat(svgHeight), className: (0, clsx_1.default)(classes.root, className) }, other, { onPointerEnter: function (event) {
            var _a, _b;
        ...
        }, ref: ref, children: [title && (0, jsx_runtime_1.jsx)("title", { children: title }), desc && (0, jsx_runtime_1.jsx)("desc", { children: desc }), (0, jsx_runtime_1.jsx)(ChartsAxesGradients_1.ChartsAxesGradients, {}), hasIntrinsicSize && children] })));
});
