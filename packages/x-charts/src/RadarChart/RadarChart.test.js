...
describe('<RadarChart />', function () {
    ...
    (0, describeConformance_1.describeConformance)(<RadarChart_1.Unstable_RadarChart {...radarConfig}/>, function () { return ({
        classes: {},
    ...
    it('should render "No Data" overlay when series prop is an empty array', function () {
        render(<RadarChart_1.Unstable_RadarChart height={100} width={100} series={[]} radar={{ metrics: [] }}/>);
    ...
    it.skipIf(skipIf_1.isJSDOM)('should call onHighlightChange', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    onHighlightChange = (0, sinon_1.spy)();
                    user = render(<RadarChart_1.Unstable_RadarChart {...radarConfig} onHighlightChange={onHighlightChange}/>).user;
    ...
    it.skipIf(skipIf_1.isJSDOM)('should highlight axis on hover', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        <RadarChart_1.Unstable_RadarChart {...radarConfig}/>
      </div>).user;
