...
function RadarDataProvider(props) {
    ...
    return (<ChartDataProvider_1.ChartDataProvider {...other} series={defaultizedSeries} width={width} height={height} margin={defaultizedMargin} colors={colors} skipAnimation={skipAnimation} plugins={(plugins !== null && plugins !== void 0 ? plugins : RadarChart_plugins_1.RADAR_PLUGINS)} rotationAxis={rotationAxes} radiusAxis={radiusAxis} seriesConfig={RADAR_SERIES_CONFIG}>
      {children}
