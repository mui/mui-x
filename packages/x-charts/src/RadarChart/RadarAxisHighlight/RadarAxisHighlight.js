...
function RadarAxisHighlight(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("g", { className: classes.axisHighlightRoot, children: [(0, jsx_runtime_1.jsx)("path", { d: "M ".concat(center.cx, " ").concat(center.cy, " L ").concat(x, " ").concat(y), stroke: (theme.vars || theme).palette.text.primary, strokeWidth: 1, className: classes.axisHighlightLine, pointerEvents: "none", strokeDasharray: "4 4" }), points.map(function (point, seriesIndex) {
                var colorGetter = (0, getSeriesColorFn_1.getSeriesColorFn)(series[seriesIndex]);
                return ((0, jsx_runtime_1.jsx)("circle", __assign({ fill: colorGetter({ value: point.value, dataIndex: highlightedIndex }), cx: point.x, cy: point.y, className: classes.axisHighlightDot, pointerEvents: "none" }, (series[seriesIndex].hideMark ? highlightMark : highlightMarkShadow)), series[seriesIndex].id));
            })] }));
}
