...
var radarClasses_1 = require("../radarClasses");
...
function getPathProps(params) {
    var getHighlightState = params.getHighlightState, seriesId = params.seriesId, classes = params.classes, points = params.points, fillArea = params.fillArea, color = params.color;
    var highlightState = getHighlightState({ type: 'radar', seriesId: seriesId });
    var isItemHighlighted = highlightState === 'highlighted';
    var isItemFaded = highlightState === 'faded';
    return {
...
function RadarSeriesArea(props) {
    var seriesId = props.seriesId, onItemClick = props.onItemClick, inClasses = props.classes, other = __rest(props, ["seriesId", "onItemClick", "classes"]);
    ...
    var classes = (0, radarClasses_1.useUtilityClasses)(inClasses);
