...
function getCircleProps(params) {
    var getHighlightState = params.getHighlightState, seriesId = params.seriesId, classes = params.classes, point = params.point, fillArea = params.fillArea, color = params.color;
