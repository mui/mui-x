...
function RadarSeriesPlot(props) {
    ...
    return ((0, jsx_runtime_1.jsx)("g", { className: classes.seriesRoot, children: seriesCoordinates === null || seriesCoordinates === void 0 ? void 0 : seriesCoordinates.map(function (_a, seriesIndex) {
