...
function RadarGrid(props) {
    ...
    return shape === 'sharp' ? (<React.Fragment>
      {stripeColor && (<SharpRadarStripes_1.SharpRadarStripes divisions={divisions} corners={corners} center={center} radius={radius} stripeColor={stripeColor} classes={classes}/>)}
      <SharpRadarGrid_1.SharpRadarGrid divisions={divisions} corners={corners} center={center} radius={radius} strokeColor={(theme.vars || theme).palette.text.primary} classes={classes}/>
    </React.Fragment>) : (<React.Fragment>
      {stripeColor && (<CircularRadarStripes_1.CircularRadarStripes divisions={divisions} corners={corners} center={center} radius={radius} stripeColor={stripeColor} classes={classes}/>)}
      <CircularRadarGrid_1.CircularRadarGrid divisions={divisions} corners={corners} center={center} radius={radius} strokeColor={(theme.vars || theme).palette.text.primary} classes={classes}/>
    </React.Fragment>);
}
RadarGrid.propTypes = {
    // ----------------------------- Warning --------------------------------
