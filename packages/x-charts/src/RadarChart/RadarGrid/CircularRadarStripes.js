...
function CircularRadarStripes(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(React.Fragment, { children: divisionRadius.map(function (r, index) {
            ...
            return ((0, jsx_runtime_1.jsx)("path", { d: getPath(center, r, smallerRadius), fillRule: "evenodd", fill: (_b = stripeColor === null || stripeColor === void 0 ? void 0 : stripeColor(index)) !== null && _b !== void 0 ? _b : 'none', fillOpacity: 0.1, className: classes === null || classes === void 0 ? void 0 : classes.gridStripe }, r));
        }) }));
}
