...
function SharpRadarStripes(props) {
    ...
    return (<React.Fragment>
      {divisionRatio.map(function (ratio, index) {
            var _a, _b;
            var smallerRatio = (_a = divisionRatio[index - 1]) !== null && _a !== void 0 ? _a : 0;
            return (<path key={ratio} d={getPath(corners, center, ratio, smallerRatio)} stroke="none" fill={(_b = stripeColor === null || stripeColor === void 0 ? void 0 : stripeColor(index)) !== null && _b !== void 0 ? _b : 'none'} fillOpacity={0.1} className={classes === null || classes === void 0 ? void 0 : classes.stripe}/>);
        })}
    </React.Fragment>);
}
