...
function SharpRadarStripes(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(React.Fragment, { children: divisionRatio.map(function (ratio, index) {
            ...
            return ((0, jsx_runtime_1.jsx)("path", { d: getPath(corners, center, ratio, smallerRatio), stroke: "none", fill: (_b = stripeColor === null || stripeColor === void 0 ? void 0 : stripeColor(index)) !== null && _b !== void 0 ? _b : 'none', fillOpacity: 0.1, className: classes === null || classes === void 0 ? void 0 : classes.gridStripe }, ratio));
        }) }));
}
