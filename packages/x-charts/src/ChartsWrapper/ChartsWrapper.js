 ...
 */
var ChartsWrapper = React.forwardRef(function ChartsWrapper(props, ref) {
    var children = props.children, sx = props.sx, extendVertically = props.extendVertically, hideLegend = props.hideLegend, legendDirection = props.legendDirection, legendPosition = props.legendPosition, other = __rest(props, ["children", "sx", "extendVertically", "hideLegend", "legendDirection", "legendPosition"]);
    var chartRootRef = (0, useChartRootRef_1.useChartRootRef)();
    var handleRef = (0, useForkRef_1.default)(chartRootRef, ref);
    ...
    var ownerState = React.useMemo(function () { return ({
        hideLegend: hideLegend,
        legendDirection: legendDirection,
        legendPosition: legendPosition,
    }); }, [hideLegend, legendDirection, legendPosition]);
    return ((0, jsx_runtime_1.jsx)(Root, __assign({ ref: handleRef, ownerState: ownerState, sx: sx, extendVertically: extendVertically !== null && extendVertically !== void 0 ? extendVertically : propsHeight === undefined, width: propsWidth }, other, { children: children })));
});
