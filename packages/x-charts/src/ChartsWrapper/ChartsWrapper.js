...
function ChartsWrapper(props) {
    ...
    var _a = (0, useSelector_1.useSelector)(store, useChartDimensions_1.selectorChartPropsSize), propsWidth = _a.width, propsHeight = _a.height;
    return (<Root ref={chartRootRef} ownerState={props} sx={sx} extendVertically={extendVertically !== null && extendVertically !== void 0 ? extendVertically : propsHeight === undefined} width={propsWidth}>
      {children}
    </Root>);
}
