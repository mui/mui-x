...
function ChartsXHighlight(props) {
    ...
    return axisXValues.map(function (_a) {
        ...
        {isXScaleOrdinal && xScale(value) !== undefined && (<ChartsAxisHighlightPath_1.ChartsAxisHighlightPath d={"M ".concat(xScale(value) - (xScale.step() - xScale.bandwidth()) / 2, " ").concat(top, " l ").concat(xScale.step(), " 0 l 0 ").concat(height, " l ").concat(-xScale.step(), " 0 Z")} className={classes.root} ownerState={{ axisHighlight: 'band' }}/>)}
