...
function ChartsYHighlight(props) {
    ...
    return axisYValues.map(function (_a) {
        ...
        {isYScaleOrdinal && yScale(value) !== undefined && (<ChartsAxisHighlightPath_1.ChartsAxisHighlightPath d={"M ".concat(left, " ").concat(yScale(value) - (yScale.step() - yScale.bandwidth()) / 2, " l 0 ").concat(yScale.step(), " l ").concat(width, " 0 l 0 ").concat(-yScale.step(), " Z")} className={classes.root} ownerState={{ axisHighlight: 'band' }}/>)}
