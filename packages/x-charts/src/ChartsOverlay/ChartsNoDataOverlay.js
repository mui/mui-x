...
function ChartsNoDataOverlay(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(common_1.StyledText, __assign({ x: left + width / 2, y: top + height / 2 }, other, { children: message !== null && message !== void 0 ? message : localeText.noData })));
}
