...
var StyledText = (0, styles_1.styled)('text')(function (_a) {
    var theme = _a.theme;
...
function ChartsNoDataOverlay(props) {
    ...
    return (<StyledText x={left + width / 2} y={top + height / 2} {...other}>
      {message !== null && message !== void 0 ? message : localeText.noData}
    </StyledText>);
}
