...
describe('<ChartsYAxis />', function () {
    ...
    it.skipIf(!skipIf_1.isJSDOM)('should not crash when axisId is invalid', function () {
        ...
        expect(function () {
            return render((0, jsx_runtime_1.jsx)(ChartContainer_1.ChartContainer, __assign({}, defaultProps, { children: (0, jsx_runtime_1.jsx)(ChartsYAxis_1.ChartsYAxis, { axisId: "invalid-axis-id" }) })));
        }).toWarnDev(expectedError);
    });
    it('should render with valid axisId', function () {
        render((0, jsx_runtime_1.jsx)(ChartContainer_1.ChartContainer, __assign({}, defaultProps, { children: (0, jsx_runtime_1.jsx)(ChartsYAxis_1.ChartsYAxis, { axisId: "test-y-axis" }) })));
