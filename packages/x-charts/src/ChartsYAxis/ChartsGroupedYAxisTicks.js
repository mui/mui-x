...
function ChartsGroupedYAxisTicks(inProps) {
    ...
    if (!(0, scaleGuards_1.isOrdinalScale)(yScale)) {
    ...
    return ((0, jsx_runtime_1.jsx)(React.Fragment, { children: yTicks.map(function (item, index) {
            ...
            return ((0, jsx_runtime_1.jsxs)("g", { transform: "translate(0, ".concat(tickOffset, ")"), className: classes.tickContainer, "data-group-index": groupIndex, children: [!disableTicks && !ignoreTick && showTick && ((0, jsx_runtime_1.jsx)(Tick, __assign({ x2: tickXSize, className: classes.tick }, slotProps === null || slotProps === void 0 ? void 0 : slotProps.axisTick))), tickLabel !== undefined && ((0, jsx_runtime_1.jsx)(TickLabel, __assign({ x: labelPositionX, y: yTickLabel }, axisTickLabelProps, { style: __assign(__assign({}, axisTickLabelProps.style), groupConfig.tickLabelStyle), text: tickLabel })))] }, index));
        }) }));
}
