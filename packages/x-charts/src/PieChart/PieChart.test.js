...
describe('<PieChart />', function () {
    ...
    it('should show focus indicator when navigating with keyboard', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = render(<PieChart_1.PieChart enableKeyboardNavigation data-testid="chart" height={100} width={100} series={[
                            {
                                data: [
                                    { id: 0, value: 10 },
                                    { id: 1, value: 20 },
                        ...
                        ]} hideLegend/>), container = _a.container, user = _a.user;
                    ...
                    return [4 /*yield*/, (0, internal_test_utils_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/, internal_test_utils_1.screen.getByTestId('chart').focus()];
                        }); }); })];
                case 1:
                    // focus the chart
                    _b.sent();
