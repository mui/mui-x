...
describe('<PieChart />', function () {
    ...
    it('should show focus indicator when navigating with keyboard', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = render((0, jsx_runtime_1.jsx)(PieChart_1.PieChart, { enableKeyboardNavigation: true, height: 100, width: 100, series: [
                            {
                                data: [
                                    { id: 0, value: 10 },
                                    { id: 1, value: 20 },
    ...
    it('should only show focus indicator for the focused series', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, container, user, svg, focusIndicators, focusIndicators2, focusIndicators3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = render((0, jsx_runtime_1.jsx)(PieChart_1.PieChart, { enableKeyboardNavigation: true, height: 400, width: 400, series: [
                            {
                                id: 'series-1',
                                data: [
                                    { id: 0, value: 10 },
