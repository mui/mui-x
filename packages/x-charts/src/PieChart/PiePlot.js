...
function PiePlot(props) {
    var inSkipAnimation = props.skipAnimation, slots = props.slots, slotProps = props.slotProps, onItemClick = props.onItemClick, className = props.className;
    ...
    return ((0, jsx_runtime_1.jsxs)("g", { className: (0, clsx_1.default)(classes.root, className), children: [seriesOrder.map(function (seriesId) {
