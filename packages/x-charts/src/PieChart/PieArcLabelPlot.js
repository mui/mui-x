...
function PieArcLabelPlot(props) {
    var _a;
    var arcLabel = props.arcLabel, _b = props.arcLabelMinAngle, arcLabelMinAngle = _b === void 0 ? 0 : _b, arcLabelRadius = props.arcLabelRadius, _c = props.cornerRadius, cornerRadius = _c === void 0 ? 0 : _c, data = props.data, _d = props.faded, faded = _d === void 0 ? { additionalRadius: -5 } : _d, highlighted = props.highlighted, id = props.id, innerRadius = props.innerRadius, outerRadius = props.outerRadius, _e = props.paddingAngle, paddingAngle = _e === void 0 ? 0 : _e, skipAnimation = props.skipAnimation, slotProps = props.slotProps, slots = props.slots, other = __rest(props, ["arcLabel", "arcLabelMinAngle", "arcLabelRadius", "cornerRadius", "data", "faded", "highlighted", "id", "innerRadius", "outerRadius", "paddingAngle", "skipAnimation", "slotProps", "slots"]);
    ...
    return (<g {...other}>
      {transformedData.map(function (item) {
            var _a;
            return (<ArcLabel key={(_a = item.id) !== null && _a !== void 0 ? _a : item.dataIndex} startAngle={item.startAngle} endAngle={item.endAngle} paddingAngle={item.paddingAngle} innerRadius={item.innerRadius} outerRadius={item.outerRadius} arcLabelRadius={item.arcLabelRadius} cornerRadius={item.cornerRadius} id={id} color={item.color} isFaded={item.isFaded} isHighlighted={item.isHighlighted} formattedArcLabel={getItemLabel(arcLabel, arcLabelMinAngle, item)} skipAnimation={skipAnimation !== null && skipAnimation !== void 0 ? skipAnimation : false} {...slotProps === null || slotProps === void 0 ? void 0 : slotProps.pieArcLabel}/>);
        })}
    </g>);
}
