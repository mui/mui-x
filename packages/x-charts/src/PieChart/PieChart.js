...
var PieChart = React.forwardRef(function PieChart(inProps, ref) {
    ...
    var _g = (0, useChartsContainerProps_1.useChartsContainerProps)(__assign(__assign({}, other), { series: series.map(function (s) { return (__assign({ type: 'pie' }, s)); }), width: width, height: height, margin: margin, colors: colors, highlightedItem: highlightedItem, onHighlightChange: onHighlightChange, skipAnimation: skipAnimation, plugins: PieChart_plugins_1.PIE_CHART_PLUGINS })), chartsDataProviderProps = _g.chartsDataProviderProps, chartsSurfaceProps = _g.chartsSurfaceProps;
