...
var PieChart = React.forwardRef(function PieChart(inProps, ref) {
    ...
    var _g = (0, useChartContainerProps_1.useChartContainerProps)(__assign(__assign({}, other), { series: series.map(function (s) { return (__assign({ type: 'pie' }, s)); }), width: width, height: height, margin: margin, colors: colors, highlightedItem: highlightedItem, onHighlightChange: onHighlightChange, skipAnimation: skipAnimation, plugins: PieChart_plugins_1.PIE_CHART_PLUGINS })), chartDataProviderProps = _g.chartDataProviderProps, chartsSurfaceProps = _g.chartsSurfaceProps;
