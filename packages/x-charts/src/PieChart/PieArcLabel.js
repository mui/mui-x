...
var PieArcLabel = React.forwardRef(function PieArcLabel(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(PieArcLabelRoot, __assign({ className: classes.root, "data-highlighted": isHighlighted || undefined, "data-faded": isFaded || undefined }, other, animatedProps, { opacity: hidden ? 0 : 1, children: formattedArcLabel })));
});
