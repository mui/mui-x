...
function ChartDataProvider(props) {
    ...
    return (<ChartProvider_1.ChartProvider {...chartProviderProps}>
      <ChartsLocalizationProvider_1.ChartsLocalizationProvider localeText={localeText}>
        <ChartsSlotsContext_1.ChartsSlotsProvider slots={slots} slotProps={slotProps} defaultSlots={material_1.defaultSlotsMaterial}>
          {children}
        </ChartsSlotsContext_1.ChartsSlotsProvider>
