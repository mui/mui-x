...
var ChartsLabelGradient = (0, consumeThemeProps_1.consumeThemeProps)('MuiChartsLabelGradient', {
    ...
    return (<Root className={(0, clsx_1.default)(classes === null || classes === void 0 ? void 0 : classes.root, className)} ownerState={__assign(__assign({}, props), { isRtl: isRtl })} aria-hidden="true" ref={ref} {...other}>
        <div className={classes === null || classes === void 0 ? void 0 : classes.mask}>
          <svg viewBox="0 0 24 24">
            <rect className={classes === null || classes === void 0 ? void 0 : classes.fill} width="24" height="24" fill={"url(#".concat(gradientId, ")")}/>
          </svg>
        </div>
      </Root>);
});
