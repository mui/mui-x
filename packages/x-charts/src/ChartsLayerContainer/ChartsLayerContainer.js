...
var ChartsLayerContainer = React.forwardRef(function ChartsLayerContainer(inProps, ref) {
    ...
    var children = themeProps.children, other = __rest(themeProps, ["children"]);
    ...
    return ((0, jsx_runtime_1.jsx)(ChartsLayerContainerDiv, __assign({ ref: handleRef, ownerState: { width: propsWidth, height: propsHeight }, tabIndex: isKeyboardNavigationEnabled ? 0 : undefined }, other, { children: children })));
});
