...
export type UseItemTooltipReturnValue<SeriesType extends ChartSeriesType> = SeriesType extends 'heatmap'
...
export function useInternalItemTooltip<SeriesType extends ChartSeriesType>():
  | (SeriesType extends 'radar' ? ItemTooltipWithMultipleValues<SeriesType> : UseItemTooltipReturnValue<SeriesType>)
  | null {
  const store = useStore();
  const identifier = store.use(selectorChartsTooltipItem) as SeriesItemIdentifierWithType<SeriesType> | null;
