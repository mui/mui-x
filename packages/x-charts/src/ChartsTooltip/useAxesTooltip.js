...
function useAxesTooltip(params) {
    ...
    Object.keys(series)
        ...
        return composition_1.composableCartesianSeriesTypes.has(seriesType);
    })
        ...
        return seriesOfType.seriesOrder.forEach(function (seriesId) {
            ...
            if (isItemVisible && !isItemVisible({ type: seriesType, seriesId: seriesId })) {
                return;
            }
            ...
            if (tooltipItemIndex >= 0) {
                ...
                tooltipAxes[tooltipItemIndex].seriesItems.push({
                    ...
                    markShape: 'showMark' in seriesToAdd && seriesToAdd.showMark
                        ? ((_g = seriesToAdd.shape) !== null && _g !== void 0 ? _g : 'circle')
                        : undefined,
                });
            }
        });
