...
function ChartsItemTooltipContent(props) {
    ...
    if ('values' in tooltipData) {
        var seriesLabel = tooltipData.label, color_1 = tooltipData.color, markType_1 = tooltipData.markType, markShape_1 = tooltipData.markShape;
        return ((0, jsx_runtime_1.jsx)(ChartsTooltipTable_1.ChartsTooltipPaper, { sx: sx, className: classes.paper, children: (0, jsx_runtime_1.jsxs)(ChartsTooltipTable_1.ChartsTooltipTable, { className: classes.table, children: [(0, jsx_runtime_1.jsxs)(Typography_1.default, { component: "caption", children: [(0, jsx_runtime_1.jsx)("div", { className: classes.markContainer, children: (0, jsx_runtime_1.jsx)(ChartsLabelMark_1.ChartsLabelMark, { type: markType_1, markShape: markShape_1, color: color_1, className: classes.mark }) }), seriesLabel] }), (0, jsx_runtime_1.jsx)("tbody", { children: tooltipData.values.map(function (_a) {
    ...
    var color = tooltipData.color, label = tooltipData.label, formattedValue = tooltipData.formattedValue, markType = tooltipData.markType, markShape = tooltipData.markShape;
