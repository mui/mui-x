...
function useAxisTooltip(params) {
    ...
    var multipleAxes = params.multipleAxes, directions = params.directions;
    ...
    var tooltipXAxes = (0, useSelector_1.useSelector)(store, useChartCartesianAxis_1.selectorChartsInteractionTooltipXAxes);
    var tooltipYAxes = (0, useSelector_1.useSelector)(store, useChartCartesianAxis_1.selectorChartsInteractionTooltipYAxes);
    var tooltipRotationAxes = (0, useSelector_1.useSelector)(store, useChartPolarInteraction_selectors_1.selectorChartsInteractionTooltipRotationAxes);
