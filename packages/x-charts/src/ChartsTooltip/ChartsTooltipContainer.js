...
var useChartCartesianTooltip_selectors_1 = require("../internals/plugins/featurePlugins/useChartCartesianAxis/useChartCartesianTooltip.selectors");
...
function getIsOpenSelector(trigger, axisSystem, shouldPreventBecauseOfBrush) {
    ...
    if (axisSystem === 'cartesian') {
        return useChartCartesianTooltip_selectors_1.selectorChartsInteractionAxisTooltip;
    }
    return selectorReturnFalse;
}
...
var getPositionSelectorByAnchor = function (anchor) {
    switch (anchor) {
        case 'node':
            return useChartTooltip_1.selectorChartsTooltipItemPosition;
        case 'chart':
            return useChartCartesianTooltip_selectors_1.selectorChartsTooltipAxisPosition;
        default:
...
function ChartsTooltipContainer(inProps) {
    ...
    var _g = props.trigger, trigger = _g === void 0 ? 'axis' : _g, position = props.position, _h = props.anchor, anchor = _h === void 0 ? 'pointer' : _h, propClasses = props.classes, children = props.children, other = __rest(props, ["trigger", "position", "anchor", "classes", "children"]);
    var store = (0, useStore_1.useStore)();
    if (process.env.NODE_ENV !== 'production') {
        var isItemControlled = (_b = (_a = store.state.tooltip) === null || _a === void 0 ? void 0 : _a.itemIsControlled) !== null && _b !== void 0 ? _b : false;
        var isAxisControlled = store.state.controlledCartesianAxisTooltip !== undefined;
        if (trigger !== 'item' && isItemControlled) {
            (0, warning_1.warnOnce)([
                "MUI X Charts: The `tooltipItem` prop is provided, but the tooltip trigger is set to '".concat(trigger, "'."),
                "The `tooltipItem` prop only has an effect when the tooltip trigger is 'item'.",
            ], 'error');
        }
        if (trigger !== 'axis' && isAxisControlled) {
            (0, warning_1.warnOnce)([
                "MUI X Charts: The `tooltipAxis` prop is provided, but the tooltip trigger is set to '".concat(trigger, "'."),
    ...
    var pointerAnchorUnavailable = lastInteraction === 'keyboard' || pointerType === null;
    var computedAnchor = pointerAnchorUnavailable ? defaultAnchorByTrigger[trigger] : anchor;
    var itemPosition = store.use(getPositionSelectorByAnchor(computedAnchor), props.position);
    var isTooltipNodeAnchored = itemPosition !== null;
    React.useEffect(function () {
        var svgElement = chartsLayerContainerRef.current;
        if (svgElement === null) {
            return function () { };
        }
    ...
    return ((0, jsx_runtime_1.jsxs)(React.Fragment, { children: [chartsLayerContainerRef.current &&
                ReactDOM.createPortal((0, jsx_runtime_1.jsx)("div", { ref: anchorRef, style: {
                        position: 'absolute',
                        display: 'hidden',
                        left: (_c = itemPosition === null || itemPosition === void 0 ? void 0 : itemPosition.x) !== null && _c !== void 0 ? _c : 0,
                        top: (_d = itemPosition === null || itemPosition === void 0 ? void 0 : itemPosition.y) !== null && _d !== void 0 ? _d : 0,
                        pointerEvents: 'none',
                        opacity: 0,
                        ...
                        width: 1,
                        height: 1,
                    } }), chartsLayerContainerRef.current), (0, jsx_runtime_1.jsx)(NoSsr_1.default, { children: isOpen && ((0, react_1.createElement)(ChartsTooltipRoot, __assign({}, other, { 
                    // The key is here to make sure the tooltip uses the new anchor immediately.
                    key: itemPosition ? 'charts-anchored' : 'charts-pointer', className: classes === null || classes === void 0 ? void 0 : classes.root, open: isOpen, placement: (_f = (_e = other.placement) !== null && _e !== void 0 ? _e : position) !== null && _f !== void 0 ? _f : (!isTooltipNodeAnchored && isMouse ? 'right-start' : 'top'), popperRef: popperRef, anchorEl: itemPosition ? anchorRef.current : pointerAnchorEl, modifiers: modifiers }), children)) })] }));
}
    ...
    container: prop_types_1.default.oneOfType([
        function (props, propName) {
            if (props[propName] == null) {
                return new Error("MUI X: Prop '".concat(propName, "' is required but wasn't specified"));
            }
            if (typeof props[propName] !== 'object' || props[propName].nodeType !== 1) {
                return new Error("MUI X: Expected prop '".concat(propName, "' to be of type Element"));
            }
            return null;
        },
        prop_types_1.default.func,
