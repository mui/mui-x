...
function ChartsTooltipContainer(inProps) {
    ...
    if (process.env.NODE_ENV !== 'production') {
        ...
        var isItemControlled = (_b = (_a = state.tooltip) === null || _a === void 0 ? void 0 : _a.itemIsControlled) !== null && _b !== void 0 ? _b : false;
        var isAxisControlled = state.controlledCartesianAxisTooltip !== undefined;
    ...
    return ((0, jsx_runtime_1.jsxs)(React.Fragment, { children: [chartsLayerContainerRef.current &&
                ReactDOM.createPortal((0, jsx_runtime_1.jsx)("div", { ref: anchorRef, style: {
                        ...
                        width: 1,
                        height: 1,
                    } }), chartsLayerContainerRef.current), (0, jsx_runtime_1.jsx)(NoSsr_1.default, { children: isOpen && ((0, jsx_runtime_1.jsx)(ChartsTooltipRoot, __assign({}, other, { className: classes === null || classes === void 0 ? void 0 : classes.root, open: isOpen, placement: (_f = (_e = other.placement) !== null && _e !== void 0 ? _e : position) !== null && _f !== void 0 ? _f : (!isTooltipNodeAnchored && isMouse ? 'right-start' : 'top'), popperRef: popperRef, anchorEl: itemPosition ? anchorRef.current : pointerAnchorEl, modifiers: modifiers, children: children }))) })] }));
}
