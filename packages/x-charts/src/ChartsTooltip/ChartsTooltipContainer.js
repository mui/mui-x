...
var noAxis = function () { return false; };
...
function ChartsTooltipContainer(inProps) {
    ...
    var isOpen = (0, useSelector_1.useSelector)(store, trigger === 'axis'
        ? (axisSystem === 'polar' && useChartPolarInteraction_selectors_1.selectorChartsInteractionPolarAxisTooltip) ||
            (axisSystem === 'cartesian' && useChartCartesianAxis_1.selectorChartsInteractionAxisTooltip) ||
            noAxis
        : useChartInteraction_1.selectorChartsInteractionItemIsDefined);
