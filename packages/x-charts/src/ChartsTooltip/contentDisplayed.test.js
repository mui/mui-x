...
// B| X
//   --------
var cellSelector = ".".concat(chartsTooltipClasses_1.chartsTooltipClasses.cell, ", .").concat(chartsTooltipClasses_1.chartsTooltipClasses.root, " caption");
...
describe.skipIf(skipIf_1.isJSDOM)('ChartsTooltip', function () {
    ...
    describe('axis trigger with sort', function () {
        it('should sort series items in ascending order', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, user, container, svg;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = render((0, jsx_runtime_1.jsx)(BarChart_1.BarChart, __assign({}, config, { series: [
                                { dataKey: 'v1', id: 's1', label: 'S1' },
                                { dataKey: 'v2', id: 's2', label: 'S2' },
                            ], xAxis: [{ dataKey: 'x', position: 'none' }], slotProps: { tooltip: { trigger: 'axis', sort: 'asc' } } })), { wrapper: wrapper }), user = _a.user, container = _a.container;
                        svg = container.querySelector('svg');
        ...
        it('should sort series items in descending order', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, user, container, svg;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = render((0, jsx_runtime_1.jsx)(BarChart_1.BarChart, __assign({}, config, { series: [
                                { dataKey: 'v1', id: 's1', label: 'S1' },
                                { dataKey: 'v2', id: 's2', label: 'S2' },
                            ], xAxis: [{ dataKey: 'x', position: 'none' }], slotProps: { tooltip: { trigger: 'axis', sort: 'desc' } } })), { wrapper: wrapper }), user = _a.user, container = _a.container;
                        svg = container.querySelector('svg');
                        // Trigger the tooltip on A where v1=4, v2=2
                        return [4 /*yield*/, user.pointer({
                                target: svg,
        ...
        it('should put undefined values at the end with descending order', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, user, container, svg;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = render((0, jsx_runtime_1.jsx)(BarChart_1.BarChart, __assign({}, config, { dataset: [
                                { x: 'A', v1: 4, v2: null },
                                { x: 'B', v1: 1, v2: 1 },
                            ], series: [
                                { dataKey: 'v1', id: 's1', label: 'S1' },
        ...
        it('should put undefined values at the end with ascending order', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, user, container, svg;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    describe('visibility filtering', function () {
        it('should filter hidden series using hiddenItems prop', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, user, container, setProps, svg;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = render((0, jsx_runtime_1.jsx)(BarChart_1.BarChart, __assign({}, config, { series: [
                            ...
                            ], hiddenItems: [], xAxis: [{ dataKey: 'x', position: 'none' }], slotProps: { tooltip: { trigger: 'axis' } } })), { wrapper: wrapper }), user = _a.user, container = _a.container, setProps = _a.setProps;
                        svg = container.querySelector('svg');
                        // Trigger the tooltip
                        return [4 /*yield*/, user.pointer({
                                target: svg,
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, (0, internal_test_utils_1.waitFor)(function () {
                                ...
                                expect(__spreadArray([], cells, true).map(function (cell) { return cell.textContent; })).to.deep.equal(__spreadArray([
                                    // Header
                                    'B'
                                ], firstRow, true));
                            })];
