    ...
    describe('axis trigger', function () {
        it('should show right values with vertical layout on axis', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render(<BarChart_1.BarChart {...config} series={[
                                { dataKey: 'v1', id: 's1', label: 'S1' },
                                { dataKey: 'v2', id: 's2', label: 'S2' },
                            ]} xAxis={[{ dataKey: 'x', position: 'none' }]} slotProps={{ tooltip: { trigger: 'axis' } }}/>, { wrapper: wrapper }).user;
        ...
        it('should show right values with horizontal layout on axis', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render(<BarChart_1.BarChart {...config} layout="horizontal" series={[
                                { dataKey: 'v1', id: 's1', label: 'S1' },
                                { dataKey: 'v2', id: 's2', label: 'S2' },
                            ]} yAxis={[{ scaleType: 'band', dataKey: 'x', position: 'none' }]} slotProps={{ tooltip: { trigger: 'axis' } }}/>, { wrapper: wrapper }).user;
                        svg = document.querySelector('svg');
                        // Trigger the tooltip
                        return [4 /*yield*/, user.pointer({
                                target: svg,
    ...
    describe('custom tooltip', function () {
        it('should show custom tooltip', function () { return __awaiter(void 0, void 0, void 0, function () {
            function CustomTooltip() {
                ...
                return (<ChartsTooltipContainer_1.ChartsTooltipContainer trigger="item">
            <div>
              <div>
                <p>sum</p>
                <p>{sum}</p>
              ...
              <div>
                <p>current</p>
                <p>{tooltipData === null || tooltipData === void 0 ? void 0 : tooltipData.formattedValue}</p>
              </div>
            </div>
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = render(<BarChart_1.BarChart {...config} dataset={undefined} series={[{ id: 's1', label: 'S1', data: [100, 200, 300, 400] }]} xAxis={[{ data: ['A', 'B', 'C', 'D'], position: 'none' }]} slotProps={{ tooltip: { trigger: 'item' } }} slots={{ tooltip: CustomTooltip }}/>, { wrapper: wrapper }).user;
                        rectangles = document.querySelectorAll('rect');
                        // Trigger the tooltip
                        return [4 /*yield*/, user.pointer({
                                target: rectangles[1],
