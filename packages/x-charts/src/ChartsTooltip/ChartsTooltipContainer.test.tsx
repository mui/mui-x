...
describe('ChartsTooltipContainer', () => {
  ...
  it.skipIf(!isJSDOM)(
    'should warn when tooltipItem is controlled but trigger is axis',
    () => {
      const expectedError = [
  ...
  // can't catch render errors in the browser for unknown reason
  it.skipIf(!isJSDOM)(
    'should warn when tooltipAxis is controlled but trigger is item',
    () => {
      const expectedError = [
  ...
  // can't catch render errors in the browser for unknown reason
  it.skipIf(!isJSDOM)(
    'should not warn when tooltipItem is controlled and trigger is item',
    () => {
      expect(() =>
        render(
          <BarChart
  ...
  // can't catch render errors in the browser for unknown reason
  it.skipIf(!isJSDOM)(
    'should not warn when tooltipAxis is controlled and trigger is axis',
    () => {
      expect(() =>
        render(
          <BarChart
