...
/**
 * Configuration of the x-axis used in cartesian charts.
 */
export type ChartsXAxisConfig<TData = any> = MakeOptional<
  AxisConfig<ScaleName, TData, ChartsXAxisProps>,
  'id'
>;

/**
 * Configuration of the y-axis used in cartesian charts.
 */
export type ChartsYAxisConfig<TData = any> = MakeOptional<
  AxisConfig<ScaleName, TData, ChartsYAxisProps>,
  'id'
>;
