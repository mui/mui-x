...
export type SeriesItemIdentifier<T extends ChartSeriesType> =
  T extends ChartSeriesType ? ChartsSeriesConfig[T]['itemIdentifier'] : never;

export type SeriesItemIdentifierWithData<T extends ChartSeriesType> =
  T extends ChartSeriesType ? ChartsSeriesConfig[T]['itemIdentifierWithData'] : never;
