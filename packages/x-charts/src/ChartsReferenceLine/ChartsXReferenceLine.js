...
var getTextParams = function (_a) {
    var top = _a.top, height = _a.height, spacingY = _a.spacingY, _b = _a.labelAlign, labelAlign = _b === void 0 ? 'middle' : _b;
    switch (labelAlign) {
        case 'start':
            return {
                y: top + spacingY,
...
function ChartsXReferenceLine(props) {
    var _a, _b;
    var x = props.x, _c = props.label, label = _c === void 0 ? '' : _c, _d = props.spacing, spacing = _d === void 0 ? 5 : _d, inClasses = props.classes, labelAlign = props.labelAlign, lineStyle = props.lineStyle, labelStyle = props.labelStyle, axisId = props.axisId;
    var _e = (0, hooks_1.useDrawingArea)(), top = _e.top, height = _e.height;
    ...
    var textParams = __assign(__assign({ x: xPosition + spacingX, text: label, fontSize: 12 }, getTextParams({
        top: top,
        height: height,
        spacingY: spacingY,
