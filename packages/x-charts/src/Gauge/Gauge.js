...
var Gauge = React.forwardRef(function Gauge(props, ref) {
    ...
    return (<GaugeContainer_1.GaugeContainer {...other} className={(0, clsx_1.default)(classes.root, className)} ref={ref}>
      <GaugeReferenceArc_1.GaugeReferenceArc className={classes.referenceArc}/>
      <GaugeValueArc_1.GaugeValueArc className={classes.valueArc} skipAnimation={skipAnimation}/>
      <GaugeValueText_1.GaugeValueText className={classes.valueText} text={text}/>
      {children}
    </GaugeContainer_1.GaugeContainer>);
});
exports.Gauge = Gauge;
Gauge.propTypes = {
    // ----------------------------- Warning --------------------------------
