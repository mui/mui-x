...
function LineHighlightPlot(props) {
    ...
    var highlightedIndexes = (0, useSelector_1.useSelector)(store, useChartCartesianAxis_1.selectorChartsHighlightXAxisIndex);
    ...
    return (<g {...other}>
      {highlightedIndexes.flatMap(function (_a) {
            ...
            return stackingGroups.flatMap(function (_a) {
                ...
                return groupIds.flatMap(function (seriesId) {
                    var _a = series[seriesId], _b = _a.xAxisId, xAxisId = _b === void 0 ? defaultXAxisId : _b, _c = _a.yAxisId, yAxisId = _c === void 0 ? defaultYAxisId : _c, stackedData = _a.stackedData, data = _a.data, disableHighlight = _a.disableHighlight, _d = _a.shape, shape = _d === void 0 ? 'circle' : _d;
                    ...
                    return (<Element key={"".concat(seriesId)} id={seriesId} color={colorGetter(highlightedIndex)} x={x} y={y} shape={shape} {...slotProps === null || slotProps === void 0 ? void 0 : slotProps.lineHighlight}/>);
                });
            });
        })}
    </g>);
