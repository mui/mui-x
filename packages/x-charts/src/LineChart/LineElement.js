...
function LineElement(props) {
    ...
    var highlightState = (0, useItemHighlightState_1.useItemHighlightState)(identifier);
    ...
    var classes = (0, lineClasses_1.useUtilityClasses)();
    ...
    var lineProps = (0, useSlotProps_1.default)({
        ...
        additionalProps: __assign(__assign({}, interactionProps), { onClick: onClick, cursor: onClick ? 'pointer' : 'unset', 'data-highlighted': isHighlighted || undefined, 'data-faded': isFaded || undefined, 'data-series-id': seriesId, 'data-series': seriesId }),
