...
var lineClasses_1 = require("./lineClasses");
/**
 ...
 */
var useDeprecatedUtilityClasses = function (ownerState) {
...
function LineElement(props) {
    ...
    var identifier = React.useMemo(function () { return ({ type: 'line', seriesId: seriesId }); }, [seriesId]);
    var interactionProps = (0, useInteractionItemProps_1.useInteractionItemProps)(identifier);
    var _b = (0, useItemHighlighted_1.useItemHighlighted)(identifier), isFaded = _b.isFaded, isHighlighted = _b.isHighlighted;
    var ownerState = {
        seriesId: seriesId,
    ...
    var classes = (0, lineClasses_1.useUtilityClasses)({ classes: innerClasses });
    var deprecatedClasses = useDeprecatedUtilityClasses(ownerState);
    ...
    var lineProps = (0, useSlotProps_1.default)({
        ...
        additionalProps: __assign(__assign({}, interactionProps), { onClick: onClick, cursor: onClick ? 'pointer' : 'unset', 'data-highlighted': isHighlighted || undefined, 'data-faded': isFaded || undefined, 'data-series-id': seriesId }),
        className: "".concat(classes.line, " ").concat(deprecatedClasses.root),
