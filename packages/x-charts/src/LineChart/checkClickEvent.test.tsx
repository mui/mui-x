...
describe('LineChart - click event', () => {
  ...
  describe('onMarkClick', () => {
    ...
    it.skipIf(isJSDOM)('should provide the right context as second argument', async () => {
      ...
      expect(onMarkClick.mock.calls[onMarkClick.mock.calls.length - 1][1]).to.deep.equal({
        type: 'line',
        seriesId: 's1',
        dataIndex: 0,
      });
  ...
  describe('onAreaClick', () => {
    ...
    it.skipIf(isJSDOM)('should provide the right context as second argument', async () => {
      ...
      expect(onAreaClick.mock.calls[onAreaClick.mock.calls.length - 1][1]).to.deep.equal({
        type: 'line',
        seriesId: 's1',
      });
  ...
  describe('onLineClick', () => {
    ...
    it.skipIf(isJSDOM)('should provide the right context as second argument', async () => {
      ...
      expect(onLineClick.mock.calls[onLineClick.mock.calls.length - 1][1]).to.deep.equal({
        type: 'line',
        seriesId: 's1',
      });
