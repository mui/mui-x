    ...
    var allData = React.useMemo(function () {
        ...
        for (var _i = 0, stackingGroups_1 = stackingGroups; _i < stackingGroups_1.length; _i++) {
            ...
            var _loop_1 = function (seriesId) {
                var _c = series[seriesId], _d = _c.xAxisId, xAxisId = _d === void 0 ? defaultXAxisId : _d, _e = _c.yAxisId, yAxisId = _e === void 0 ? defaultYAxisId : _e, stackedData = _c.stackedData, data = _c.data, connectNulls = _c.connectNulls, curve = _c.curve, strictStepCurve = _c.strictStepCurve;
