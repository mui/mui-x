...
var AreaPlotRoot = (0, styles_1.styled)('g', {
    ...
    _a["& .".concat(lineClasses_1.lineClasses.area)] = {
...
function AreaPlot(props) {
    var slots = props.slots, slotProps = props.slotProps, onItemClick = props.onItemClick, inSkipAnimation = props.skipAnimation, className = props.className, other = __rest(props, ["slots", "slotProps", "onItemClick", "skipAnimation", "className"]);
    ...
    return ((0, jsx_runtime_1.jsx)(AreaPlotRoot, __assign({ className: (0, clsx_1.default)(classes.areaPlot, className) }, other, { children: completedData.map(function (_a) {
