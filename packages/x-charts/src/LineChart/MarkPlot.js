...
function MarkPlot(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(MarkPlotRoot, __assign({}, other, { children: completedData.map(function (_a) {
            var _b;
            ...
            var isSeriesHighlighted = isHighlighted(identifier);
            var isSeriesFaded = !isSeriesHighlighted && isFaded(identifier);
