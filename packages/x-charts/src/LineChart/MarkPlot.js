...
var MarkPlotRoot = (0, styles_1.styled)('g', {
    name: 'MuiMarkPlot',
    slot: 'Root',
})({});
/**
...
function MarkPlot(props) {
    var slots = props.slots, slotProps = props.slotProps, inSkipAnimation = props.skipAnimation, onItemClick = props.onItemClick, className = props.className, other = __rest(props, ["slots", "slotProps", "skipAnimation", "onItemClick", "className"]);
    ...
    var getHighlightState = (0, hooks_1.useItemHighlightStateGetter)();
    ...
    return ((0, jsx_runtime_1.jsx)(MarkPlotRoot, __assign({ className: (0, clsx_1.default)(classes.markPlot, className) }, other, { children: completedData.map(function (_a) {
            var _b;
            ...
            var identifier = { type: 'line', seriesId: seriesId };
            var seriesHighlightState = getHighlightState(identifier);
