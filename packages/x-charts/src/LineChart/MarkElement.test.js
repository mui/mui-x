...
describe.for([
...
])('%s data attributes', function (_a) {
    var _ = _a[0], MarkElementComponent = _a[1];
    var render = (0, internal_test_utils_1.createRenderer)().render;
    it('should have data-series-id attribute', function () {
        render((0, jsx_runtime_1.jsx)(TestWrapper, { children: (0, jsx_runtime_1.jsx)(MarkElementComponent, { seriesId: "s1", dataIndex: 0, x: 10, y: 10, color: "red", shape: "circle", "data-testid": "mark" }) }));
        var mark = internal_test_utils_1.screen.getByTestId('mark');
        expect(mark.getAttribute('data-series-id')).to.equal('s1');
    });
    it('should have data-index attribute', function () {
        render((0, jsx_runtime_1.jsx)(TestWrapper, { children: (0, jsx_runtime_1.jsx)(MarkElementComponent, { seriesId: "s1", dataIndex: 2, x: 10, y: 10, color: "red", shape: "circle", "data-testid": "mark" }) }));
        var mark = internal_test_utils_1.screen.getByTestId('mark');
        expect(mark.getAttribute('data-index')).to.equal('2');
    });
    it('should have both new and deprecated classes', function () {
        render((0, jsx_runtime_1.jsx)(TestWrapper, { children: (0, jsx_runtime_1.jsx)(MarkElementComponent, { seriesId: "s1", dataIndex: 0, x: 10, y: 10, color: "red", shape: "circle", "data-testid": "mark" }) }));
        var mark = internal_test_utils_1.screen.getByTestId('mark');
    ...
    it('should apply custom classes passed via the classes prop', function () {
        render((0, jsx_runtime_1.jsx)(TestWrapper, { children: (0, jsx_runtime_1.jsx)(MarkElementComponent, { seriesId: "s1", dataIndex: 0, x: 10, y: 10, color: "red", shape: "circle", classes: { mark: 'my-custom-mark' }, "data-testid": "mark" }) }));
        var mark = internal_test_utils_1.screen.getByTestId('mark');
