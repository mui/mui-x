...
var LinePlotRoot = (0, styles_1.styled)('g', {
    ...
    _a["& .".concat(lineClasses_1.lineClasses.line)] = {
...
function LinePlot(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(LinePlotRoot, __assign({ className: (0, clsx_1.default)(classes.linePlot, className) }, other, { children: completedData.map(function (_a) {
