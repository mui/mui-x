...
function LineHighlightElement(props) {
    ...
    var deprecatedClasses = useDeprecatedUtilityClasses(props);
    ...
    return ((0, jsx_runtime_1.jsx)(Element, __assign({ pointerEvents: "none", className: "".concat(classes.highlight, " ").concat(deprecatedClasses.root), transform: "translate(".concat(x, " ").concat(y, ")"), fill: color }, transformOrigin, additionalProps, other)));
}
