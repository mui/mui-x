...
function LineHighlightElement(props) {
    var x = props.x, y = props.y, seriesId = props.seriesId, color = props.color, shape = props.shape, other = __rest(props, ["x", "y", "seriesId", "color", "shape"]);
    ...
    return ((0, jsx_runtime_1.jsx)(Element, __assign({ pointerEvents: "none", className: classes.highlight, transform: "translate(".concat(x, " ").concat(y, ")"), fill: color }, transformOrigin, additionalProps, other)));
}
