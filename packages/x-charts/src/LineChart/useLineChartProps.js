...
var useLineChartProps = function (props) {
    var _a, _b, _c, _d, _e;
    var xAxis = props.xAxis, yAxis = props.yAxis, series = props.series, width = props.width, height = props.height, margin = props.margin, colors = props.colors, dataset = props.dataset, sx = props.sx, onAreaClick = props.onAreaClick, onLineClick = props.onLineClick, onMarkClick = props.onMarkClick, axisHighlight = props.axisHighlight, disableLineItemHighlight = props.disableLineItemHighlight, hideLegend = props.hideLegend, grid = props.grid, children = props.children, slots = props.slots, slotProps = props.slotProps, skipAnimation = props.skipAnimation, loading = props.loading, highlightedItem = props.highlightedItem, onHighlightChange = props.onHighlightChange, className = props.className, showToolbar = props.showToolbar, other = __rest(props, ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "onAreaClick", "onLineClick", "onMarkClick", "axisHighlight", "disableLineItemHighlight", "hideLegend", "grid", "children", "slots", "slotProps", "skipAnimation", "loading", "highlightedItem", "onHighlightChange", "className", "showToolbar"]);
    ...
    var chartContainerProps = __assign(__assign({}, other), { series: seriesWithDefault, width: width, height: height, margin: margin, colors: colors, dataset: dataset, xAxis: xAxis !== null && xAxis !== void 0 ? xAxis : [
            ...
            (axisHighlight === null || axisHighlight === void 0 ? void 0 : axisHighlight.y) === 'none', className: className, skipAnimation: skipAnimation, plugins: LineChart_plugins_1.LINE_CHART_PLUGINS });
    var gridProps = {
