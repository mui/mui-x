...
var useLineChartProps = function (props) {
    ...
    var chartsContainerProps = __assign(__assign({}, other), { series: seriesWithDefault, width: width, height: height, margin: margin, colors: colors, dataset: dataset, xAxis: xAxis !== null && xAxis !== void 0 ? xAxis : [
            {
            ...
            (axisHighlight === null || axisHighlight === void 0 ? void 0 : axisHighlight.y) === 'none', skipAnimation: skipAnimation, brushConfig: brushConfig, plugins: LineChart_plugins_1.LINE_CHART_PLUGINS });
    var gridProps = {
