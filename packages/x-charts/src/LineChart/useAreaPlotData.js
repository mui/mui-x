    ...
    var allData = React.useMemo(function () {
        ...
        for (var _i = 0, stackingGroups_1 = stackingGroups; _i < stackingGroups_1.length; _i++) {
            ...
            var _loop_1 = function (i) {
                ...
                var _b = series[seriesId], _c = _b.xAxisId, xAxisId = _c === void 0 ? defaultXAxisId : _c, _d = _b.yAxisId, yAxisId = _d === void 0 ? defaultYAxisId : _d, stackedData = _b.stackedData, data = _b.data, connectNulls = _b.connectNulls, baseline = _b.baseline, curve = _b.curve, strictStepCurve = _b.strictStepCurve, area = _b.area;
                ...
                var shouldExpand = (curve === null || curve === void 0 ? void 0 : curve.includes('step')) && !strictStepCurve && (0, isBandScale_1.isBandScale)(xScale);
                var formattedData = (_a = xData === null || xData === void 0 ? void 0 : xData.flatMap(function (x, index) {
                    var _a, _b;
                    var nullData = data[index] == null;
                    if (shouldExpand) {
                        var rep = [{ x: x, y: stackedData[index], nullData: nullData, isExtension: false }];
                    ...
                    return { x: x, y: stackedData[index], nullData: nullData };
                })) !== null && _a !== void 0 ? _a : [];
