...
function CircleMarkElement(props) {
    ...
    var classes = (0, lineClasses_1.useUtilityClasses)({ skipAnimation: skipAnimation, classes: innerClasses });
    var deprecatedClasses = (0, markElementClasses_1.useUtilityClasses)(ownerState);
    return ((0, jsx_runtime_1.jsx)(Circle, __assign({}, other, { cx: x, cy: y, r: 5, fill: (theme.vars || theme).palette.background.paper, stroke: color, strokeWidth: 2, className: "".concat(classes.mark, " ").concat(deprecatedClasses.root), onClick: onClick, cursor: onClick ? 'pointer' : 'unset', pointerEvents: hidden ? 'none' : undefined }, interactionProps, { "data-highlighted": isHighlighted || undefined, "data-faded": isFaded || undefined, "data-series-id": seriesId, "data-index": dataIndex, opacity: hidden ? 0 : 1 })));
}
