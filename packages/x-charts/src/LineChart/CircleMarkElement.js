...
var Circle = (0, styles_1.styled)('circle', {
    ...
    _a["&.".concat(lineClasses_1.lineClasses.markAnimate)] = {
...
function CircleMarkElement(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(Circle, __assign({}, other, { cx: x, cy: y, r: 5, fill: (theme.vars || theme).palette.background.paper, stroke: color, strokeWidth: 2, className: classes.mark, onClick: onClick, cursor: onClick ? 'pointer' : 'unset', pointerEvents: hidden ? 'none' : undefined }, interactionProps, { "data-highlighted": isHighlighted || undefined, "data-faded": isFaded || undefined, "data-series-id": seriesId, "data-series": seriesId, "data-index": dataIndex, opacity: hidden ? 0 : 1 })));
}
