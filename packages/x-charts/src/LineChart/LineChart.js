...
var MarkPlot_1 = require("./MarkPlot");
var ChartsAxis_1 = require("../ChartsAxis/ChartsAxis");
...
var LineHighlightPlot_1 = require("./LineHighlightPlot");
var ChartsGrid_1 = require("../ChartsGrid");
var ChartsOverlay_1 = require("../ChartsOverlay");
var useLineChartProps_1 = require("./useLineChartProps");
...
var FocusedLineMark_1 = require("./FocusedLineMark");
/**
 * Demos:
 *
 ...
 */
var LineChart = React.forwardRef(function LineChart(inProps, ref) {
    var _a, _b, _c, _d, _e;
    var props = (0, styles_1.useThemeProps)({ props: inProps, name: 'MuiLineChart' });
    var _f = (0, useLineChartProps_1.useLineChartProps)(props), chartsWrapperProps = _f.chartsWrapperProps, chartsContainerProps = _f.chartsContainerProps, gridProps = _f.gridProps, clipPathProps = _f.clipPathProps, clipPathGroupProps = _f.clipPathGroupProps, areaPlotProps = _f.areaPlotProps, linePlotProps = _f.linePlotProps, markPlotProps = _f.markPlotProps, overlayProps = _f.overlayProps, chartsAxisProps = _f.chartsAxisProps, axisHighlightProps = _f.axisHighlightProps, lineHighlightPlotProps = _f.lineHighlightPlotProps, legendProps = _f.legendProps, children = _f.children;
    var _g = (0, useChartsContainerProps_1.useChartsContainerProps)(chartsContainerProps), chartsDataProviderProps = _g.chartsDataProviderProps, chartsSurfaceProps = _g.chartsSurfaceProps;
    ...
    return ((0, jsx_runtime_1.jsx)(ChartsDataProvider_1.ChartsDataProvider, __assign({}, chartsDataProviderProps, { children: (0, jsx_runtime_1.jsxs)(ChartsWrapper_1.ChartsWrapper, __assign({}, chartsWrapperProps, { ref: ref, children: [props.showToolbar && Toolbar ? (0, jsx_runtime_1.jsx)(Toolbar, __assign({}, (_d = props.slotProps) === null || _d === void 0 ? void 0 : _d.toolbar)) : null, !props.hideLegend && (0, jsx_runtime_1.jsx)(ChartsLegend_1.ChartsLegend, __assign({}, legendProps)), (0, jsx_runtime_1.jsxs)(ChartsSurface_1.ChartsSurface, __assign({}, chartsSurfaceProps, { children: [(0, jsx_runtime_1.jsx)(ChartsGrid_1.ChartsGrid, __assign({}, gridProps)), (0, jsx_runtime_1.jsxs)("g", __assign({}, clipPathGroupProps, { children: [(0, jsx_runtime_1.jsx)(AreaPlot_1.AreaPlot, __assign({}, areaPlotProps)), (0, jsx_runtime_1.jsx)(LinePlot_1.LinePlot, __assign({}, linePlotProps)), (0, jsx_runtime_1.jsx)(ChartsOverlay_1.ChartsOverlay, __assign({}, overlayProps)), (0, jsx_runtime_1.jsx)(ChartsAxisHighlight_1.ChartsAxisHighlight, __assign({}, axisHighlightProps))] })), (0, jsx_runtime_1.jsx)(FocusedLineMark_1.FocusedLineMark, {}), (0, jsx_runtime_1.jsx)(ChartsAxis_1.ChartsAxis, __assign({}, chartsAxisProps)), (0, jsx_runtime_1.jsx)("g", { "data-drawing-container": true, children: (0, jsx_runtime_1.jsx)(MarkPlot_1.MarkPlot, __assign({}, markPlotProps)) }), (0, jsx_runtime_1.jsx)(LineHighlightPlot_1.LineHighlightPlot, __assign({}, lineHighlightPlotProps)), (0, jsx_runtime_1.jsx)(ChartsClipPath_1.ChartsClipPath, __assign({}, clipPathProps)), children] })), !props.loading && (0, jsx_runtime_1.jsx)(Tooltip, __assign({}, (_e = props.slotProps) === null || _e === void 0 ? void 0 : _e.tooltip))] })) })));
});
...
LineChart.propTypes = {
     ...
     */
    disableLineItemHighlight: prop_types_1.default.bool,
    /**
     ...
     */
    onLineClick: prop_types_1.default.func,
    /**
