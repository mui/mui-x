...
describe('<ChartsXAxis />', function () {
    ...
    it('should not crash when axisId is invalid', function () {
        ...
        expect(function () {
            return render((0, jsx_runtime_1.jsx)(ChartsContainer_1.ChartsContainer, __assign({}, defaultProps, { children: (0, jsx_runtime_1.jsx)(ChartsXAxis_1.ChartsXAxis, { axisId: "invalid-axis-id" }) })));
        }).toWarnDev(expectedError);
    });
    it('should render with valid axisId', function () {
        render((0, jsx_runtime_1.jsx)(ChartsContainer_1.ChartsContainer, __assign({}, defaultProps, { children: (0, jsx_runtime_1.jsx)(ChartsXAxis_1.ChartsXAxis, { axisId: "test-x-axis" }) })));
