...
var ChartsSingleXAxis_1 = require("./ChartsSingleXAxis");
var ChartsGroupedXAxis_1 = require("./ChartsGroupedXAxis");
/**
 * Demos:
 *
...
function ChartsXAxis(inProps) {
    ...
    if ('groups' in axis && Array.isArray(axis.groups)) {
        return <ChartsGroupedXAxis_1.ChartsGroupedXAxis {...inProps}/>;
    }
    return <ChartsSingleXAxis_1.ChartsSingleXAxis {...inProps}/>;
}
