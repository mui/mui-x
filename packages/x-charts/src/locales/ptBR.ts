...
export const ptBRLocaleText: Partial<ChartsLocaleText> = {
  ...
  chartConfigurationBorderRadius: 'Raio de borda',
  ...
  chartConfigurationTickPlacement: 'Posição da marca de escala',
  chartConfigurationTickLabelPlacement: 'Posição do rótulo da marca de escala',
  chartConfigurationCategoriesAxisLabel: 'Rótulo do eixo de categorias',
  chartConfigurationSeriesAxisLabel: 'Rótulo do eixo de séries',
  ...
  chartConfigurationBarLabels: 'Rótulos de barra',
  chartConfigurationColumnLabels: 'Rótulos de coluna',
  ...
  chartConfigurationArcLabels: 'Rótulos de arco',
  chartConfigurationStartAngle: 'Ângulo de início',
  chartConfigurationEndAngle: 'Ângulo de fim',
  ...
  chartConfigurationOptionTick: 'Marca de Escala',
