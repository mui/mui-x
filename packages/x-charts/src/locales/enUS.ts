...
export const enUSLocaleText: ChartsLocaleText = {
  ...
  chartConfiguration: {
    ...
    categoryGapRatio: 'Category gap ratio',
    barGapRatio: 'Series gap ratio',
    stacked: 'Stacked',
    ...
    tickPlacement: 'Tick placement',
    tickLabelPlacement: 'Tick label placement',
    categoriesAxisLabel: 'Categories axis label',
    seriesAxisLabel: 'Series axis label',
    xAxisPosition: 'X-axis position',
    yAxisPosition: 'Y-axis position',
    axisReverse: 'Reverse series axis',
