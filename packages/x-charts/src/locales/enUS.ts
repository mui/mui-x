...
export const enUSLocaleText: ChartsLocaleText = {
  ...
  chartPaletteNameSignalDuo: 'Signal duo',
  chartPaletteNameDesertDune: 'Desert dune',
  chartPaletteNameTropicalPunch: 'Tropical punch',
  chartPaletteNameSageGarden: 'Sage garden',
  chartPaletteNameNeonCyber: 'Neon cyber',
  chartPaletteNameAutumnSpice: 'Autumn spice',
  chartPaletteNameSunsetCoral: 'Sunset coral',
  chartPaletteNameCandyPop: 'Candy pop',
