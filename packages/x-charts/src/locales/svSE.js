...
exports.svSELocaleText = {
    ...
    toolbarExportImage: function (mimeType) { var _a; return "Exportera som ".concat((_a = imageMimeTypes_1.imageMimeTypes[mimeType]) !== null && _a !== void 0 ? _a : mimeType); },
...
exports.svSE = (0, getChartsLocalization_1.getChartsLocalization)(exports.svSELocaleText);
