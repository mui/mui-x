...
export const frFRLocalText: Partial<ChartsLocaleText> = {
  ...
  chartPaletteNameSignalDuo: 'Duo signalétique',
  chartPaletteNameDesertDune: 'Dune du désert',
  chartPaletteNameTropicalPunch: 'Punch tropical',
  chartPaletteNameSageGarden: 'Jardin de sauge',
  chartPaletteNameNeonCyber: 'Néon cyber',
  chartPaletteNameAutumnSpice: 'Épice automne',
  chartPaletteNameSunsetCoral: 'Corail au coucher',
  chartPaletteNameCandyPop: 'Bonbon acidulé',
