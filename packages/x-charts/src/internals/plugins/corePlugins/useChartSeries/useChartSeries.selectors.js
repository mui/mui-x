...
exports.selectorChartSeriesConfigGetter = exports.selectorChartSeriesLayout = exports.selectorChartSeriesProcessed = exports.selectorChartsDataset = exports.selectorChartDefaultizedSeries = exports.selectorChartSeriesState = void 0;
 ...
 */
exports.selectorChartsDataset = (0, store_1.createSelector)(exports.selectorChartSeriesState, function (seriesState) { return seriesState.dataset; });
/**
 ...
 */
exports.selectorChartSeriesProcessed = (0, store_1.createSelectorMemoized)(exports.selectorChartDefaultizedSeries, useChartSeriesConfig_selectors_1.selectorChartSeriesConfig, exports.selectorChartsDataset, useChartVisibilityManager_1.selectorIsItemVisibleGetter, function selectorChartSeriesProcessed(defaultizedSeries, seriesConfig, dataset, isItemVisible) {
 ...
 */
exports.selectorChartSeriesConfigGetter = (0, store_1.createSelectorMemoized)(useChartSeriesConfig_selectors_1.selectorChartSeriesConfig, exports.selectorChartSeriesProcessed, function (seriesConfig, processedSeries) {
    return function getSeriesConfigById(seriesId) {
        for (var type in processedSeries) {
            if (!Object.hasOwn(processedSeries, type)) {
                continue;
            }
            var seriesGroup = processedSeries[type];
            if (seriesGroup === null || seriesGroup === void 0 ? void 0 : seriesGroup.series) {
                var item = seriesGroup.series[seriesId];
                if (item) {
