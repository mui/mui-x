...
var useChartDimensions = function (_a) {
    ...
    var computeSize = React.useCallback(function () {
        ...
        store.update(function (prev) {
            ...
            return __assign(__assign({}, prev), { dimensions: {
                    margin: {
    ...
    React.useEffect(function () {
        store.update(function (prev) {
            var _a, _b;
            var width = (_a = params.width) !== null && _a !== void 0 ? _a : prev.dimensions.width;
            var height = (_b = params.height) !== null && _b !== void 0 ? _b : prev.dimensions.height;
            return __assign(__assign({}, prev), { dimensions: {
                    margin: {
                        top: params.margin.top,
                        right: params.margin.right,
