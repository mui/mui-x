...
var useChartDimensions = function (_a) {
    ...
    var computeSize = React.useCallback(function () {
        var _a, _b;
        var mainEl = chartsLayerContainerRef === null || chartsLayerContainerRef === void 0 ? void 0 : chartsLayerContainerRef.current;
        if (!mainEl) {
            return {};
        }
    ...
    (0, useEnhancedEffect_1.default)(function () {
        ...
        computeSize();
        var elementToObserve = chartsLayerContainerRef.current;
