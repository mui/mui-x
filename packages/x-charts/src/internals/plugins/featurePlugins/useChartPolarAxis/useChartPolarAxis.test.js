...
describe('useChartPolarAxis', function () {
    ...
    it.skipIf(!skipIf_1.isJSDOM)('should throw an error when axis have duplicate ids', function () {
        ...
        expect(function () {
            return render(<ChartDataProvider_1.ChartDataProvider rotationAxis={[
    ...
    it.skipIf(!skipIf_1.isJSDOM)('should throw an error when axis have duplicate ids across different directions (radius, rotation)', function () {
        ...
        expect(function () {
            return render(<ChartDataProvider_1.ChartDataProvider rotationAxis={[{ scaleType: 'band', id: 'qwerty', data: ['a', 'b', 'c'] }]} radiusAxis={[{ id: 'qwerty' }]} height={100} width={100} plugins={[useChartPolarAxis_1.useChartPolarAxis]}/>);
        }).toErrorDev(expectedError);
    });
});
