 ...
 */
var selectorChartsInteractionRotationAngle = (0, selectors_1.createSelector)([useChartInteraction_selectors_1.selectorChartsInteractionPointerX, useChartInteraction_selectors_1.selectorChartsInteractionPointerY, useChartPolarAxis_selectors_1.selectorChartPolarCenter], function (x, y, center) {
    if (x === null || y === null) {
        return null;
    }
    return (0, coordinateTransformation_1.generateSvg2rotation)(center)(x, y);
});
exports.selectorChartsInteractionRotationAxisIndex = (0, selectors_1.createSelector)([selectorChartsInteractionRotationAngle, useChartPolarAxis_selectors_1.selectorChartRotationAxis, optionalGetAxisId], function (rotation, rotationAxis, id) {
    if (id === void 0) { id = rotationAxis.axisIds[0]; }
    return rotation === null ? null : indexGetter(rotation, rotationAxis, id);
});
exports.selectorChartsInteractionRotationAxisIndexes = (0, selectors_1.createSelector)([selectorChartsInteractionRotationAngle, useChartPolarAxis_selectors_1.selectorChartRotationAxis, optionalGetAxisIds], function (rotation, rotationAxis, ids) {
    if (ids === void 0) { ids = rotationAxis.axisIds; }
    return rotation === null ? null : indexGetter(rotation, rotationAxis, ids);
});
exports.selectorChartsInteractionRotationAxisValue = (0, selectors_1.createSelector)([useChartPolarAxis_selectors_1.selectorChartRotationAxis, exports.selectorChartsInteractionRotationAxisIndex, optionalGetAxisId], function (rotationAxis, rotationIndex, id) {
    var _a;
    if (id === void 0) { id = rotationAxis.axisIds[0]; }
...
exports.selectorChartsInteractionRotationAxisValues = (0, selectors_1.createSelector)([useChartPolarAxis_selectors_1.selectorChartRotationAxis, exports.selectorChartsInteractionRotationAxisIndexes, optionalGetAxisIds], function (rotationAxis, rotationIndexes, ids) {
    if (ids === void 0) { ids = rotationAxis.axisIds; }
 ...
 */
exports.selectorChartsInteractionTooltipRotationAxes = (0, selectors_1.createSelector)([exports.selectorChartsInteractionRotationAxisIndexes, useChartPolarAxis_selectors_1.selectorChartRotationAxis], function (indexes, axes) {
    if (indexes === null) {
        return [];
    }
    return axes.axisIds
 ...
 */
exports.selectorChartsInteractionTooltipRadiusAxes = (0, selectors_1.createSelector)([], function () {
 ...
 */
exports.selectorChartsInteractionPolarAxisTooltip = (0, selectors_1.createSelector)([exports.selectorChartsInteractionTooltipRotationAxes], function (rotationTooltip) { return rotationTooltip.length > 0; });
