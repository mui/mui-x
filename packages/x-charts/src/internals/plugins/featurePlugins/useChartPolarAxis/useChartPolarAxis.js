...
var useChartPolarAxis = function (_a) {
    ...
    React.useEffect(function () {
        ...
        var gestureHandler = function (event) {
            ...
            if (event.detail.srcEvent.pointerType === 'touch') {
                ...
                var svgPoint_1 = (0, getChartPoint_1.getChartPoint)(element, srcEvent);
            ...
            var svgPoint = (0, getChartPoint_1.getChartPoint)(element, srcEvent);
    ...
    React.useEffect(function () {
        ...
        var axisClickHandler = instance.addInteractionListener('tap', function (event) {
            ...
            var svgPoint = (0, getChartPoint_1.getChartPoint)(element, event.detail.srcEvent);
