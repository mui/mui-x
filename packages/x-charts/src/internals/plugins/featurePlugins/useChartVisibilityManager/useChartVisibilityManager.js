...
var useChartVisibilityManager = function (_a) {
    ...
    (0, useEffectAfterFirstRender_1.useEffectAfterFirstRender)(function () {
        ...
        store.set('visibilityManager', __assign(__assign({}, store.state.visibilityManager), { visibilityMap: (0, visibilityParamToMap_1.visibilityParamToMap)(params.hiddenItems.map(function (item) { return instance.identifierWithType(item); }), store.state.seriesConfig.config) }));
    ...
    var hideItem = (0, useEventCallback_1.default)(function (identifier) {
        ...
        var id = instance.serializeIdentifier(instance.identifierWithType(identifier));
