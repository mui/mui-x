...
var useChartVisibilityManager = function (_a) {
    ...
    (0, useEffectAfterFirstRender_1.useEffectAfterFirstRender)(function () {
        ...
        store.set('visibilityManager', __assign(__assign({}, store.state.visibilityManager), { visibilityMap: (0, visibilityParamToMap_1.visibilityParamToMap)(params.hiddenItems.map(function (item) { return instance.identifierWithType(item, 'visibility'); }), store.state.seriesConfig.config) }));
    ...
    var hideItem = (0, useEventCallback_1.default)(function (identifier) {
        ...
        var identifierWithType = instance.identifierWithType(identifier, 'visibility');
        var id = instance.serializeIdentifier(identifierWithType);
        ...
        var values = Array.from(newVisibilityMap.values());
        (_a = params.onHiddenItemsChange) === null || _a === void 0 ? void 0 : _a.call(params, values);
    });
    ...
    return {
        visibilityManager: {
            visibilityMap: initialItems
                ? (0, visibilityParamToMap_1.visibilityParamToMap)(initialItems.map(function (item) { return (0, useChartSeries_1.createIdentifierWithType)(currentState)(item); }), seriesConfig)
