...
var selectorChartsIsHighlightedCallbackImpl = (0, store_1.createSelectorMemoized)(exports.selectorChartsHighlightScope, exports.selectorChartsHighlightedItem, useChartSeriesConfig_1.selectorChartSeriesConfig, function selectorChartsIsHighlightedCallbackCombiner(highlightScope, highlightedItem, seriesConfig) {
...
var selectorChartsIsFadedCallbackImpl = (0, store_1.createSelectorMemoized)(exports.selectorChartsHighlightScope, exports.selectorChartsHighlightedItem, useChartSeriesConfig_1.selectorChartSeriesConfig, function selectorChartsIsFadedCallbackCombiner(highlightScope, highlightedItem, seriesConfig) {
    if (highlightedItem === null || highlightScope === null) {
        return alwaysFalse;
    }
...
var selectorChartsIsHighlightedImpl = (0, store_1.createSelector)(exports.selectorChartsHighlightScope, exports.selectorChartsHighlightedItem, useChartSeriesConfig_1.selectorChartSeriesConfig, function selectorChartsIsHighlightedCombiner(highlightScope, highlightedItem, seriesConfig, item) {
    if (highlightedItem === null || highlightScope === null) {
        return false;
    }
...
var selectorChartsIsFadedImpl = (0, store_1.createSelector)(exports.selectorChartsHighlightScope, exports.selectorChartsHighlightedItem, useChartSeriesConfig_1.selectorChartSeriesConfig, function selectorChartsIsFadedCombiner(highlightScope, highlightedItem, seriesConfig, item) {
    if (highlightedItem === null || highlightScope === null) {
        return false;
    }
