...
var useChartHighlight = function (_a) {
    ...
    var clearHighlight = (0, useEventCallback_1.default)(function () {
        ...
        store.update(function (prev) { return (__assign(__assign({}, prev), { highlight: { item: null, lastUpdate: 'pointer' } })); });
    });
    var setHighlight = (0, useEventCallback_1.default)(function (newItem) {
        ...
        store.update(function (prev) { return (__assign(__assign({}, prev), { highlight: { item: newItem, lastUpdate: 'pointer' } })); });
    });
    return {
        instance: {
