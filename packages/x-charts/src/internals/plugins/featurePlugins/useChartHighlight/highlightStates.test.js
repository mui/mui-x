...
describe('highlightStates', function () {
    ...
    describe('getSeriesHighlightedItem', function () {
        describe('when scope.highlight is "item"', function () {
            ...
            it('should only return item.dataIndex when item.seriesId matches', function () {
                expect((0, highlightStates_1.getSeriesHighlightedItem)(highlightItemScope, itemData1, s1)).to.equal(itemData1.dataIndex);
                expect((0, highlightStates_1.getSeriesHighlightedItem)(highlightItemScope, itemData1, s2)).to.equal(null);
                expect((0, highlightStates_1.getSeriesHighlightedItem)(highlightItemScope, null, s1)).to.equal(null);
                expect((0, highlightStates_1.getSeriesHighlightedItem)(highlightItemScope, null, s2)).to.equal(null);
            });
            it('should handle undefined dataIndex', function () {
                var itemWithoutDataIndex = { seriesId: s1 };
                expect((0, highlightStates_1.getSeriesHighlightedItem)(highlightItemScope, itemWithoutDataIndex, s1)).to.equal(undefined);
            });
        });
        describe('when scope.highlight is not "item"', function () {
            it('should return null when scope.highlight is "series"', function () {
                ...
                expect((0, highlightStates_1.getSeriesHighlightedItem)(scope, itemData1, s1)).to.equal(null);
                expect((0, highlightStates_1.getSeriesHighlightedItem)(scope, itemData1, s2)).to.equal(null);
            });
        ...
        describe('when scope is null', function () {
            it('should return null when scope or item are null', function () {
                expect((0, highlightStates_1.getSeriesHighlightedItem)(null, itemData1, s1)).to.equal(null);
                expect((0, highlightStates_1.getSeriesHighlightedItem)(null, itemData1, s2)).to.equal(null);
                expect((0, highlightStates_1.getSeriesHighlightedItem)({ highlight: 'series' }, null, s1)).to.equal(null);
                expect((0, highlightStates_1.getSeriesHighlightedItem)({ highlight: 'series' }, null, s2)).to.equal(null);
                expect((0, highlightStates_1.getSeriesHighlightedItem)(null, null, s1)).to.equal(null);
                expect((0, highlightStates_1.getSeriesHighlightedItem)(null, null, s2)).to.equal(null);
            });
        });
    ...
    describe('getSeriesUnfadedItem', function () {
        describe('when scope.fade is not "none"', function () {
            it('should only return item.dataIndex when scope.fade is "global" and item.seriesId matches', function () {
                var scope = { fade: 'global' };
                expect((0, highlightStates_1.getSeriesUnfadedItem)(scope, itemData1, s1)).to.equal(dataIndex);
                expect((0, highlightStates_1.getSeriesUnfadedItem)(scope, itemData1, s2)).to.equal(null);
            });
            ...
            it('should return null when item is null', function () {
                var scope = { fade: 'global' };
                expect((0, highlightStates_1.getSeriesUnfadedItem)(scope, null, s1)).to.equal(null);
                expect((0, highlightStates_1.getSeriesUnfadedItem)(scope, null, s2)).to.equal(null);
            });
            it('should handle undefined dataIndex', function () {
                var scope = { fade: 'global' };
                var itemWithoutDataIndex = { seriesId: s1 };
                expect((0, highlightStates_1.getSeriesUnfadedItem)(scope, itemWithoutDataIndex, s1)).to.equal(undefined);
            });
        });
        it('should return null when scope.fade is "none"', function () {
            var scope = { fade: 'none' };
            expect((0, highlightStates_1.getSeriesUnfadedItem)(scope, itemData1, s1)).to.equal(null);
        });
        it('should return null when scope.fade is "series", but an item is highlighted', function () {
            var highlightSeriesScope = { highlight: 'series', fade: 'series' };
            expect((0, highlightStates_1.getSeriesUnfadedItem)(highlightSeriesScope, itemData1, s1)).to.equal(null);
            var highlightItemScope = { highlight: 'item', fade: 'series' };
            expect((0, highlightStates_1.getSeriesUnfadedItem)(highlightItemScope, itemData1, s1)).to.equal(null);
        });
        it('should return null when scope or item are null', function () {
            expect((0, highlightStates_1.getSeriesUnfadedItem)(null, itemData1, s1)).to.equal(null);
            expect((0, highlightStates_1.getSeriesUnfadedItem)(null, itemData1, s2)).to.equal(null);
            expect((0, highlightStates_1.getSeriesUnfadedItem)(null, null, s2)).to.equal(null);
            expect((0, highlightStates_1.getSeriesUnfadedItem)(null, null, s2)).to.equal(null);
        });
