        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    firstBar = container.querySelector("[data-series=\"A\"] .".concat(BarChart_1.barElementClasses.root, ":nth-child(1)"));
                    secondBar = container.querySelector("[data-series=\"A\"] .".concat(BarChart_1.barElementClasses.root, ":nth-child(2)"));
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    bars = container.querySelectorAll(".".concat(BarChart_1.barElementClasses.root));
