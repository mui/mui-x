...
var selectAxisHighlight = function (computedIndex, axis, axisItems, isBrushSelectionActive) {
...
exports.selectorChartsHighlightXAxisIndex = (0, selectors_1.createSelector)([
    ...
    useChartBrush_1.selectorBrushShouldPreventAxisHighlight,
], selectAxisHighlight);
...
var selectAxisHighlightWithValue = function (computedIndex, computedValue, axis, controlledAxisItems, keyboardAxisItem, lastInteractionUpdate, isBrushSelectionActive) {
    ...
    var keyboardValue = keyboardAxisItem && ((_b = (_a = axis.axis[keyboardAxisItem.axisId]) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b[keyboardAxisItem.dataIndex]);
    var keyboardHighlight = keyboardAxisItem &&
...
exports.selectorChartsHighlightXAxisValue = (0, selectors_1.createSelector)([
    ...
    useChartCartesianAxisRendering_selectors_1.selectorChartXAxis,
    selectorChartControlledCartesianAxisHighlight,
    useChartKeyboardNavigation_selectors_1.selectorChartsKeyboardXAxisIndex,
    useChartInteraction_selectors_1.selectorChartsLastInteraction,
    useChartBrush_1.selectorBrushShouldPreventAxisHighlight,
...
exports.selectorChartsHighlightYAxisValue = (0, selectors_1.createSelector)([
    ...
    useChartCartesianAxisRendering_selectors_1.selectorChartYAxis,
    selectorChartControlledCartesianAxisHighlight,
    useChartKeyboardNavigation_selectors_1.selectorChartsKeyboardYAxisIndex,
    useChartInteraction_selectors_1.selectorChartsLastInteraction,
    useChartBrush_1.selectorBrushShouldPreventAxisHighlight,
], selectAxisHighlightWithValue);
/**
