    ...
    allAxis.forEach(function (eachAxis) {
        ...
        if ((0, scaleGuards_1.isOrdinalScale)(scale)) {
            ...
            if ((0, scaleGuards_1.isBandScale)(scale) && (0, axis_1.isBandScaleConfig)(axis)) {
                var categoryGapRatio = (_c = axis.categoryGapRatio) !== null && _c !== void 0 ? _c : DEFAULT_CATEGORY_GAP_RATIO;
                var barGapRatio = (_d = axis.barGapRatio) !== null && _d !== void 0 ? _d : DEFAULT_BAR_GAP_RATIO;
                completeAxis[axis.id] = __assign(__assign({ offset: 0, height: 0, categoryGapRatio: categoryGapRatio, barGapRatio: barGapRatio, triggerTooltip: triggerTooltip }, axis), { data: data, scale: scale, tickNumber: axis.data.length, colorScale: axis.colorMap &&
            ...
            if ((0, axis_1.isPointScaleConfig)(axis)) {
                completeAxis[axis.id] = __assign(__assign({ offset: 0, height: 0, triggerTooltip: triggerTooltip }, axis), { data: data, scale: scale, tickNumber: axis.data.length, colorScale: axis.colorMap &&
                        (axis.colorMap.type === 'ordinal'
                            ? (0, colorScale_1.getOrdinalColorScale)(__assign({ values: axis.data }, axis.colorMap))
                            : (0, colorScale_1.getColorScale)(axis.colorMap)) });
            }
