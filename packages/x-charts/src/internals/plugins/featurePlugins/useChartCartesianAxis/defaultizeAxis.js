...
function defaultizeXAxis(inAxes, dataset) {
    ...
    var parsedAxes = inputAxes.map(function (axisConfig, index) {
        ...
        var sharedConfig = __assign(__assign({ offset: offsets[position] }, axisConfig), { id: id, position: position, height: (_c = axisConfig.height) !== null && _c !== void 0 ? _c : defaultHeight, zoom: (0, defaultizeZoom_1.defaultizeZoom)(axisConfig.zoom, id, 'x') });
...
function defaultizeYAxis(inAxes, dataset) {
    ...
    var parsedAxes = inputAxes.map(function (axisConfig, index) {
        ...
        var sharedConfig = __assign(__assign({ offset: offsets[position] }, axisConfig), { id: id, position: position, width: (_c = axisConfig.width) !== null && _c !== void 0 ? _c : defaultWidth, zoom: (0, defaultizeZoom_1.defaultizeZoom)(axisConfig.zoom, id, 'y') });
        // Increment the offset for the next axis
        if (position !== 'none') {
