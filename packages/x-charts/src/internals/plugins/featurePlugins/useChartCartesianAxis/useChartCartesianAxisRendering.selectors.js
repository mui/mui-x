...
exports.selectorChartYAxisWithDomains = (0, store_1.createSelectorMemoized)(useChartCartesianAxisLayout_selectors_1.selectorChartRawYAxis, useChartSeries_1.selectorChartSeriesProcessed, useChartSeriesConfig_1.selectorChartSeriesConfig, exports.selectorDefaultYAxisTickNumber, function selectorChartYAxisWithDomains(axes, formattedSeries, seriesConfig, defaultTickNumber) {
    ...
    axes === null || axes === void 0 ? void 0 : axes.forEach(function (eachAxis, axisIndex) {
        ...
        var axisExtrema = (0, getAxisExtrema_1.getAxisExtrema)(axis, axisDirection, seriesConfig, axisIndex, formattedSeries);
        domains[axis.id] = (0, domain_1.calculateInitialDomainAndTickNumber)(axis, 'y', axisIndex, formattedSeries, axisExtrema, defaultTickNumber);
    });
    return { axes: axes, domains: domains };
});
...
exports.selectorChartFilteredXDomains = (0, store_1.createSelectorMemoized)(useChartSeries_1.selectorChartSeriesProcessed, useChartSeriesConfig_1.selectorChartSeriesConfig, exports.selectorChartZoomMap, exports.selectorChartZoomOptionsLookup, exports.selectorChartZoomAxisFilters, exports.selectorChartXAxisWithDomains, function selectorChartFilteredXDomains(formattedSeries, seriesConfig, zoomMap, zoomOptions, getFilters, _a) {
    ...
    axes === null || axes === void 0 ? void 0 : axes.forEach(function (axis, axisIndex) {
        ...
        filteredDomains[axis.id] = (0, domain_1.calculateFinalDomain)(axis, 'x', axisIndex, formattedSeries, axisExtrema, rawTickNumber);
    });
    return filteredDomains;
});
exports.selectorChartFilteredYDomains = (0, store_1.createSelectorMemoized)(useChartSeries_1.selectorChartSeriesProcessed, useChartSeriesConfig_1.selectorChartSeriesConfig, exports.selectorChartZoomMap, exports.selectorChartZoomOptionsLookup, exports.selectorChartZoomAxisFilters, exports.selectorChartYAxisWithDomains, function selectorChartFilteredYDomains(formattedSeries, seriesConfig, zoomMap, zoomOptions, getFilters, _a) {
    var axes = _a.axes, domains = _a.domains;
    var filteredDomains = {};
    axes === null || axes === void 0 ? void 0 : axes.forEach(function (axis, axisIndex) {
        var domain = domains[axis.id].domain;
        ...
        filteredDomains[axis.id] = (0, domain_1.calculateFinalDomain)(axis, 'y', axisIndex, formattedSeries, axisExtrema, rawTickNumber);
    });
    return filteredDomains;
});
