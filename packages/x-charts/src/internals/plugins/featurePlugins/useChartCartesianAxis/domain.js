 ...
 */
function calculateInitialDomainAndTickNumber(axis, axisDirection, axisIndex, formattedSeries, _a, defaultTickNumber) {
    var _b, _c;
    var minData = _a[0], maxData = _a[1];
    var domainLimit = (0, getAxisDomainLimit_1.getAxisDomainLimit)(axis, axisDirection, axisIndex, formattedSeries);
 ...
 */
function calculateFinalDomain(axis, axisDirection, axisIndex, formattedSeries, _a, tickNumber) {
    var _b, _c;
    var minData = _a[0], maxData = _a[1];
    var domainLimit = (0, getAxisDomainLimit_1.getAxisDomainLimit)(axis, axisDirection, axisIndex, formattedSeries);
    var axisExtrema = getActualAxisExtrema(axis, minData, maxData);
