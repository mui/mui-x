...
exports.selectorChartsInteractionTooltipXAxes = (0, store_1.createSelectorMemoizedWithOptions)({
...
})(selectorChartControlledCartesianAxisTooltip, useChartInteraction_1.selectorChartsInteractionPointerX, useChartCartesianAxisRendering_selectors_1.selectorChartXAxis, useChartInteraction_selectors_1.selectorChartsLastInteraction, useChartKeyboardNavigation_selectors_1.selectorChartsKeyboardXAxisIndex, function (controlledValues, value, axes, lastInteraction, keyboardIndex) {
    ...
    if (lastInteraction === 'keyboard') {
        ...
        var axis = axes.axis[keyboardIndex.axisId];
        if (!(axis === null || axis === void 0 ? void 0 : axis.triggerTooltip)) {
            return EMPTY_ARRAY;
        }
...
})(selectorChartControlledCartesianAxisTooltip, useChartInteraction_1.selectorChartsInteractionPointerY, useChartCartesianAxisRendering_selectors_1.selectorChartYAxis, useChartInteraction_selectors_1.selectorChartsLastInteraction, useChartKeyboardNavigation_selectors_1.selectorChartsKeyboardYAxisIndex, function (controlledValues, value, axes, lastInteraction, keyboardIndex) {
    if (controlledValues !== undefined) {
        if (controlledValues.length === 0) {
            return EMPTY_ARRAY;
        }
