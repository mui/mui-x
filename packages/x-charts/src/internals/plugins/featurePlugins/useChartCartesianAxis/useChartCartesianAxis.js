...
var useChartCartesianAxis = function (_a) {
    ...
    var xAxis = params.xAxis, yAxis = params.yAxis, dataset = params.dataset, onHighlightedAxisChange = params.onHighlightedAxisChange, onTooltipAxisChange = params.onTooltipAxisChange, axesGap = params.axesGap;
    ...
    (0, store_1.useStoreEffect)(store, useChartCartesianInteraction_selectors_1.selectorChartAxisInteraction, function (prevAxisInteraction, nextAxisInteraction) {
        ...
        if (prevAxisInteraction.length !== nextAxisInteraction.length) {
            onHighlightedAxisChange === null || onHighlightedAxisChange === void 0 ? void 0 : onHighlightedAxisChange(nextAxisInteraction);
            onTooltipAxisChange === null || onTooltipAxisChange === void 0 ? void 0 : onTooltipAxisChange(nextAxisInteraction);
            return;
        }
    ...
    React.useEffect(function () {
        ...
        var gestureHandler = function (event) {
            ...
            var svgPoint = (0, getChartPoint_1.getChartPoint)(element, srvEvent);
