...
exports.selectorChartsItemIsFocused = (0, store_1.createSelector)(selectKeyboardNavigation, function (keyboardNavigationState, item) {
    return (keyboardNavigationState === null || keyboardNavigationState === void 0 ? void 0 : keyboardNavigationState.isFocused) === true &&
        (keyboardNavigationState === null || keyboardNavigationState === void 0 ? void 0 : keyboardNavigationState.item) != null &&
        (0, fastObjectShallowCompare_1.fastObjectShallowCompare)(keyboardNavigationState.item, item);
});
exports.selectorChartsHasFocusedItem = (0, store_1.createSelector)(selectKeyboardNavigation, function (keyboardNavigationState) {
    return (keyboardNavigationState === null || keyboardNavigationState === void 0 ? void 0 : keyboardNavigationState.isFocused) === true && (keyboardNavigationState === null || keyboardNavigationState === void 0 ? void 0 : keyboardNavigationState.item) != null;
});
exports.selectorChartsFocusedItem = (0, store_1.createSelector)(selectKeyboardNavigation, function (keyboardNavigationState) { var _a; return (keyboardNavigationState === null || keyboardNavigationState === void 0 ? void 0 : keyboardNavigationState.isFocused) === true ? ((_a = keyboardNavigationState === null || keyboardNavigationState === void 0 ? void 0 : keyboardNavigationState.item) !== null && _a !== void 0 ? _a : null) : null; });
exports.selectorChartsIsKeyboardNavigationEnabled = (0, store_1.createSelector)(selectKeyboardNavigation, function (keyboardNavigationState) { return !!(keyboardNavigationState === null || keyboardNavigationState === void 0 ? void 0 : keyboardNavigationState.enabled); });
/**
...
exports.selectorChartsKeyboardItem = (0, store_1.createSelector)(selectKeyboardNavigation, function selectorChartsKeyboardItem(keyboardState) {
    if ((keyboardState === null || keyboardState === void 0 ? void 0 : keyboardState.isFocused) !== true || (keyboardState === null || keyboardState === void 0 ? void 0 : keyboardState.item) == null) {
        return null;
    }
