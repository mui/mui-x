...
var useChartKeyboardNavigation = function (_a) {
    ...
    var removeFocus = (0, useEventCallback_1.default)(function removeFocus() {
        if (store.state.keyboardNavigation.isFocused) {
            store.set('keyboardNavigation', __assign(__assign({}, store.state.keyboardNavigation), { isFocused: false }));
        }
    });
    var restoreFocus = (0, useEventCallback_1.default)(function restoreFocus() {
        if (!store.state.keyboardNavigation.isFocused) {
            ...
            })), { keyboardNavigation: __assign(__assign({}, store.state.keyboardNavigation), { isFocused: true }) }));
        }
    });
    ...
    (0, useEnhancedEffect_1.default)(function () {
        store.set('keyboardNavigation', __assign(__assign({}, store.state.keyboardNavigation), { enabled: !params.disableKeyboardNavigation }));
