...
(0, vitest_1.describe)('findClosestPoints', function () {
    it('finds the closest points without zoom and using two linear scales', function () {
        ...
        var closestPoint = (0, findClosestPoints_1.findClosestPoints)(flatbush, drawingArea, seriesData, xScale, yScale, noZoom.start, // x
        noZoom.end, // x
        noZoom.start, // y
        noZoom.end, // y
    ...
    (0, vitest_1.describe)('linear and log scales', function () {
        ...
        (0, vitest_1.describe)('with zoom', function () {
            ...
            it('finds the closest points', function () {
                ...
                var flatbush = prepareFlatbush(seriesData, xScale, yScale);
                expect((0, findClosestPoints_1.findClosestPoints)(flatbush, drawingArea, seriesData, xScale, yScale, xZoom.start, xZoom.end, yZoom.start, yZoom.end, svgPoint.x, svgPoint.y)).to.deep.eq([0]);
            });
            it('finds the closest points with max radius', function () {
                ...
                var maxRadius = 100;
                var flatbush = prepareFlatbush(seriesData, xScale, yScale);
                expect((0, findClosestPoints_1.findClosestPoints)(flatbush, drawingArea, seriesData, xScale, yScale, xZoom.start, xZoom.end, yZoom.start, yZoom.end, 
