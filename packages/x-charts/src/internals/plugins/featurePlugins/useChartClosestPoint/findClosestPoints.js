...
function findClosestPoints(flatbush, drawingArea, seriesData, xScale, yScale, xZoomStart, xZoomEnd, yZoomStart, yZoomEnd, svgPointX, svgPointY, maxRadius, maxResults) {
    ...
    var pointX = originalXScale(invertScale(xScale, svgPointX, function (dataIndex) { return seriesData[dataIndex].x; }));
    var pointY = originalYScale(invertScale(yScale, svgPointY, function (dataIndex) { return seriesData[dataIndex].y; }));
