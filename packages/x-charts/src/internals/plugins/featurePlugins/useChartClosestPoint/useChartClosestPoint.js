...
var useChartClosestPoint = function (_a) {
    ...
    var flatbushMap = (0, useSelector_1.useSelector)(store, zoomIsInteracting ? useChartCartesianAxis_1.selectorChartSeriesEmptyFlatbushMap : useChartCartesianAxis_1.selectorChartSeriesFlatbushMap);
    ...
    React.useEffect(function () {
        ...
        function getClosestPoint(event) {
            ...
            for (var _i = 0, _g = seriesOrder !== null && seriesOrder !== void 0 ? seriesOrder : []; _i < _g.length; _i++) {
                ...
                var xAxisZoom = (0, useChartCartesianAxis_1.selectorChartAxisZoomData)(store.getSnapshot(), xAxisId);
                var yAxisZoom = (0, useChartCartesianAxis_1.selectorChartAxisZoomData)(store.getSnapshot(), yAxisId);
                ...
                var closestPointIndex = (0, findClosestPoints_1.findClosestPoints)(flatbush, drawingArea, aSeries.data, xScale, yScale, xZoomStart, xZoomEnd, yZoomStart, yZoomEnd, svgPoint.x, svgPoint.y, maxRadius)[0];
