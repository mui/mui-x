...
var getChartPoint_1 = require("../../../getChartPoint");
...
var useChartClosestPoint = function (_a) {
    ...
    var disableHitArea = params.disableHitArea, hitAreaRadius = params.hitAreaRadius, onItemClick = params.onItemClick;
    var resolvedDisableHitArea = disableHitArea;
    var resolvedHitAreaRadius = hitAreaRadius;
    ...
    React.useEffect(function () {
        ...
        function getClosestPoint(event) {
            ...
            for (var _i = 0, _g = seriesOrder !== null && seriesOrder !== void 0 ? seriesOrder : []; _i < _g.length; _i++) {
                ...
                var maxRadius = resolvedHitAreaRadius === 'item' ? aSeries.markerSize : resolvedHitAreaRadius;
...
exports.useChartClosestPoint.getDefaultizedParams = function (_a) {
    ...
    return (__assign(__assign({}, params), { disableHitArea: (_b = params.disableHitArea) !== null && _b !== void 0 ? _b : !params.series.some(function (item) { return item.type === 'scatter'; }) }));
};
