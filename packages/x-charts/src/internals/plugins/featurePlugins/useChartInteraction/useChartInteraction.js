...
var useChartInteraction = function (_a) {
    ...
    var cleanInteraction = (0, useEventCallback_1.default)(function cleanInteraction() {
        store.update(function (prev) {
            return __assign(__assign({}, prev), { interaction: __assign(__assign({}, prev.interaction), { pointer: null, item: null }) });
        });
    });
    ...
    var setPointerCoordinate = (0, useEventCallback_1.default)(function setPointerCoordinate(coordinate) {
        store.update(function (prev) { return (__assign(__assign({}, prev), { interaction: __assign(__assign({}, prev.interaction), { pointer: coordinate, lastUpdate: coordinate !== null ? 'pointer' : prev.interaction.lastUpdate }) })); });
    });
    return {
        instance: {
