...
var Flatbush = /** @class */ (function () {
    ...
    function Flatbush(numItems, nodeSize, ArrayType, ArrayBufferType, data, byteOffset) {
        ...
        if (numItems === undefined) {
            throw new Error('MUI X Charts: Missing required argument "numItems" for spatial index. ' +
                'The index needs to know how many items it will contain. ' +
                'Provide the expected number of items as the first argument.');
        }
        if (isNaN(numItems) || numItems <= 0) {
            throw new Error("MUI X Charts: Unexpected numItems value: ".concat(numItems, ". ") +
        ...
        if (arrayTypeIndex < 0) {
            throw new Error("MUI X Charts: Unexpected typed array class: ".concat(ArrayType, ". ") +
    ...
    Flatbush.from = function (data, byteOffset) {
        if (byteOffset === void 0) { byteOffset = 0; }
        if (byteOffset % 8 !== 0) {
            throw new Error('MUI X Charts: byteOffset must be 8-byte aligned. ' +
        ...
        if (!data || data.byteLength === undefined || data.buffer) {
            throw new Error('MUI X Charts: Data must be an instance of ArrayBuffer or SharedArrayBuffer. ' +
        ...
        if (magic !== 0xfb) {
            throw new Error('MUI X Charts: Data does not appear to be in a Flatbush format. ' +
        ...
        if (version !== VERSION) {
            throw new Error("MUI X Charts: Got v".concat(version, " data when expected v").concat(VERSION, ". ") +
        ...
        if (!ArrayType) {
            throw new Error('MUI X Charts: Unrecognized array type in spatial index data. ' +
    ...
    Flatbush.prototype.finish = function () {
        if (this._pos >> 2 !== this.numItems) {
            throw new Error("MUI X Charts: Added ".concat(this._pos >> 2, " items when expected ").concat(this.numItems, ". ") +
    ...
    Flatbush.prototype.search = function (minX, minY, maxX, maxY, filterFn) {
        if (this._pos !== this._boxes.length) {
            throw new Error('MUI X Charts: Spatial index data not yet indexed. ' +
