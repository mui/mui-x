...
function ChartsContinuousGradient(props) {
    ...
    return (<linearGradient id={gradientId} x1="0" x2="0" y1="0" y2="0" {..._a = {},
        _a["".concat(direction).concat(isReversed ? 1 : 2)] = gradientUnits === 'objectBoundingBox' ? 1 : "".concat(size, "px"),
        _a} gradientUnits={gradientUnits !== null && gradientUnits !== void 0 ? gradientUnits : 'userSpaceOnUse'} // Use the SVG coordinate instead of the component ones.
    >
