...
var consumeThemeProps_1 = require("./consumeThemeProps");
var SlotsWrapper = (0, consumeThemeProps_1.consumeThemeProps)('MuiSlotsWrapper', {
    defaultProps: { data: 'test' },
    classesResolver: function (props) { return ({
        root: ['wrapper-root', props.data, props.shouldOmit ? 'shouldOmit' : ''].join(' '),
    }); },
}, function SlotsWrapper(props, ref) {
    var _a;
    return ((0, jsx_runtime_1.jsxs)("div", { ref: ref, children: [(0, jsx_runtime_1.jsx)("div", { className: "data", children: props.data }), (0, jsx_runtime_1.jsx)("div", { className: "classes", children: (_a = props.classes) === null || _a === void 0 ? void 0 : _a.root })] }));
});
describe('consumeThemeProps', function () {
    var render = (0, internal_test_utils_1.createRenderer)().render;
    it('should render default props', function test() {
    ...
    it('should render passed props', function test() {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
