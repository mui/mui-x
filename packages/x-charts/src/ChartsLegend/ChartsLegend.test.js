...
describe('<ChartsLegend />', function () {
    var render = (0, internal_test_utils_1.createRenderer)().render;
    (0, internal_test_utils_1.describeConformance)((0, jsx_runtime_1.jsx)(ChartsLegend_1.ChartsLegend, {}), function () { return ({
        classes: ChartsLegend_1.legendClasses,
        inheritComponent: 'ul',
