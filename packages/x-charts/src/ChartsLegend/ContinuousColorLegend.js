...
var ContinuousColorLegend = (0, consumeThemeProps_1.consumeThemeProps)('MuiContinuousColorLegend', {
    ...
    var minComponent = (<li className={classes === null || classes === void 0 ? void 0 : classes.minLabel}>
        <ChartsLabel_1.ChartsLabel className={classes === null || classes === void 0 ? void 0 : classes.label}>{minText}</ChartsLabel_1.ChartsLabel>
      </li>);
    var maxComponent = (<li className={classes === null || classes === void 0 ? void 0 : classes.maxLabel}>
        <ChartsLabel_1.ChartsLabel className={classes === null || classes === void 0 ? void 0 : classes.label}>{maxText}</ChartsLabel_1.ChartsLabel>
      </li>);
    return (<RootElement className={(0, clsx_1.default)(classes === null || classes === void 0 ? void 0 : classes.root, className)} ref={ref} {...other} ownerState={props}>
        ...
        <li className={classes === null || classes === void 0 ? void 0 : classes.gradient}>
          <ChartsLabelGradient_1.ChartsLabelGradient direction={direction} rotate={rotateGradient} reverse={reverse} thickness={thickness} gradientId={gradientId !== null && gradientId !== void 0 ? gradientId : generateGradientId(axisItem.id)}/>
        </li>
