...
var RootElement = (0, styles_1.styled)('ul', {
    ...
    return __assign(__assign({}, theme.typography.caption), (_b = { color: (theme.vars || theme).palette.text.primary, lineHeight: '100%', display: 'flex', flexDirection: ownerState.direction === 'vertical' ? 'column' : 'row', flexShrink: 0, gap: theme.spacing(0.5), listStyleType: 'none', paddingInlineStart: 0, marginBlock: theme.spacing(1), marginInline: theme.spacing(1), width: 'max-content' }, _b["button.".concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.item)] = {
        ...
        color: 'inherit',
    }, _b[".".concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.item)] = {
        display: 'flex',
        gap: theme.spacing(0.5),
    }, _b["li :not(.".concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.minLabel, ", .").concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.maxLabel, ") .").concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses === null || piecewiseColorLegendClasses_1.piecewiseColorLegendClasses === void 0 ? void 0 : piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.mark)] = {
        alignSelf: 'center',
    }, _b["&.".concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.start)] = {
        alignItems: 'end',
    }, _b["&.".concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.end)] = {
        alignItems: 'start',
    }, _b["&.".concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.horizontal)] = (_c = {
            alignItems: 'center'
        },
        _c[".".concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.item)] = {
            flexDirection: 'column',
        },
        _c["&.".concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.start)] = {
            alignItems: 'end',
        },
        _c["&.".concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.end)] = {
            alignItems: 'start',
        },
        _c[".".concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.minLabel)] = {
            alignItems: 'end',
        },
        _c["&.".concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.extremes)] = (_d = {},
            _d[".".concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.minLabel, ", .").concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.maxLabel)] = {
                alignItems: 'center',
                display: 'flex',
                flexDirection: 'row',
            },
            _d),
        _c), _b["&.".concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.vertical)] = (_e = {},
        _e[".".concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.item)] = {
            flexDirection: 'row',
            alignItems: 'center',
        },
        _e["&.".concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.start)] = {
            alignItems: 'end',
        },
        _e["&.".concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.end)] = {
            alignItems: 'start',
        },
        _e["&.".concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.extremes)] = (_f = {
                alignItems: 'center'
            },
            _f[".".concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.minLabel, ", .").concat(piecewiseColorLegendClasses_1.piecewiseColorLegendClasses.maxLabel)] = {
                alignItems: 'center',
                display: 'flex',
                flexDirection: 'column',
            },
...
var PiecewiseColorLegend = (0, consumeThemeProps_1.consumeThemeProps)('MuiPiecewiseColorLegend', {
    ...
    return (<RootElement className={(0, clsx_1.default)(classes === null || classes === void 0 ? void 0 : classes.root, className)} ref={ref} {...other} ownerState={props}>
        {orderedColors.map(function (_a, index) {
            var _b;
            ...
            var isTextBefore = isStart || (isExtremes && isFirst);
            var isTextAfter = isEnd || (isExtremes && isLast);
            var clickObject = {
                type: 'piecewiseColor',
                color: color,
                label: label,
            ...
            return (<li key={colorIndex}>
              <Element role={onItemClick ? 'button' : undefined} type={onItemClick ? 'button' : undefined} onClick={
                ...
                onItemClick ? function (event) { return onItemClick(event, clickObject, index); } : undefined} className={(0, clsx_1.default)(classes === null || classes === void 0 ? void 0 : classes.item, (_b = {},
                    ...
                    _b))}>
                {isTextBefore && <ChartsLabel_1.ChartsLabel className={classes === null || classes === void 0 ? void 0 : classes.label}>{label}</ChartsLabel_1.ChartsLabel>}
                <ChartsLabelMark_1.ChartsLabelMark className={classes === null || classes === void 0 ? void 0 : classes.mark} type={markType} color={color}/>
                {isTextAfter && <ChartsLabel_1.ChartsLabel className={classes === null || classes === void 0 ? void 0 : classes.label}>{label}</ChartsLabel_1.ChartsLabel>}
              </Element>
            </li>);
        })}
      </RootElement>);
