...
var ChartsLegend = (0, consumeSlots_1.consumeSlots)('MuiChartsLegend', 'legend', {
    ...
    return ((0, jsx_runtime_1.jsx)(RootElement, __assign({ className: (0, clsx_1.default)(classes === null || classes === void 0 ? void 0 : classes.root, className), ref: ref }, other, { ownerState: props, children: data.items.map(function (item, i) {
            ...
            return ((0, jsx_runtime_1.jsx)("li", { className: classes === null || classes === void 0 ? void 0 : classes.item, "data-series": item.seriesId, "data-index": item.dataIndex, children: isButton ? ((0, jsx_runtime_1.jsxs)("button", { className: (0, clsx_1.default)(classes === null || classes === void 0 ? void 0 : classes.series, !isVisible && (classes === null || classes === void 0 ? void 0 : classes.hidden)), onClick: handleClick(item, i), type: "button", children: [(0, jsx_runtime_1.jsx)(ChartsLabelMark_1.ChartsLabelMark, { className: classes === null || classes === void 0 ? void 0 : classes.mark, color: item.color, type: item.markType, markShape: item.markShape }), (0, jsx_runtime_1.jsx)(ChartsLabel_1.ChartsLabel, { className: classes === null || classes === void 0 ? void 0 : classes.label, children: item.label })] })) : ((0, jsx_runtime_1.jsxs)("div", { className: (0, clsx_1.default)(classes === null || classes === void 0 ? void 0 : classes.series, !isVisible && (classes === null || classes === void 0 ? void 0 : classes.hidden)), children: [(0, jsx_runtime_1.jsx)(ChartsLabelMark_1.ChartsLabelMark, { className: classes === null || classes === void 0 ? void 0 : classes.mark, color: item.color, type: item.markType, markShape: item.markShape }), (0, jsx_runtime_1.jsx)(ChartsLabel_1.ChartsLabel, { className: classes === null || classes === void 0 ? void 0 : classes.label, children: item.label })] })) }, "".concat(item.seriesId, "-").concat(item.dataIndex)));
        }) })));
}));
