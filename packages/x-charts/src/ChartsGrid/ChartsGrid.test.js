...
var ChartsContainer_1 = require("@mui/x-charts/ChartsContainer");
describe('<ChartsGrid />', function () {
    ...
    it('should render grid at millisecond level without warnings', function () {
        render((0, jsx_runtime_1.jsx)(ChartsContainer_1.ChartsContainer, { series: [], width: 500, height: 500, xAxis: [
                {
                    scaleType: 'time',
    ...
    it('should render grid on band scale without error', function () {
        render((0, jsx_runtime_1.jsx)(ChartsContainer_1.ChartsContainer, { series: [], width: 500, height: 500, xAxis: [{ scaleType: 'band', data: ['A', 'B', 'C'] }], yAxis: [{ scaleType: 'band', data: ['A', 'B', 'C'] }], children: (0, jsx_runtime_1.jsx)(ChartsGrid_1.ChartsGrid, { vertical: true, horizontal: true }) }));
        var gridLines = document.querySelectorAll('.MuiChartsGrid-line');
        expect(gridLines.length).to.be.greaterThan(0);
    });
});
