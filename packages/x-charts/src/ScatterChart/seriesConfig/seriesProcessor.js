...
var seriesProcessor = function (_a, dataset) {
    ...
    var completeSeries = Object.fromEntries(Object.entries(series).map(function (_a) {
        ...
        var missingKeys = ['x', 'y', 'id'].filter(function (key) { return typeof (datasetKeys === null || datasetKeys === void 0 ? void 0 : datasetKeys[key]) !== 'string'; });
        ...
        return [
            seriesId,
            __assign(__assign({ labelMarkType: 'circle', markerSize: 4 }, seriesData), { preview: __assign({ markerSize: 1 }, seriesData === null || seriesData === void 0 ? void 0 : seriesData.preview), data: data, valueFormatter: (_d = seriesData.valueFormatter) !== null && _d !== void 0 ? _d : (function (v) { return v && "(".concat(v.x, ", ").concat(v.y, ")"); }) }),
        ];
    }));
    return {
