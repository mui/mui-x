...
describe('<ScatterChart />', function () {
    ...
    (0, describeConformance_1.describeConformance)(<ScatterChart_1.ScatterChart height={100} width={100} series={[
            {
                data: [
                    { id: 'A', x: 100, y: 10 },
                    { id: 'B', x: 200, y: 20 },
    ...
    it.skipIf(skipIf_1.isJSDOM)('should show the tooltip without errors in default config', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        <ScatterChart_1.ScatterChart {...config} series={[{ id: 's1', label: 'series', data: config.dataset }]} hideLegend/>
      </div>).user;
    ...
    it.skipIf(skipIf_1.isJSDOM)('should show the tooltip without errors with voronoi disabled', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        <ScatterChart_1.ScatterChart {...config} disableVoronoi series={[{ id: 's1', data: config.dataset }]}/>
      </div>).user;
    ...
    it.skipIf(skipIf_1.isJSDOM)('should support dataset with missing values', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    render(<ScatterChart_1.ScatterChart dataset={dataset} series={[{ datasetKeys: { id: 'version', x: 'a1', y: 'a2' }, label: 'Series A' }]} width={500} height={300}/>);
    ...
    it('should render "No data to display" when axes are empty arrays', function () {
        render(<ScatterChart_1.ScatterChart series={[]} width={100} height={100} xAxis={[]} yAxis={[]}/>);
