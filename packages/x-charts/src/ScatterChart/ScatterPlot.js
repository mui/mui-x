...
var ScatterPlotRoot = (0, styles_1.styled)('g', {
    name: 'MuiScatterPlot',
    slot: 'Root',
})();
/**
...
function ScatterPlot(props) {
    var _a;
    var slots = props.slots, slotProps = props.slotProps, onItemClick = props.onItemClick, renderer = props.renderer, className = props.className, inClasses = props.classes;
    ...
    var classes = (0, scatterClasses_1.useUtilityClasses)({ classes: inClasses });
    ...
    return ((0, jsx_runtime_1.jsx)(ScatterPlotRoot, { className: (0, clsx_1.default)(classes.root, className), children: seriesOrder.map(function (seriesId) {
