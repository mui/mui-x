...
function useCreatePaths(seriesData, markerSize, xScale, yScale, color, colorGetter) {
    ...
    var getXPosition = (0, getValueToPositionMapper_1.getValueToPositionMapper)(xScale);
    var getYPosition = (0, getValueToPositionMapper_1.getValueToPositionMapper)(yScale);
    var paths = new Map();
...
function BatchScatter(props) {
    var series = props.series, xScale = props.xScale, yScale = props.yScale, color = props.color, colorGetter = props.colorGetter, className = props.className;
    ...
    var classes = (0, scatterClasses_1.useUtilityClasses)(props);
    var siblings = [];
