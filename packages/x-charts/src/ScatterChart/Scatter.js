...
function Scatter(props) {
    ...
    var isVoronoiEnabled = (0, useSelector_1.useSelector)(store, useChartVoronoi_1.selectorChartsVoronoiIsVoronoiEnabled);
    ...
    return (<g data-series={series.id} className={classes.root}>
      {scatterPlotData.map(function (dataPoint, i) {
            ...
            return (<Marker key={(_a = dataPoint.id) !== null && _a !== void 0 ? _a : dataPoint.dataIndex} dataIndex={dataPoint.dataIndex} color={colorGetter ? colorGetter(i) : color} isHighlighted={isItemHighlighted} isFaded={isItemFaded} x={dataPoint.x} y={dataPoint.y} onClick={onItemClick &&
                    (function (event) {
