...
function Scatter(props) {
    ...
    var skipInteractionHandlers = isVoronoiEnabled;
    ...
    var _b = (0, useSlotProps_1.default)({
        ...
        ownerState: {},
    }), ownerState = _b.ownerState, markerProps = __rest(_b, ["ownerState"]);
    var classes = (0, scatterClasses_1.useUtilityClasses)({ classes: inClasses });
    return ((0, jsx_runtime_1.jsx)("g", { "data-series": series.id, className: classes.series, children: scatterPlotData.map(function (dataPoint) {
            var _a;
            var highlightState = getHighlightState(dataPoint);
            var isItemHighlighted = highlightState === 'highlighted';
            var isItemFaded = highlightState === 'faded';
            return ((0, jsx_runtime_1.jsx)(Marker, __assign({ className: (0, clsx_1.default)(classes.marker, markerProps.className), dataIndex: dataPoint.dataIndex, color: colorGetter(dataPoint.dataIndex), isHighlighted: isItemHighlighted, isFaded: isItemFaded, x: dataPoint.x, y: dataPoint.y, onClick: onItemClick &&
                    (function (event) {
