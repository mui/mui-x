...
var ChartsSurfaceStyles = (0, styles_1.styled)('svg', {
    ...
    return ({
        ...
        '&:focus-visible': {
            ...
            outline: "".concat(((_d = theme.vars) !== null && _d !== void 0 ? _d : theme).palette.text.primary, " solid 2px"),
        ...
        '& [data-focused=true]': {
            outline: "".concat(((_e = theme.vars) !== null && _e !== void 0 ? _e : theme).palette.text.primary, " solid 2px"),
        },
    });
});
/**
...
var ChartsSurface = React.forwardRef(function ChartsSurface(inProps, ref) {
    ...
    var isKeyboardNavigationEnabled = (0, useSelector_1.useSelector)(store, useChartKeyboardNavigation_1.selectorChartsIsKeyboardNavigationEnabled);
    var hasFocusedItem = (0, useSelector_1.useSelector)(store, useChartKeyboardNavigation_1.selectorChartsHasFocusedItem);
    ...
    return (<ChartsSurfaceStyles ownerState={{ width: propsWidth, height: propsHeight }} viewBox={"".concat(0, " ").concat(0, " ").concat(svgWidth, " ").concat(svgHeight)} className={className} tabIndex={isKeyboardNavigationEnabled ? 0 : undefined} data-has-focused-item={hasFocusedItem || undefined} {...other} ref={handleRef}>
