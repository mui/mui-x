...
var ChartsSurface = React.forwardRef(function ChartsSurface(inProps, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(ChartsLayerContainer_1.ChartsLayerContainer, { className: (0, clsx_1.default)(classes.root, className), ref: ref, children: (0, jsx_runtime_1.jsx)(ChartsSvgLayer_1.ChartsSvgLayer, __assign({}, other, { children: children })) }));
});
