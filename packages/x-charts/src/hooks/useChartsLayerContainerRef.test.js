...
var useChartsLayerContainerRef_1 = require("./useChartsLayerContainerRef");
var ChartsProvider_1 = require("../context/ChartsProvider");
function UseChartsLayerContainerRef() {
    var _a;
    var ref = (0, useChartsLayerContainerRef_1.useChartsLayerContainerRef)();
    return ((0, jsx_runtime_1.jsx)("div", { ref: ref, id: "test-id", children: (_a = ref.current) === null || _a === void 0 ? void 0 : _a.id }));
}
describe('useChartsLayerContainerRef', function () {
    ...
    it('should throw an error when parent context not present', function () {
        ...
        expect(function () {
            return render((0, jsx_runtime_1.jsx)(internal_test_utils_1.ErrorBoundary, { ref: errorRef, children: (0, jsx_runtime_1.jsx)(UseChartsLayerContainerRef, {}) }));
        }).toErrorDev(expectedError);
        expect(errorRef.current.errors).to.have.length(1);
        expect(errorRef.current.errors[0].toString()).to.include('MUI X Charts: Could not find the Charts context. ');
    });
    it('should not throw an error when parent context is present', function () { return __awaiter(void 0, void 0, void 0, function () {
        function RenderDrawingProvider() {
            return ((0, jsx_runtime_1.jsx)(ChartsProvider_1.ChartsProvider, { pluginParams: { width: 200, height: 200 }, children: (0, jsx_runtime_1.jsx)(UseChartsLayerContainerRef, {}) }));
        }
        var forceUpdate, _a;
