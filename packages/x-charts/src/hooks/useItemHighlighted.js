...
function useItemHighlighted(item) {
    ...
    var isHighlighted = (0, useSelector_1.useSelector)(store, useChartHighlight_1.selectorChartsIsHighlighted, [item]);
    var isFaded = (0, useSelector_1.useSelector)(store, useChartHighlight_1.selectorChartsIsFaded, [item]);
