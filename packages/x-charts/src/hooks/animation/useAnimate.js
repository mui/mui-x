...
function useAnimate(props, _a) {
    ...
    var animateRef = (0, useAnimateInternal_1.useAnimateInternal)(props, {
    ...
    var usedProps = skip ? props : initialProps;
    return __assign(__assign({}, transformProps(usedProps)), { ref: (0, useForkRef_1.default)(animateRef, ref) });
}
