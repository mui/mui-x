...
function useItemHighlightedGetter() {
    ...
    var isHighlighted = (0, useSelector_1.useSelector)(store, useChartHighlight_selectors_1.selectorChartsIsHighlightedCallback);
    var isFaded = (0, useSelector_1.useSelector)(store, useChartHighlight_selectors_1.selectorChartsIsFadedCallback);
    return {
