...
describe('BarChart - click event', function () {
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        user = render((0, jsx_runtime_1.jsx)("div", { style: {
                                width: 400,
                                height: 400,
                            }, children: (0, jsx_runtime_1.jsx)(BarChart_1.BarChart, __assign({}, config, { series: [
                                    { dataKey: 'v1', id: 's1' },
                                    { dataKey: 'v2', id: 's2' },
                                ], xAxis: [{ dataKey: 'x' }], onAxisClick: onAxisClick })) })).user;
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        user = render((0, jsx_runtime_1.jsx)("div", { style: {
                                width: 400,
                                height: 400,
                            }, children: (0, jsx_runtime_1.jsx)(BarChart_1.BarChart, __assign({}, config, { layout: "horizontal", series: [
                                    { dataKey: 'v1', id: 's1' },
                                    { dataKey: 'v2', id: 's2' },
                                ], yAxis: [{ scaleType: 'band', dataKey: 'x' }], onAxisClick: onAxisClick })) })).user;
                        svg = document.querySelector(constants_1.CHART_SELECTOR);
                        return [4 /*yield*/, user.pointer([
                                {
                                    keys: '[MouseLeft]',
    ...
    describe('onItemClick', function () {
        it('should add cursor="pointer" to bar elements', function () {
            render((0, jsx_runtime_1.jsx)(BarChart_1.BarChart, __assign({}, config, { series: [
                    { dataKey: 'v1', id: 's1' },
                    { dataKey: 'v2', id: 's2' },
                ], xAxis: [{ dataKey: 'x' }], onItemClick: function () { } })));
            var rectangles = document.querySelectorAll('rect.MuiBarChart-element');
                    ...
                    case 0:
                        ...
                        user = render((0, jsx_runtime_1.jsx)("div", { style: {
                                ...
                                height: 400,
                                    ...
                                    { dataKey: 'v1', id: 's1' },
                                    { dataKey: 'v2', id: 's2' },
                                ], xAxis: [{ dataKey: 'x' }], onItemClick: onItemClick })) })).user;
                        rectangles = document.querySelectorAll('rect.MuiBarChart-element');
