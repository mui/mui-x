    ...
    seriesOrder.forEach(function (id) {
        ...
        if (process.env.NODE_ENV !== 'production') {
            if (!data && dataset) {
                ...
                if (!dataKey_1) {
                    throw new Error([
                        "MUI X Charts: bar series with id='".concat(id, "' has no data and no dataKey."),
                ...
                dataset.forEach(function (entry, index) {
                    ...
                    if (value != null && typeof value !== 'number') {
                        (0, warning_1.warnOnce)([
                            "MUI X Charts: your dataset key \"".concat(dataKey_1, "\" is used for plotting bars, but the dataset contains the non-null non-numerical element \"").concat(value, "\" at index ").concat(index, "."),
