...
var seriesProcessor = function (params, dataset, isItemVisible) {
    ...
    var stackingGroups = (0, stacking_1.getStackingGroups)(params);
    ...
    seriesOrder.forEach(function (id) {
        ...
        if (data !== undefined) {
            ...
            throw new Error("MUI X Charts: Bar series with id=\"".concat(id, "\" has no data. ") +
        ...
        if (process.env.NODE_ENV !== 'production') {
            if (!data && dataset) {
                ...
                if (!dataKey_1) {
                    throw new Error("MUI X Charts: Bar series with id=\"".concat(id, "\" has no data and no dataKey. ") +
                ...
                dataset.forEach(function (entry, index) {
                    ...
                    if (value != null && typeof value !== 'number') {
                        (0, warning_1.warnOnce)("MUI X Charts: your dataset key \"".concat(dataKey_1, "\" is used for plotting bars, but the dataset contains the non-null non-numerical element \"").concat(value, "\" at index ").concat(index, ".\nBar plots only support numeric and null values."));
                    }
                });
            }
        }
    ...
    stackingGroups.forEach(function (stackingGroup) {
        ...
        var visibleStackedData = (0, d3_shape_1.stack)()
            ...
            if (!(isItemVisible === null || isItemVisible === void 0 ? void 0 : isItemVisible({ type: 'bar', seriesId: seriesId }))) {
        ...
        ids.forEach(function (id, index) {
            ...
            var data = dataKey
                ...
                : series[id].data;
            var hidden = !(isItemVisible === null || isItemVisible === void 0 ? void 0 : isItemVisible({ type: 'bar', seriesId: id }));
            completedSeries[id] = __assign(__assign({ layout: 'vertical', labelMarkType: 'square', minBarSize: 0, valueFormatter: (_a = series[id].valueFormatter) !== null && _a !== void 0 ? _a : barValueFormatter }, series[id]), { data: data, hidden: hidden, stackedData: stackedData[index], visibleStackedData: visibleStackedData[index] });
        });
    });
    return {
