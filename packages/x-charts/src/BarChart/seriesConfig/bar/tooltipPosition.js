...
var tooltipItemPositionGetter = function (params) {
    ...
    var groupIndex = series.bar.stackingGroups.findIndex(function (group) {
        return group.ids.includes(itemSeries.id);
    });
    var dimensions = (0, createGetBarDimensions_1.createGetBarDimensions)({
