...
export type BarLabelItemProps<V extends BarValueType | BarRangeValueType | null> = Omit<
  BarLabelOwnerState,
 ...
 */
function BarLabelItem<V extends BarValueType | BarRangeValueType | null = BarValueType | null>(
