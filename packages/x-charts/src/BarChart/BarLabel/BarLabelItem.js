...
function BarLabelItem(props) {
    ...
    var highlightState = (0, useItemHighlightState_1.useItemHighlightState)({
        type: 'bar',
        seriesId: seriesId,
        dataIndex: dataIndex,
    });
    ...
    var classes = (0, barClasses_1.useUtilityClasses)(ownerState);
    ...
    var _b = (0, useSlotProps_1.default)({
        ...
        additionalProps: __assign(__assign({}, other), { xOrigin: xOrigin, yOrigin: yOrigin, x: x, y: y, width: width, height: height, placement: barLabelPlacement, className: classes.label, 'data-highlighted': isHighlighted || undefined, 'data-faded': isFaded || undefined }),
        ownerState: ownerState,
    }), barLabelOwnerState = _b.ownerState, barLabelProps = __rest(_b, ["ownerState"]);
    if (!barLabel) {
        return null;
    }
