...
function BarLabelItem(props) {
    var _a;
    var seriesId = props.seriesId, innerClasses = props.classes, color = props.color, dataIndex = props.dataIndex, barLabel = props.barLabel, slots = props.slots, slotProps = props.slotProps, xOrigin = props.xOrigin, yOrigin = props.yOrigin, x = props.x, y = props.y, width = props.width, height = props.height, value = props.value, skipAnimation = props.skipAnimation, layout = props.layout, other = __rest(props, ["seriesId", "classes", "color", "dataIndex", "barLabel", "slots", "slotProps", "xOrigin", "yOrigin", "x", "y", "width", "height", "value", "skipAnimation", "layout"]);
    ...
    var _c = (0, useSlotProps_1.default)({
        ...
        additionalProps: __assign(__assign({}, other), { xOrigin: xOrigin, yOrigin: yOrigin, x: x, y: y, width: width, height: height, className: classes.root }),
    ...
    return (<Component {...barLabelProps} {...barLabelOwnerState}>
      {formattedLabelText}
    </Component>);
}
