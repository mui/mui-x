...
function BarLabelItem(props) {
    ...
    var deprecatedClasses = (0, barLabelClasses_1.useUtilityClasses)(ownerState);
    ...
    var _c = (0, useSlotProps_1.default)({
        ...
        additionalProps: __assign(__assign({}, other), { xOrigin: xOrigin, yOrigin: yOrigin, x: x, y: y, width: width, height: height, placement: barLabelPlacement, className: "".concat(classes.label, " ").concat(deprecatedClasses.root), 'data-highlighted': isHighlighted || undefined, 'data-faded': isFaded || undefined }),
