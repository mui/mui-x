...
describe('BarChart - checkScaleErrors', function () {
    describe('verticalLayout: true', function () {
        it('should throw an error when the x-axis is not a band scale', function () {
            expect(function () {
                ...
                (0, checkScaleErrors_1.checkScaleErrors)(true, 'seriesId', 
                // @ts-expect-error
                { stackedData: [[0, 1]] }, xKey, (_a = {},
                    _a[xKey] = { id: xKey, scaleType: 'linear' },
                    _a), yKey, (_b = {},
                    _b[yKey] = { id: yKey, scaleType: 'linear' },
                    _b));
        ...
        it('should throw an error when the x-axis has no data property', function () {
            expect(function () {
                ...
                // @ts-expect-error
                { stackedData: [[0, 1]] }, xKey, (_a = {},
                    _a[xKey] = { id: xKey, scaleType: 'band' },
                    _a), yKey, (_b = {},
                    _b[yKey] = { id: yKey, scaleType: 'linear' },
                    _b));
        ...
        it('should throw an error when the x-axis data property is smaller than the series data.', function () {
            expect(function () {
                ...
                // @ts-expect-error
                {
                    ...
                    _a[xKey] = { id: xKey, scaleType: 'band', data: [1] },
                    _a), yKey, (_b = {},
                    _b[yKey] = { id: yKey, scaleType: 'linear' },
                    _b));
        ...
        it('should throw an error when the y-axis is not a continuous scale', function () {
            expect(function () {
                ...
                // @ts-expect-error
                { stackedData: [[0, 1]] }, xKey, (_a = {},
                    _a[xKey] = { id: xKey, scaleType: 'band', data: [] },
                    _a), yKey, (_b = {},
                    _b[yKey] = { id: yKey, scaleType: 'band' },
                    _b));
    ...
    describe('verticalLayout: false', function () {
        it('should throw an error when the y-axis is not a band scale', function () {
            expect(function () {
                ...
                var xKey = constants_1.DEFAULT_X_AXIS_KEY;
                var yKey = constants_1.DEFAULT_Y_AXIS_KEY;
                (0, checkScaleErrors_1.checkScaleErrors)(false, 'seriesId', 
                // @ts-expect-error
                { stackedData: [[0, 1]] }, xKey, (_a = {},
                    _a[xKey] = { id: xKey, scaleType: 'linear' },
                    _a), yKey, (_b = {},
        ...
        it('should throw an error when the x-axis is not a continuous scale', function () {
            expect(function () {
                ...
                { stackedData: [[0, 1]] }, xKey, (_a = {},
                    _a[xKey] = { id: xKey, scaleType: 'band' },
                    _a), yKey, (_b = {},
                    _b[yKey] = { id: yKey, scaleType: 'band', data: [] },
                    _b));
