...
function BarElement(props) {
    ...
    var isFocused = (0, useIsItemFocused_1.useIsItemFocused)({
        seriesType: 'bar',
        seriesId: id,
        dataIndex: dataIndex,
    });
    ...
    var barProps = (0, useSlotProps_1.default)({
        ...
        additionalProps: __assign(__assign({}, interactionProps), { id: id, dataIndex: dataIndex, color: color, x: x, xOrigin: xOrigin, y: y, yOrigin: yOrigin, width: width, height: height, style: style, onClick: onClick, cursor: onClick ? 'pointer' : 'unset', stroke: 'none', fill: color, skipAnimation: skipAnimation, layout: layout, 'data-focused': isFocused || undefined }),
