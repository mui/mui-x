...
var useBarChartProps = function (props) {
    ...
    var chartContainerProps = __assign(__assign({}, rest), { series: seriesWithDefault, width: width, height: height, margin: margin, colors: colors, dataset: dataset, xAxis: processedXAxis, yAxis: processedYAxis, highlightedItem: highlightedItem, onHighlightChange: onHighlightChange, disableAxisListener: ((_a = slotProps === null || slotProps === void 0 ? void 0 : slotProps.tooltip) === null || _a === void 0 ? void 0 : _a.trigger) !== 'axis' &&
            (axisHighlight === null || axisHighlight === void 0 ? void 0 : axisHighlight.x) === 'none' &&
            (axisHighlight === null || axisHighlight === void 0 ? void 0 : axisHighlight.y) === 'none', className: className, skipAnimation: skipAnimation, plugins: BarChart_plugins_1.BAR_CHART_PLUGINS });
    var barPlotProps = {
