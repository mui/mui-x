...
var extremums_1 = require("./seriesConfig/extremums");
...
var buildDataWithAxisId = function (data, layout, testedDirection) {
    ...
    return {
        series: {
            id1: __assign({ id: 'id1', type: 'bar', color: 'red', data: data, minBarSize: 0, stackedData: data.length
                    ? [
                        [data[0], data[1]],
                        [data[2], data[3]],
                    ]
                    : [], layout: layout, valueFormatter: function () { return ''; } }, axesIds),
        },
        axis: {
