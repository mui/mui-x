...
var useChartContainerProps = function (props, ref) {
    var _a = props, width = _a.width, height = _a.height, margin = _a.margin, children = _a.children, series = _a.series, colors = _a.colors, dataset = _a.dataset, desc = _a.desc, onAxisClick = _a.onAxisClick, highlightedAxis = _a.highlightedAxis, onHighlightedAxisChange = _a.onHighlightedAxisChange, disableVoronoi = _a.disableVoronoi, voronoiMaxRadius = _a.voronoiMaxRadius, onItemClick = _a.onItemClick, disableAxisListener = _a.disableAxisListener, highlightedItem = _a.highlightedItem, onHighlightChange = _a.onHighlightChange, sx = _a.sx, title = _a.title, xAxis = _a.xAxis, yAxis = _a.yAxis, zAxis = _a.zAxis, rotationAxis = _a.rotationAxis, radiusAxis = _a.radiusAxis, skipAnimation = _a.skipAnimation, seriesConfig = _a.seriesConfig, plugins = _a.plugins, localeText = _a.localeText, slots = _a.slots, slotProps = _a.slotProps, experimentalFeatures = _a.experimentalFeatures, enableKeyboardNavigation = _a.enableKeyboardNavigation, brushConfig = _a.brushConfig, other = __rest(_a, ["width", "height", "margin", "children", "series", "colors", "dataset", "desc", "onAxisClick", "highlightedAxis", "onHighlightedAxisChange", "disableVoronoi", "voronoiMaxRadius", "onItemClick", "disableAxisListener", "highlightedItem", "onHighlightChange", "sx", "title", "xAxis", "yAxis", "zAxis", "rotationAxis", "radiusAxis", "skipAnimation", "seriesConfig", "plugins", "localeText", "slots", "slotProps", "experimentalFeatures", "enableKeyboardNavigation", "brushConfig"]);
