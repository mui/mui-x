...
export interface UseTreeViewFocusInstance {
  ...
  focusNode: (event: React.SyntheticEvent, itemId: string | null) => void;
...
export interface UseTreeViewFocusParameters {
   ...
   * @param {string} itemId The id of the node focused.
   * @param {string} value of the focused node.
   */
  onNodeFocus?: (event: React.SyntheticEvent, itemId: string) => void;
}
