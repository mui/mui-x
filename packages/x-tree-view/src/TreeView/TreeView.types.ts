...
export type SingleSelectTreeViewProps = UseSingleSelectTreeViewProps & TreeViewPropsBase;
export type MultiSelectTreeViewProps = UseMultiSelectTreeViewProps & TreeViewPropsBase;
