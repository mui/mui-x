...
import type { ExportedCalendarPickerProps } from '../../../components/CalendarPicker/CalendarPicker';
import type { ExportedClockPickerProps } from '../../../components/ClockPicker/ClockPickerInternal';

export interface CalendarAndClockProps<TDate>
  extends ExportedCalendarPickerProps<TDate>,
    ExportedClockPickerProps<TDate> {}

export type BaseToolbarProps<TDate> = CalendarAndClockProps<TDate> & {
  ampmInClock?: boolean;
  date: TDate;
