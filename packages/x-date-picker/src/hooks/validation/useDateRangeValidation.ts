...
import {DateValidationProps, DateValidationError, validateDate, ExportedDateValidationProps} from './useDateValidation'
import {RangeInput} from "../../models";

export interface DateRangeValidationProps<TDate> extends ExportedDateValidationProps<TDate>, ValidationProps<DateRangeValidationError, RangeInput<TDate>> {}
...
const isSameDateRangeError = (a: DateRangeValidationError, b: DateRangeValidationError | null) => b !== null && a[1] === b[1] && a[0] === b[0];
