...
import { validateDate, DateValidationError, ExportedDateValidationProps } from "./useDateValidation";
import { validateTime, TimeValidationError, ExportedTimeValidationProps} from "./useTimeValidation";

export interface DateTimeValidationProps<TDate>
    extends ExportedDateValidationProps<TDate>, ExportedTimeValidationProps<TDate>, ValidationProps<DateTimeValidationError, TDate> {}
