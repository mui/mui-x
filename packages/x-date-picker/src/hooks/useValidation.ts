...
import { DateValidationProps, validateDate, validateDateRange } from '../utils/date-utils';
import { DateTimeValidationProps, validateDateTime } from '../utils/date-time-utils';
import { TimeValidationProps, validateTime } from '../utils/time-utils';
import { RangeInput, MuiPickersAdapter } from '../models';
...
export type TimeValidationError = import('../utils/time-utils').TimeValidationError;
...
export type DateValidationError = import('../utils/date-utils').DateValidationError;
...
export type DateTimeValidationError = import('../utils/date-time-utils').DateTimeValidationError;
...
export type DateRangeValidationError = import('../utils/date-utils').DateRangeValidationError;
