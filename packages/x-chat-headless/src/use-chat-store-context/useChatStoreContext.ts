...
export function useChatStoreContext<Cursor = string>(optional: true): ChatStoreInContext<Cursor> | null;
...
export function useChatStoreContext<Cursor = string>(optional = false) {
  ...
  if (context == null && !optional) {
    throw new Error('MUI X Chat: useChatStoreContext must be used within a <ChatProvider> component');
  }
