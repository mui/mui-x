...
function CopilotTurnSpacer() {
  ...
  React.useLayoutEffect(() => {
    ...
    // `ResizeObserver` is unavailable in some non-browser environments (e.g.
    // jsdom). Guard so the spacer degrades to a one-shot measurement rather
    // than throwing.
