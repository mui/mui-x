 ...
 */
var StaticDatePicker = React.forwardRef(function StaticDatePicker(inProps, ref) {
    var _a, _b, _c;
    var defaultizedProps = (0, shared_1.useDatePickerDefaultizedProps)(inProps, 'MuiStaticDatePicker');
