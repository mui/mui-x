 ...
 */
var MobileDateTimePicker = React.forwardRef(function MobileDateTimePicker(inProps, ref) {
    var _a, _b, _c;
    var _d, _e, _f, _g, _h, _j, _k;
    var adapter = (0, usePickerAdapter_1.usePickerAdapter)();
    // Props with the default values common to all date time pickers
    var defaultizedProps = (0, shared_1.useDateTimePickerDefaultizedProps)(inProps, 'MuiMobileDateTimePicker');
    ...
    var ampmInClock = (_d = defaultizedProps.ampmInClock) !== null && _d !== void 0 ? _d : false;
    // Need to avoid adding the `meridiem` view when unexpected renderer is specified
    var shouldHoursRendererContainMeridiemView = ((_e = viewRenderers.hours) === null || _e === void 0 ? void 0 : _e.name) === timeViewRenderers_1.renderMultiSectionDigitalClockTimeView.name;
    ...
    var props = __assign(__assign({}, defaultizedProps), { viewRenderers: viewRenderers, format: (0, date_time_utils_1.resolveDateTimeFormat)(adapter, defaultizedProps), views: views, ampmInClock: ampmInClock, slots: __assign({ field: DateTimeField_1.DateTimeField }, defaultizedProps.slots), slotProps: __assign(__assign({}, defaultizedProps.slotProps), { field: function (ownerState) {
                var _a;
            ...
            }, toolbar: __assign({ hidden: false, ampmInClock: ampmInClock }, (_f = defaultizedProps.slotProps) === null || _f === void 0 ? void 0 : _f.toolbar), tabs: __assign({ hidden: false }, (_g = defaultizedProps.slotProps) === null || _g === void 0 ? void 0 : _g.tabs), layout: __assign(__assign({}, (_h = defaultizedProps.slotProps) === null || _h === void 0 ? void 0 : _h.layout), { sx: (0, utils_1.mergeSx)([
                    (_a = {},
                        ...
                        _a["& .".concat(DigitalClock_1.digitalClockClasses.root)] = (_c = {
                            ...
                            _c),
                        _a),
                ], (_k = (_j = defaultizedProps.slotProps) === null || _j === void 0 ? void 0 : _j.layout) === null || _k === void 0 ? void 0 : _k.sx) }) }) });
