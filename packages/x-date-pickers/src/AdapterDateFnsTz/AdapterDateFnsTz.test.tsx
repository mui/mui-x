...
import { AdapterDateFnsTz } from '@mui/x-date-pickers/AdapterDateFnsTz';
...
describe('<AdapterDateFns />', () => {
  describeGregorianAdapter(AdapterDateFnsTz, {
    formatDateTime: 'yyyy-MM-dd HH:mm:ss',
    setDefaultTimezone: (tz) => (tz ? TZDateMini.tz(tz) : new TZDateMini()),
    frenchLocale: fr,
    dateLibInstanceWithTimezoneSupport: TZDateMini,
  });

  describe('Adapter localization', () => {
    describe('Default locale', () => {
      const adapter = new AdapterDateFnsTz();
    ...
    describe('English', () => {
      ...
      const date = adapter.date(TEST_DATE_ISO_STRING) as TZDate;
    ...
    describe('Russian', () => {
      const adapter = new AdapterDateFnsTz({ locale: ru });
    ...
    it('Formatting', () => {
      const adapter = new AdapterDateFnsTz({ locale: enUS });
      const adapterRu = new AdapterDateFnsTz({ locale: ru });
      ...
      const expectDate = (
        ...
        const date = adapter.date('2020-02-01T23:44:00.000Z') as TZDate;
