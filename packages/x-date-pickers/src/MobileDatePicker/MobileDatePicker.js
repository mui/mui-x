 ...
 */
var MobileDatePicker = React.forwardRef(function MobileDatePicker(inProps, ref) {
    var _a;
    var adapter = (0, usePickerAdapter_1.usePickerAdapter)();
    // Props with the default values common to all date pickers
    var defaultizedProps = (0, shared_1.useDatePickerDefaultizedProps)(inProps, 'MuiMobileDatePicker');
    ...
    var props = __assign(__assign({}, defaultizedProps), { viewRenderers: viewRenderers, format: (0, date_utils_1.resolveDateFormat)(adapter, defaultizedProps, false), slots: __assign({ field: DateField_1.DateField }, defaultizedProps.slots), slotProps: __assign(__assign({}, defaultizedProps.slotProps), { field: function (ownerState) {
                var _a;
            ...
            }, toolbar: __assign({ hidden: false }, (_a = defaultizedProps.slotProps) === null || _a === void 0 ? void 0 : _a.toolbar) }) });
