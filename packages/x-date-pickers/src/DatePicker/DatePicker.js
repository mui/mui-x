...
var DesktopDatePicker_1 = require("../DesktopDatePicker");
var MobileDatePicker_1 = require("../MobileDatePicker");
 ...
 */
var DatePicker = React.forwardRef(function DatePicker(inProps, ref) {
    var props = (0, styles_1.useThemeProps)({ props: inProps, name: 'MuiDatePicker' });
    ...
    if (isDesktop) {
        return <DesktopDatePicker_1.DesktopDatePicker ref={ref} {...other}/>;
    }
    return <MobileDatePicker_1.MobileDatePicker ref={ref} {...other}/>;
});
