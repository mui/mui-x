...
var shared_1 = require("../DatePicker/shared");
 ...
 */
var DesktopDatePicker = React.forwardRef(function DesktopDatePicker(inProps, ref) {
    var _a, _b, _c;
    var adapter = (0, usePickerAdapter_1.usePickerAdapter)();
    // Props with the default values common to all date pickers
    var defaultizedProps = (0, shared_1.useDatePickerDefaultizedProps)(inProps, 'MuiDesktopDatePicker');
    var viewRenderers = __assign({ day: dateViewRenderers_1.renderDateViewCalendar, month: dateViewRenderers_1.renderDateViewCalendar, year: dateViewRenderers_1.renderDateViewCalendar }, defaultizedProps.viewRenderers);
    // Props with the default values specific to the desktop variant
    var props = __assign(__assign({}, defaultizedProps), { closeOnSelect: (_a = defaultizedProps.closeOnSelect) !== null && _a !== void 0 ? _a : true, viewRenderers: viewRenderers, format: (0, date_utils_1.resolveDateFormat)(adapter, defaultizedProps, false), yearsPerRow: (_b = defaultizedProps.yearsPerRow) !== null && _b !== void 0 ? _b : 4, slots: __assign({ field: DateField_1.DateField }, defaultizedProps.slots), slotProps: __assign(__assign({}, defaultizedProps.slotProps), { field: function (ownerState) {
                var _a;
            ...
            }, toolbar: __assign({ hidden: true }, (_c = defaultizedProps.slotProps) === null || _c === void 0 ? void 0 : _c.toolbar) }) });
