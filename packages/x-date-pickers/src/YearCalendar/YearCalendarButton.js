...
var DefaultYearButton = (0, styles_1.styled)('button', {
    ...
    overridesResolver: function (_, styles) {
        ...
        return [
            styles.button,
            (_a = {}, _a["&.".concat(yearCalendarClasses_1.yearCalendarClasses.disabled)] = styles.disabled, _a),
            (_b = {}, _b["&.".concat(yearCalendarClasses_1.yearCalendarClasses.selected)] = styles.selected, _b),
        ];
    },
})(function (_a) {
    var _b;
    ...
    return (__assign(__assign({ color: 'unset', backgroundColor: 'transparent', border: 0, outline: 0 }, theme.typography.subtitle1), (_b = { height: 36, width: 72, borderRadius: 18, cursor: 'pointer', '&:focus': {
                backgroundColor: theme.vars
                    ? "rgba(".concat(theme.vars.palette.action.activeChannel, " / ").concat(theme.vars.palette.action.focusOpacity, ")")
                    : (0, styles_1.alpha)(theme.palette.action.active, theme.palette.action.focusOpacity),
            }, '&:hover': {
                backgroundColor: theme.vars
                ...
                cursor: 'auto',
                pointerEvents: 'none',
            } }, _b["&.".concat(yearCalendarClasses_1.yearCalendarClasses.disabled)] = {
        color: (theme.vars || theme).palette.text.secondary,
    }, _b["&.".concat(yearCalendarClasses_1.yearCalendarClasses.selected)] = {
 ...
 */
exports.YearCalendarButton = React.memo(function YearCalendarButton(props) {
    var _a;
    ...
    var ownerState = __assign(__assign({}, pickerOwnerState), { isYearDisabled: disabled, isYearSelected: selected });
    ...
    var YearButton = (_a = slots === null || slots === void 0 ? void 0 : slots.yearButton) !== null && _a !== void 0 ? _a : DefaultYearButton;
    var yearButtonProps = (0, useSlotProps_1.default)({
