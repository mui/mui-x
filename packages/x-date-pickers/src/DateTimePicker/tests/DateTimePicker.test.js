        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    user = render(<DateTimePicker_1.DateTimePicker />).user;
                    return [4 /*yield*/, user.click(createRenderer_1.screen.getByLabelText(/Choose date/))];
                case 1:
                    _a.sent();
                    expect(createRenderer_1.screen.queryByRole('dialog')).to.not.equal(null);
                    return [2 /*return*/];
            }
        });
    }); });
