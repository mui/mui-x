...
import { MobileDateTimePicker2Props } from './MobileDateTimePicker2.types';
...
type MobileDateTimePickerComponent = (<TDate>(
  props: MobileDateTimePicker2Props<TDate> & React.RefAttributes<HTMLDivElement>,
...
const MobileDateTimePicker2 = React.forwardRef(function MobileDateTimePicker2<TDate>(
  inProps: MobileDateTimePicker2Props<TDate>,
  ...
  const { className, sx, ...defaultizedProps } = useDateTimePicker2DefaultizedProps<
    TDate,
    MobileDateTimePicker2Props<TDate>
  >(inProps, 'MuiMobileDateTimePicker2');
