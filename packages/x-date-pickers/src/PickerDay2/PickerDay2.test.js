...
var PickerDay2_1 = require("@mui/x-date-pickers/PickerDay2");
var pickers_1 = require("test/utils/pickers");
var describeConformance_1 = require("test/utils/describeConformance");
describe('<PickerDay2 />', function () {
    var render = (0, pickers_1.createPickerRenderer)().render;
    (0, describeConformance_1.describeConformance)(<PickerDay2_1.PickerDay2 day={pickers_1.adapterToUse.date()} outsideCurrentMonth={false} isFirstVisibleCell={false} isLastVisibleCell={false} selected onDaySelect={function () { }}/>, function () { return ({
        classes: PickerDay2_1.pickerDay2Classes,
    ...
    it('selects the date on click, Enter and Space', function () {
        ...
        render(<PickerDay2_1.PickerDay2 day={day} outsideCurrentMonth={false} isFirstVisibleCell={false} isLastVisibleCell={false} onDaySelect={handleDaySelect}/>);
    ...
    it('renders the day of the month by default', function () {
        render(<PickerDay2_1.PickerDay2 day={pickers_1.adapterToUse.date('2020-02-02T02:02:02.000')} onDaySelect={function () { }} outsideCurrentMonth={false} isFirstVisibleCell={false} isLastVisibleCell={false}/>);
    ...
    it('should render children instead of the day of the month when children prop is present', function () {
        render(<PickerDay2_1.PickerDay2 day={pickers_1.adapterToUse.date('2020-02-02T02:02:02.000')} outsideCurrentMonth={false} isFirstVisibleCell={false} isLastVisibleCell={false} onDaySelect={function () { }}>
        2 (free)
      </PickerDay2_1.PickerDay2>);
        var day = internal_test_utils_1.screen.getByRole('button');
