...
var useDateTimeField_1 = require("./useDateTimeField");
 ...
 */
var DateTimeField = React.forwardRef(function DateTimeField(inProps, inRef) {
    var themeProps = (0, styles_1.useThemeProps)({
        props: inProps,
        name: 'MuiDateTimeField',
    });
    var slots = themeProps.slots, slotProps = themeProps.slotProps, other = __rest(themeProps, ["slots", "slotProps"]);
    var textFieldProps = (0, PickerFieldUI_1.useFieldTextFieldProps)({
        slotProps: slotProps,
        ref: inRef,
        externalForwardedProps: other,
    });
    var fieldResponse = (0, useDateTimeField_1.useDateTimeField)(textFieldProps);
    return (<PickerFieldUI_1.PickerFieldUI slots={slots} slotProps={slotProps} fieldResponse={fieldResponse} defaultOpenPickerIcon={icons_1.CalendarIcon}/>);
});
