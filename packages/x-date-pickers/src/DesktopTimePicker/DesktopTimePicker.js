 ...
 */
var DesktopTimePicker = React.forwardRef(function DesktopTimePicker(inProps, ref) {
    var _a, _b, _c;
    var adapter = (0, usePickerAdapter_1.usePickerAdapter)();
    // Props with the default values common to all time pickers
    var defaultizedProps = (0, shared_1.useTimePickerDefaultizedProps)(inProps, 'MuiDesktopTimePicker');
    var _d = (0, date_time_utils_1.resolveTimeViewsResponse)(defaultizedProps), shouldRenderTimeInASingleColumn = _d.shouldRenderTimeInASingleColumn, resolvedViews = _d.views, timeSteps = _d.timeSteps;
    var renderTimeView = shouldRenderTimeInASingleColumn
    ...
    var views = !shouldHoursRendererContainMeridiemView
        ? resolvedViews.filter(function (view) { return view !== 'meridiem'; })
        : resolvedViews;
    // Props with the default values specific to the desktop variant
    var props = __assign(__assign({}, defaultizedProps), { ampmInClock: ampmInClock, timeSteps: timeSteps, viewRenderers: viewRenderers, format: (0, time_utils_1.resolveTimeFormat)(adapter, defaultizedProps), 
        // Setting only `hours` time view in case of single column time picker
        // Allows for easy view lifecycle management
        views: shouldRenderTimeInASingleColumn ? ['hours'] : views, slots: __assign({ field: TimeField_1.TimeField }, defaultizedProps.slots), slotProps: __assign(__assign({}, defaultizedProps.slotProps), { field: function (ownerState) {
                var _a;
            ...
            }, toolbar: __assign({ hidden: true, ampmInClock: ampmInClock }, (_c = defaultizedProps.slotProps) === null || _c === void 0 ? void 0 : _c.toolbar) }) });
