...
var useDateField_1 = require("./useDateField");
 ...
 */
var DateField = React.forwardRef(function DateField(inProps, inRef) {
    ...
    var fieldResponse = (0, useDateField_1.useDateField)(textFieldProps);
