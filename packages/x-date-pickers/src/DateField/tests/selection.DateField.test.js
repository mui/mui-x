...
describe('<DateField /> - Selection', function () {
    var render = (0, pickers_1.createPickerRenderer)().render;
    var renderWithProps = (0, pickers_1.buildFieldInteractions)({ render: render, Component: DateField_1.DateField }).renderWithProps;
    describe('Focus', function () {
        it('should select 1st section (v7) / all sections (v6) on mount (`autoFocus = true`)', function () {
        ...
        it('should select 1st section (v7) / all sections (v6) (`autoFocus = true`) with start separator', function () {
            // Test with accessible DOM structure
            var view = renderWithProps({
                enableAccessibleFieldDOMStructure: true,
                autoFocus: true,
                format: "- ".concat(pickers_1.adapterToUse.formats.year),
            });
        ...
        it('should not select 1st section (v7) on mount (`autoFocus = true` and `disabled = true`)', function () {
            // Test with accessible DOM structure
            var view = renderWithProps({
                enableAccessibleFieldDOMStructure: true,
                autoFocus: true,
            ...
            (0, pickers_1.expectFieldValueV7)(view.getSectionsContainer(), 'MM/DD/YYYY');
            expect((0, pickers_1.getCleanedSelectedContent)()).to.equal('');
            view.unmount();
        });
        ...
        it('should select all on <Tab> focus with start separator (v6 only)', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, input;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should select day on mobile (v6 only)', function () { return __awaiter(void 0, void 0, void 0, function () {
            var input;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should select day on desktop (v6 only)', function () { return __awaiter(void 0, void 0, void 0, function () {
            var view, input;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('Click', function () {
        ...
        it('should not select section on click (`disabled = true`)', function () { return __awaiter(void 0, void 0, void 0, function () {
            var view;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('key: Ctrl + A', function () {
        it('should select all sections', function () { return __awaiter(void 0, void 0, void 0, function () {
            var view, input;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should select all sections with start separator', function () { return __awaiter(void 0, void 0, void 0, function () {
            var view, input;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('key: ArrowRight', function () {
        it('should move selection to the next section when one section is selected', function () { return __awaiter(void 0, void 0, void 0, function () {
            var view, input;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should select the last section when all the sections are selected', function () { return __awaiter(void 0, void 0, void 0, function () {
            var view, input;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        expect((0, pickers_1.getCleanedSelectedContent)()).to.equal('MM/DD/YYYY');
                        internal_test_utils_1.fireEvent.keyDown(view.getSectionsContainer(), { key: 'ArrowRight' });
                        expect((0, pickers_1.getCleanedSelectedContent)()).to.equal('YYYY');
                        view.unmount();
                        // Test with non-accessible DOM structure
                        view = renderWithProps({ enableAccessibleFieldDOMStructure: false });
        ...
        it('should select the next section when editing after all the sections were selected', function () { return __awaiter(void 0, void 0, void 0, function () {
            var view, input;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        expect((0, pickers_1.getCleanedSelectedContent)()).to.equal('MM/DD/YYYY');
                        internal_test_utils_1.fireEvent.keyDown(view.getSectionsContainer(), { key: 'ArrowDown' });
                        expect((0, pickers_1.getCleanedSelectedContent)()).to.equal('12');
    ...
    describe('key: ArrowLeft', function () {
        it('should move selection to the previous section when one section is selected', function () { return __awaiter(void 0, void 0, void 0, function () {
            var view, input;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should select the first section when all the sections are selected', function () { return __awaiter(void 0, void 0, void 0, function () {
            var view, input;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should select the first section when `inputRef.current` is focused', function () {
            function TestCase() {
                var inputRef = React.useRef(null);
                return (<React.Fragment>
            <DateField_1.DateField inputRef={inputRef}/>
            <button onClick={function () { var _a; return (_a = inputRef.current) === null || _a === void 0 ? void 0 : _a.focus(); }}>Focus input</button>
          </React.Fragment>);
            }
            render(<TestCase />);
            internal_test_utils_1.fireEvent.click(internal_test_utils_1.screen.getByRole('button', { name: 'Focus input' }));
            expect((0, pickers_1.getCleanedSelectedContent)()).to.equal('MM');
        });
    });
});
