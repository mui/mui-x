...
describe('<StaticTimePicker />', () => {
  ...
  it('should allow view modification, but not update value when `readOnly` prop is passed', async () => {
    const selectEvent = {
      changedTouches: [
        {
          clientX: 150,
  ...
  it('should allow switching between views and display disabled options when `disabled` prop is passed', async () => {
    const selectEvent = {
      changedTouches: [
        {
          clientX: 150,
