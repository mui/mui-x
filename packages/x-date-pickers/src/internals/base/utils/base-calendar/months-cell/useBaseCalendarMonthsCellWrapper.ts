...
import { useBaseCalendarMonthsCell } from './useBaseCalendarMonthsCell';
import { useBaseCalendarMonthsGridOrListContext } from '../months-grid/BaseCalendarMonthsGridOrListContext';

export function useBaseCalendarMonthsCellWrapper(
  parameters: useBaseCalendarMonthsCellWrapper.Parameters,
): useBaseCalendarMonthsCellWrapper.ReturnValue {
  const { forwardedRef, value } = parameters;
  const baseRootContext = useBaseCalendarRootContext();
  const baseMonthListOrGridContext = useBaseCalendarMonthsGridOrListContext();
  ...
  const ctx = React.useMemo<useBaseCalendarMonthsCell.Context>(
    () => ({
      isSelected,
      isDisabled,
      isInvalid,
...
export namespace useBaseCalendarMonthsCellWrapper {
  export interface Parameters extends Pick<useBaseCalendarMonthsCell.Parameters, 'value'> {
    /**
  ...
  export interface ReturnValue {
     ...
     */
    ctx: useBaseCalendarMonthsCell.Context;
  }
}
