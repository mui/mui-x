 ...
 * - MobileTimePicker
 */
var useMobilePicker = function (_a) {
    var _b, _c, _d;
    ...
    var _e = (0, usePicker_1.usePicker)(__assign(__assign({}, pickerParams), { props: props, localeText: localeText, autoFocusView: true, viewContainerRole: 'dialog', variant: 'mobile', getStepNavigation: getStepNavigation })), providerProps = _e.providerProps, renderCurrentView = _e.renderCurrentView, ownerState = _e.ownerState;
    ...
    var slotProps = __assign(__assign({}, innerSlotProps), { toolbar: __assign(__assign({}, innerSlotProps === null || innerSlotProps === void 0 ? void 0 : innerSlotProps.toolbar), { titleId: labelId }), mobilePaper: __assign({ 'aria-labelledby': labelledById }, innerSlotProps === null || innerSlotProps === void 0 ? void 0 : innerSlotProps.mobilePaper) });
    var renderPicker = function () { return (<PickerProvider_1.PickerProvider {...providerProps}>
      <PickerFieldUI_1.PickerFieldUIContextProvider slots={slots} slotProps={slotProps} inputRef={inputRef}>
        <Field {...fieldProps}/>
        <PickersModalDialog_1.PickersModalDialog slots={slots} slotProps={slotProps}>
          <Layout {...slotProps === null || slotProps === void 0 ? void 0 : slotProps.layout} slots={slots} slotProps={slotProps}>
            {renderCurrentView()}
          </Layout>
        </PickersModalDialog_1.PickersModalDialog>
