...
var DesktopTimePicker_1 = require("../DesktopTimePicker");
var MobileTimePicker_1 = require("../MobileTimePicker");
 ...
 */
var TimePicker = React.forwardRef(function TimePicker(inProps, ref) {
    var props = (0, styles_1.useThemeProps)({ props: inProps, name: 'MuiTimePicker' });
    ...
    if (isDesktop) {
        return <DesktopTimePicker_1.DesktopTimePicker ref={ref} {...other}/>;
    }
    return <MobileTimePicker_1.MobileTimePicker ref={ref} {...other}/>;
});
