...
describe.only('<CalendarPicker />', () => {
  ...
  describe('view: year', () => {
    ...
    it.only('should go to next view without changing the date when no date of the new year is enabled', () => {
      const onChange = spy();
      ...
      const april = screen.getByText('2022', { selector: 'button' });
      fireEvent.click(april);
      clock.runToLast();
