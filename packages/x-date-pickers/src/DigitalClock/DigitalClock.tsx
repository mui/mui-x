...
import { type DigitalClockClasses, getDigitalClockUtilityClass } from './digitalClockClasses';
import { type DigitalClockOwnerState, type DigitalClockProps } from './DigitalClock.types';
