...
import type { TimelineGridEventDependencyHandle } from '../timeline-grid/event-dependency-handle/TimelineGridEventDependencyHandle';
...
declare module '@mui/x-scheduler-internals/internals' {
  interface EventDropDataLookup {
    ...
    TimelineGridEventDependencyHandle: TimelineGridEventDependencyHandle.DragData;
  }
}
