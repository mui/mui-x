...
import { ColumnsContainer, DataContainer, GridRoot, Window } from 'core/components/styled-wrappers/index';
import {
  AutoSizerWrapper,
  ColumnsHeader,
  Viewport,
...
import { Columns, DEFAULT_GRID_OPTIONS, ElementSize, GridOptions, RowsProp, GridApi } from 'core/models/index';
import { debounce, mergeOptions } from 'core/utils/index';
import { DATA_CONTAINER_CSS_CLASS } from 'core/constants/cssClassesConstants';
import { GridRootRef } from 'core/gridApiRef';
export const version = '__VERSION__';

export type GridOptionsProp = Partial<
...
export const DataGrid: React.FC<GridProps> = React.memo(({ rows, columns, options, loading, children }) => {
  ...
  const [internalOptions, setInternalOptions] = useState<GridOptions>(
    mergeOptions(DEFAULT_GRID_OPTIONS, {
      ...options,
      ...{ pagination: true, enableMultipleColumnsSorting: false, enableMultipleSelection: false },
    }),
  );
  useEffect(() => {
