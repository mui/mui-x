...
var asyncExec = util_1.default.promisify(child_process_1.exec);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    return [2 /*return*/, String(response).trim()];
                case 2:
                    _1 = _a.sent();
...
function getRawProjectId() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, execCLI("git config --local --get remote.origin.url")];
                case 1:
                    _a = (_b.sent()) ||
                        process.env.REPOSITORY_URL;
                    if (_a) return [3 /*break*/, 3];
                    return [4 /*yield*/, execCLI("git rev-parse --show-toplevel")];
                case 2:
                    _a = (_b.sent());
                    _b.label = 3;
...
function getAnonymousProjectId() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getRawProjectId()];
                case 1:
                    rawProjectId = _a.sent();
                    return [2 /*return*/, (0, crypto_1.createHash)('sha256').update(rawProjectId).digest('hex')];
            }
        });
    });
}
