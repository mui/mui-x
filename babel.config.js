...
const defaultAlias = {
  ...
  '@mui/x-adapter-date-fns-v2': resolveAliasPath('./packages/adapters/x-adapter-date-fns-v2/src'),
  '@mui/x-adapter-date-fns-v3': resolveAliasPath('./packages/adapters/x-adapter-date-fns-v3/src'),
