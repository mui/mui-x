  ...
  return [
    {
      ...
      path: 'packages/grid/x-grid/build/index-esm.js',
    },
    {
      name: '@mui/x-data-grid',
      path: 'packages/grid/data-grid/build/index-esm.js',
    },
    {
...
module.exports = async function webpackConfig(webpack, environment) {
  ...
  const configurations = entries.map((entry) => {
    return {
      ...
      resolve: {
        alias: {
          '@mui/x-data-grid': path.join(workspaceRoot, 'packages/grid/x-grid/build/index-esm.js'),
          '@mui/x-data-grid-pro': path.join(
            workspaceRoot,
            'packages/grid/data-grid/build/index-esm.js',
          ),
          '@mui/x-license-pro': path.join(workspaceRoot, 'packages/x-license/build/esm/index.js'),
        },
      },
